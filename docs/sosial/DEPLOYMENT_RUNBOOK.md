...
8. Buat master `SosialChannel` sandbox, isi credential/callback melalui write boundary admin, lalu hubungkan setiap jenis dana Zakat/Infaq/Shodaqoh ke channel yang sesuai.
   Jangan menghapus atau mengubah credential channel lama selama masih ada order terbuka.
...
- Dua donasi yang memakai SosialChannel berbeda menggunakan username/endpoint dan callback secret channel masing-masing.
- Callback yang ditandatangani secret SosialChannel lain ditolak.
