...
<body>
	<div id="camBox" style="width: 100%; height: 100%;">
		<div class="revdivshowimg"
			...
			<input style="font-size: 24px;text-align: center;" type="password" placeholder="Masukkan RFID" id="search" onkeydown="search(this)"/>  
			<br>
	...
	function loadDoc(qrCodeMessage) {
	  ...
	  xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
		  ...
		  cell1.innerHTML = (!obj.nim?"kode tidak ditemukan":obj.nim);
