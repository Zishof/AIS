...
.revdivshowimg {
	...
	webkit-box-shadow: 6px 0 10px rgba(0, 0, 0, .2), -6px 0 10px
		rgba(0, 0, 0, .2);
	-moz-box-shadow: 6px 0 10px rgba(0, 0, 0, .2), -6px 0 10px
		rgba(0, 0, 0, .2);
...
<body style="text-align: center;">
	...
	<div id="camBox" style="width: 100%; height: 100%;">
		...
		%>
			<div
				style="color: red; font-family: 'Open Sans', sans-serif; font-size: 11px;">
				<strong>*) Pastikan lokasi Anda telah tampil di peta sebelum klik "Ambil
					Lokasi"</strong>
			</div>
			<br>
			<h2 style="color: red; display: none;" id="title_data">
				Harap Tunggu, lokasi Anda sedang diproses, browser Anda jangan
				ditutup.. <br>
				<img alt="Gambar Loading"
					src="<%=Common.getRequestHostWithProtocol(request)%>/loading_icon.gif"
					width="65%" />
			</h2>
			...
			<button id="ambil_gambar" class="btn" onClick="take_snapshot()">
				<i class="fa fa-location-arrow fa-2x"></i> Ambil Lokasi
			</button>

			<p id="location"></p>
			<br>
			<div style="color: blue; font-size: 10px">*) Pastikan browser
				yang Anda gunakan sudah diizinkan akses lokasi.</div>
	...
	<script language="JavaScript">
		...
		function showPosition(position) {
			...
			document.getElementById("location").innerHTML = "<div style=\"color: blue;font-size: 10px\">Lokasi Anda :</div><br><iframe style=\"width:100%;height:650px\" frameborder=\"0\" scrolling=\"no\" marginheight=\"0\"  marginwidth=\"0\" src=\"https://maps.google.com/maps?q="+lat+","+lng+"&hl=id&z=14&amp;output=embed\"></iframe>";
		}
		...
		function getLocation() {
			if (navigator.geolocation) {
				  ...
				  document.getElementById("location").innerHTML = "<div style=\"color: blue;font-size: 10px\">Pastikan browser Anda mendukung akses lokasi GPS. Jika lokasi tidak diaktifkan, maka Anda tidak bisa melakukan absensi via Lokasi</div>";
				  return false;
			}
		}
		...
		function take_snapshot() {
			...
			document.getElementById("ambil_gambar").style.display="none";
			document.getElementById("title_data").style.display="block";

			setTimeout(dotake_snapshot(), 500);
		}

		function dotake_snapshot() {
