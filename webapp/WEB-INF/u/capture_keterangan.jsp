...
<body style="text-align: center;">
	...
	<div id="camBox" style="width: 100%; height: 100%;">
		...
		%>
				...
				<br>
				<h2 style="color:red;display: none;" id="title_data">Harap Tunggu, data Anda, browser Anda jangan ditutup..
				...
				<button id="ambil_gambar" class="btn" onClick="take_snapshot()"><i class="fa fa-check-square-o fa-2x"></i> Absen Sekarang</button>
				...
				<textarea id="keterangan" rows="10" cols="30"></textarea>
		...
		function take_snapshot() {
			...
			if(document.getElementById("keterangan").value==''){
				tampilkanPesanGagalFormal(
					...
					'<%= Common.getBahasaConfig("Kolom Keterangan belum diisi, padahal kolom tersebut wajib diisi sebelum foto dapat diambil.") %>',
					["Isi terlebih dahulu kolom Keterangan yang tersedia.", "Setelah terisi, silakan ulangi proses pengambilan foto."]
				);
				return;
			}
