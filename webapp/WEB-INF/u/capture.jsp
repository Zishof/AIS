...
<body style="text-align: center;">
	...
	<div id="camBox" style="width: 100%; height: 100%;">
		...
		%>
			<div style="color: red;font-family: 'Open Sans', sans-serif;font-size: 11px;"><strong>*) Pastikan gambar telah tampil sebelum klik "Ambil Gambar", dan wajah Anda tampak jelas</strong></div>
			<%
		} else { 
		%>
		<div style="color: red;font-family: 'Open Sans', sans-serif;font-size: 11px;"><strong>*) Pastikan gambar telah tampil sebelum klik "Ambil Gambar"</strong></div>
		<%
		} 
		%>
				<br>
				<h2 style="color:red;display: none;" id="title_data">Harap Tunggu, foto Anda sedang diproses, browser Anda jangan ditutup..
				...
				<button id="ambil_gambar" class="btn" onClick="take_snapshot()"><i class="fa fa-camera fa-2x"></i> Ambil Gambar</button>
	    ...
	    async function initializeCamera() {
		    ...
		    try {
		      ...
		      tampilkanPesanGagalFormal(
		        "pengaktifan kamera untuk pengambilan foto",
