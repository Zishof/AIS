<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <script src="<%=request.getContextPath() %>/component/adminlte/js/adminlte.js"></script>
   <!-- datepicker --> <script src="https://cdn.jsdelivr.net/npm/vanillajs-datepicker@1.3.4/dist/js/datepicker-full.min.js"></script>
   
   <!-- datepicker script --> <script src="./live-demo.js"></script>
    <script>
