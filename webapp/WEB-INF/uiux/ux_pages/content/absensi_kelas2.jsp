...
<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="card-header">
				<h3 class="card-title fw-bold">Absensi Kelas</h3>
					...
					<div class="row row-cols-1 row-cols-md-5 g-4 ms-3 me-3 mt-2 mb-5">
						...
						<div class="col">
							<div class="card h-150">
								...
								<div class="card-body">
									<h4 class="card-title">Judul Absensi</h4>
								</div>
								<div>
									<p class="card-text ms-3 mb-3">keterangan Absensi</p>
									
									

									<div class="d-grid gap-2 me-2 ms-2 mb-2">
										<button class="btn btn-primary" type="Buka Tugas" data-bs-toggle="modal" data-bs-target="#AbsenModal">Buka
											Absensi</button>
											
											<jsp:include
										page="/WEB-INF/uiux/ux_pages/content/modal/absensi_kelas.jsp"></jsp:include>
									</div>
