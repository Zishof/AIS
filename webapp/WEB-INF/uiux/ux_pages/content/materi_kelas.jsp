...
<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="card-header">
				<h3 class="card-title fw-bold">Materi Kelas</h3>
					...
					<div class="row row-cols-1 row-cols-md-5 g-4 ms-3 me-3 mt-2 mb-5">
						...
						<div class="col">
							<div class="card h-150">
								...
								<div class="card-body">
									<h4 class="card-title">Judul Materi</h4>
								</div>
								<div>
									<p class="card-text ms-3 mb-3">keterangan Materi</p>
									<jsp:include
										page="/WEB-INF/uiux/ux_pages/content/modal/catatan.jsp"></jsp:include>

									<div class="d-grid gap-2 me-2 ms-2 mb-2">
										<button class="btn btn-primary" type="Buka Tugas" data-bs-toggle="modal" data-bs-target="#exampleModal"><%= Common.getBahasaConfig("Buka Materi") %></button>
									</div>
						...
						<div class="col">
							<div class="card h-150">
								...
								<div>
									...
									<div class="d-grid gap-2 me-2 ms-2 mb-2">
										<button class="btn btn-primary" type="Buka Tugas"><%= Common.getBahasaConfig("Buka Materi") %></button>
									</div>
