...
<!-- Modal -->
<div class="modal fade" id="BuatPertemuan" data-bs-backdrop="static"
...
<div class="mb-3">
        ...
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" aria-label="Close"><%= Common.getBahasaConfig("Close") %></button>
