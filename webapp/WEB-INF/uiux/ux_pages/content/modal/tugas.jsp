...
<a href=""
	class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover"
	data-bs-toggle="modal" data-bs-target="#tugasModal"> Selengkapnya<i
	class="bi bi-link-45deg"></i>
</a>
	...
	<div class="modal-dialog modal-fullscreen">
		<div class="modal-content">
			<div class="modal-header">
				<h1 class="modal-title fs-5" id="tugasModalLabel"></h1>
...
<div class="row row-cols-1 row-cols-md-5 g-4 ms-3 me-3 mt-2 mb-5">
  ...
  <a
														href="<%=request.getContextPath()%>/main2?page=isi_tugas"
														type="button" class="btn btn-primary btn-sm mt-3">
														Buka Tugas</a>
</div>
