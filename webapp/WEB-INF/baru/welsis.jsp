...
if(hanya_tampil_jsp){
    ...
    // layanan milik modulnya SENDIRI (dipanggil linkService di modul/welsis/welsis.jsp).
    ...
    boolean psDiizinkan = "welsis".equals(p) && "_welsis_service".equals(s);
    if(!p.trim().isEmpty() && !s.trim().isEmpty() && psDiizinkan){
        try{
            ...
            e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit webapp/WEB-INF/baru/welsis.jsp:29");
            %>
...
%>
<jsp:include page="/WEB-INF/baru/modul/welsis/welsis.jsp"></jsp:include>
