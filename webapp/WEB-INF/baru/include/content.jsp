              ...
              <div class="card h-md-100">
                ...
                <div class="card-body pt-2">
                  <div class="row g-0 h-100 align-items-center">
                    <div class="col">
                      <div class="d-flex align-items-center"><img class="me-3" src="<%=request.getContextPath() %>/component/uiux/assets/img/icons/weather-icon.png" alt="" height="60" />
                        <div>
                  ...
                  <div class="table-responsive scrollbar">
                    <table class="table table-dashboard mb-0 table-borderless fs-10 border-200">
                      <thead class="bg-body-tertiary">
                        <tr>
                          <th class="text-900"><%= Common.getBahasaConfig("Best Selling Products") %></th>
                          <th class="text-900 text-end">Revenue ($3333)</th>
                          <th class="text-900 pe-x1 text-end" style="width: 8rem"><%= Common.getBahasaConfig("Revenue (%)") %></th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="<%=request.getContextPath() %>/component/uiux/assets/img/products/12.png" width="60" alt="" />
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="<%=request.getContextPath() %>/component/uiux/assets/img/products/10.png" width="60" alt="" />
                              <div class="flex-1 ms-3">
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="<%=request.getContextPath() %>/component/uiux/assets/img/products/11.png" width="60" alt="" />
                              <div class="flex-1 ms-3">
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="<%=request.getContextPath() %>/component/uiux/assets/img/products/14.png" width="60" alt="" />
                              <div class="flex-1 ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="<%=request.getContextPath() %>/component/uiux/assets/img/products/13.png" width="60" alt="" />
                              <div class="flex-1 ms-3">
              ...
              <div class="card h-100">
                ...
                <div class="card-body pb-0">
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 object-fit-cover rounded-2" src="<%=request.getContextPath() %>/component/uiux/assets/img/products/5-thumb.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                      ...
                      <div class="hover-actions end-0 top-50 translate-middle-y"><a class="btn btn-tertiary border-300 btn-sm me-1 text-600" data-bs-toggle="tooltip" data-bs-placement="top" title="Download" href="<%=request.getContextPath() %>/component/uiux/assets/img/icons/cloud-download.svg" download="download"><img src="<%=request.getContextPath() %>/component/uiux/assets/img/icons/cloud-download.svg" alt="" width="15" /></a>
                        <button class="btn btn-tertiary border-300 btn-sm me-1 text-600 shadow-none" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><img src="<%=request.getContextPath() %>/component/uiux/assets/img/icons/edit-alt.svg" alt="" width="15" /></button>
                      </div>
                    </div>
                  </div>
                  <hr class="text-200" />
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 object-fit-cover rounded-2" src="<%=request.getContextPath() %>/component/uiux/assets/img/products/3-thumb.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                  ...
                  <hr class="text-200" />
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="img-fluid" src="<%=request.getContextPath() %>/component/uiux/assets/img/icons/zip.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                  ...
                  <hr class="text-200" />
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 object-fit-cover rounded-2" src="<%=request.getContextPath() %>/component/uiux/assets/img/products/2-thumb.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                  ...
                  <hr class="text-200" />
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="img-fluid" src="<%=request.getContextPath() %>/component/uiux/assets/img/icons/docs.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                ...
                <div class="card-body py-2">
                  <div class="d-flex align-items-center position-relative mb-3">
                    <div class="avatar avatar-2xl status-online">
                      <img class="rounded-circle" src="<%=request.getContextPath() %>/component/uiux/assets/img/team/1.jpg" alt="" />
                  ...
                  <div class="d-flex align-items-center position-relative mb-3">
                    <div class="avatar avatar-2xl status-online">
                      <img class="rounded-circle" src="<%=request.getContextPath() %>/component/uiux/assets/img/team/2.jpg" alt="" />
                  ...
                  <div class="d-flex align-items-center position-relative mb-3">
                    <div class="avatar avatar-2xl status-away">
                      <img class="rounded-circle" src="<%=request.getContextPath() %>/component/uiux/assets/img/team/3.jpg" alt="" />
                  ...
                  <div class="d-flex align-items-center position-relative mb-3">
                    <div class="avatar avatar-2xl status-offline">
                      <img class="rounded-circle" src="<%=request.getContextPath() %>/component/uiux/assets/img/team/4.jpg" alt="" />
                  ...
                  <div class="d-flex align-items-center position-relative false">
                    <div class="avatar avatar-2xl status-offline">
                      <img class="rounded-circle" src="<%=request.getContextPath() %>/component/uiux/assets/img/team/5.jpg" alt="" />
