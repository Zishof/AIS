...
if(hanya_tampil_jsp){
    ...
    // layanan milik modulnya SENDIRI (dipanggil linkService di modul/tamu/tamu.jsp).
    ...
    boolean psDiizinkan = "tamu".equals(p) && "_tamu_service".equals(s);
    if(!p.trim().isEmpty() && !s.trim().isEmpty() && psDiizinkan){
        try{
            ...
            e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit webapp/WEB-INF/baru/tamu.jsp:29");
            %>
...
%>
<jsp:include page="/WEB-INF/baru/modul/tamu/tamu.jsp"></jsp:include>
