            ...
            <div class="card border-0 shadow-sm rounded-4 border-top border-primary border-4">
                ...
                <div class="card-header bg-white border-0 pt-4 pb-0 px-4">
                    <h5 class="fw-bold text-dark mb-1">
                        <i class="fas fa-trophy text-primary me-2"></i><%=Common.getBahasaConfig("Pusat Kegiatan Mahasiswa")%>
                    </h5>
                    <small class="text-muted mb-3 d-block"><%=Common.getBahasaConfig("Pantau dan kelola data pencapaian mahasiswa secara komprehensif.")%></small>
                    ...
                    <ul class="nav nav-tabs border-bottom-0" id="kegiatanTab<%=rndTab%>" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active fw-bold text-secondary" id="dashboard-tab-<%=rndTab%>" data-bs-toggle="tab" data-bs-target="#dashboard-pane-<%=rndTab%>" type="button" role="tab" aria-controls="dashboard-pane" aria-selected="true">
                                <i class="fas fa-chart-pie me-2"></i><%=Common.getBahasaConfig("Dashboard Kegiatan")%>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                ...
                <div class="card-body p-4 bg-light rounded-bottom-4">
                    <div class="tab-content" id="kegiatanTabContent<%=rndTab%>">
                        ...
                        <div class="tab-pane fade show active" id="dashboard-pane-<%=rndTab%>" role="tabpanel" aria-labelledby="dashboard-tab" tabindex="0">
                            <jsp:include page="/WEB-INF/baru/modul/kegiatan/_dashboard_kegiatan_mahasiswa.jsp"/>
                        </div>

                        <div class="tab-pane fade" id="data-pane-<%=rndTab%>" role="tabpanel" aria-labelledby="data-tab" tabindex="0">
                            <jsp:include page="/WEB-INF/baru/modul/kegiatan/_kegiatan_kemahasiswaan.jsp"/>
                        </div>
