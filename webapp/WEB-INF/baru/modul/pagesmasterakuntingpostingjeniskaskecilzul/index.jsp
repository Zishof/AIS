...
<%
    // /pages/master/akunting/posting_jenis_kas_kecil.zul
    String title = "Jurnal Saldo Awal Kas Kecil";
    String html = "<div style=\"font-family:Arial,sans-serif;padding:24px;\">" +
        ...
        "<p style=\"margin:8px 0 0;font-size:0.85em;color:#3b82f6;\">URL ZK: /pages/master/akunting/posting_jenis_kas_kecil.zul</p>" +
        "</div></div>";
    out.println(html);
%>
