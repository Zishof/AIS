...
<div class="container-fluid mt-4" style="position: relative; z-index: 3; min-height: 50vh;">
    <ul class="nav nav-tabs shadow-sm" id="mainTab<%=rnd%>" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active fw-bold" id="tab-matapelajaran<%=rnd%>" data-bs-toggle="tab" data-bs-target="#content-matapelajaran<%=rnd%>" type="button" role="tab" 
                data-url="<%=Common.ROOT%>/dsh?hanya_tampil_jsp=true&p=pagesmastersekolahmatapelajaranzul&s=_statistik_matapelajaran&baru=true&rnd=<%=rnd%>">
                <%= Common.getBahasaConfig("Matapelajaran") %>
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link fw-bold" id="tab-kurikulum<%=rnd%>" data-bs-toggle="tab" data-bs-target="#content-kurikulum<%=rnd%>" type="button" role="tab" 
                data-url="<%=Common.ROOT%>/dsh?hanya_tampil_jsp=true&p=pagesmastersekolahkurikulumsekolahzul&s=_statistik_kurikulum_sekolah&baru=true&rnd=<%=rnd%>">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link fw-bold" id="tab-dosen<%=rnd%>" data-bs-toggle="tab" data-bs-target="#content-dosen<%=rnd%>" type="button" role="tab" 
                data-url="<%=Common.ROOT%>/dsh?hanya_tampil_jsp=true&p=pagesmastersekolahguruzul&s=_statistik_guru&baru=true&rnd=<%=rnd%>">
                <%= Common.getBahasaConfig("Guru") %>
            </button>
        </li>
        <li class="nav-item" role="presentation">
    ...
    <div class="tab-content border-start border-end border-bottom p-4 bg-white shadow-sm" id="mainTabContent<%=rnd%>">
        <div class="tab-pane fade show active" id="content-matapelajaran<%=rnd%>" role="tabpanel"></div>
