...
<div class="animate__animated animate__fadeInUp" id="dashboardKaryaPegawai<%=rnd%>">
    <!-- KPI Row -->
...
(function(){
    ...
    function renderKpi(total, disetujui, proses) {
        ...
        var kpiRow = document.getElementById('kpiRow<%=rnd%>');
        kpiRow.innerHTML =
    ...
    async function muatDashboard<%=rnd%>() {
        ...
        var statusRows = await fetchSql(sqlStatus);
        renderStatus(statusRows);

        var terbaruRows = await fetchSql(sqlTerbaru);
        renderTerbaru(terbaruRows);
    }
