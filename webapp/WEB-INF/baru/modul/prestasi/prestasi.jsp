        ...
        <div class="card border-0 shadow-sm rounded-4 border-top border-primary border-4">
            <div class="card-header bg-white border-0 pt-4 pb-0 px-4">
                <h5 class="fw-bold text-dark mb-3">
                    <i class="fas fa-trophy text-primary me-2"></i><%=Common.getBahasaConfig("Pusat Manajemen Prestasi")%>
                </h5>
            ...
            <div class="card-body p-4 bg-light rounded-bottom-4">
                ...
                <% if (pt) { %>
                    <div class="tab-pane fade show active" id="mhs-pane-<%=rndTab%>" role="tabpanel" tabindex="0">
                        <jsp:include page="/WEB-INF/baru/modul/prestasi/_tab_mahasiswa.jsp" />
                    </div>
                    <% } %>
                    <% if (ya) { %>
                    <div class="tab-pane fade" id="siswa-pane-<%=rndTab%>" role="tabpanel" tabindex="0">
                        <jsp:include page="/WEB-INF/baru/modul/prestasi/_tab_siswa.jsp" />
                    </div>
                    <% } %>
                    <% if (pt) { %>
                    <div class="tab-pane fade" id="dosen-pane-<%=rndTab%>" role="tabpanel" tabindex="0">
                        <jsp:include page="/WEB-INF/baru/modul/prestasi/_tab_dosen.jsp" />
                    </div>
                    <% } %>
                    <% if (ya) { %>
                    <div class="tab-pane fade" id="guru-pane-<%=rndTab%>" role="tabpanel" tabindex="0">
                        <jsp:include page="/WEB-INF/baru/modul/prestasi/_tab_guru.jsp" />
                    </div>
                    <% } %>
                    <div class="tab-pane fade" id="pegawai-pane-<%=rndTab%>" role="tabpanel" tabindex="0">
                        <jsp:include page="/WEB-INF/baru/modul/prestasi/_tab_pegawai.jsp" />
                    </div>
                </div>
            </div>
        </div>
