    ...
    <div class="card shadow-sm border-0 h-100">
        ...
        <div class="card-header bg-white py-3 border-bottom-0 d-flex align-items-center">
            ...
            <h5 class="mb-0 fw-bold text-dark">
                <%=Common.getBahasaConfig("Jumlah kegiatan KKN") %>
            </h5>
        </div>
        
        <div class="card-body p-0">
            <div id="Jml_pertemuan_kkn" data-list='{"valueNames":["tahun","smt","jumlahMhs"],"page":5,"pagination":true}'>
                            ...
                            %>
                                <tr>
                                    <td colspan="3" class="text-center py-5 text-muted fst-italic">
                                        <%=Common.getBahasaConfig("Belum ada kegiatan KKN") %>
                                    </td>
