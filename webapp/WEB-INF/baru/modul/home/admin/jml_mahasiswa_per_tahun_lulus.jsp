...
<%
    ...
    sb.append("SELECT b.id AS jurusan_id, b.nama AS jurusan, a.tahunlulus, count(*) AS jumlah_siswa ");
    ...
    sb.append("AND a.status_keluar=1 "); // Filter Status Keluar = Lulus
    sb.append("AND a.tahunlulus > 1900 AND a.tahunlulus < 2100 ");
    ...
    sb.append("GROUP BY b.id, a.tahunlulus ");
    sb.append("ORDER BY b.id, a.tahunlulus DESC");

    // 3. Eksekusi Query dengan Null Safety
    List<Object[]> jurusans = Common.ambilSql(sb.toString());
    if (jurusans == null) {
        jurusans = new ArrayList<Object[]>(); // Mencegah Error Null Pointer
    }
%>
    ...
    <div class="card shadow-sm border-0 h-100">
        ...
        <div class="card-header bg-white py-3 border-bottom-0 d-flex align-items-center justify-content-between">
            <h5 class="mb-0 text-success fw-bold">
                <i class="fas fa-graduation-cap me-2"></i><%=Common.getBahasaConfig("Jml mahasiswa per tahun lulus") %>
            </h5>
        </div>
        
        <div class="card-body p-0">
            <div id="Jml_mahasiswa_per_tahun_lulus" data-list='{"valueNames":["prodi","tahun","jumlahMhs"],"page":5,"pagination":true}'>
                    ...
                    <table class="table table-striped table-hover align-middle mb-0">
                        ...
                        <tbody class="list small">
                            ...
                            <%
                                ...
                                for (Object[] obj : jurusans) {
                                    ...
                                    // Safety casting
                                    int tahunLulus = (obj[2] instanceof Number) ? ((Number) obj[2]).intValue() : 0;
                            ...
                            %>
                                <tr>
                                    ...
                                    <td class="tahun text-secondary"><%=tahunLulus %></td>
                                    <td class="jumlahMhs text-end pe-4">
                                        <span class="badge bg-success rounded-pill"><%=jumlahSiswa %></span>
                                    </td>
                                </tr>
                            <%
                                }
                        ...
                        <tfoot class="bg-light border-top">
                            <tr>
                                ...
                                <td></td>
                                <td class="text-end pe-4 fw-bold text-success fs-6"><%=total %></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
