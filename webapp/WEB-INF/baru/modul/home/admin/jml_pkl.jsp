...
<%
    ...
    sb.append("FROM mahasiswa_dapat_kelompok_kelompok_pkl aa ");
    ...
    // 3. Eksekusi Query
    List<Object[]> dataPKL = Common.ambilSql(sb.toString());
    if (dataPKL == null) {
        dataPKL = new ArrayList<Object[]>(); // Prevent NullPointer
    }
%>
    ...
    <div class="card shadow-sm border-0 h-100">
        <div class="card-header bg-white py-3 border-bottom-0 d-flex align-items-center justify-content-between">
            <h5 class="mb-0 text-primary fw-bold">
                <i class="fas fa-users-cog me-2"></i><%=Common.getBahasaConfig("Jumlah Peserta PKL") %>
            </h5>
        </div>
        
        <div class="card-body p-0">
            <div id="Jml_pkl" data-list='{"valueNames":["prodi","tahun","smt","jumlahMhs"],"page":5,"pagination":true}'>
                            ...
                            %>
                                <tr>
                                    <td colspan="4" class="text-center py-4 text-muted fst-italic">
                                        <%=Common.getBahasaConfig("Belum ada data PKL") %>
                                    </td>
                ...
                <jsp:include page="/WEB-INF/baru/componen/paging_default.jsp">
		            <jsp:param name="size" value="<%=dataPKL.size() %>" />
		        </jsp:include>
