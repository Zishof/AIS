...
<%
    ...
    String hasilUrl = Common.ROOT + "/baru?p=pagesmasterperkuliahanzul&s=laporan_per_ruangan_hasil&hanya_tampil_jsp=true";
%>
<div class="mb-3">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Jadwal Per Ruangan</li>
        </ol>
    </nav>
    <h5 class="fw-bold text-primary"><i class="fas fa-building me-2"></i>Jadwal Perkuliahan Per Ruangan</h5>
    <p class="text-muted small">Pemakaian ruangan per slot waktu.</p>
</div>
<%=LaporanPerkuliahanJspHelper.buildFilterFormAjax(p, hasilUrl, "laporan-per-ruangan", "hasil-per-ruangan")%>
<div id="hasil-per-ruangan">
