...
<%
    ...
    String hasilUrl = Common.ROOT + "/baru?p=pagesmasterperkuliahanzul&s=laporan_per_asisten_hasil&hanya_tampil_jsp=true";
%>
<div class="mb-3">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Jadwal Per Asisten</li>
        </ol>
    </nav>
    <h5 class="fw-bold text-primary"><i class="fas fa-user-graduate me-2"></i>Jadwal Perkuliahan Per Asisten</h5>
    <p class="text-muted small">Daftar perkuliahan yang memiliki dosen asisten (dosen 2).</p>
</div>
<%=LaporanPerkuliahanJspHelper.buildFilterFormAjax(p, hasilUrl, "laporan-per-asisten", "hasil-per-asisten")%>
<div id="hasil-per-asisten">
