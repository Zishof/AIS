...
<%
    ...
    try {
        ...
        out.print(LaporanPerkuliahanJspHelper.buildTabelPerKelas(sess, p));
    } catch (Exception ex) {
        ...
        if (sess != null && sess.isOpen()) try { sess.close(); } catch (Exception ig) { ais.common.ErrorAuditUtil.record(ig, "auto-audit(empty-catch) webapp/WEB-INF/baru/modul/pagesmasterperkuliahanzul/laporan_per_kelas_hasil.jsp:25");}
    }
%>
