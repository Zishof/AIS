...
<%
    ...
    String hasilUrl = Common.ROOT + "/baru?p=pagesmasterperkuliahanzul&s=laporan_per_kelas_hasil&hanya_tampil_jsp=true";
%>
<div class="mb-3">
    ...
    <h5 class="fw-bold text-primary"><i class="fas fa-door-open me-2"></i>Jadwal Perkuliahan Per Kelas</h5>
    <p class="text-muted small">Jadwal perkuliahan dikelompokkan per kelas/semester.</p>
</div>
<%=LaporanPerkuliahanJspHelper.buildFilterFormAjax(p, hasilUrl, "laporan-per-kelas", "hasil-per-kelas")%>
<div id="hasil-per-kelas">
