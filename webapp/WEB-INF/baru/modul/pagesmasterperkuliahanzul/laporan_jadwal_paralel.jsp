...
<%
    ...
    String hasilUrl = Common.ROOT + "/baru?p=pagesmasterperkuliahanzul&s=laporan_jadwal_paralel_hasil&hanya_tampil_jsp=true";
%>
<div class="mb-3">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Jadwal Paralel</li>
        </ol>
    </nav>
    <h5 class="fw-bold text-primary"><i class="fas fa-columns me-2"></i>Jadwal Perkuliahan Paralel</h5>
    <p class="text-muted small">Daftar perkuliahan yang bersifat paralel lintas kelas.</p>
</div>
<%=LaporanPerkuliahanJspHelper.buildFilterFormAjax(p, hasilUrl, "laporan-jadwal-paralel", "hasil-jadwal-paralel")%>
<div id="hasil-jadwal-paralel">
