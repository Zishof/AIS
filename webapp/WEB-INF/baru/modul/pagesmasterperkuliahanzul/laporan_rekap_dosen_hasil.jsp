...
<%
    ...
    try {
        ...
        out.print(LaporanPerkuliahanJspHelper.buildTabelRekapDosen(sess, p));
    } catch (Exception ex) {
        ...
        if (sess != null && sess.isOpen()) try { sess.close(); } catch (Exception ig) { ais.common.ErrorAuditUtil.record(ig, "auto-audit(empty-catch) webapp/WEB-INF/baru/modul/pagesmasterperkuliahanzul/laporan_rekap_dosen_hasil.jsp:25");}
    }
%>
