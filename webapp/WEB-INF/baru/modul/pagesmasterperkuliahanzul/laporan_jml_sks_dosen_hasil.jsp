...
<%
    ...
    try {
        ...
        out.print(LaporanPerkuliahanJspHelper.buildTabelJmlSksDosen(sess, p));
    } catch (Exception ex) {
        ...
        if (sess != null && sess.isOpen()) try { sess.close(); } catch (Exception ig) { ais.common.ErrorAuditUtil.record(ig, "auto-audit(empty-catch) webapp/WEB-INF/baru/modul/pagesmasterperkuliahanzul/laporan_jml_sks_dosen_hasil.jsp:25");}
    }
%>
