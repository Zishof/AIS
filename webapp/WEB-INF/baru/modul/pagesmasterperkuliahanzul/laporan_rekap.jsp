...
<%
    ...
    String hasilUrl = Common.ROOT + "/baru?p=pagesmasterperkuliahanzul&s=laporan_rekap_hasil&hanya_tampil_jsp=true";
%>
<div class="mb-3">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Rekap Semua Jadwal</li>
        </ol>
    </nav>
    <h5 class="fw-bold text-primary"><i class="fas fa-table me-2"></i>Rekap Semua Jadwal Perkuliahan</h5>
    <p class="text-muted small">Daftar lengkap seluruh kelas perkuliahan aktif sesuai filter.</p>
</div>
<%=LaporanPerkuliahanJspHelper.buildFilterFormAjax(p, hasilUrl, "laporan-rekap", "hasil-rekap")%>
<div id="hasil-rekap">
