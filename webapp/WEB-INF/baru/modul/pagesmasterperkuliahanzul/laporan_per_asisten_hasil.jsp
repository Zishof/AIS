...
<%
    ...
    try {
        ...
        out.print(LaporanPerkuliahanJspHelper.buildTabelPerAsisten(sess, p));
    } catch (Exception ex) {
        ...
        if (sess != null && sess.isOpen()) try { sess.close(); } catch (Exception ig) { ais.common.ErrorAuditUtil.record(ig, "auto-audit(empty-catch) webapp/WEB-INF/baru/modul/pagesmasterperkuliahanzul/laporan_per_asisten_hasil.jsp:25");}
    }
%>
