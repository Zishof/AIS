...
<%
    ...
    try {
        ...
        out.print(LaporanPerkuliahanJspHelper.buildTabelJadwalParalel(sess, p));
    } catch (Exception ex) {
        ...
        if (sess != null && sess.isOpen()) try { sess.close(); } catch (Exception ig) { ais.common.ErrorAuditUtil.record(ig, "auto-audit(empty-catch) webapp/WEB-INF/baru/modul/pagesmasterperkuliahanzul/laporan_jadwal_paralel_hasil.jsp:25");}
    }
%>
