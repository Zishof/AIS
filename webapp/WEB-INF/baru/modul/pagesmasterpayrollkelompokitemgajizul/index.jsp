...
<%
String[] _c = { "ais.database.model.payroll.KelompokItemGaji", "ais.database.model.KelompokItemGaji" };
Class _cls = null;
for (String _cn : _c) { try { _cls = Class.forName(_cn); break; } catch (ClassNotFoundException _e) { ais.common.ErrorAuditUtil.record(_e, "auto-audit(empty-catch) webapp/WEB-INF/baru/modul/pagesmasterpayrollkelompokitemgajizul/index.jsp:5");} }
if (_cls != null) {
