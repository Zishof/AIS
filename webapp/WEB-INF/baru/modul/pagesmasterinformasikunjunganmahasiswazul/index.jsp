...
<%
    // /pages/master/informasi_kunjungan_mahasiswa.zul
    String title = "Informasi Kunjungan Mahasiswa";
    String html = "<div style=\"font-family:Arial,sans-serif;padding:24px;\">" +
        ...
        "<p style=\"margin:8px 0 0;font-size:0.85em;color:#3b82f6;\">URL ZK: /pages/master/informasi_kunjungan_mahasiswa.zul</p>" +
        "</div></div>";
    out.println(html);
%>
