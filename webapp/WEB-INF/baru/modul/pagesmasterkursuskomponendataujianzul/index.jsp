...
<%
    // /pages/master/kursus/komponen_data_ujian.zul
    String title = "Komponen Produk Ujian";
    String html = "<div style=\"font-family:Arial,sans-serif;padding:24px;\">" +
        ...
        "<p style=\"margin:8px 0 0;font-size:0.85em;color:#3b82f6;\">URL ZK: /pages/master/kursus/komponen_data_ujian.zul</p>" +
        "</div></div>";
    out.println(html);
%>
