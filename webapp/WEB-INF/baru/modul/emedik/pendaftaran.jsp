...
%>
<div class="mb-3 d-flex justify-content-between"><div><h4>Pendaftaran Pasien</h4><p class="text-muted">Booking dan registrasi rawat jalan, rawat inap, serta UGD.</p></div><div><a class="btn btn-success align-self-start me-2" href="<%=request.getContextPath()%>/baru?p=emedik&amp;s=help&amp;mode=qa&amp;menu=emedik_pendaftaran"><i class="fas fa-comments"></i> Tanya Jawab</a><a class="btn btn-warning align-self-start" href="<%=request.getContextPath()%>/baru?p=emedik&amp;s=help&amp;menu=emedik_pendaftaran"><i class="fas fa-question-circle"></i> Bantuan</a></div></div>
