...
%>
<div class="mb-3 d-flex justify-content-between"><div><h4>Laporan eMedik</h4><p class="text-muted">Monitoring pendaftaran, tagihan, dan pembayaran layanan medis.</p></div><a class="btn btn-warning align-self-start" href="<%=request.getContextPath()%>/baru?p=emedik&amp;s=help&amp;menu=emedik_laporan"><i class="fas fa-question-circle"></i> Bantuan</a></div>
