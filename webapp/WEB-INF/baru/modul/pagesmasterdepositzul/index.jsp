...
<%
String[] _c = { "ais.database.model.Deposit" };
Class _cls = null;
for (String _cn : _c) { try { _cls = Class.forName(_cn); break; } catch (ClassNotFoundException _e) { ais.common.ErrorAuditUtil.record(_e, "auto-audit(empty-catch) webapp/WEB-INF/baru/modul/pagesmasterdepositzul/index.jsp:5");} }
if (_cls != null) {
    ...
    out.println(
        ...
        "<h5 style='margin:0 0 .4rem;font-weight:500;color:var(--color-text-primary)'>Deposit</h5>" +
