...
<%
    // /pages/master/bkd/laporan_rinci.zul
    String title = "Laporan Kinerja Rinci";
    String html = "<div style=\"font-family:Arial,sans-serif;padding:24px;\">" +
        ...
        "<p style=\"margin:8px 0 0;font-size:0.85em;color:#3b82f6;\">URL ZK: /pages/master/bkd/laporan_rinci.zul</p>" +
        "</div></div>";
    out.println(html);
%>
