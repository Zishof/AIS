...
(function(){
  ...
  function tombolCetak(r){
    return '<button class="btn btn-sm btn-outline-secondary me-1" title="Cetak / pratinjau"'
         + ' onclick="cetakDokumen' + RND + '(\'dpc\',' + r.id
         + ',\'' + esc(r.kode || "") + '\')">'
      ...
      .then(function(d){
        ...
        if (!rows.length){
          ...
          for (var i=0;i<rows.length;i++){
            ...
            var aksi = tombolCetak(r) + '<button class="btn btn-sm btn-outline-primary me-1" title="Lihat / ubah" onclick="dpForm' + RND + '(' + r.id + ')"><i class="fas fa-edit"></i></button>';
            if (disetujui){
