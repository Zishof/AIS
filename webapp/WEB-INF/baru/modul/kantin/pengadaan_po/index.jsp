...
(function(){
  ...
  function tombolCetak(r){
    return '<button class="btn btn-sm btn-outline-secondary me-1" title="Cetak / pratinjau"'
         + ' onclick="cetakDokumen' + RND + '(\'po\',' + r.id
         + ',\'' + esc(r.kode || "") + '\')">'
  ...
  function aksiHtml(r, st){
    ...
    var h = tombolCetak(r) + '<button class="btn btn-sm btn-outline-primary me-1" title="Lihat / ubah" onclick="poForm' + RND + '(' + r.id + ')"><i class="fas fa-edit"></i></button>';
    if (st === "DRAFT") {
