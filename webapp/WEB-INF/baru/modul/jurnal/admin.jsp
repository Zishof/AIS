...
(function(){
  ...
  var specs={
    masterJurnal:[['createJournal','Tambah jurnal',[['tenant','Tenant'],['title','Nama jurnal'],['slug','Slug'],['locale','Locale','id_ID']]],['updateProfiles','Simpan profil',[['collectionId','Collection ID'],['metadataProfile','Metadata profile JSON','textarea'],['workflowProfile','Workflow profile JSON','textarea'],['accessPolicy','Access policy JSON','textarea']]]],
