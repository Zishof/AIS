...
<%
    // /pages/master/library/item_tree.zul
    String title = "Publikasi Karya Ilmiah";
    String html = "<div style=\"font-family:Arial,sans-serif;padding:24px;\">" +
        ...
        "<p style=\"margin:8px 0 0;font-size:0.85em;color:#3b82f6;\">URL ZK: /pages/master/library/item_tree.zul</p>" +
        "</div></div>";
    out.println(html);
%>
