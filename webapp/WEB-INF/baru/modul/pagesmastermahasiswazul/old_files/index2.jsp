...
<ul class="nav nav-tabs" id="myTab" role="tablist">
	<li class="nav-item"><a class="nav-link active" id="Mahasiswa-tab"
		data-bs-toggle="tab" href="#tab-Mahasiswa" role="tab"
		aria-controls="tab-Mahasiswa" aria-selected="true">Mahasiswa</a></li>
	<li class="nav-item"><a class="nav-link" id="Pendukung-tab"
		data-bs-toggle="tab" href="#tab-Pendukung" role="tab"
		aria-controls="tab-Pendukung" aria-selected="false">Pendukung</a></li>
	<li class="nav-item"><a class="nav-link" id="Prestasi-tab"
		data-bs-toggle="tab" href="#tab-Prestasi" role="tab"
		aria-controls="tab-Prestasi" aria-selected="false">Prestasi</a></li>
</ul>
<div class="tab-content border border-top-0 p-3" id="myTabContentUtama">
	<div class="tab-pane fade show active" id="tab-Mahasiswa"
		...
		try {
			...
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit webapp/WEB-INF/baru/modul/pagesmastermahasiswazul/old_files/index2.jsp:194");
		}
		%>

	</div>
	<div class="tab-pane fade" id="tab-Pendukung" role="tabpanel"
		aria-labelledby="Pendukung-tab">



		<ul class="nav nav-tabs" id="myTab" role="tablist">
			<li class="nav-item"><a class="nav-link active" id="Kelas-tab"
				data-bs-toggle="tab" href="#tab-Kelas" role="tab"
				aria-controls="tab-Kelas" aria-selected="true">Kelas</a></li>
			<li class="nav-item"><a class="nav-link" id="Asrama-tab"
				data-bs-toggle="tab" href="#tab-Asrama" role="tab"
				aria-controls="tab-Asrama" aria-selected="false">Asrama</a></li>
			<li class="nav-item"><a class="nav-link" id="Prestasi-tab"
				data-bs-toggle="tab" href="#tab-Kelompok" role="tab"
				aria-controls="tab-Kelompok" aria-selected="false">Kelompok</a></li>
		</ul>

		<div class="tab-content border border-top-0 p-3"
			id="myTabContentPendukung">
			<div class="tab-pane fade show active" id="tab-Kelas" role="tabpanel"
				...
				<%
				try{
					tableColumns = new String[] { "nama", "fakultas", "jurusan", "tahunAngkatan", "dosenPaDefault", "aktif" };
					tableLabels = new String[] { "Nama", "Fakultas", "Program Studi", "Khusus Tahun Angkatan", "Khusus Dosen PA", "Aktif" };
					search = new String[] { "nama", "fakultas", "jurusan", "dosenPaDefault", "aktif" };
					String[] formsData = new String[] { "nama", "fakultas", "jurusan", "tahunAngkatan", "dosenPaDefault", "aktif" };
					paramRequired = new HashSet<String>();
					paramRequired.add("nama");

					paramTidakBolehSama = new HashSet<String>();
					paramTidakBolehSama.add("nama");

					// Generate HTML
					String htmlOutput = DynamicTableGenerator.generateTable(tableColumns, tableLabels, search, formsData,
							Common.getGeneratedBarCode(5), "Kelas", Kelas.class.getName(), paramRequired, paramTidakBolehSama);

					out.println(htmlOutput);
				}catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) webapp/WEB-INF/baru/modul/pagesmastermahasiswazul/old_files/index2.jsp:239");
			...
			<div class="tab-pane fade" id="tab-Asrama" role="tabpanel"
				aria-labelledby="Asrama-tab">

				<%
				tableColumns = new String[] { "nama", "fakultas", "jurusan", "tahunAngkatan", "keterangan", "aktif" };
				tableLabels = new String[] { "Nama", "Fakultas", "Jurusan", "Tahun Angkatan", "Keterangan", "Aktif" };
				search = new String[] { "nama", "fakultas", "jurusan", "tahunAngkatan", "aktif" };
				String[] formsDataAsrama = new String[] { "nama", "fakultas", "jurusan", "tahunAngkatan", "keterangan", "aktif" };
				paramRequired = new HashSet<String>();
				paramRequired.add("nama");
				...
				// Generate HTML
				String htmlOutputAsrama = DynamicTableGenerator.generateTable(tableColumns, tableLabels, search, formsDataAsrama,
						Common.getGeneratedBarCode(5), "Asrama", Asrama.class.getName(), paramRequired, paramTidakBolehSama);

				out.println(htmlOutputAsrama);
				%>

			</div>

			<div class="tab-pane fade" id="tab-Kelompok" role="tabpanel"
				aria-labelledby="Kelompok-tab">

				<%
				tableColumns = new String[] {"nama", "keterangan", };
				tableLabels = new String[] { "Nama", "Keterangan"};
				search = new String[] { "nama"};
				String[] formsDataKelompok = new String[] { "nama", "keterangan", "statusAwalMahasiswa", "smtMulai", "smtSampai",
				...
				// Generate HTML
				String htmlOutputKelompok = DynamicTableGenerator.generateTable(tableColumns, tableLabels, search, formsDataKelompok,
						Common.getGeneratedBarCode(5), "Kelompok", KelompokMahasiswa.class.getName(), paramRequired,
						paramTidakBolehSama);

				out.println(htmlOutputKelompok);
				%>
