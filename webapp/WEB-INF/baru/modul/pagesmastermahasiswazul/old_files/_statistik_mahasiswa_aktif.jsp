...
<%
    ...
    if ("get_html_detail".equals(actionParams)) {
        ...
        try {
            ...
            try { sess.disconnect(); } catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) webapp/WEB-INF/baru/modul/pagesmastermahasiswazul/old_files/_statistik_mahasiswa_aktif.jsp:64");}
            try { sess.close(); } catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) webapp/WEB-INF/baru/modul/pagesmastermahasiswazul/old_files/_statistik_mahasiswa_aktif.jsp:65");}
    ...
    try {
        ...
        e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit webapp/WEB-INF/baru/modul/pagesmastermahasiswazul/old_files/_statistik_mahasiswa_aktif.jsp:88");
    } finally {
        try { sessFilter.disconnect(); } catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) webapp/WEB-INF/baru/modul/pagesmastermahasiswazul/old_files/_statistik_mahasiswa_aktif.jsp:90");}
        try { sessFilter.close(); } catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) webapp/WEB-INF/baru/modul/pagesmastermahasiswazul/old_files/_statistik_mahasiswa_aktif.jsp:91");}
        HibernateUtil.closeSession();
    }
%>
