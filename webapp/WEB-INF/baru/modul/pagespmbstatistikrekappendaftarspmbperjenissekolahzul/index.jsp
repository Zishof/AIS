...
<%
    // /pages/pmb/statistik/rekap_pendaftar_spmb_per_jenis_sekolah.zul
    String title = "Rekap Pendaftar SPMB (Jenis Sekolah)";
    String html = "<div style=\"font-family:Arial,sans-serif;padding:24px;\">" +
        ...
        "<p style=\"margin:8px 0 0;font-size:0.85em;color:#3b82f6;\">URL ZK: /pages/pmb/statistik/rekap_pendaftar_spmb_per_jenis_sekolah.zul</p>" +
        "</div></div>";
    out.println(html);
%>
