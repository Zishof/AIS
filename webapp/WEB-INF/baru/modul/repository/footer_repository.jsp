...
<%
    // Inisialisasi Data Perguruan Tinggi khusus untuk Footer
    ...
    <div class="container text-center text-md-start">
        <div class="row text-center text-md-start">
            ...
            <div class="col-md-5 col-lg-5 col-xl-5 mx-auto mb-4">
                ...
                <p class="text-white-50 small pe-md-4 lh-lg"><%= Common.getBahasaConfig("Repositori Digital Terpadu. Platform pelestarian aset intelektual digital institusi yang mendukung penuh protokol standar pertukaran data seperti OAI-PMH untuk interoperabilitas publik.") %></p>
