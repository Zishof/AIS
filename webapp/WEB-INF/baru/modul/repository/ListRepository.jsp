  ...
  %>
    ...
    <section class="repo-wrap repo-section" id="repository-faq" aria-labelledby="repository-faq-title">
      ...
      <div class="repo-faq repo-faq-catalog">
        ...
        <%for(FaqItem faqItem:faq.items){%><details class="repo-card" id="faq-<%=faqItem.id%>"><summary><span><small><%=rh(faqItem.category)%></small><%=rh(faqItem.question)%></span></summary><div class="repo-faq-answer"><p><%=rh(faqItem.answer)%></p><a href="#repository-faq" class="repo-link">Kembali ke pencarian FAQ ↑</a></div></details><%}%>
      </div>
