...
<%
    // /pages/master/epsbed/transaksi_kapasitas_mahasiswa_baru.zul
    String title = "Transaksi Kapasitas Mahasiswa Baru";
    String html = "<div style=\"font-family:Arial,sans-serif;padding:24px;\">" +
        ...
        "<p style=\"margin:8px 0 0;font-size:0.85em;color:#3b82f6;\">URL ZK: /pages/master/epsbed/transaksi_kapasitas_mahasiswa_baru.zul</p>" +
        "</div></div>";
    out.println(html);
%>
