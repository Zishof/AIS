...
System.out.println("[HOME-CHECK] trace=" + trace + " elapsed=0ms START uri=" + request.getRequestURI() + " query=" + request.getQueryString());
...
<%
System.out.println("[HOME-CHECK] trace=" + trace + " elapsed=" + (System.currentTimeMillis() - start) + "ms FINISH committed=" + response.isCommitted());
%>
