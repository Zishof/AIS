    ...
    <div class="container">
        <div class="proposal-paper">
            ...
            <ul class="dash-list">
                ...
                <li><strong>Kurikulum Ganda & OBE:</strong> Mengimplementasikan <i>Outcome Based Education</i> (OBE) secara penuh — perumusan <strong>Profil Lulusan (PL)</strong> sebagai fondasi program studi, <strong>Capaian Pembelajaran Lulusan (CPL)</strong> berdasarkan 4 kategori SN-Dikti (<i>Sikap, Pengetahuan, Keterampilan Umum, Keterampilan Khusus</i>), <strong>Capaian Pembelajaran Mata Kuliah (CPMK)</strong> dengan bobot dan minimal ketercapaian per RPS, hingga <strong>Sub-CPMK</strong> sebagai indikator penilaian terkecil. Dilengkapi 3 siklus monitoring berkelanjutan: <strong>Loop 1</strong> (ketercapaian CPMK per semester), <strong>Loop 2</strong> (ketercapaian CPL per tahun akademik), <strong>Loop 3</strong> (evaluasi Profil Lulusan setiap 3–5 tahun via Tracer Study). Dasbor <strong>OBE</strong> mengukur kesiapan OBE institusi (tier Bronze/Silver/Gold/Platinum) dan menghasilkan rekomendasi <i>Continuous Quality Improvement</i> (CQI) otomatis. Fleksibel memadukan kurikulum Diknas dengan Kitab Kuning (khusus ePesantren).</li>
            </ul>
