    ...
    <div class="container">
        <div class="document-paper">
            ...
            <ul class="list-dash">
                ...
                <li><strong>Kurikulum OBE:</strong> Adaptasi <i>Outcome Based Education (OBE)</i> secara lengkap — perumusan <strong>Profil Lulusan (PL)</strong>, <strong>CPL</strong> berdasarkan 4 kategori SN-Dikti (<i>Sikap, Pengetahuan, Keterampilan Umum, Keterampilan Khusus</i>), <strong>CPMK</strong> per RPS dengan bobot dan minimal ketercapaian, serta <strong>Sub-CPMK</strong> sebagai indikator penilaian terkecil. Pemantauan melalui 3 loop CQI: <strong>Loop 1</strong> (ketercapaian CPMK per semester), <strong>Loop 2</strong> (ketercapaian CPL per tahun akademik), <strong>Loop 3</strong> (evaluasi PL tiap 3–5 tahun via Tracer Study). Dasbor <strong>PIKOBE</strong> menampilkan skor kesiapan OBE (Bronze/Silver/Gold/Platinum). Ditambah Kurikulum Ganda (Diknas & Pesantren).</li>
            </ul>
