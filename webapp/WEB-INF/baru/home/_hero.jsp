    ...
    <div class="home-shell">
        <div class="home-hero">
            ...
            <div class="home-hero-media" aria-hidden="true">
                ...
                <div class="home-float-card"><i class="fa-solid fa-building-columns"></i><span><strong><%=h(vm.terminology.institutionLabel)%> Digital</strong><small>Akademik, pustaka, repository</small></span></div>
            </div>
