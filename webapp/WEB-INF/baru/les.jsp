...
if(hanya_tampil_jsp){
	if(!p.trim().isEmpty() && !s.trim().isEmpty()){
        	  ...
        	  try{
        		  ...
        		  e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit webapp/WEB-INF/baru/les.jsp:32");
 					%>
  ...
  <body>
    ...
    <main class="main" id="top">
      <div class="container-fluid">
        ...
        <jsp:include page="/WEB-INF/baru/modul/les/landing_page.jsp"/>
...
<% 
		...
		e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit webapp/WEB-INF/baru/les.jsp:73");
	}
