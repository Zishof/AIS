...
request.setAttribute("nuiServicePage", "helper/format_kpi_detail");
request.setAttribute("nuiServiceTitle", "Format KPI Detail");
request.setAttribute("nuiServiceType", "form");
request.setAttribute("nuiServiceSourceClass", "FormatKpiDetailAction");
