...
request.setAttribute("nuiServicePage", "helper/perpustakaan_resources_helper");
request.setAttribute("nuiServiceTitle", "Perpustakaan Resources Helper");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "PerpustakaanResourcesHelper");
