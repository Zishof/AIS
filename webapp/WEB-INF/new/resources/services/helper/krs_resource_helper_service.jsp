...
request.setAttribute("nuiServicePage", "helper/krs_resource_helper");
request.setAttribute("nuiServiceTitle", "KRS Resource Helper");
request.setAttribute("nuiServiceType", "academic");
request.setAttribute("nuiServiceSourceClass", "KrsResourceHelper");
