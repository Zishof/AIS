...
request.setAttribute("nuiServicePage", "data_resource");
request.setAttribute("nuiServiceTitle", "Data Resource");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "DataResource");
