...
request.setAttribute("nuiServicePage", "pos_resource");
request.setAttribute("nuiServiceTitle", "Pos Resource");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "PosResource");
