...
request.setAttribute("nuiServicePage", "kode_tunjangan");
request.setAttribute("nuiServiceTitle", "Kode Tunjangan");
request.setAttribute("nuiServiceType", "finance");
request.setAttribute("nuiServiceSourceClass", "KodeTunjanganAction");
request.setAttribute("nuiServiceSourcePackage", "ais.action.master.payroll");
request.setAttribute("nuiServiceSourcePath", "src/ais/action/master/payroll/KodeTunjanganAction.java");
