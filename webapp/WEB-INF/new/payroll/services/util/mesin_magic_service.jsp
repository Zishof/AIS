...
request.setAttribute("nuiServicePage", "util/mesin_magic");
request.setAttribute("nuiServiceTitle", "Mesin Magic");
request.setAttribute("nuiServiceType", "finance");
request.setAttribute("nuiServiceSourceClass", "MesinMagic");
request.setAttribute("nuiServiceSourcePackage", "ais.action.master.payroll.util");
request.setAttribute("nuiServiceSourcePath", "src/ais/action/master/payroll/util/MesinMagic.java");
