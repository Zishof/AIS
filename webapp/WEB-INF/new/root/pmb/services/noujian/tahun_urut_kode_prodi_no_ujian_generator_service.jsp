...
request.setAttribute("nuiServicePage", "noujian/tahun_urut_kode_prodi_no_ujian_generator");
request.setAttribute("nuiServiceTitle", "Tahun Urut Kode Prodi No Ujian Generator");
request.setAttribute("nuiServiceType", "academic");
request.setAttribute("nuiServiceSourceClass", "TahunUrutKodeProdiNoUjianGenerator");
