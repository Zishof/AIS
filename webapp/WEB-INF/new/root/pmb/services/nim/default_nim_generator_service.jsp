...
request.setAttribute("nuiServicePage", "nim/default_nim_generator");
request.setAttribute("nuiServiceTitle", "Default NIM Generator");
request.setAttribute("nuiServiceType", "academic");
request.setAttribute("nuiServiceSourceClass", "DefaultNimGenerator");
