...
request.setAttribute("nuiServicePage", "nim/yy_prodi_status_pindahan_urut_nim_generator");
request.setAttribute("nuiServiceTitle", "NIM Generator");
request.setAttribute("nuiServiceType", "academic");
request.setAttribute("nuiServiceSourceClass", "YY_PRODI_STATUS_PINDAHAN_URUT_NimGenerator");
