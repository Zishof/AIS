...
request.setAttribute("nuiServicePage", "bms");
request.setAttribute("nuiServiceTitle", "BMS");
request.setAttribute("nuiServiceType", "integration");
request.setAttribute("nuiServiceSourceClass", "BMS");
request.setAttribute("nuiServiceSourcePackage", "ais.action.servlet");
request.setAttribute("nuiServiceSourcePath", "src/ais/action/servlet/BMS.java");
