...
request.setAttribute("nuiServicePage", "otto");
request.setAttribute("nuiServiceTitle", "Otto");
request.setAttribute("nuiServiceType", "integration");
request.setAttribute("nuiServiceSourceClass", "Otto");
request.setAttribute("nuiServiceSourcePackage", "ais.action.servlet");
request.setAttribute("nuiServiceSourcePath", "src/ais/action/servlet/Otto.java");
