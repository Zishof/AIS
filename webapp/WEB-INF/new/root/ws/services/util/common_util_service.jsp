...
request.setAttribute("nuiServicePage", "util/common_util");
request.setAttribute("nuiServiceTitle", "Common Util");
request.setAttribute("nuiServiceType", "integration");
request.setAttribute("nuiServiceSourceClass", "CommonUtil");
