<%--
    Adaptor native: Pemesanan Pengadaan Item

    Sumber menu : ais.action.report.format1.library.LaporanPemesanan
    Kontrak     : ais.common.newui.laporan.NewUiLaporanUmumController
                  (kunci registri "library_pemesanan_pengadaan", template library/pemesanan_pengadaan_semua)
...
request.setAttribute("nuiPage", "format1/library/laporan_pemesanan");
request.setAttribute("nuiPageTitle", "Pemesanan Pengadaan Item");
