...
request.setAttribute("nuiPage", "format1/sekolah/laporan_rapor_siswa");
request.setAttribute("nuiPageTitle", "Laporan Rapor Siswa");
...
request.setAttribute("nuiSourceClass", "LaporanRaporSiswa");
request.setAttribute("nuiSourcePackage", "ais.action.report.format1.sekolah");
request.setAttribute("nuiSourcePath", "src/ais/action/report/format1/sekolah/LaporanRaporSiswa.java");
