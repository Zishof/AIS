...
request.setAttribute("nuiServicePage", "helper/laporan_tanggal_util");
request.setAttribute("nuiServiceTitle", "Laporan Tanggal Util");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanTanggalUtil");
