...
request.setAttribute("nuiServicePage", "std9/laporan_akreditasi2_b");
request.setAttribute("nuiServiceTitle", "Laporan Akreditasi 2 B");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanAkreditasi2B");
