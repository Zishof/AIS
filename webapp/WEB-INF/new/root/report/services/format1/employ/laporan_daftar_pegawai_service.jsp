...
request.setAttribute("nuiServicePage", "format1/employ/laporan_daftar_pegawai");
request.setAttribute("nuiServiceTitle", "Laporan Daftar Pegawai");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanDaftarPegawai");
