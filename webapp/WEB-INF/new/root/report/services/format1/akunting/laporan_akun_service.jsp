...
request.setAttribute("nuiServicePage", "format1/akunting/laporan_akun");
request.setAttribute("nuiServiceTitle", "Laporan Akun");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanAkun");
