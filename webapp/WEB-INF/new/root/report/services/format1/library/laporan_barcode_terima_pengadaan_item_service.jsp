...
request.setAttribute("nuiServicePage", "format1/library/laporan_barcode_terima_pengadaan_item");
request.setAttribute("nuiServiceTitle", "Laporan Barcode Terima Pengadaan Item");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanBarcodeTerimaPengadaanItem");
