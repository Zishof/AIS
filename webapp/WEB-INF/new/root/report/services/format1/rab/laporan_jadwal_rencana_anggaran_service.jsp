...
request.setAttribute("nuiServicePage", "format1/rab/laporan_jadwal_rencana_anggaran");
request.setAttribute("nuiServiceTitle", "Laporan Jadwal Rencana Anggaran");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanJadwalRencanaAnggaran");
