...
request.setAttribute("nuiServicePage", "format1/payroll/laporan_slip_gaji_real_pegawai_per_orang");
request.setAttribute("nuiServiceTitle", "Laporan Slip Gaji Real Pegawai Per Orang");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanSlipGajiRealPegawaiPerOrang");
