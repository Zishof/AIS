...
request.setAttribute("nuiServicePage", "format1/payroll/laporan_item_gaji");
request.setAttribute("nuiServiceTitle", "Laporan Item Gaji");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanItemGaji");
