...
request.setAttribute("nuiServicePage", "format1/sirs/umum/laporan_kiup_per_periode");
request.setAttribute("nuiServiceTitle", "Laporan Kiup Per Periode");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanKiupPerPeriodeWindow");
