...
request.setAttribute("nuiServicePage", "format1/sirs/apotik/laporan_penggunaan_item");
request.setAttribute("nuiServiceTitle", "Laporan Penggunaan Item");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanPenggunaanItemWindow");
