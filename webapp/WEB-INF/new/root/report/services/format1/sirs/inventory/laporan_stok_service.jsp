...
request.setAttribute("nuiServicePage", "format1/sirs/inventory/laporan_stok");
request.setAttribute("nuiServiceTitle", "Laporan Stok");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanStokWindow");
