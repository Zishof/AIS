...
request.setAttribute("nuiServicePage", "format1/sekolah/laporan_album_siswa");
request.setAttribute("nuiServiceTitle", "Laporan Album Siswa");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanAlbumSiswa");
