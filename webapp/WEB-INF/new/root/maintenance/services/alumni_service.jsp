...
request.setAttribute("nuiServiceSourceClass", "AlumniAction");
...
request.setAttribute("nuiServiceMethods", new String[]{"doBeforeCompose", "doAfterCompose", "onInfo", "onLihatOnline", "onPengumuman", "onEvent"});
