...
request.setAttribute("nuiPage", "dosen_action_bisa_ngajar");
request.setAttribute("nuiPageTitle", "Dosen Action Bisa Ngajar");
...
request.setAttribute("nuiSourceClass", "DosenActionBisaNgajar");
request.setAttribute("nuiSourcePackage", "ais.action.master");
request.setAttribute("nuiSourcePath", "src/ais/action/master/DosenActionBisaNgajar.java");
