...
request.setAttribute("nuiPage", "matakuliah");
request.setAttribute("nuiPageTitle", "Matakuliah");
...
request.setAttribute("nuiSourceClass", "MatakuliahAction");
request.setAttribute("nuiSourcePackage", "ais.action.master");
request.setAttribute("nuiSourcePath", "src/ais/action/master/MatakuliahAction.java");
