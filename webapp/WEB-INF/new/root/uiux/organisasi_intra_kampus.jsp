...
request.setAttribute("nuiPage", "organisasi_intra_kampus");
request.setAttribute("nuiPageTitle", "Organisasi Intra Kampus");
...
request.setAttribute("nuiSourceClass", "OrganisasiIntraKampusAction");
request.setAttribute("nuiSourcePackage", "ais.action.master");
request.setAttribute("nuiSourcePath", "src/ais/action/master/OrganisasiIntraKampusAction.java");
