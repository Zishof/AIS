...
request.setAttribute("nuiPage", "blokir_mahasiswa");
request.setAttribute("nuiPageTitle", "Blokir Mahasiswa");
...
request.setAttribute("nuiSourceClass", "BlokirMahasiswaAction");
request.setAttribute("nuiSourcePackage", "ais.action.master");
request.setAttribute("nuiSourcePath", "src/ais/action/master/BlokirMahasiswaAction.java");
