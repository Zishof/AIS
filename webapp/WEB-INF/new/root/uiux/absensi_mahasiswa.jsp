...
request.setAttribute("nuiPageTitle", "Absensi Mahasiswa");
...
request.setAttribute("nuiSourceClass", "AbsensiMahasiswaAction");
request.setAttribute("nuiSourcePackage", "ais.action.master");
request.setAttribute("nuiSourcePath", "src/ais/action/master/AbsensiMahasiswaAction.java");
