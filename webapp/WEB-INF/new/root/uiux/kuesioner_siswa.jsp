...
request.setAttribute("nuiPage", "kuesioner_siswa");
request.setAttribute("nuiPageTitle", "Kuesioner Siswa");
...
request.setAttribute("nuiSourceClass", "KuesionerSiswaAction");
request.setAttribute("nuiSourcePackage", "ais.action.master");
request.setAttribute("nuiSourcePath", "src/ais/action/master/KuesionerSiswaAction.java");
