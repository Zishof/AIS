...
request.setAttribute("nuiServicePage", "matapelajaran_sekolah");
request.setAttribute("nuiServiceTitle", "Matapelajaran Sekolah");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "MatapelajaranSekolahAction");
