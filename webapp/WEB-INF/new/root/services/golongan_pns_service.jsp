...
request.setAttribute("nuiServicePage", "golongan_pns");
request.setAttribute("nuiServiceTitle", "Golongan Pns");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "GolonganPnsAction");
