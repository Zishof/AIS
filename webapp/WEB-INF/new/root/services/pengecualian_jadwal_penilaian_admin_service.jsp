...
request.setAttribute("nuiServicePage", "pengecualian_jadwal_penilaian_admin");
request.setAttribute("nuiServiceTitle", "Pengecualian Jadwal Penilaian Admin");
request.setAttribute("nuiServiceType", "academic");
request.setAttribute("nuiServiceSourceClass", "PengecualianJadwalPenilaianAdminAction");
