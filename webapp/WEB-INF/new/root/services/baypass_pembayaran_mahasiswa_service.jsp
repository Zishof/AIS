...
request.setAttribute("nuiServicePage", "baypass_pembayaran_mahasiswa");
request.setAttribute("nuiServiceTitle", "Baypass Pembayaran Mahasiswa");
request.setAttribute("nuiServiceType", "finance");
request.setAttribute("nuiServiceSourceClass", "BaypassPembayaranMahasiswaAction");
