...
request.setAttribute("nuiServicePage", "pembobotan_nilai");
request.setAttribute("nuiServiceTitle", "Pembobotan Nilai");
request.setAttribute("nuiServiceType", "academic");
request.setAttribute("nuiServiceSourceClass", "PembobotanNilaiAction");
