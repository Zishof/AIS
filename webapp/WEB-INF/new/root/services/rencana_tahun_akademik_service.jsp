...
request.setAttribute("nuiServicePage", "rencana_tahun_akademik");
request.setAttribute("nuiServiceTitle", "Rencana Tahun Akademik");
request.setAttribute("nuiServiceType", "academic");
request.setAttribute("nuiServiceSourceClass", "RencanaTahunAkademikAction");
