...
request.setAttribute("nuiServicePage", "pegawai_simple");
request.setAttribute("nuiServiceTitle", "Pegawai Simple");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "PegawaiSimpleAction");
