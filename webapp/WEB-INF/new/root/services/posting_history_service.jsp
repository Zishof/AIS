...
request.setAttribute("nuiServicePage", "posting_history");
request.setAttribute("nuiServiceTitle", "Posting History");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "PostingHistoryAction");
