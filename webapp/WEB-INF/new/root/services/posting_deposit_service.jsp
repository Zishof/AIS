...
request.setAttribute("nuiServicePage", "posting_deposit");
request.setAttribute("nuiServiceTitle", "Posting Deposit");
request.setAttribute("nuiServiceType", "finance");
request.setAttribute("nuiServiceSourceClass", "PostingDepositAction");
request.setAttribute("nuiServiceSourcePackage", "ais.action.master");
request.setAttribute("nuiServiceSourcePath", "src/ais/action/master/PostingDepositAction.java");
