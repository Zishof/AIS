...
request.setAttribute("nuiServiceMethods", new String[]{"onPengumumanPerkuliahan", "onKategoriPengumuman", "onTeksBerjalan", "doBeforeCompose", "doAfterCompose", "onEvent", "render", "init", "onAdd", "tampilkanPolling", "tandaiKehadiranHomeDitampilkan", "isKehadiranHomeDitampilkan", "tampilkanKehadiranDosen", "tampilkanKehadiranGuru", "tampilPengumuanLangsungTampil", "tampilPengumuman", "tampilPengumumanLain", "onSave", "initCriteria", "onSearchDefault", "initIsiPolling"});
request.setAttribute("nuiServiceLegacyRefs", new String[]{"/pages/master/pengumuman_perkuliahan.zul", "/pages/master/kategori_pengumuman.zul", "/pages/master/text_berjalan.zul"});
