...
request.setAttribute("nuiServicePage", "tampilan_pengumuman_alumni");
request.setAttribute("nuiServiceTitle", "Tampilan Pengumuman Alumni");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "TampilanPengumumanAlumniAction");
