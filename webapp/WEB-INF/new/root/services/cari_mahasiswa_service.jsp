...
request.setAttribute("nuiServicePage", "cari_mahasiswa");
request.setAttribute("nuiServiceTitle", "Cari Mahasiswa");
request.setAttribute("nuiServiceType", "academic");
request.setAttribute("nuiServiceSourceClass", "CariMahasiswaAction");
