...
request.setAttribute("nuiServicePage", "panel_peserta");
request.setAttribute("nuiServiceTitle", "Peserta Jadwal");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceEntities", new String[]{"PesertaJadwalAntarJemput"});
%>
