...
request.setAttribute("nuiServicePage", "panel_jadwal");
request.setAttribute("nuiServiceTitle", "Jadwal Antar Jemput");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceEntities", new String[]{"JadwalAntarJemput"});
%>
