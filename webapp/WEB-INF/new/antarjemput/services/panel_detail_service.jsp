...
request.setAttribute("nuiServicePage", "panel_detail");
request.setAttribute("nuiServiceTitle", "Detail Penjemputan");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceEntities", new String[]{"DetailPenjemputanAntarJemput"});
%>
