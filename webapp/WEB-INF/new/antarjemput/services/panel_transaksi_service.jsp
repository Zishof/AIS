...
request.setAttribute("nuiServicePage", "panel_transaksi");
request.setAttribute("nuiServiceTitle", "Transaksi Penjemputan");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceEntities", new String[]{"TransaksiPenjemputanAntarJemput"});
%>
