...
request.setAttribute("nuiServicePage", "panel_rute");
request.setAttribute("nuiServiceTitle", "Rute");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceEntities", new String[]{"RuteAntarJemput"});
%>
