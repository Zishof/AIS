...
request.setAttribute("nuiPage", "panel_jadwal");
request.setAttribute("nuiPageTitle", "Jadwal Antar Jemput");
request.setAttribute("nuiPageType", "list");
request.setAttribute("nuiEntityCandidates", new String[]{"JadwalAntarJemput"});
%>
