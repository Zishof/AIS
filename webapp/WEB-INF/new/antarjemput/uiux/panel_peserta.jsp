...
request.setAttribute("nuiPage", "panel_peserta");
request.setAttribute("nuiPageTitle", "Peserta Jadwal");
request.setAttribute("nuiPageType", "list");
request.setAttribute("nuiEntityCandidates", new String[]{"PesertaJadwalAntarJemput"});
%>
