...
request.setAttribute("nuiPage", "panel_detail");
request.setAttribute("nuiPageTitle", "Detail Penjemputan");
request.setAttribute("nuiPageType", "list");
request.setAttribute("nuiEntityCandidates", new String[]{"DetailPenjemputanAntarJemput"});
%>
