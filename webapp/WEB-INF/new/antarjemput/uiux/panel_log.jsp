...
request.setAttribute("nuiPage", "panel_log");
request.setAttribute("nuiPageTitle", "Log Notifikasi");
request.setAttribute("nuiPageType", "list");
request.setAttribute("nuiEntityCandidates", new String[]{"LogNotifikasiAntarJemput"});
%>
