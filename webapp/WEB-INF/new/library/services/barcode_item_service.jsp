...
request.setAttribute("nuiServicePage", "barcode_item");
request.setAttribute("nuiServiceTitle", "Barcode Item");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "BarcodeItemAction");
