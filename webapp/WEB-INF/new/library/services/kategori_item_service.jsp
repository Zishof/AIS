...
request.setAttribute("nuiServicePage", "kategori_item");
request.setAttribute("nuiServiceTitle", "Kategori Item");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "KategoriItemAction");
