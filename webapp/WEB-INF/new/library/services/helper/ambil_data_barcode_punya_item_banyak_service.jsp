...
request.setAttribute("nuiServicePage", "helper/ambil_data_barcode_punya_item_banyak");
request.setAttribute("nuiServiceTitle", "Ambil Data Barcode Punya Item Banyak");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "AmbilDataBarcodePunyaItemBanyak");
