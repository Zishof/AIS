...
request.setAttribute("nuiServicePage", "helper/ambil_data_kategori_item_banbox");
request.setAttribute("nuiServiceTitle", "Ambil Data Kategori Item Banbox");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "AmbilDataKategoriItemBanbox");
