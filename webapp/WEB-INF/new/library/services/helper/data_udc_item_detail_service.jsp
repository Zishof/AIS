...
request.setAttribute("nuiServicePage", "helper/data_udc_item_detail");
request.setAttribute("nuiServiceTitle", "Data Udc Item Detail");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "DataUdcItemDetailAction");
