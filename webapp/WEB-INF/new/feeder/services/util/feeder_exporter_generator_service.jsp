...
request.setAttribute("nuiServicePage", "util/feeder_exporter_generator");
request.setAttribute("nuiServiceTitle", "Feeder Exporter Generator");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "FeederExporterGenerator");
