...
request.setAttribute("nuiServicePage", "util/feeder_connector");
request.setAttribute("nuiServiceTitle", "Feeder Connector");
request.setAttribute("nuiServiceType", "integration");
request.setAttribute("nuiServiceSourceClass", "FeederConnector");
