<%--
    Adaptor native: Integrator Kelulusan

    Sumber ZK   : ais.action.master.feeder.integrator.KelulusanIntegrator
    Kontrak     : ais.common.newui.feeder.NewUiFeederIntegratorController (mode kelulusan)
...
request.setAttribute("nuiPage", "integrator/kelulusan_integrator");
request.setAttribute("nuiPageTitle", "Integrator Kelulusan");
