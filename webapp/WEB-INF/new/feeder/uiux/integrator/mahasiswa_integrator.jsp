<%--
    Adaptor native: Integrator Mahasiswa

    Sumber ZK   : ais.action.master.feeder.integrator.MahasiswaIntegrator
    Kontrak     : ais.common.newui.feeder.NewUiFeederIntegratorController (mode mahasiswa)
...
request.setAttribute("nuiPage", "integrator/mahasiswa_integrator");
request.setAttribute("nuiPageTitle", "Integrator Mahasiswa");
