<%--
    Adaptor native: Integrator KRS

    Sumber ZK   : ais.action.master.feeder.integrator.KrsIntegrator
    Kontrak     : ais.common.newui.feeder.NewUiFeederIntegratorController (mode krs)
...
request.setAttribute("nuiPage", "integrator/krs_integrator");
request.setAttribute("nuiPageTitle", "Integrator KRS");
