<%--
    Adaptor native: Integrator Matakuliah

    Sumber ZK   : ais.action.master.feeder.integrator.MatakuliahIntegrator
    Kontrak     : ais.common.newui.feeder.NewUiFeederIntegratorController (mode matakuliah)
...
request.setAttribute("nuiPage", "integrator/matakuliah_integrator");
request.setAttribute("nuiPageTitle", "Integrator Matakuliah");
