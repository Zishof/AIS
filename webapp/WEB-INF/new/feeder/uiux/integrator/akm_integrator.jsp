<%--
    Adaptor native: Integrator AKM

    Sumber ZK   : ais.action.master.feeder.integrator.AkmIntegrator
    Kontrak     : ais.common.newui.feeder.NewUiFeederIntegratorController (mode akm)
...
request.setAttribute("nuiPage", "integrator/akm_integrator");
request.setAttribute("nuiPageTitle", "Integrator AKM");
