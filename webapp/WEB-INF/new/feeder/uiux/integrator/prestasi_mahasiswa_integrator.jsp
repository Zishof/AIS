<%--
    Adaptor native: Integrator Prestasi Mahasiswa

    Sumber ZK   : ais.action.master.feeder.integrator.PrestasiMahasiswaIntegrator
    Kontrak     : ais.common.newui.feeder.NewUiFeederIntegratorController (mode prestasi_mahasiswa)
...
request.setAttribute("nuiPage", "integrator/prestasi_mahasiswa_integrator");
request.setAttribute("nuiPageTitle", "Integrator Prestasi Mahasiswa");
