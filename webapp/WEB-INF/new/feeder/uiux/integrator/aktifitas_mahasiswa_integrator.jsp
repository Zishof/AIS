<%--
    Adaptor native: Integrator Aktifitas Mahasiswa

    Sumber ZK   : ais.action.master.feeder.integrator.AktifitasMahasiswaIntegrator
    Kontrak     : ais.common.newui.feeder.NewUiFeederIntegratorController (mode aktifitas_mahasiswa)
...
request.setAttribute("nuiPage", "integrator/aktifitas_mahasiswa_integrator");
request.setAttribute("nuiPageTitle", "Integrator Aktifitas Mahasiswa");
