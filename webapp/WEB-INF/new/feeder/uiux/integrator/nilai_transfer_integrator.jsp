<%--
    Adaptor native: Integrator Nilai Transfer

    Sumber ZK   : ais.action.master.feeder.integrator.NilaiTransferIntegrator
    Kontrak     : ais.common.newui.feeder.NewUiFeederIntegratorController (mode nilai_transfer)
...
request.setAttribute("nuiPage", "integrator/nilai_transfer_integrator");
request.setAttribute("nuiPageTitle", "Integrator Nilai Transfer");
