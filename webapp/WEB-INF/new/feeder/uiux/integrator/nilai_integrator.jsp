<%--
    Adaptor native: Integrator Nilai

    Sumber ZK   : ais.action.master.feeder.integrator.NilaiIntegrator
    Kontrak     : ais.common.newui.feeder.NewUiFeederIntegratorController (mode nilai)
...
request.setAttribute("nuiPage", "integrator/nilai_integrator");
request.setAttribute("nuiPageTitle", "Integrator Nilai");
