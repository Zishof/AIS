...
request.setAttribute("nuiPage", "integrator/aktifitas_mahasiswa_peserta_mahasiswa_integrator");
request.setAttribute("nuiPageTitle", "Integrator Peserta Mahasiswa");
