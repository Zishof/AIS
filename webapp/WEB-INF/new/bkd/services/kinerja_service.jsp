...
request.setAttribute("nuiServiceMethods", new String[]{"onBidangPenunjang", "onBidangPendidikan", "onEvent", "onBidangPenelitian", "onBidangPengabdian", "tampilRingkasan", "doAfterCompose"});
