...
request.setAttribute("nuiServicePage", "helper/pedagang");
request.setAttribute("nuiServiceTitle", "Pedagang");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "PedagangAction");
