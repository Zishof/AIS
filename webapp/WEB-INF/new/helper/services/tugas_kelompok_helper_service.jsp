...
request.setAttribute("nuiServicePage", "tugas_kelompok_helper");
request.setAttribute("nuiServiceTitle", "Tugas Kelompok Helper");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "TugasKelompokHelper");
