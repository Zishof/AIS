...
request.setAttribute("nuiServicePage", "krs_helper");
request.setAttribute("nuiServiceTitle", "KRS Helper");
request.setAttribute("nuiServiceType", "academic");
request.setAttribute("nuiServiceSourceClass", "KrsHelper");
request.setAttribute("nuiServiceSourcePackage", "ais.action.master.helper");
request.setAttribute("nuiServiceSourcePath", "src/ais/action/master/helper/KrsHelper.java");
