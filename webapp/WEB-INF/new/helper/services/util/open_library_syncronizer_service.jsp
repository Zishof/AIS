...
request.setAttribute("nuiServicePage", "util/open_library_syncronizer");
request.setAttribute("nuiServiceTitle", "Open Library Syncronizer");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "OpenLibrarySyncronizer");
