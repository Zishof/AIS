...
request.setAttribute("nuiServicePage", "absensi_ui_helper");
request.setAttribute("nuiServiceTitle", "Absensi Ui Helper");
request.setAttribute("nuiServiceType", "academic");
request.setAttribute("nuiServiceSourceClass", "AbsensiUiHelper");
