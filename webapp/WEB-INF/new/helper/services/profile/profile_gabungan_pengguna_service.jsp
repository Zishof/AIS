...
request.setAttribute("nuiServicePage", "profile/profile_gabungan_pengguna");
request.setAttribute("nuiServiceTitle", "Profile Gabungan Pengguna");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "ProfileGabunganPengguna");
