...
request.setAttribute("nuiServicePage", "main_menu_helper");
request.setAttribute("nuiServiceTitle", "Main Menu Helper");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "MainMenuHelper");
