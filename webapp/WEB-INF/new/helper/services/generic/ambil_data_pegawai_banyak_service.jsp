...
request.setAttribute("nuiServicePage", "generic/ambil_data_pegawai_banyak");
request.setAttribute("nuiServiceTitle", "Ambil Data Pegawai Banyak");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "AmbilDataPegawaiBanyak");
