...
request.setAttribute("nuiServicePage", "kehadiran_presensi_util");
request.setAttribute("nuiServiceTitle", "Kehadiran Presensi Util");
request.setAttribute("nuiServiceType", "academic");
request.setAttribute("nuiServiceSourceClass", "KehadiranPresensiUtil");
