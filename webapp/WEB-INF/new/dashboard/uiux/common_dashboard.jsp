...
request.setAttribute("nuiPage", "common_dashboard");
request.setAttribute("nuiPageTitle", "Common Dashboard");
...
request.setAttribute("nuiSourceClass", "CommonDashboard");
request.setAttribute("nuiSourcePackage", "ais.action.master.dashboard");
request.setAttribute("nuiSourcePath", "src/ais/action/master/dashboard/CommonDashboard.java");
