...
request.setAttribute("nuiServicePage", "helper/dashboard_akunting_helper");
request.setAttribute("nuiServiceTitle", "Dashboard Akunting Helper");
request.setAttribute("nuiServiceType", "dashboard");
request.setAttribute("nuiServiceSourceClass", "DashboardAkuntingHelper");
