...
request.setAttribute("nuiServicePage", "admin/dasboard_kelulusan_siswa");
request.setAttribute("nuiServiceTitle", "Dasboard Kelulusan Siswa");
request.setAttribute("nuiServiceType", "dashboard");
request.setAttribute("nuiServiceSourceClass", "DasboardKelulusanSiswa");
