...
request.setAttribute("nuiServicePage", "admin/dasboard_guru");
request.setAttribute("nuiServiceTitle", "Dasboard Guru");
request.setAttribute("nuiServiceType", "dashboard");
request.setAttribute("nuiServiceSourceClass", "DasboardGuru");
