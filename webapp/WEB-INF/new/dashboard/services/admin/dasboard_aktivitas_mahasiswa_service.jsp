...
request.setAttribute("nuiServicePage", "admin/dasboard_aktivitas_mahasiswa");
request.setAttribute("nuiServiceTitle", "Dasboard Aktivitas Mahasiswa");
request.setAttribute("nuiServiceType", "dashboard");
request.setAttribute("nuiServiceSourceClass", "DasboardAktivitasMahasiswa");
