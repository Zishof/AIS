...
request.setAttribute("nuiServicePage", "admin/dashboard_ui_util");
request.setAttribute("nuiServiceTitle", "Dashboard Ui Util");
request.setAttribute("nuiServiceType", "dashboard");
request.setAttribute("nuiServiceSourceClass", "DashboardUiUtil");
