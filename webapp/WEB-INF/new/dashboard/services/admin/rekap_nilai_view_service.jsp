...
request.setAttribute("nuiServicePage", "admin/rekap_nilai_view");
request.setAttribute("nuiServiceTitle", "Rekap Nilai View");
request.setAttribute("nuiServiceType", "dashboard");
request.setAttribute("nuiServiceSourceClass", "RekapNilaiView");
