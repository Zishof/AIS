...
request.setAttribute("nuiServicePage", "jabatan_struktural");
request.setAttribute("nuiServiceTitle", "Jabatan Struktural");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "JabatanStrukturalAction");
