...
request.setAttribute("nuiServicePage", "util/employ_util");
request.setAttribute("nuiServiceTitle", "Employ Util");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "EmployUtil");
