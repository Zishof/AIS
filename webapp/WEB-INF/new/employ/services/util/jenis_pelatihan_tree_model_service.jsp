...
request.setAttribute("nuiServicePage", "util/jenis_pelatihan_tree_model");
request.setAttribute("nuiServiceTitle", "Jenis Pelatihan Tree Model");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "JenisPelatihanTreeModel");
