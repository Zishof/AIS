...
request.setAttribute("nuiServicePage", "riwayat_status_kepegawaian");
request.setAttribute("nuiServiceTitle", "Riwayat Status Kepegawaian");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "RiwayatStatusKepegawaianAction");
