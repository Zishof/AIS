...
request.setAttribute("nuiServicePage", "helper/masa_kerja_util");
request.setAttribute("nuiServiceTitle", "Masa Kerja Util");
request.setAttribute("nuiServiceType", "list");
request.setAttribute("nuiServiceSourceClass", "MasaKerjaUtil");
