...
Source: src/ais/action/master/employ/InsentifAction.java
...
request.setAttribute("nuiPage", "insentif");
request.setAttribute("nuiPageTitle", "Insentif");
...
request.setAttribute("nuiSourceClass", "InsentifAction");
request.setAttribute("nuiSourcePackage", "ais.action.master.employ");
request.setAttribute("nuiSourcePath", "src/ais/action/master/employ/InsentifAction.java");
