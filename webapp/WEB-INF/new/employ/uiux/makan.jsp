...
Source: src/ais/action/master/employ/MakanAction.java
...
request.setAttribute("nuiPage", "makan");
request.setAttribute("nuiPageTitle", "Makan");
...
request.setAttribute("nuiSourceClass", "MakanAction");
request.setAttribute("nuiSourcePackage", "ais.action.master.employ");
request.setAttribute("nuiSourcePath", "src/ais/action/master/employ/MakanAction.java");
...
request.setAttribute("nuiEntityCandidates", new String[]{"Golongan", "Peraturan", "Makan"});
%>
