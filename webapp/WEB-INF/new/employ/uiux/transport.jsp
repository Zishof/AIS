...
request.setAttribute("nuiPage", "transport");
request.setAttribute("nuiPageTitle", "Transport");
...
request.setAttribute("nuiSourceClass", "TransportAction");
request.setAttribute("nuiSourcePackage", "ais.action.master.employ");
request.setAttribute("nuiSourcePath", "src/ais/action/master/employ/TransportAction.java");
...
request.setAttribute("nuiEntityCandidates", new String[]{"Golongan", "Peraturan", "Transport"});
%>
