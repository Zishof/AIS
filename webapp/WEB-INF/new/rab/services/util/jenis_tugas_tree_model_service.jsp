...
request.setAttribute("nuiServicePage", "util/jenis_tugas_tree_model");
request.setAttribute("nuiServiceTitle", "Jenis Tugas Tree Model");
request.setAttribute("nuiServiceType", "finance");
request.setAttribute("nuiServiceSourceClass", "JenisTugasTreeModel");
request.setAttribute("nuiServiceSourcePackage", "ais.action.master.rab.util");
request.setAttribute("nuiServiceSourcePath", "src/ais/action/master/rab/util/JenisTugasTreeModel.java");
