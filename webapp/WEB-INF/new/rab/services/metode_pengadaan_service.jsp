...
request.setAttribute("nuiServicePage", "metode_pengadaan");
request.setAttribute("nuiServiceTitle", "Metode Pengadaan");
request.setAttribute("nuiServiceType", "finance");
request.setAttribute("nuiServiceSourceClass", "MetodePengadaanAction");
