...
request.setAttribute("nuiPage", "matapelajaran");
request.setAttribute("nuiPageTitle", "Matapelajaran");
...
request.setAttribute("nuiSourceClass", "MatapelajaranAction");
request.setAttribute("nuiSourcePackage", "ais.action.master.sekolah");
request.setAttribute("nuiSourcePath", "src/ais/action/master/sekolah/MatapelajaranAction.java");
