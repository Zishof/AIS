...
request.setAttribute("nuiPage", "hukuman");
request.setAttribute("nuiPageTitle", "Hukuman");
...
request.setAttribute("nuiSourceClass", "HukumanAction");
request.setAttribute("nuiSourcePackage", "ais.action.master.sekolah");
request.setAttribute("nuiSourcePath", "src/ais/action/master/sekolah/HukumanAction.java");
...
request.setAttribute("nuiEntityCandidates", new String[]{"Hukuman"});
%>
