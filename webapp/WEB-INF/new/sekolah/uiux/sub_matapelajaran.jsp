...
request.setAttribute("nuiPage", "sub_matapelajaran");
request.setAttribute("nuiPageTitle", "Sub Matapelajaran");
...
request.setAttribute("nuiSourceClass", "SubMatapelajaranAction");
request.setAttribute("nuiSourcePackage", "ais.action.master.sekolah");
request.setAttribute("nuiSourcePath", "src/ais/action/master/sekolah/SubMatapelajaranAction.java");
...
request.setAttribute("nuiEntityCandidates", new String[]{"SubMatapelajaran", "Matapelajaran"});
%>
