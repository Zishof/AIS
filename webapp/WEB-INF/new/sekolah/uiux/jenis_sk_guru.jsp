...
request.setAttribute("nuiPage", "jenis_sk_guru");
request.setAttribute("nuiPageTitle", "Jenis SK Guru");
...
request.setAttribute("nuiSourceClass", "JenisSKGuruAction");
request.setAttribute("nuiSourcePackage", "ais.action.master.sekolah");
request.setAttribute("nuiSourcePath", "src/ais/action/master/sekolah/JenisSKGuruAction.java");
...
request.setAttribute("nuiEntityCandidates", new String[]{"JenisSKGuru", "LampiranLain"});
%>
