...
Source: src/ais/action/master/sekolah/JenisGuruAction.java
...
request.setAttribute("nuiPage", "jenis_guru");
request.setAttribute("nuiPageTitle", "Jenis Guru");
...
request.setAttribute("nuiSourceClass", "JenisGuruAction");
request.setAttribute("nuiSourcePackage", "ais.action.master.sekolah");
request.setAttribute("nuiSourcePath", "src/ais/action/master/sekolah/JenisGuruAction.java");
...
request.setAttribute("nuiEntityCandidates", new String[]{"JenisGuru"});
%>
