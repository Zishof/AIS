...
Source: src/ais/action/master/sekolah/PembinaSiswaAction.java
...
request.setAttribute("nuiPage", "pembina_siswa");
request.setAttribute("nuiPageTitle", "Pembina Siswa");
...
request.setAttribute("nuiSourceClass", "PembinaSiswaAction");
request.setAttribute("nuiSourcePackage", "ais.action.master.sekolah");
request.setAttribute("nuiSourcePath", "src/ais/action/master/sekolah/PembinaSiswaAction.java");
...
request.setAttribute("nuiEntityCandidates", new String[]{"Yayasan", "PembinaSiswa"});
%>
