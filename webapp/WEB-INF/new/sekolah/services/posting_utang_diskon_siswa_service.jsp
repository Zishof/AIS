...
request.setAttribute("nuiServicePage", "posting_utang_diskon_siswa");
request.setAttribute("nuiServiceTitle", "Posting Utang Diskon Siswa");
request.setAttribute("nuiServiceType", "finance");
request.setAttribute("nuiServiceSourceClass", "PostingUtangDiskonSiswaAction");
request.setAttribute("nuiServiceSourcePackage", "ais.action.master.sekolah");
request.setAttribute("nuiServiceSourcePath", "src/ais/action/master/sekolah/PostingUtangDiskonSiswaAction.java");
