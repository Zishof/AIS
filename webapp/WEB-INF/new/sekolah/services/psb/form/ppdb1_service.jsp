...
request.setAttribute("nuiServicePage", "psb/form/ppdb1");
request.setAttribute("nuiServiceTitle", "1");
request.setAttribute("nuiServiceType", "form");
request.setAttribute("nuiServiceSourceClass", "PPDB1");
request.setAttribute("nuiServiceSourcePackage", "ais.action.master.sekolah.psb.form");
request.setAttribute("nuiServiceSourcePath", "src/ais/action/master/sekolah/psb/form/PPDB1.java");
