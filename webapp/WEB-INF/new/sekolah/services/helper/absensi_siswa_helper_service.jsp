...
request.setAttribute("nuiServicePage", "helper/absensi_siswa_helper");
request.setAttribute("nuiServiceTitle", "Absensi Siswa Helper");
request.setAttribute("nuiServiceType", "academic");
request.setAttribute("nuiServiceSourceClass", "AbsensiSiswaHelper");
