...
request.setAttribute("nuiServicePage", "dana_penerimaan_sapto");
request.setAttribute("nuiServiceTitle", "Dana Penerimaan SAPTO");
request.setAttribute("nuiServiceType", "integration");
request.setAttribute("nuiServiceSourceClass", "DanaPenerimaanSaptoAction");
