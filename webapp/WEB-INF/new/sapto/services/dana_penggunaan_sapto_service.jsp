...
request.setAttribute("nuiServicePage", "dana_penggunaan_sapto");
request.setAttribute("nuiServiceTitle", "Dana Penggunaan SAPTO");
request.setAttribute("nuiServiceType", "integration");
request.setAttribute("nuiServiceSourceClass", "DanaPenggunaanSaptoAction");
