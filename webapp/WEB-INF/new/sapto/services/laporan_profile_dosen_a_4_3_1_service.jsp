...
request.setAttribute("nuiServicePage", "laporan_profile_dosen_a_4_3_1");
request.setAttribute("nuiServiceTitle", "Laporan Profile Dosen 4 3 1");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanProfileDosen_A_4_3_1");
