...
request.setAttribute("nuiServicePage", "laporan_profile_mahasiswa_dan_lulusan_a_3_2_4");
request.setAttribute("nuiServiceTitle", "Laporan Profile Mahasiswa Dan Lulusan 3 2 4");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanProfileMahasiswaDanLulusan_A_3_2_4");
