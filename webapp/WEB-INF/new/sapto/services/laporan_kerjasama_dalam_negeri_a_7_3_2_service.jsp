...
request.setAttribute("nuiServicePage", "laporan_kerjasama_dalam_negeri_a_7_3_2");
request.setAttribute("nuiServiceTitle", "Laporan Kerjasama Dalam Negeri 7 3 2");
request.setAttribute("nuiServiceType", "report");
request.setAttribute("nuiServiceSourceClass", "LaporanKerjasamaDalamNegeri_A_7_3_2");
