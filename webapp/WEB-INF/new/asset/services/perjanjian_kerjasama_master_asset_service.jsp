...
request.setAttribute("nuiServicePage", "perjanjian_kerjasama_master_asset");
request.setAttribute("nuiServiceTitle", "Perjanjian Kerjasama Master Asset");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "PerjanjianKerjasamaMasterAssetAction");
