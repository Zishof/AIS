...
request.setAttribute("nuiServicePage", "helper/sinkron_persetujuan_sop_pengadaan_helper");
request.setAttribute("nuiServiceTitle", "Sinkron Persetujuan SOP Pengadaan Helper");
request.setAttribute("nuiServiceType", "integration");
request.setAttribute("nuiServiceSourceClass", "SinkronPersetujuanSopPengadaanHelper");
