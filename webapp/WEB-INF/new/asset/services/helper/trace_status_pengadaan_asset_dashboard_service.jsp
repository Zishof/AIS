...
request.setAttribute("nuiServicePage", "helper/trace_status_pengadaan_asset_dashboard");
request.setAttribute("nuiServiceTitle", "Trace Status Pengadaan Asset Dashboard");
request.setAttribute("nuiServiceType", "dashboard");
request.setAttribute("nuiServiceSourceClass", "TraceStatusPengadaanAssetDashboard");
