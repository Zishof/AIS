...
request.setAttribute("nuiServicePage", "posting_jurnal_balik_dp_pemesanan_pekerjaan");
request.setAttribute("nuiServiceTitle", "Posting Jurnal Balik Dp Pemesanan Pekerjaan");
request.setAttribute("nuiServiceType", "finance");
request.setAttribute("nuiServiceSourceClass", "PostingJurnalBalikDpPemesananPekerjaanAction");
