...
<div id="nuiLoading" class="nui-loading"></div><div class="nui-app">
  <aside id="nuiSidebar" class="nui-sidebar"><div class="nui-brand"><div class="nui-logo">◆</div><div><strong>eCampus &amp; eSchool</strong><small>Enterprise Education</small></div></div><nav class="nui-nav" aria-label="Menu utama"><jsp:include page="/WEB-INF/new/_shared/ui/sidebar.jsp" flush="false"/></nav><div class="nui-sidebar-foot">● Online &nbsp; • &nbsp; Menu sesuai peran aktif</div></aside>
  <main class="nui-main"><header class="nui-topbar"><button id="nuiMenuToggle" class="nui-menu-toggle" aria-label="Buka menu">☰</button><div class="nui-global-search"><input id="nuiGlobalSearch" placeholder="Cari menu yang boleh diakses..." aria-label="Pencarian menu"><span class="nui-kbd">Ctrl + K</span></div><div class="nui-top-actions"><jsp:include page="/WEB-INF/new/_shared/ui/role_switcher.jsp" flush="false"/><button class="nui-icon-btn" aria-label="Notifikasi">♢<span class="nui-badge">0</span></button><button class="nui-icon-btn" aria-label="Pesan">✉</button><div class="nui-user"><div class="nui-avatar"><%=nuiShellH(currentName.substring(0,1).toUpperCase())%></div><div><strong><%=nuiShellH(currentName)%></strong><small>Pengguna aktif</small></div></div></div></header>
