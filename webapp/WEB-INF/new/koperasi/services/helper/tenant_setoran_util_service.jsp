...
request.setAttribute("nuiServicePage", "helper/tenant_setoran_util");
request.setAttribute("nuiServiceTitle", "Tenant Setoran Util");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "TenantSetoranUtil");
