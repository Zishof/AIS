...
request.setAttribute("nuiServicePage", "helper/deposito_aro_helper");
request.setAttribute("nuiServiceTitle", "Deposito Aro Helper");
request.setAttribute("nuiServiceType", "finance");
request.setAttribute("nuiServiceSourceClass", "DepositoAroHelper");
