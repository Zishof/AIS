<%--
    Adaptor native: Persetujuan Pertanggungjawaban Kas Besar

    Sumber ZK   : /pages/master/akunting/persetujuan_pertangungjawaban_kas_besar.zul (PersetujuanPertangungjawabanKasBesarAction)
    Kontrak     : ais.common.newui.akunting.NewUiPersetujuanAkuntingController (mode pertanggungjawaban_kas_besar)
...
request.setAttribute("nuiPage", "persetujuan_pertangungjawaban_kas_besar");
request.setAttribute("nuiPageTitle", "Persetujuan Pertanggungjawaban Kas Besar");
