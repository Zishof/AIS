...
request.setAttribute("nuiServicePage", "update_data_mahasiswa");
request.setAttribute("nuiServiceTitle", "Update Data Mahasiswa");
request.setAttribute("nuiServiceType", "integration");
request.setAttribute("nuiServiceSourceClass", "UpdateDataMahasiswa");
