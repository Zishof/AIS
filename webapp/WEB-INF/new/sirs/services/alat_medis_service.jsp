...
request.setAttribute("nuiServicePage", "alat_medis");
request.setAttribute("nuiServiceTitle", "Alat Medis");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "AlatMedisAction");
