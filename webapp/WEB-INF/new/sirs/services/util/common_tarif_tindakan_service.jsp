...
request.setAttribute("nuiServicePage", "util/common_tarif_tindakan");
request.setAttribute("nuiServiceTitle", "Common Tarif Tindakan");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "CommonTarifTindakan");
