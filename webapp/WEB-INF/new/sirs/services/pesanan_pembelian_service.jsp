...
request.setAttribute("nuiServicePage", "pesanan_pembelian");
request.setAttribute("nuiServiceTitle", "Pesanan Pembelian");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "PesananPembelianAction");
