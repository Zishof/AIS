...
request.setAttribute("nuiServicePage", "pemakaiani_item");
request.setAttribute("nuiServiceTitle", "Pemakaiani Item");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "PemakaianiItemAction");
