...
request.setAttribute("nuiServicePage", "helper/ambil_data_pasien_banyak");
request.setAttribute("nuiServiceTitle", "Ambil Data Pasien Banyak");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "AmbilDataPasienBanyak");
