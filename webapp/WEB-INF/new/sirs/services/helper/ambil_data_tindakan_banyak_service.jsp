...
request.setAttribute("nuiServicePage", "helper/ambil_data_tindakan_banyak");
request.setAttribute("nuiServiceTitle", "Ambil Data Tindakan Banyak");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "AmbilDataTindakanBanyak");
request.setAttribute("nuiServiceSourcePackage", "ais.action.master.sirs.helper");
request.setAttribute("nuiServiceSourcePath", "src/ais/action/master/sirs/helper/AmbilDataTindakanBanyak.java");
