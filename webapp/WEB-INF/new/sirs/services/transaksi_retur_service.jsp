...
request.setAttribute("nuiServicePage", "transaksi_retur");
request.setAttribute("nuiServiceTitle", "Transaksi Retur");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "TransaksiReturAction");
