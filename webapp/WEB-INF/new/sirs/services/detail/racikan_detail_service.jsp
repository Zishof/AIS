...
request.setAttribute("nuiServicePage", "detail/racikan_detail");
request.setAttribute("nuiServiceTitle", "Racikan Detail");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "RacikanDetailAction");
