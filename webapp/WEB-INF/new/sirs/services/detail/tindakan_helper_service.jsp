...
request.setAttribute("nuiServicePage", "detail/tindakan_helper");
request.setAttribute("nuiServiceTitle", "Tindakan Helper");
request.setAttribute("nuiServiceType", "inventory");
request.setAttribute("nuiServiceSourceClass", "TindakanHelper");
