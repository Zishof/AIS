<%--
    Adaptor native: Penjadwalan Lokasi

    Sumber ZK   : /pages/master/sirs/jadwal_dokter/penjadwalan_lokasi.zul
                  (composer CalendarJadwalLokasiComposer)
...
request.setAttribute("nuiPage", "penjadwalan_lokasi");
request.setAttribute("nuiPageTitle", "Penjadwalan Lokasi");
