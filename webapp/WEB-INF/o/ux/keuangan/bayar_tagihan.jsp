										...
										<div class="card card-flush h-xl-100">
											...
											<div class="card-body pt-0">
												...
												<div class="table-responsive" style="padding-left: 20px;">
													...
													<table
														...
														<tbody class="fw-bold text-gray-600">
															...
															for (DetailKegiatan detailKegiatan : detailKegiatans) {
																...
																e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit webapp/WEB-INF/o/ux/keuangan/bayar_tagihan.jsp:198");
																	}
															%>
															<tr>
																<%
																if ((detailKegiatan.getBiaya() - sumCicilan.doubleValue()) > 0.0) {
																%>
																<td><input type="checkbox" onclick="document.getElementById('nilai_<%=detailKegiatan.getId()%>').style.display= this.checked ? '' : 'none';document.getElementById('nilai_plus_<%=detailKegiatan.getId()%>').style.display= this.checked ? '' : 'none';"
																	value="<%=detailKegiatan.getId()%>" /></td>
																<%
																} else {
																%>
																<td><%=index%></td>
																...
																<td class="">
																	<%=Common.numberFormat.get().format(sumCicilan.doubleValue())%>
																	<label id="nilai_plus_<%=detailKegiatan.getId()%>" style="display: none;" >+</label>
																	<input width="30px" type="number" id="nilai_<%=detailKegiatan.getId()%>" name="nilai_<%=detailKegiatan.getId()%>" style="display: none;" /> 
																</td>
													...
													<div class="text-justify fw-bold">
														Dibayar : 300.000 ( Tiga Ratus Ribu ) <br> Total
														Bayar : 899.900 ( Delapan Ratus Sembilan Puluh Sembilan
														Ribu Sembilan Ratus )
													</div>
													<div class="text-center mt-5">
														...
														<button type="button" class="btn btn-secondary"
															...
															data-bs-target="#kt_modal_scrollable_bayar"><%= Common.getBahasaConfig("BAYAR") %></button>
													</div>
												</div>
