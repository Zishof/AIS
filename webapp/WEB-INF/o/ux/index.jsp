				...
				<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
					...
					<div class="d-flex flex-column flex-column-fluid">
						...
						<jsp:include page="/WEB-INF/o/ux/content/common/page_title.jsp">
							<jsp:param value="Beranda" name="judul" />
							<jsp:param value="Beranda" name="subjudul" />
						</jsp:include>
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<div id="kt_app_content_container"
								...
								%>
								<jsp:include
									page="/WEB-INF/o/ux/content/index/dashboard_mahasiswa.jsp"></jsp:include>
								<%
								} else if (tbmuser.getSiswa() != null) {
								%>
								<jsp:include page="/WEB-INF/o/ux/content/index/dashboard_siswa.jsp"></jsp:include>
								<%
								}
								else if (tbmuser.getDosen() != null) {
								%>
								<jsp:include page="/WEB-INF/o/ux/content/index/dashboard_dosen.jsp"></jsp:include>
								<%
								}
								%>
