				...
				<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
					...
					<div class="d-flex flex-column flex-column-fluid ">
						...
						<jsp:include page="/WEB-INF/o/ux/content/common/page_title.jsp">
							...
							<jsp:param value="e-Learning" name="subjudul" />
						</jsp:include>
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<div id="kt_app_content_container"
								...
								%>
								<jsp:include
									page="/WEB-INF/o/ux/content/elearning/mahasiswa/elearning.jsp"></jsp:include>
								<%
								} else if (tbmuser.getSiswa() != null) {
								%>
								<jsp:include
									page="/WEB-INF/o/ux/content/elearning/siswa/elearning.jsp"></jsp:include>
								<%
								}
								%>
