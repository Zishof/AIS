...
PengumumanAkademis pengumumanAkademis = (PengumumanAkademis) ConstantValues.ambil(PengumumanAkademis.class.getName(),
		Long.parseLong(request.getParameter("id")));
String kat = pengumumanAkademis.getKategoriPengumuman() == null ? "Pengumuman Akademik"
		: pengumumanAkademis.getKategoriPengumuman().getNama();
%>
					...
					<div class="d-flex flex-column flex-column-fluid ">
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<jsp:include page="content/common/page_title.jsp">
								<jsp:param value="<%=kat%>" name="judul" />
								<jsp:param value="Pengumuman" name="subjudul" />
							</jsp:include>
									...
									<div class="card-body pt-9 pb-0">
										...
										<div class="card-header pt-7">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold text-dark"><%=pengumumanAkademis.getJudul()%></span>
											</h3>
											<!--end::Title-->
										</div>
										<!--end::Header-->
