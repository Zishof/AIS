...
try {
	...
	e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit webapp/WEB-INF/o/ux/nilai.jsp:41");
}
													...
													<table id="kt_datatable_nilai"
														...
														<thead>
															<tr class="fw-semibold fs-6 text-gray-800">
																...
																<th class="min-w-100px"><%= Common.getBahasaConfig("Kelas") %></th>
																<th class="min-w-100px"><%= Common.getBahasaConfig("Dosen") %></th>
																<th class="min-w-50px"><%= Common.getBahasaConfig("SKS") %></th>
																<th class="min-w-100px"><%= Common.getBahasaConfig("Nilai Akhir") %></th>
																<th class="min-w-50px"><%= Common.getBahasaConfig("Huruf") %></th>
																<th class="min-w-75px"><%= Common.getBahasaConfig("Jumlah") %></th>
														...
														<tbody>
															...
															<tr>
																...
																<td class=""><%=Common.numberFormat.get().format(detailperkuliahan.getTotalNilai())%></td>
																<td class=""><%=detailperkuliahan.getNilaiHuruf()%></td>
																<td class=""><%=Common.numberFormat.get().format(detailperkuliahan.getTotalIP() * matakuliah.getSks())%></td>
																<td><a
																	href="<%=request.getContextPath()%>/pages/ux/content/nilai_mhs/nilai-detail.jsp?id=<%=detailperkuliahanid%>"
