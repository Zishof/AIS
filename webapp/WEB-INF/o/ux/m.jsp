...
request.setAttribute("subjudul", subjudul);
					...
					<div class="d-flex flex-column flex-column-fluid ">
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<jsp:include page="content/common/page_title.jsp">
								<jsp:param value="${judul}" name="judul" />
								<jsp:param value="${subjudul}" name="subjudul" />
							</jsp:include>
							...
							<div id="kt_app_content_container"
								...
								<div class="card mb-6 mb-xl-9">
									<div class="card-body pt-9 pb-0">
										...
										<iframe src="<%=url%>" width="100%" style="border: none;"
											height="<%=tinggi%>px"></iframe>
