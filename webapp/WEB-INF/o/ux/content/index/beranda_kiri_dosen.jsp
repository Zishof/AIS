		...
		<div
			...
			<h3 class="card-title align-items-start flex-column text-white pt-15">
				...
				if (tbmuser.getMahasiswa() != null && krsMahasiswa != null) {
					String keteranganMahasiswa = KrsDetailHelper.rubahKeteranganPengambilanKRSBersih(krsMahasiswa.getMahasiswa(), krsMahasiswa.getSemester(), krsMahasiswa.getTahapan(), krsMahasiswa.getSemesterPendek(), krsMahasiswa, false);
				%>
