...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="<%=request.getContextPath()%>/pages/ux/index.jsp">
		<div class="d-flex align-items-center">
			<img alt="Logo"
				...
				class="h-35px app-sidebar-logo-default" /> <span
				class="text-white-500 fw-semibold app-sidebar-logo-default fs-5"
				style="padding-left: 11px; line-height: 18px;"><%=perguruanTinggi.getNama() %>
			</span>
		</div> <img alt="Logo" src="<%=logo_PerguruanTinggi%>"
	...
	<div id="kt_app_sidebar_toggle"
		...
		<span class="svg-icon svg-icon-2 rotate-180"> <svg width="24"
