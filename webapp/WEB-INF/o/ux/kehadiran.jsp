...
KrsMahasiswa krsMahasiswa = tbmuser.getMahasiswa() == null ? null
		: Common.singkronkanKrsMahasiswa(tbmuser.getMahasiswa());
					...
					<div class="d-flex flex-column flex-column-fluid ">
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<jsp:include page="content/common/page_title.jsp">
								<jsp:param value="Home" name="judul" />
								<jsp:param value="Kehadiran" name="subjudul" />
							</jsp:include>
							...
							<div id="kt_app_content_container"
								...
								<div class="card mb-6 mb-xl-9">
									<div class="card-body pt-9 pb-0">
										...
										<jsp:include
											page="/WEB-INF/o/ux/content/index/kehadiran_mahasiswa.jsp"></jsp:include>
