...
String prodi_pilihan = request.getParameter("prodi_pilihan");
...
for (Jurusan jurusan : jurusans) {
	...
	int total = 0;
	for (int tahun = angkatan; tahun <= angkatansd; tahun++) {
		Integer count = ((Number) mySession.createCriteria(BiodataCalonMahasiswa.class)
		.setProjection(Projections.rowCount()).add(Restrictions.eq(prodi_pilihan, jurusan))
