...
try {
	...
	e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit webapp/WEB-INF/o/ux/dashboard/service/ipk_mahasiswa.jsp:41");
}
...
for (Jurusan jurusan : jurusans) {
	...
	dataIpk = (Number) mySession.createCriteria(KrsMahasiswa.class).createAlias("mahasiswa", "mahasiswa")
			.setProjection(Projections.avg("ipk")).add(Restrictions.eq("tahunAkademik", ta))
	...
	categories.add(tahun + "");
		...
		} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) webapp/WEB-INF/o/ux/dashboard/service/ipk_mahasiswa.jsp:103");
