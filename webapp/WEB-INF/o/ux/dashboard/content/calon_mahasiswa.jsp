	...
	<div class="card card-flush h-xl-100">
		...
		<div class="card-header pt-7">
			...
			<h3 class="card-title align-items-start flex-column">
				<span class="card-label fw-bold text-gray-800">Calon
					Mahasiswa</span>
			</h3>
			<!--end::Title-->
			<div>
				<a
					href="javascript:popupCenter({url: '<%=request.getContextPath()%>/win.zul?win=ais.action.master.dashboard.admin.DashboardCalonMahasiswa', title: 'Book', w: 1200, h: 600});"
		...
		<div class="card-body pb-2">
			<form action="" class="form">
				<div class="row">
					<div class="col-lg-3">
						<div class="form-group mb-2">
							<label for="fakultas"><%= Common.getBahasaConfig("Fakultas") %></label> <select
								onchange="reloadcalonMahasiswa();" id="fakultas_calon_mahasiswa"
					...
					<div class="col-lg-3">
						<div class="form-group mb-2">
							<label for="prodi"><%= Common.getBahasaConfig("Prodi") %></label> <select name=""
								id="prodi_calon_mahasiswa" onchange="reloadcalonMahasiswa();"
								class="form-control form-control-sm">
								<%
						...
						<div class="form-group">
							...
							<div class="d-flex align-items-center">
								<div class="flex-grow-1">
									<select name="" onchange="reloadcalonMahasiswa();"
										id="angkatan_calon_mahasiswa"
										class="form-control form-control-sm">
					...
					<div class="col-lg-3">
						<div class="form-group mb-2">
							<label for="prodi"><%= Common.getBahasaConfig("Pilihan Prodi") %></label> <select name=""
								id="prodi_pilihan_calon_mahasiswa"
								onchange="reloadcalonMahasiswa();"
								class="form-control form-control-sm">
								<option selected value="prodiLulus">Prodi Lulus</option>
								<option value="prodi1">Prodi Pilihan I</option>
								<option value="prodi2">Prodi Pilihan II</option>
								<option value="prodi3">Prodi Pilihan III</option>
								<option value="prodi4">Prodi Pilihan IV</option>
								<option value="prodi5">Prodi Pilihan V</option>
							</select>
						</div>
					</div>
		...
		<div class="card-body d-flex align-items-end px-0 pt-3 pb-5">
			<!--begin::Chart-->
			<div id="calon_mahasiswa_data"
				class="h-500px w-100 min-h-auto ps-4 pe-6"></div>
			<!--end::Chart-->
		</div>
		<div class="card-body pt-3">
			<table id="calon_mahasiswa_data_table"
...
function reloadcalonMahasiswa(){
	
	document.getElementById("calon_mahasiswa_data").innerHTML = "";
	document.getElementById("calon_mahasiswa_data_table").innerHTML = "";
	
	
	var fakultas = document.getElementById("fakultas_calon_mahasiswa").value;
	var prodi = document.getElementById("prodi_calon_mahasiswa").value;
	var angkatan = document.getElementById("angkatan_calon_mahasiswa").value;
	var angkatansd = document.getElementById("angkatansd_calon_mahasiswa").value;
	var prodi_pilihan  = document.getElementById("prodi_pilihan_calon_mahasiswa").value;
	...
	var xhttp = new XMLHttpRequest();
	  xhttp.onreadystatechange = function() {
	    if (this.readyState == 4 && this.status == 200) {
	     ...
	     series = obj.series;
	     document.getElementById("calon_mahasiswa_data_table").innerHTML = obj.tr;
	     calonMahasiswa.init();
	    }
	  };
	  xhttp.open("GET", "<%=(request.getContextPath() + "/ux/dashboard/service/calon_mahasiswa.jsp")%>?fakultas="+fakultas+"&prodi="+prodi+"&angkatan="+angkatan+"&angkatansd="+angkatansd+"&prodi_pilihan="+prodi_pilihan, true);
	  xhttp.send();
}


var calonMahasiswa = function () {
	  var e = {
	    self: null,
	    rendered: !1
	  }
	  ...
	  const t = function (e) {
	    var t = document.getElementById("calon_mahasiswa_data");
	    if (t == null) {
	      return
	    }
	...
	"undefined" != typeof module && (module.exports = calonMahasiswa)

	KTUtil.onDOMContentLoaded((function () {
		reloadcalonMahasiswa();
	}));
