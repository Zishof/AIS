	...
	<div class="card card-flush h-xl-100">
		...
		<div class="card-header pt-7">
			...
			<h3 class="card-title align-items-start flex-column">
				<span class="card-label fw-bold text-gray-800">Mahasiswa</span>
			</h3>
			<!--end::Title-->
			<div>
				<a
					href="javascript:popupCenter({url: '<%=request.getContextPath()%>/win.zul?win=ais.action.master.dashboard.admin.DashboardMahasiswa', title: 'Book', w: 1200, h: 600});"
					...
					<div class="col-lg-3">
						<div class="form-group mb-2">
							<label for="fakultas"><%= Common.getBahasaConfig("Fakultas") %></label> <select
								onchange="reloadMahasiswa();" id="fakultas_mahasiswa"
					...
					<div class="col-lg-3">
						<div class="form-group mb-2">
							<label for="prodi"><%= Common.getBahasaConfig("Prodi") %></label> <select name=""
								id="prodi_mahasiswa" onchange="reloadMahasiswa();"
								class="form-control form-control-sm">
								<%
						...
						<div class="form-group">
							...
							<div class="d-flex align-items-center">
								<div class="flex-grow-1">
									<select name="" onchange="reloadMahasiswa();"
										id="angkatan_mahasiswa" class="form-control form-control-sm">
								...
								<div class="flex-grow-1">
									<select name="" onchange="reloadMahasiswa();"
										id="angkatansd_mahasiswa" class="form-control form-control-sm">
										<%
		...
		<div class="card-body d-flex align-items-end px-0 pt-3 pb-5">
			<!--begin::Chart-->
			<div id="mahasiswa_data" class="h-500px w-100 min-h-auto ps-4 pe-6"></div>
			<!--end::Chart-->
		</div>
		<div class="card-body pt-3">
			<table id="mahasiswa_data_table"
...
function reloadMahasiswa(){
	...
	document.getElementById("mahasiswa_data").innerHTML = "";
	document.getElementById("mahasiswa_data_table").innerHTML = "";
	
	
	var fakultas = document.getElementById("fakultas_mahasiswa").value;
	var prodi = document.getElementById("prodi_mahasiswa").value;
	var angkatan = document.getElementById("angkatan_mahasiswa").value;
	var angkatansd = document.getElementById("angkatansd_mahasiswa").value;
	...
	var xhttp = new XMLHttpRequest();
	  xhttp.onreadystatechange = function() {
	    if (this.readyState == 4 && this.status == 200) {
	     ...
	     series = obj.series;
	     document.getElementById("mahasiswa_data_table").innerHTML = obj.tr;
	     Mahasiswa.init();
	    }
	  };
	  xhttp.open("GET", "<%=(request.getContextPath() + "/ux/dashboard/service/mahasiswa.jsp")%>?fakultas="+fakultas+"&prodi="+prodi+"&angkatan="+angkatan+"&angkatansd="+angkatansd, true);
	  xhttp.send();
}
...
var Mahasiswa = function () {
	  ...
	  const t = function (e) {
	    var t = document.getElementById("mahasiswa_data");
	    if (t == null) {
	      return
	    }
	...
	"undefined" != typeof module && (module.exports = Mahasiswa)
