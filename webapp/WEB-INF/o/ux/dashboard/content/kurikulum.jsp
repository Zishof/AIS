	...
	<div class="card card-flush h-xl-100">
		...
		<div class="card-header pt-7">
			...
			<h3 class="card-title align-items-start flex-column">
				<span class="card-label fw-bold text-gray-800">Kurikulum</span>
			</h3>
			<!--end::Title-->
			<div>
				<a
					href="javascript:popupCenter({url: '<%=request.getContextPath()%>/win.zul?win=ais.action.master.dashboard.admin.DashboardKurikulum', title: 'Book', w: 1200, h: 600});"
				...
				<div class="row">
					<div class="col-lg-3">
						<div class="form-group mb-2">
							<label for="fakultas"><%= Common.getBahasaConfig("Fakultas") %></label> <select
								onchange="reloadKurikulum();" id="fakultas_kurikulum"
					...
					<div class="col-lg-3">
						<div class="form-group mb-2">
							<label for="prodi"><%= Common.getBahasaConfig("Prodi") %></label> <select name=""
								id="prodi_kurikulum" onchange="reloadKurikulum();"
								class="form-control form-control-sm">
								<%
					...
					<div class="col-lg-4">
						<div class="form-group">
							<label for="tahun"><%= Common.getBahasaConfig("Tahun kurikulum") %></label>
							<div class="d-flex align-items-center">
								<div class="flex-grow-1">
									<select name="" onchange="reloadKurikulum();"
										id="angkatan_kurikulum" class="form-control form-control-sm">
								...
								<div class="flex-grow-1">
									<select name="" onchange="reloadKurikulum();"
										id="angkatansd_kurikulum" class="form-control form-control-sm">
										<%
		...
		<div class="card-body d-flex align-items-end px-0 pt-3 pb-5">
			<!--begin::Chart-->
			<div id="kurikulum_data" class="h-500px w-100 min-h-auto ps-4 pe-6">
			</div>
			<!--end::Chart-->
		</div>
		<div class="card-body pt-3">
			<table id="kurikulum_data_table"
...
function reloadKurikulum(){
	
	document.getElementById("kurikulum_data").innerHTML = "";
	document.getElementById("kurikulum_data_table").innerHTML = "";
	
	
	var fakultas = document.getElementById("fakultas_kurikulum").value;
	var prodi = document.getElementById("prodi_kurikulum").value;
	var angkatan = document.getElementById("angkatan_kurikulum").value;
	var angkatansd = document.getElementById("angkatansd_kurikulum").value;
	...
	var xhttp = new XMLHttpRequest();
	  xhttp.onreadystatechange = function() {
	    if (this.readyState == 4 && this.status == 200) {
	     ...
	     series = obj.series;
	     document.getElementById("kurikulum_data_table").innerHTML = obj.tr;
	     Kurikulum.init();
	    }
	  };
	  xhttp.open("GET", "<%=(request.getContextPath() + "/ux/dashboard/service/kurikulum.jsp")%>?fakultas="+fakultas+"&prodi="+prodi+"&angkatan="+angkatan+"&angkatansd="+angkatansd, true);
	  xhttp.send();
}
...
var Kurikulum = function () {
	  ...
	  const t = function (e) {
	    var t = document.getElementById("kurikulum_data");
	    if (t == null) {
	      return
	    }
	...
	"undefined" != typeof module && (module.exports = Kurikulum)
