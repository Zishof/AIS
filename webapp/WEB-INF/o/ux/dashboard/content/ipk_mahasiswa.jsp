	...
	<div class="card card-flush h-xl-100">
		...
		<div class="card-header pt-7">
			...
			<h3 class="card-title align-items-start flex-column">
				<span class="card-label fw-bold text-gray-800">Rata Rata IPK Mahasiswa</span>
			</h3>
			<!--end::Title-->
			<div>
				...
				<div class="row">
					...
					<div class="col-lg-3">
						<div class="form-group">
							<label for="tahun-ajaran">Tahun Ajaran</label> <select name=""
								onchange="reloadIpkMahasiswa();" id="idsmt_ipk_mahasiswa"
					...
					<div class="col-lg-3">
						<div class="form-group mb-2">
							<label for="fakultas"><%= Common.getBahasaConfig("Fakultas") %></label> <select
								onchange="reloadIpkMahasiswa();" id="fakultas_ipk_mahasiswa"
								class="form-control form-control-sm">
								<%
					...
					<div class="col-lg-3">
						<div class="form-group mb-2">
							<label for="prodi"><%= Common.getBahasaConfig("Prodi") %></label> <select name=""
								id="prodi_ipk_mahasiswa" onchange="reloadIpkMahasiswa();"
								class="form-control form-control-sm">
								<%
						...
						<div class="form-group">
							...
							<div class="d-flex align-items-center">
								<div class="flex-grow-1">
									<select name="" onchange="reloadIpkMahasiswa();"
										id="angkatan_ipk_mahasiswa"
										class="form-control form-control-sm">
		...
		<div class="card-body d-flex align-items-end px-0 pt-3 pb-5">
			<!--begin::Chart-->
			<div id="ipk_mahasiswa_data"
				class="h-500px w-100 min-h-auto ps-4 pe-6"></div>
			<!--end::Chart-->
		</div>
		<div class="card-body pt-3">
			<table id="ipk_mahasiswa_data_table"
...
function reloadIpkMahasiswa(){
	
	document.getElementById("ipk_mahasiswa_data").innerHTML = "";
	document.getElementById("ipk_mahasiswa_data_table").innerHTML = "";
	
	
	var fakultas = document.getElementById("fakultas_ipk_mahasiswa").value;
	var prodi = document.getElementById("prodi_ipk_mahasiswa").value;
	var angkatan = document.getElementById("angkatan_ipk_mahasiswa").value;
	var angkatansd = document.getElementById("angkatansd_ipk_mahasiswa").value;
	var idsmt = document.getElementById("idsmt_ipk_mahasiswa").value;
	...
	var xhttp = new XMLHttpRequest();
	  xhttp.onreadystatechange = function() {
	    if (this.readyState == 4 && this.status == 200) {
	     ...
	     series = obj.series;
	     document.getElementById("ipk_mahasiswa_data_table").innerHTML = obj.tr;
	     IpkMahasiswa.init();
	    }
	  };
	  xhttp.open("GET", "<%=(request.getContextPath() + "/ux/dashboard/service/ipk_mahasiswa.jsp")%>?fakultas="+fakultas+"&prodi="+prodi+"&angkatan="+angkatan+"&angkatansd="+angkatansd+"&idsmt="+idsmt, true);
	  xhttp.send();
}


var IpkMahasiswa = function () {
	  var e = {
	    self: null,
	    rendered: !1
	  }
	  ...
	  const t = function (e) {
	    var t = document.getElementById("ipk_mahasiswa_data");
	    if (t == null) {
	      return
	    }
	...
	"undefined" != typeof module && (module.exports = IpkMahasiswa)
