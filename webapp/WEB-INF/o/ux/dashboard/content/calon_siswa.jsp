...
<div class="col-xl-12">
	...
	<div class="card card-flush h-xl-100">
					...
					<div class="col-lg-3">
						<div class="form-group mb-2">
							<label for="sekolah"><%= Common.getBahasaConfig("Sekolah") %></label> <select
								onchange="reloadcalonSiswa();" id="sekolah_calon_siswa"
						...
						<div class="form-group">
							...
							<div class="d-flex align-items-center">
								<div class="flex-grow-1">
									<select name="" onchange="reloadcalonSiswa();"
										id="angkatan_calon_siswa"
										class="form-control form-control-sm">
		...
		<div class="card-body d-flex align-items-end px-0 pt-3 pb-5">
			<!--begin::Chart-->
			<div id="calon_siswa_data"
				class="h-500px w-100 min-h-auto ps-4 pe-6"></div>
			<!--end::Chart-->
		</div>
		<div class="card-body pt-3">
			<table id="calon_siswa_data_table"
...
function reloadcalonSiswa(){
	
	document.getElementById("calon_siswa_data").innerHTML = "";
	document.getElementById("calon_siswa_data_table").innerHTML = "";
	
	
	var sekolah = document.getElementById("sekolah_calon_siswa").value;
	var angkatan = document.getElementById("angkatan_calon_siswa").value;
	var angkatansd = document.getElementById("angkatansd_calon_siswa").value;
	...
	var xhttp = new XMLHttpRequest();
	  xhttp.onreadystatechange = function() {
	    if (this.readyState == 4 && this.status == 200) {
	     ...
	     series = obj.series;
	     document.getElementById("calon_siswa_data_table").innerHTML = obj.tr;
	     calonSiswa.init();
	    }
	  };
	  xhttp.open("GET", "<%=(request.getContextPath() + "/ux/dashboard/service/calon_siswa.jsp")%>?sekolah="+sekolah+"&angkatan="+angkatan+"&angkatansd="+angkatansd, true);
	  xhttp.send();
}


var calonSiswa = function () {
	  var e = {
	    self: null,
	    rendered: !1
	  }
	  ...
	  const t = function (e) {
	    var t = document.getElementById("calon_siswa_data");
	    if (t == null) {
	      return
	    }
	...
	"undefined" != typeof module && (module.exports = calonSiswa)
