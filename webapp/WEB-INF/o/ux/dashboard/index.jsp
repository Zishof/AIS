						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<div id="kt_app_content_container"
								...
								<div class="row g-5 g-xl-10 mb-5 mb-xl-10">
									...
									<jsp:include
										page="/WEB-INF/o/ux/dashboard/content/kunjungan_pengguna.jsp"></jsp:include>

									<jsp:include
										page="/WEB-INF/o/ux/dashboard/content/status_dosen.jsp"></jsp:include>

									<jsp:include
										page="/WEB-INF/o/ux/dashboard/content/status_dosen_tiap_prodi.jsp"></jsp:include>

									<jsp:include
										page="/WEB-INF/o/ux/dashboard/content/status_mahasiswa.jsp"></jsp:include>
