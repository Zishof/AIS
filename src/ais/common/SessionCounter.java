...
public class SessionCounter implements HttpSessionListener {
	...
	/**
	 * Tipe implementasi bersarang {@link SessionDeleter} milik {@link SessionCounter}. Kelas ini memberi nama pada
	 * state atau perilaku lokal agar tanggung jawabnya tidak tersebar sebagai blok anonim.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link SessionCounter} dan dapat mengakses state
	 ...
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi state utama: {@code String sessionId}; operasi lokal:
	 * {@code run}(). Aturan bisnis bersama tetap berada pada kelas induk atau service yang dipanggilnya.</p>
