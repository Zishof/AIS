...
/**
 * Helper integrasi bank untuk bsi common. Kelas ini memusatkan format request/response, koneksi,
 ...
 * <p>Perbedaan lokal yang dapat diamati adalah mutasi data ({@code onSaveBsi()}, {@code onSaveBsi()}); operasi
 * domain lain ({@code createButton()}, {@code populateDetailBiaya()}, {@code
 * populateBsiRequestDetailDariDetailBiaya()}, {@code populateBsiRequestDetail()}, {@code
 * populateBsiRequestDetail()}, {@code bayarCalonMahasiswa()}). Bagian lain dari kontrak tetap mengikuti kelas
