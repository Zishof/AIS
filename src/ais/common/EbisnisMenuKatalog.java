...
public final class EbisnisMenuKatalog {
	...
	static {
		...
		// padanan alur ZKoss versi umum. Atas permintaan pemilik produk (2026-08-20) kelima
		// menu Pengadaan TAMPIL secara bawaan supaya toko dapat langsung memakainya; hak
		// per-aksi tetap diatur admin lewat grid CRUD TbmroleAction.
		DAFTAR.add(new Entri(MODUL_POS, "pengadaan_pr", "Pengadaan: Permintaan Pembelian (PR)", "desktop", "android", "jsp"));
		DAFTAR.add(new Entri(MODUL_POS, "pengadaan_po", "Pengadaan: Pemesanan Pembelian (PO)", "desktop", "android", "jsp"));
		DAFTAR.add(new Entri(MODUL_POS, "pengadaan_bast", "Pengadaan: Penerimaan Barang/Jasa (BAST)", "desktop", "android", "jsp"));
		...
		DAFTAR.add(new Entri(MODUL_POS, "dana_talangan", "Keuangan: Dana Talangan", "desktop", "android"));
		DAFTAR.add(new Entri(MODUL_POS, "reimbursement", "Keuangan: Reimbursement Pegawai", "desktop", "android"));
		// Master data Keuangan (2026-08-23): jenis uang muka, jenis kas kecil/besar, jenis
		// reimbursement, jenis pengeluaran, dan cara pembayaran transfer. Di sinilah akun
		// setiap dokumen Keuangan dipetakan; tanpa akun yang lengkap dokumen tetap bisa
		// diajukan tetapi DILEWATI mesin posting tanpa pesan galat. Satu kunci untuk keenam
		// tipe karena yang memeliharanya orang yang sama, dan memisahkannya hanya akan
		// membuat enam baris hak akses yang selalu disetel serupa.
		DAFTAR.add(new Entri(MODUL_POS, "master_keuangan", "Keuangan: Master Data (jenis & cara pembayaran)", "desktop", "android"));
		// Proses Transfer (2026-08-23): PENCAIRAN baris DPC. Mata rantai terakhir alur
		// Keuangan -- delapan modul sebelumnya bermuara di DaftarPengajuanTransfer lalu
		// berhenti, padahal mesin posting menuntut prosesTransfer tidak null. Hak approve
		// dipakai untuk menyetujui DAN merealisasikan; reject untuk membatalkan keduanya.
		DAFTAR.add(new Entri(MODUL_POS, "proses_transfer", "Keuangan: Proses Transfer (pencairan DPC)", "desktop", "android"));
		// Proses Transitori (2026-08-23): jalan KELUAR dari rekening transitori. Baris
		// DPC yang ditandai Transitori pada Proses Transfer melahirkan satu catatan
