...
/**
 * Helper integrasi bank untuk bni common. Kelas ini memusatkan format request/response, koneksi,
 ...
 * <p>Perbedaan lokal yang dapat diamati adalah pembacaan/pencarian ({@code ambilInfoTeknisTerakhir()}); mutasi
 * data ({@code onSaveBni()}, {@code onSaveBni()}, {@code onSaveBni()}); operasi domain lain ({@code
 * createButton()}, {@code populateDetailBiaya()}, {@code populateBniRequestDetailDariDetailBiaya()}, {@code
 * populateBniRequestDetail()}, {@code populateBniRequestDetail()}, {@code bayarCalonMahasiswa()}). Bagian lain
