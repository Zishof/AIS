...
/**
 * Konverter angka menjadi teks untuk indonesian number to words. Utilitas ini menjadi implementasi
 ...
 * numNames}; operasi domain lain ({@code convertLessThanOneThousand()}, {@code convert()}, {@code convert()},
 * {@code main()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di atas.</p>
