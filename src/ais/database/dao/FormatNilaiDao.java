...
/**
 * Kontrak DAO untuk entitas {@link ais.database.model.FormatNilai} (format/skala penilaian).
 ...
 * tersedia.
 */
public interface FormatNilaiDao extends GenericDao<FormatNilai, Long> {
