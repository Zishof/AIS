...
/**
 * Kontrak DAO untuk entitas {@link ais.database.model.TemplateSurat} (data template surat).
 ...
 * tersedia.
 */
public interface TemplateSuratDao extends GenericDao<TemplateSurat, Long>{
