...
/**
 * Kontrak DAO untuk entitas {@link ais.database.model.DetailBiaya} (detail komponen biaya).
 ...
 * tersedia.
 */
public interface DetailBiayaDao extends GenericDao<DetailBiaya, Long>{
