...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/jenis_diklat}</b> (daftar jenis diklat/pelatihan — mirror sinkronisasi independen; TIDAK berelasi ke {@code employ.JenisDiklat} lokal (dikonfirmasi sesi lain dalam inisiatif ini)).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/jenis_diklat"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_jenis_diklat_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_jenis_diklat")
public class RefJenisDiklatSister extends GeneralValueObject {
