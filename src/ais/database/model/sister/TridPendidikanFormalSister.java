...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint <b>trid/pendidikan_formal</b>. Kolom bernama = field SISTER; {@code kode}=id item (kunci upsert); {@code keterangan}=JSON mentah. @Audited (tabel __audit auto hbm2ddl).
 *
 * <p>Memetakan tabel fisik {@code sister_trid_pendidikan_formal}, terdaftar pada {@link SisterEntitasRegistry}
 * dengan kunci {@code "pendidikan_formal"}. Bentuk &amp; semantik field administratif (id/oleh/olehId/
...
@Audited
@Table(schema = "public", name = "sister_trid_pendidikan_formal")
public class TridPendidikanFormalSister extends GeneralValueObject {
	...
	/** Jenjang pendidikan formal (mis. S1/S2/S3) sesuai referensi SISTER. */
	private String jenjangPendidikan;
	/** Gelar akademik yang diperoleh. */
	private String gelarAkademik;
	/** Bidang studi/program studi pendidikan. */
	private String bidangStudi;
	/** Nama perguruan tinggi penyelenggara pendidikan. */
	private String namaPerguruanTinggi;
	/** Tahun kelulusan. */
	private Integer tahunLulus;
	/** Kode jenis pengajuan data pendidikan formal (mis. tambah/ubah) sesuai konvensi SISTER. */
	private Integer jenisAjuan;

	/** Konstruktor default (dibutuhkan Hibernate). */
	public TridPendidikanFormalSister() {}
	/** @return {@link #id}. */
	...
	/** @return {@link #gelarAkademik}. */
	@Column(name = "gelar_akademik", columnDefinition = "text") public String getGelarAkademik() { return gelarAkademik; }
	/** @param v nilai {@link #gelarAkademik} baru. */
	public void setGelarAkademik(String v) { this.gelarAkademik = v; }
	...
	/** @return {@link #namaPerguruanTinggi}. */
	@Column(name = "nama_perguruan_tinggi", columnDefinition = "text") public String getNamaPerguruanTinggi() { return namaPerguruanTinggi; }
	/** @param v nilai {@link #namaPerguruanTinggi} baru. */
	public void setNamaPerguruanTinggi(String v) { this.namaPerguruanTinggi = v; }
	/** @return {@link #tahunLulus}. */
	@Column(name = "tahun_lulus") public Integer getTahunLulus() { return tahunLulus; }
	/** @param v nilai {@link #tahunLulus} baru. */
	public void setTahunLulus(Integer v) { this.tahunLulus = v; }
	/** @return {@link #jenisAjuan}. */
	@Column(name = "jenis_ajuan") public Integer getJenisAjuan() { return jenisAjuan; }
	/** @param v nilai {@link #jenisAjuan} baru. */
	public void setJenisAjuan(Integer v) { this.jenisAjuan = v; }
