...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/jenis_tunjangan}</b> (daftar jenis tunjangan).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/jenis_tunjangan"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_jenis_tunjangan_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_jenis_tunjangan")
public class RefJenisTunjanganSister extends GeneralValueObject {
	...
	public RefJenisTunjanganSister() {}
