...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/golongan_pangkat}</b> (daftar golongan/pangkat kepegawaian).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/golongan_pangkat"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_golongan_pangkat_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_golongan_pangkat")
public class RefGolonganPangkatSister extends GeneralValueObject {
	...
	public RefGolonganPangkatSister() {}
