...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/jenis_bahan_ajar}</b> (daftar jenis bahan ajar).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/jenis_bahan_ajar"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_jenis_bahan_ajar_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_jenis_bahan_ajar")
public class RefJenisBahanAjarSister extends GeneralValueObject {
	...
	public RefJenisBahanAjarSister() {}
