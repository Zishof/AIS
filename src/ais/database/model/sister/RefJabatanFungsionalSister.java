...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/jabatan_fungsional}</b> (daftar jabatan fungsional dosen/tenaga kependidikan).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/jabatan_fungsional"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_jabatan_fungsional_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_jabatan_fungsional")
public class RefJabatanFungsionalSister extends GeneralValueObject {
	...
	public RefJabatanFungsionalSister() {}
