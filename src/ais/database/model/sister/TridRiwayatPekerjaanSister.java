...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint <b>trid/riwayat_pekerjaan</b>. Kolom bernama = field SISTER; {@code kode}=id item (kunci upsert); {@code keterangan}=JSON mentah. @Audited (tabel __audit auto hbm2ddl).
 *
 * <p>Memetakan tabel fisik {@code sister_trid_riwayat_pekerjaan}, terdaftar pada {@link SisterEntitasRegistry}
 * dengan kunci {@code "riwayat_pekerjaan"}. Bentuk &amp; semantik field administratif (id/oleh/olehId/
...
@Audited
@Table(schema = "public", name = "sister_trid_riwayat_pekerjaan")
public class TridRiwayatPekerjaanSister extends GeneralValueObject {
	...
	/** Jenis pekerjaan sesuai referensi SISTER. */
	private String jenisPekerjaan;
	/** Nama jabatan pada riwayat pekerjaan. */
	private String namaJabatan;
	/** Nama instansi tempat bekerja. */
	private String instansi;
	/** Nama divisi/unit pada instansi tempat bekerja. */
	private String divisi;
	/** Tanggal mulai bekerja, teks mentah dari SISTER. */
	private String mulaiBekerja;
	/** Tanggal selesai bekerja, teks mentah dari SISTER (kosong bila masih bekerja). */
	private String selesaiBekerja;
	/** Penanda apakah pekerjaan berada di luar negeri. */
	private Boolean luarNegeri;
	/** Bidang usaha instansi tempat bekerja. */
	private String bidangUsaha;

	/** Konstruktor default (dibutuhkan Hibernate). */
	public TridRiwayatPekerjaanSister() {}
	/** @return {@link #id}. */
	...
	/** @return {@link #jenisPekerjaan}. */
	@Column(name = "jenis_pekerjaan", columnDefinition = "text") public String getJenisPekerjaan() { return jenisPekerjaan; }
	/** @param v nilai {@link #jenisPekerjaan} baru. */
	public void setJenisPekerjaan(String v) { this.jenisPekerjaan = v; }
	/** @return {@link #namaJabatan}. */
	@Column(name = "nama_jabatan", columnDefinition = "text") public String getNamaJabatan() { return namaJabatan; }
	/** @param v nilai {@link #namaJabatan} baru. */
	public void setNamaJabatan(String v) { this.namaJabatan = v; }
	...
	/** @return {@link #divisi}. */
	@Column(name = "divisi", columnDefinition = "text") public String getDivisi() { return divisi; }
	/** @param v nilai {@link #divisi} baru. */
	public void setDivisi(String v) { this.divisi = v; }
	/** @return {@link #mulaiBekerja}. */
	@Column(name = "mulai_bekerja", columnDefinition = "text") public String getMulaiBekerja() { return mulaiBekerja; }
	/** @param v nilai {@link #mulaiBekerja} baru. */
	public void setMulaiBekerja(String v) { this.mulaiBekerja = v; }
	/** @return {@link #selesaiBekerja}. */
	@Column(name = "selesai_bekerja", columnDefinition = "text") public String getSelesaiBekerja() { return selesaiBekerja; }
	/** @param v nilai {@link #selesaiBekerja} baru. */
	public void setSelesaiBekerja(String v) { this.selesaiBekerja = v; }
	/** @return {@link #luarNegeri}. */
	@Column(name = "luar_negeri") public Boolean getLuarNegeri() { return luarNegeri; }
	/** @param v nilai {@link #luarNegeri} baru. */
	public void setLuarNegeri(Boolean v) { this.luarNegeri = v; }
	/** @return {@link #bidangUsaha}. */
	@Column(name = "bidang_usaha", columnDefinition = "text") public String getBidangUsaha() { return bidangUsaha; }
	/** @param v nilai {@link #bidangUsaha} baru. */
	public void setBidangUsaha(String v) { this.bidangUsaha = v; }
