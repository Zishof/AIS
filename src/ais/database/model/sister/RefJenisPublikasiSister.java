...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/jenis_publikasi}</b> (daftar jenis publikasi ilmiah).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/jenis_publikasi"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_jenis_publikasi_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_jenis_publikasi")
public class RefJenisPublikasiSister extends GeneralValueObject {
	...
	public RefJenisPublikasiSister() {}
