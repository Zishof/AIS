...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/kategori_capaian_luaran}</b> (daftar kategori capaian luaran penelitian/pengabdian).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/kategori_capaian_luaran"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_kategori_capaian_luaran_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_kategori_capaian_luaran")
public class RefKategoriCapaianLuaranSister extends GeneralValueObject {
	...
	public RefKategoriCapaianLuaranSister() {}
