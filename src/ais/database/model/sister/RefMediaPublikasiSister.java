...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/media_publikasi}</b> (daftar media publikasi ilmiah).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/media_publikasi"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_media_publikasi_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_media_publikasi")
public class RefMediaPublikasiSister extends GeneralValueObject {
	...
	public RefMediaPublikasiSister() {}
