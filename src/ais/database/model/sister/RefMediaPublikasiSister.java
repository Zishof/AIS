...
/** Entitas hasil sinkronisasi SISTER untuk endpoint <b>referensi/media_publikasi</b>. Kolom bernama = field SISTER; {@code kode}=id item (kunci upsert); {@code keterangan}=JSON mentah. @Audited (tabel __audit auto hbm2ddl). */
@Entity
