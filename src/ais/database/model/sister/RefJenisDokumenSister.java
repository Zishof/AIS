...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/jenis_dokumen}</b> (daftar jenis dokumen kepegawaian).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/jenis_dokumen"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_jenis_dokumen_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_jenis_dokumen")
public class RefJenisDokumenSister extends GeneralValueObject {
