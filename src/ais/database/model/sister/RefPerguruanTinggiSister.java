...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/perguruan_tinggi}</b> (daftar perguruan tinggi).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/perguruan_tinggi"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_perguruan_tinggi_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_perguruan_tinggi")
public class RefPerguruanTinggiSister extends GeneralValueObject {
	...
	public RefPerguruanTinggiSister() {}
