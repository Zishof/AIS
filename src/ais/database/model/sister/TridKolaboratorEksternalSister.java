...
/**
 * <h2>Entitas Tridharma tersinkron SISTER &mdash; Kolaborator Eksternal</h2>
 *
 * <p>Baris tabel {@code sister_trid_kolaborator_eksternal}, hasil sinkronisasi endpoint SISTER
 * (Kemdikbudristek) <b>{@code kolaborator_eksternal}</b> &mdash; daftar mitra/kolaborator eksternal
 * (di luar institusi dosen ybs., termasuk pihak asing) yang tercatat dalam kegiatan Tridharma seorang
 ...
 * {@link SisterEntitasRegistry} pada kunci {@code "kolaborator_eksternal"}, dirutekan &amp; di-upsert secara
 ...
 *
 * <p>Field bisnis endpoint ini: {@link #getNama() nama} (nama kolaborator), {@link #getKodeNegara() kodeNegara}
 * (kode negara asal, merujuk referensi {@code negara} sisi SISTER), {@link #getJenisKelamin() jenisKelamin}.</p>
 *
...
@Audited
@Table(schema = "public", name = "sister_trid_kolaborator_eksternal")
public class TridKolaboratorEksternalSister extends GeneralValueObject {
	...
	/** Nama kolaborator eksternal. */
	private String nama;
	/** Kode negara asal kolaborator (merujuk referensi {@code negara} sisi SISTER). */
	private String kodeNegara;
	/** Jenis kelamin kolaborator eksternal. */
	private String jenisKelamin;

	/** Konstruktor bawaan (dibutuhkan Hibernate &amp; refleksi upsert {@code DataSisterApi}); field diisi lewat setter. */
	public TridKolaboratorEksternalSister() {}
