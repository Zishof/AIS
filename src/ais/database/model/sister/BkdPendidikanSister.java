...
/** Entitas hasil sinkronisasi SISTER untuk endpoint <b>bkd/pendidikan</b>. Kolom bernama = field SISTER; {@code kode}=id item (kunci upsert); {@code keterangan}=JSON mentah. @Audited (tabel __audit auto hbm2ddl). */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_bkd_pendidikan")
public class BkdPendidikanSister extends GeneralValueObject {
	/** Versi serialisasi. */
	...
	/** Kode/id item kegiatan pendidikan/pengajaran (non-tatap muka) pada SISTER — kunci upsert sinkronisasi (bukan PK lokal). */
	private String kode;
	...
	/** id_sdm dosen pemilik butir beban pendidikan ini (acuan ke {@code RefSdmSister}). */
	private String idSdm;
	/** id_smt semester butir beban pendidikan ini dihitung. */
	...
	private String nidn;
	/** Unsur/komponen kegiatan pendidikan menurut kategori SISTER. */
	private String unsur;
	/** Judul/uraian kegiatan pendidikan yang menjadi butir beban ini. */
	private String judulKeg;
	/** id kategori kegiatan pendidikan pada SISTER. */
	private Integer idKatgiat;
	/** Nama kategori kegiatan pendidikan (salinan denormalisasi dari SISTER). */
	private String nmKat;
	/** Beban SKS (satuan kredit semester) kegiatan pendidikan ini yang diperhitungkan dalam BKD. */
	private Double bebanSks;
	/** Nilai/skor kegiatan pendidikan ini sebagaimana dihitung SISTER. */
	private Double nilai;

	/** Konstruktor kosong (dibutuhkan Hibernate). */
	public BkdPendidikanSister() {}
	...
	/** @return id kategori kegiatan pendidikan pada SISTER. */
	...
	/** @return nama kategori kegiatan pendidikan. */
	...
	/** @return beban SKS kegiatan pendidikan ini. */
	...
	/** @return nilai/skor kegiatan pendidikan ini. */
