...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/bidang_studi}</b> (daftar bidang studi akademik).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/bidang_studi"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_bidang_studi_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_bidang_studi")
public class RefBidangStudiSister extends GeneralValueObject {
