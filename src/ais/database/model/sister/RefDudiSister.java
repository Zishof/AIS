...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/dudi}</b> (daftar instansi/perusahaan DUDI (dunia usaha/dunia industri) mitra kerja sama).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/dudi"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_dudi_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_dudi")
public class RefDudiSister extends GeneralValueObject {
