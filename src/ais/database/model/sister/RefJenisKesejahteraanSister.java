...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/jenis_kesejahteraan}</b> (daftar jenis program kesejahteraan pegawai).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/jenis_kesejahteraan"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_jenis_kesejahteraan_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_jenis_kesejahteraan")
public class RefJenisKesejahteraanSister extends GeneralValueObject {
	...
	public RefJenisKesejahteraanSister() {}
