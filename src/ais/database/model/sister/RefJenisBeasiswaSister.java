...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/jenis_beasiswa}</b> (daftar jenis beasiswa).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/jenis_beasiswa"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_jenis_beasiswa_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_jenis_beasiswa")
public class RefJenisBeasiswaSister extends GeneralValueObject {
