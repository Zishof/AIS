...
/** Entitas hasil sinkronisasi SISTER untuk endpoint <b>referensi/jenis_beasiswa</b>. Kolom bernama = field SISTER; {@code kode}=id item (kunci upsert); {@code keterangan}=JSON mentah. @Audited (tabel __audit auto hbm2ddl). */
@Entity
