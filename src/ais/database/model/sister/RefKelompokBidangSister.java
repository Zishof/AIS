...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/kelompok_bidang}</b> (daftar kelompok bidang ilmu/keahlian (IPTEK)).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/kelompok_bidang"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_kelompok_bidang_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_kelompok_bidang")
public class RefKelompokBidangSister extends GeneralValueObject {
	...
	public RefKelompokBidangSister() {}
