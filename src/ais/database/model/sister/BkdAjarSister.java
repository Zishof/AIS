...
/** Entitas hasil sinkronisasi SISTER untuk endpoint <b>bkd/ajar</b>. Kolom bernama = field SISTER; {@code kode}=id item (kunci upsert); {@code keterangan}=JSON mentah. @Audited (tabel __audit auto hbm2ddl). */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_bkd_ajar")
public class BkdAjarSister extends GeneralValueObject {
	/** Versi serialisasi. */
	...
	/** Kode/id item kegiatan mengajar pada SISTER — kunci upsert sinkronisasi (bukan PK lokal). */
	private String kode;
	...
	/** id_sdm dosen pemilik butir beban mengajar ini (acuan ke {@code RefSdmSister}). */
	private String idSdm;
	/** id_smt semester butir beban mengajar ini dihitung. */
	...
	private String nidn;
	/** Unsur/komponen kegiatan mengajar (mis. perkuliahan, praktikum) menurut kategori SISTER. */
	private String unsur;
	/** Judul/uraian kegiatan mengajar (mis. nama mata kuliah) yang menjadi butir beban ini. */
	private String judulKeg;
	/** id kategori kegiatan mengajar pada SISTER. */
	private Integer idKatgiat;
	/** Nama kategori kegiatan mengajar (salinan denormalisasi dari SISTER). */
	private String nmKat;
	/** Beban SKS (satuan kredit semester) kegiatan mengajar ini yang diperhitungkan dalam BKD. */
	private Double bebanSks;
	/** Nilai/skor kegiatan mengajar ini sebagaimana dihitung SISTER. */
	private Double nilai;

	/** Konstruktor kosong (dibutuhkan Hibernate). */
	public BkdAjarSister() {}
	...
	/** @return id kategori kegiatan mengajar pada SISTER. */
	...
	/** @return nama kategori kegiatan mengajar. */
	...
	/** @return beban SKS kegiatan mengajar ini. */
	...
	/** @return nilai/skor kegiatan mengajar ini. */
