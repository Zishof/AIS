...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint <b>trid/beasiswa</b>. Kolom bernama = field SISTER; {@code kode}=id item (kunci upsert); {@code keterangan}=JSON mentah. @Audited (tabel __audit auto hbm2ddl).
 *
 * <p>Memetakan tabel fisik {@code sister_trid_beasiswa}, terdaftar pada {@link SisterEntitasRegistry} dengan kunci
 * {@code "beasiswa"}. Bentuk &amp; semantik field administratif (id/oleh/olehId/tanggal_dirubah/kode/keterangan/aktif/idSdm)
 * identik dengan {@link TridBahanAjarSister}, kelas rujukan klaster {@code Trid*Sister} bagian 2 — lihat javadoc
 * di sana untuk penjelasan lengkap pola tersebut. Field spesifik-domain didokumentasikan di bawah.</p>
 *
...
@Audited
@Table(schema = "public", name = "sister_trid_beasiswa")
public class TridBeasiswaSister extends GeneralValueObject {
	...
	/** Jenis/kategori beasiswa sesuai referensi SISTER. */
	private String jenisBeasiswa;
	/** Nama beasiswa/program pemberi. */
	private String nama;
	/** Tahun mulai menerima beasiswa. */
	private Integer tahunMulai;
	/** Tahun selesai menerima beasiswa (boleh kosong bila masih berjalan). */
	private Integer tahunSelesai;
	/** Penanda apakah dosen masih menerima beasiswa ini saat data dilaporkan. */
	private Boolean masihMenerima;

	/** Konstruktor default (dibutuhkan Hibernate). */
	public TridBeasiswaSister() {}
	/** @return {@link #id}. */
	...
	/** @return {@link #jenisBeasiswa}. */
	@Column(name = "jenis_beasiswa", columnDefinition = "text") public String getJenisBeasiswa() { return jenisBeasiswa; }
	/** @param v nilai {@link #jenisBeasiswa} baru. */
	public void setJenisBeasiswa(String v) { this.jenisBeasiswa = v; }
	/** @return {@link #nama}. */
	...
	/** @return {@link #masihMenerima}. */
	@Column(name = "masih_menerima") public Boolean getMasihMenerima() { return masihMenerima; }
	/** @param v nilai {@link #masihMenerima} baru. */
	public void setMasihMenerima(Boolean v) { this.masihMenerima = v; }
