...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/sumber_gaji}</b> (daftar sumber dana gaji).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/sumber_gaji"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_sumber_gaji_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_sumber_gaji")
public class RefSumberGajiSister extends GeneralValueObject {
