...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/jabatan_tugas_tambahan}</b> (daftar jabatan tugas tambahan (dekan, ketua program studi, dan sejenisnya)).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/jabatan_tugas_tambahan"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_jabatan_tugas_tambahan_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_jabatan_tugas_tambahan")
public class RefJabatanTugasTambahanSister extends GeneralValueObject {
	...
	public RefJabatanTugasTambahanSister() {}
