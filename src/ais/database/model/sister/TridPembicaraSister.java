...
/**
 * <h2>Entitas Tridharma tersinkron SISTER &mdash; Pembicara</h2>
 *
 * <p>Baris tabel {@code sister_trid_pembicara}, hasil sinkronisasi endpoint SISTER (Kemdikbudristek)
 * <b>{@code pembicara}</b> &mdash; riwayat dosen menjadi pembicara/narasumber pada seminar, workshop,
 * atau forum ilmiah lain, BERBEDA dari {@link TridOrasiIlmiahSister} yang khusus mencatat orasi ilmiah
 * (mis. pidato pengukuhan Guru Besar). Mengikuti KERANGKA STRUKTUR &amp; MEKANISME SINKRONISASI yang
 * identik dengan {@link TridPenelitianSister} (lihat javadoc kelas tersebut untuk penjelasan lengkap):
 * terdaftar di {@link SisterEntitasRegistry} pada kunci {@code "pembicara"}, dirutekan &amp; di-upsert
 * secara reflektif oleh {@link ais.common.DataSisterApi} berdasarkan {@link #getKode()}, dengan
 ...
 * tanggalPelaksanaan}. Struktur field SAMA PERSIS dengan {@link TridOrasiIlmiahSister} &mdash; hanya beda
 * peran (pembicara umum vs. orasi ilmiah) dan endpoint/tabel tujuan.</p>
 *
 * @see TridPenelitianSister
 * @see TridOrasiIlmiahSister
...
@Audited
@Table(schema = "public", name = "sister_trid_pembicara")
public class TridPembicaraSister extends GeneralValueObject {
	...
	/** Judul makalah/materi yang dibawakan sebagai pembicara. */
	private String judulMakalah;
	/** Nama acara/forum tempat menjadi pembicara. */
	private String namaPertemuan;
	/** Penyelenggara acara. */
	private String penyelenggara;
	/** Tanggal pelaksanaan (string sesuai format SISTER, bukan {@code Date}). */
