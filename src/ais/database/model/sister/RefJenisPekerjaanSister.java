...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/jenis_pekerjaan}</b> (daftar jenis pekerjaan).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/jenis_pekerjaan"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_jenis_pekerjaan_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_jenis_pekerjaan")
public class RefJenisPekerjaanSister extends GeneralValueObject {
	...
	public RefJenisPekerjaanSister() {}
