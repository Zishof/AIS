...
/** Entitas hasil sinkronisasi SISTER untuk endpoint <b>bkd/pengmas</b>. Kolom bernama = field SISTER; {@code kode}=id item (kunci upsert); {@code keterangan}=JSON mentah. @Audited (tabel __audit auto hbm2ddl). */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_bkd_pengmas")
public class BkdPengmasSister extends GeneralValueObject {
	/** Versi serialisasi. */
	...
	/** Kode/id item kegiatan pengabdian masyarakat (Pengmas) pada SISTER — kunci upsert sinkronisasi (bukan PK lokal). */
	private String kode;
	...
	/** id_sdm dosen pemilik butir beban pengabdian masyarakat ini (acuan ke {@code RefSdmSister}). */
	private String idSdm;
	/** id_smt semester butir beban pengabdian masyarakat ini dihitung. */
	...
	private String nidn;
	/** Unsur/komponen kegiatan pengabdian masyarakat menurut kategori SISTER. */
	private String unsur;
	/** Judul/uraian kegiatan pengabdian masyarakat yang menjadi butir beban ini. */
	private String judulKeg;
	/** id kategori kegiatan pengabdian masyarakat pada SISTER. */
	private Integer idKatgiat;
	/** Nama kategori kegiatan pengabdian masyarakat (salinan denormalisasi dari SISTER). */
	private String nmKat;
	/** Beban SKS (satuan kredit semester) kegiatan pengabdian masyarakat ini yang diperhitungkan dalam BKD. */
	private Double bebanSks;
	/** Nilai/skor kegiatan pengabdian masyarakat ini sebagaimana dihitung SISTER. */
	private Double nilai;

	/** Konstruktor kosong (dibutuhkan Hibernate). */
	public BkdPengmasSister() {}
	...
	/** @return id_sdm dosen pemilik butir beban pengabdian masyarakat ini. */
	@Column(name = "id_sdm", columnDefinition = "text") public String getIdSdm() { return idSdm; }
	/** @param v id_sdm baru. */
	public void setIdSdm(String v) { this.idSdm = v; }
	/** @return id_smt semester butir beban pengabdian masyarakat ini. */
	...
	/** @return id kategori kegiatan pengabdian masyarakat pada SISTER. */
	...
	/** @return nama kategori kegiatan pengabdian masyarakat. */
	...
	/** @return beban SKS kegiatan pengabdian masyarakat ini. */
	...
	/** @return nilai/skor kegiatan pengabdian masyarakat ini. */
