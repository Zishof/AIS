...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/ikatan_kerja}</b> (daftar jenis ikatan kerja pegawai (tetap, kontrak, dan sejenisnya)).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/ikatan_kerja"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_ikatan_kerja_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_ikatan_kerja")
public class RefIkatanKerjaSister extends GeneralValueObject {
