...
/**
 * <h2>Entitas Tridharma tersinkron SISTER &mdash; Visiting Scientist</h2>
 *
 * <p>Baris tabel {@code sister_trid_visiting_scientist}, hasil sinkronisasi endpoint SISTER
 * (Kemdikbudristek) <b>{@code visiting_scientist}</b> &mdash; riwayat kegiatan dosen sebagai ilmuwan
 * tamu (visiting scientist/scholar) di perguruan tinggi lain. Mengikuti KERANGKA STRUKTUR &amp; MEKANISME
 * SINKRONISASI yang identik dengan {@link TridPenelitianSister} (lihat javadoc kelas tersebut untuk
 * penjelasan lengkap): terdaftar di {@link SisterEntitasRegistry} pada kunci {@code "visiting_scientist"},
 ...
 *
 * <p>Field bisnis endpoint ini: {@link #getPerguruanTinggi() perguruanTinggi} (institusi tujuan),
 * {@link #getLamaKegiatan() lamaKegiatan} (durasi kegiatan; DISIMPAN SEBAGAI STRING pada entity ini,
 * BERBEDA dengan {@link TridPenelitianSister#getLamaKegiatan()} yang bertipe {@code Integer} &mdash; SISTER
 * tidak konsisten memakai tipe data yang sama untuk field bernama sama di endpoint berbeda), dan
 * {@link #getTanggal() tanggal} (tanggal pelaksanaan).</p>
 *
...
@Audited
@Table(schema = "public", name = "sister_trid_visiting_scientist")
public class TridVisitingScientistSister extends GeneralValueObject {
	...
	/** Perguruan tinggi tujuan kegiatan visiting scientist. */
	private String perguruanTinggi;
	/** Lama kegiatan visiting scientist (string bebas sesuai SISTER; bukan angka bertipe {@code Integer}). */
	private String lamaKegiatan;
	/** Tanggal pelaksanaan kegiatan visiting scientist (string sesuai format SISTER, bukan {@code Date}). */
	private String tanggal;

	/** Konstruktor bawaan (dibutuhkan Hibernate &amp; refleksi upsert {@code DataSisterApi}); field diisi lewat setter. */
	public TridVisitingScientistSister() {}
	...
	/**
	 * @return perguruan tinggi tujuan kegiatan visiting scientist
	 */
	@Column(name = "perguruan_tinggi", columnDefinition = "text") public String getPerguruanTinggi() { return perguruanTinggi; }

	/**
	 * @param v perguruan tinggi tujuan kegiatan visiting scientist
	 */
	public void setPerguruanTinggi(String v) { this.perguruanTinggi = v; }

	/**
	 * @return lama kegiatan visiting scientist (string bebas sesuai SISTER, bukan angka)
	 */
	@Column(name = "lama_kegiatan", columnDefinition = "text") public String getLamaKegiatan() { return lamaKegiatan; }

	/**
	 * @param v lama kegiatan visiting scientist
	 */
	public void setLamaKegiatan(String v) { this.lamaKegiatan = v; }

	/**
	 * @return tanggal pelaksanaan kegiatan visiting scientist (string, format sesuai SISTER)
	 */
	@Column(name = "tanggal", columnDefinition = "text") public String getTanggal() { return tanggal; }

	/**
	 * @param v tanggal pelaksanaan kegiatan visiting scientist
	 */
