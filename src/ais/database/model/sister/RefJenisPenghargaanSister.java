...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/jenis_penghargaan}</b> (daftar jenis penghargaan).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/jenis_penghargaan"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_jenis_penghargaan_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_jenis_penghargaan")
public class RefJenisPenghargaanSister extends GeneralValueObject {
	...
	public RefJenisPenghargaanSister() {}
