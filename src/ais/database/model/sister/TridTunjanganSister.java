...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint <b>trid/tunjangan</b>. Kolom bernama = field SISTER; {@code kode}=id item (kunci upsert); {@code keterangan}=JSON mentah. @Audited (tabel __audit auto hbm2ddl).
 *
 * <p>Memetakan tabel fisik {@code sister_trid_tunjangan}, terdaftar pada {@link SisterEntitasRegistry}
 * dengan kunci {@code "tunjangan"}. Bentuk &amp; semantik field administratif (id/oleh/olehId/
...
@Audited
@Table(schema = "public", name = "sister_trid_tunjangan")
public class TridTunjanganSister extends GeneralValueObject {
	...
	/** Jenis tunjangan sesuai referensi SISTER. */
	private String jenisTunjangan;
	/** Nama tunjangan. */
	private String nama;
	/** Nama instansi pemberi tunjangan. */
	private String instansiPemberi;
	/** Sumber dana tunjangan (mis. APBN, mandiri). */
	private String sumberDana;
	/** Tahun mulai menerima tunjangan. */
	private Integer tahunMulai;
	/** Tahun selesai menerima tunjangan. */
	private Integer tahunSelesai;
	/** Nilai nominal tunjangan yang diterima. */
	private Double nominal;

	/** Konstruktor default (dibutuhkan Hibernate). */
	public TridTunjanganSister() {}
	/** @return {@link #id}. */
	...
	/** @return {@link #jenisTunjangan}. */
	@Column(name = "jenis_tunjangan", columnDefinition = "text") public String getJenisTunjangan() { return jenisTunjangan; }
	/** @param v nilai {@link #jenisTunjangan} baru. */
	public void setJenisTunjangan(String v) { this.jenisTunjangan = v; }
	/** @return {@link #nama}. */
	...
	/** @return {@link #instansiPemberi}. */
	@Column(name = "instansi_pemberi", columnDefinition = "text") public String getInstansiPemberi() { return instansiPemberi; }
	/** @param v nilai {@link #instansiPemberi} baru. */
	public void setInstansiPemberi(String v) { this.instansiPemberi = v; }
	/** @return {@link #sumberDana}. */
	@Column(name = "sumber_dana", columnDefinition = "text") public String getSumberDana() { return sumberDana; }
	/** @param v nilai {@link #sumberDana} baru. */
	public void setSumberDana(String v) { this.sumberDana = v; }
	...
	/** @return {@link #nominal}. */
	@Column(name = "nominal") public Double getNominal() { return nominal; }
	/** @param v nilai {@link #nominal} baru. */
