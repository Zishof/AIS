...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/jenjang_pendidikan}</b> (daftar jenjang pendidikan (S1/S2/S3, dan sejenisnya)).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/jenjang_pendidikan"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_jenjang_pendidikan_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_jenjang_pendidikan")
public class RefJenjangPendidikanSister extends GeneralValueObject {
	...
	public RefJenjangPendidikanSister() {}
