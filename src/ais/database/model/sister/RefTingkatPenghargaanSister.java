...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/tingkat_penghargaan}</b> (daftar tingkat penghargaan (nasional/internasional, dan sejenisnya)).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/tingkat_penghargaan"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_tingkat_penghargaan_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_tingkat_penghargaan")
public class RefTingkatPenghargaanSister extends GeneralValueObject {
	...
	public RefTingkatPenghargaanSister() {}
