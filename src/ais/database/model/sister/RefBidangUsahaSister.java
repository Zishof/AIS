...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/bidang_usaha}</b> (daftar bidang usaha DUDI (dunia usaha/industri) tempat kerja mitra).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/bidang_usaha"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_bidang_usaha_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_bidang_usaha")
public class RefBidangUsahaSister extends GeneralValueObject {
