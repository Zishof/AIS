...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint <b>trid/pengelola_jurnal</b>. Kolom bernama = field SISTER; {@code kode}=id item (kunci upsert); {@code keterangan}=JSON mentah. @Audited (tabel __audit auto hbm2ddl).
 *
 * <p>Memetakan tabel fisik {@code sister_trid_pengelola_jurnal}, terdaftar pada {@link SisterEntitasRegistry}
 * dengan kunci {@code "pengelola_jurnal"}. Bentuk &amp; semantik field administratif (id/oleh/olehId/
...
@Audited
@Table(schema = "public", name = "sister_trid_pengelola_jurnal")
public class TridPengelolaJurnalSister extends GeneralValueObject {
	...
	/** Kategori kegiatan pengelolaan jurnal sesuai referensi SISTER. */
	private String kategoriKegiatan;
	/** Nama media/jurnal yang dikelola. */
	private String mediaPublikasi;
	/** Nomor SK penugasan sebagai pengelola jurnal. */
	private String skPenugasan;
	/** Tanggal mulai menjabat sebagai pengelola jurnal, teks mentah dari SISTER. */
	private String tanggalMulai;
	/** Tanggal selesai menjabat sebagai pengelola jurnal, teks mentah dari SISTER. */
	private String tanggalSelesai;
	/** Peran/jabatan dalam pengelolaan jurnal (mis. editor, reviewer). */
	private String peran;

	/** Konstruktor default (dibutuhkan Hibernate). */
	public TridPengelolaJurnalSister() {}
	/** @return {@link #id}. */
	...
	/** @return {@link #mediaPublikasi}. */
	@Column(name = "media_publikasi", columnDefinition = "text") public String getMediaPublikasi() { return mediaPublikasi; }
	/** @param v nilai {@link #mediaPublikasi} baru. */
	public void setMediaPublikasi(String v) { this.mediaPublikasi = v; }
