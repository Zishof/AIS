...
/**
 * <h2>Entitas Tridharma tersinkron SISTER &mdash; Orasi Ilmiah</h2>
 *
 * <p>Baris tabel {@code sister_trid_orasi_ilmiah}, hasil sinkronisasi endpoint SISTER (Kemdikbudristek)
 * <b>{@code orasi_ilmiah}</b> &mdash; riwayat dosen menyampaikan orasi ilmiah (mis. pidato pengukuhan
 * Guru Besar, orasi ilmiah pada wisuda/dies natalis). Mengikuti KERANGKA STRUKTUR &amp; MEKANISME
 * SINKRONISASI yang identik dengan {@link TridPenelitianSister} (lihat javadoc kelas tersebut untuk
 * penjelasan lengkap): terdaftar di {@link SisterEntitasRegistry} pada kunci {@code "orasi_ilmiah"},
 * dirutekan &amp; di-upsert secara reflektif oleh {@link ais.common.DataSisterApi} berdasarkan
 * {@link #getKode()}, dengan {@link #getKeterangan()} menyimpan salinan JSON mentah dan {@link #getAktif()}
 * tetap flag satu-arah. Endpoint ini TIDAK BER-PAGINASI.</p>
 *
 * <p>Field bisnis endpoint ini: {@link #getJudulMakalah() judulMakalah}, {@link #getNamaPertemuan()
 * namaPertemuan} (nama acara/forum), {@link #getPenyelenggara() penyelenggara}, {@link #getTanggalPelaksanaan()
 * tanggalPelaksanaan}. Struktur field SAMA PERSIS dengan {@link TridPembicaraSister} &mdash; hanya beda
 * peran (orasi ilmiah vs. pembicara umum) dan endpoint/tabel tujuan.</p>
 *
 * @see TridPenelitianSister
 * @see TridPembicaraSister
...
@Audited
@Table(schema = "public", name = "sister_trid_orasi_ilmiah")
public class TridOrasiIlmiahSister extends GeneralValueObject {
	...
	/** Judul makalah/naskah orasi ilmiah. */
	private String judulMakalah;
	/** Nama acara/forum tempat orasi ilmiah disampaikan. */
	private String namaPertemuan;
	/** Penyelenggara acara orasi ilmiah. */
	private String penyelenggara;
	/** Tanggal pelaksanaan orasi ilmiah (string sesuai format SISTER, bukan {@code Date}). */
	...
	/**
	 * @return judul makalah/naskah orasi ilmiah
	 */
	@Column(name = "judul_makalah", columnDefinition = "text") public String getJudulMakalah() { return judulMakalah; }

	/**
	 * @param v judul makalah/naskah orasi ilmiah
	 */
	public void setJudulMakalah(String v) { this.judulMakalah = v; }

	/**
	 * @return nama acara/forum tempat orasi ilmiah disampaikan
	 */
	@Column(name = "nama_pertemuan", columnDefinition = "text") public String getNamaPertemuan() { return namaPertemuan; }

	/**
	 * @param v nama acara/forum tempat orasi ilmiah disampaikan
	 */
	public void setNamaPertemuan(String v) { this.namaPertemuan = v; }

	/**
	 * @return penyelenggara acara orasi ilmiah
	 */
	@Column(name = "penyelenggara", columnDefinition = "text") public String getPenyelenggara() { return penyelenggara; }

	/**
	 * @param v penyelenggara acara orasi ilmiah
	 */
	public void setPenyelenggara(String v) { this.penyelenggara = v; }

	/**
	 * @return tanggal pelaksanaan orasi ilmiah (string, format sesuai SISTER)
	 */
	@Column(name = "tanggal_pelaksanaan", columnDefinition = "text") public String getTanggalPelaksanaan() { return tanggalPelaksanaan; }

	/**
	 * @param v tanggal pelaksanaan orasi ilmiah
	 */
	public void setTanggalPelaksanaan(String v) { this.tanggalPelaksanaan = v; }
