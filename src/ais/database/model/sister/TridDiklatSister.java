...
/**
 * <h2>Entitas Tridharma tersinkron SISTER &mdash; Diklat</h2>
 *
 * <p>Baris tabel {@code sister_trid_diklat}, hasil sinkronisasi endpoint SISTER (Kemdikbudristek)
 * <b>{@code diklat}</b> &mdash; riwayat pendidikan &amp; pelatihan (diklat) yang pernah diikuti seorang
 * dosen. Mengikuti KERANGKA STRUKTUR &amp; MEKANISME SINKRONISASI yang identik dengan
 * {@link TridPenelitianSister} (lihat javadoc kelas tersebut untuk penjelasan lengkap): terdaftar di
 * {@link SisterEntitasRegistry} pada kunci {@code "diklat"}, dirutekan &amp; di-upsert secara reflektif
 * oleh {@link ais.common.DataSisterApi} berdasarkan {@link #getKode()}, dengan {@link #getKeterangan()}
 * menyimpan salinan JSON mentah dan {@link #getAktif()} tetap flag satu-arah. Endpoint ini TIDAK BER-PAGINASI.</p>
 *
 * <p>Field bisnis endpoint ini: {@link #getJenisDiklat() jenisDiklat}, {@link #getNama() nama} (nama
 * diklat), {@link #getPenyelenggara() penyelenggara}, {@link #getTahun() tahun}.</p>
 *
 * <p><b>Catatan verifikasi (sudah dikonfirmasi sesi sebelumnya):</b> {@link #getJenisDiklat()} adalah
 * STRING BEBAS berisi label jenis diklat sisi SISTER (mis. hasil dari referensi {@code jenis_diklat}
 * SISTER, {@code RefJenisDiklatSister}) &mdash; TIDAK BERELASI dan TIDAK MEREFERENSIKAN entity lokal
 * {@link ais.database.model.employ.JenisDiklat} (master jenis diklat internal e-Campus, dipakai domain
 * kepegawaian yang sama sekali terpisah). Kedua sekadar kebetulan berbagi nama.</p>
 *
...
@Audited
@Table(schema = "public", name = "sister_trid_diklat")
public class TridDiklatSister extends GeneralValueObject {
	...
	/** Jenis diklat (string bebas sisi SISTER; TIDAK berelasi ke {@link ais.database.model.employ.JenisDiklat} lokal). */
	...
	/**
	 * @return jenis diklat (string bebas sisi SISTER; TIDAK berelasi ke {@link ais.database.model.employ.JenisDiklat} lokal)
	 */
	@Column(name = "jenis_diklat", columnDefinition = "text") public String getJenisDiklat() { return jenisDiklat; }

	/**
	 * @param v jenis diklat
	 */
	public void setJenisDiklat(String v) { this.jenisDiklat = v; }

	/**
	 * @return nama diklat yang diikuti
	 */
	@Column(name = "nama", columnDefinition = "text") public String getNama() { return nama; }

	/**
	 * @param v nama diklat yang diikuti
	 */
	public void setNama(String v) { this.nama = v; }

	/**
	 * @return penyelenggara diklat
	 */
	@Column(name = "penyelenggara", columnDefinition = "text") public String getPenyelenggara() { return penyelenggara; }

	/**
	 * @param v penyelenggara diklat
	 */
	public void setPenyelenggara(String v) { this.penyelenggara = v; }

	/**
	 * @return tahun pelaksanaan diklat
	 */
	@Column(name = "tahun") public Integer getTahun() { return tahun; }

	/**
	 * @param v tahun pelaksanaan diklat
	 */
