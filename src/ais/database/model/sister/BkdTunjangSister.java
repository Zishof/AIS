...
public class BkdTunjangSister extends GeneralValueObject {
	...
	/** Kode/id item kegiatan penunjang (unsur "tunjang"/penunjang tridharma) pada SISTER — kunci upsert sinkronisasi (bukan PK lokal). */
	private String kode;
	...
	/** id_sdm dosen pemilik butir beban penunjang ini (acuan ke {@code RefSdmSister}). */
	private String idSdm;
	/** id_smt semester butir beban penunjang ini dihitung. */
	...
	private String nidn;
	/** Unsur/komponen kegiatan penunjang menurut kategori SISTER. */
	private String unsur;
	/** Judul/uraian kegiatan penunjang yang menjadi butir beban ini. */
	private String judulKeg;
	/** id kategori kegiatan penunjang pada SISTER. */
	private Integer idKatgiat;
	/** Nama kategori kegiatan penunjang (salinan denormalisasi dari SISTER). */
	private String nmKat;
	/** Beban SKS (satuan kredit semester) kegiatan penunjang ini yang diperhitungkan dalam BKD. */
	private Double bebanSks;
	/** Nilai/skor kegiatan penunjang ini sebagaimana dihitung SISTER. */
	...
	/** @return id kategori kegiatan penunjang pada SISTER. */
	...
	/** @return nama kategori kegiatan penunjang. */
	...
	/** @return beban SKS kegiatan penunjang ini. */
	...
	/** @return nilai/skor kegiatan penunjang ini. */
