...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/jenis_keluar}</b> (daftar jenis status keluar pegawai (pensiun, mengundurkan diri, dan sejenisnya)).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/jenis_keluar"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_jenis_keluar_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_jenis_keluar")
public class RefJenisKeluarSister extends GeneralValueObject {
