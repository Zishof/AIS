...
/**
 * <h2>Entitas Tridharma tersinkron SISTER &mdash; Pengabdian Masyarakat</h2>
 *
 * <p>Baris tabel {@code sister_trid_pengabdian}, hasil sinkronisasi endpoint SISTER (Kemdikbudristek)
 * <b>{@code pengabdian}</b> &mdash; daftar kegiatan pengabdian kepada masyarakat seorang dosen yang telah
 * dilaporkan ke SISTER. Mengikuti KERANGKA STRUKTUR &amp; MEKANISME SINKRONISASI yang identik dengan
 * {@link TridPenelitianSister} (lihat javadoc kelas tersebut untuk penjelasan lengkap): terdaftar di
 * {@link SisterEntitasRegistry} pada kunci {@code "pengabdian"}, dirutekan &amp; di-upsert secara reflektif
 * oleh {@link ais.common.DataSisterApi} berdasarkan {@link #getKode()}, dengan {@link #getKeterangan()}
 * menyimpan salinan JSON mentah dan {@link #getAktif()} tetap merupakan flag satu-arah (tidak pernah
 * disetel {@code false} oleh jalur sinkron otomatis). {@code pengabdian} juga termasuk salah satu dari
 * HANYA 5 endpoint Tridharma yang BER-PAGINASI di SISTER (bersama {@code penelitian, publikasi,
 * penunjang_lain, kekayaan_intelektual}).</p>
 *
 * <p>Field bisnis endpoint ini &mdash; {@link #getJudul() judul}, {@link #getBidangKeilmuan() bidangKeilmuan},
 * {@link #getTahunPelaksanaan() tahunPelaksanaan}, {@link #getLamaKegiatan() lamaKegiatan} &mdash; SAMA PERSIS
 * strukturnya dengan {@link TridPenelitianSister} (hanya beda tabel/endpoint tujuan), karena SISTER
 * memakai skema field yang identik untuk kedua jenis Tridharma "kegiatan riset" ini.</p>
 *
...
@Audited
@Table(schema = "public", name = "sister_trid_pengabdian")
public class TridPengabdianSister extends GeneralValueObject {
	...
	/** Judul kegiatan pengabdian kepada masyarakat, sebagaimana dilaporkan ke SISTER. */
	private String judul;
	/** Bidang keilmuan kegiatan pengabdian (kode/label sisi SISTER). */
	private String bidangKeilmuan;
	/** Tahun pelaksanaan kegiatan pengabdian. */
	private Integer tahunPelaksanaan;
	/** Lama kegiatan pengabdian (satuan sesuai konvensi SISTER, umumnya bulan). */
