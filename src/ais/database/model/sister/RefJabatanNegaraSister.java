...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/jabatan_negara}</b> (daftar jabatan negara (struktural pemerintahan)).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/jabatan_negara"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_jabatan_negara_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_jabatan_negara")
public class RefJabatanNegaraSister extends GeneralValueObject {
