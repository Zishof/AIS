...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/status_kepegawaian}</b> (daftar status kepegawaian).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/status_kepegawaian"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_status_kepegawaian_AUD} otomatis via hbm2ddl).
 */
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@Audited
@Table(schema = "public", name = "sister_ref_status_kepegawaian")
public class RefStatusKepegawaianSister extends GeneralValueObject {
	...
	public RefStatusKepegawaianSister() {}
