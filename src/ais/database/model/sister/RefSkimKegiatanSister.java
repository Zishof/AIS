...
/**
 * Entitas hasil sinkronisasi SISTER untuk endpoint referensi <b>{@code referensi/skim_kegiatan}</b> (daftar skema/skim kegiatan penelitian/pengabdian).
 ...
 * =JSON mentah baris ini. Dipetakan di {@link SisterEntitasRegistry} pada key {@code "referensi/skim_kegiatan"}.
 * {@code @Audited} (tabel bayangan {@code sister_ref_skim_kegiatan_AUD} otomatis via hbm2ddl).
 */
@Entity
