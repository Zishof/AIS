...
/**
 * <h2>Entitas Tridharma tersinkron SISTER &mdash; Penghargaan</h2>
 *
 * <p>Baris tabel {@code sister_trid_penghargaan}, hasil sinkronisasi endpoint SISTER (Kemdikbudristek)
 * <b>{@code penghargaan}</b> &mdash; riwayat penghargaan yang pernah diterima seorang dosen. Mengikuti
 * KERANGKA STRUKTUR &amp; MEKANISME SINKRONISASI yang identik dengan {@link TridPenelitianSister} (lihat
 * javadoc kelas tersebut untuk penjelasan lengkap): terdaftar di {@link SisterEntitasRegistry} pada kunci
 * {@code "penghargaan"}, dirutekan &amp; di-upsert secara reflektif oleh {@link ais.common.DataSisterApi}
 ...
 *
 * <p>Field bisnis endpoint ini: {@link #getJenisPenghargaan() jenisPenghargaan} (kode/label sisi SISTER,
 * umumnya merujuk referensi {@code jenis_penghargaan}), {@link #getNama() nama} (nama penghargaan),
 * {@link #getTahun() tahun}, {@link #getInstansiPemberi() instansiPemberi}.</p>
 *
...
@Audited
@Table(schema = "public", name = "sister_trid_penghargaan")
public class TridPenghargaanSister extends GeneralValueObject {
	...
	/** Jenis penghargaan (kode/label sisi SISTER, umumnya merujuk referensi jenis penghargaan). */
	private String jenisPenghargaan;
	/** Nama penghargaan yang diterima. */
	private String nama;
	/** Tahun penerimaan penghargaan. */
	private Integer tahun;
	/** Instansi/lembaga pemberi penghargaan. */
	private String instansiPemberi;

	/** Konstruktor bawaan (dibutuhkan Hibernate &amp; refleksi upsert {@code DataSisterApi}); field diisi lewat setter. */
	public TridPenghargaanSister() {}
	...
	/**
	 * @return jenis penghargaan (kode/label sisi SISTER)
	 */
	@Column(name = "jenis_penghargaan", columnDefinition = "text") public String getJenisPenghargaan() { return jenisPenghargaan; }

	/**
	 * @param v jenis penghargaan
	 */
	public void setJenisPenghargaan(String v) { this.jenisPenghargaan = v; }

	/**
	 * @return nama penghargaan yang diterima
	 */
	@Column(name = "nama", columnDefinition = "text") public String getNama() { return nama; }

	/**
	 * @param v nama penghargaan yang diterima
	 */
	public void setNama(String v) { this.nama = v; }

	/**
	 * @return tahun penerimaan penghargaan
	 */
	@Column(name = "tahun") public Integer getTahun() { return tahun; }

	/**
	 * @param v tahun penerimaan penghargaan
	 */
	public void setTahun(Integer v) { this.tahun = v; }

	/**
	 * @return instansi/lembaga pemberi penghargaan
	 */
	@Column(name = "instansi_pemberi", columnDefinition = "text") public String getInstansiPemberi() { return instansiPemberi; }

	/**
	 * @param v instansi/lembaga pemberi penghargaan
	 */
	public void setInstansiPemberi(String v) { this.instansiPemberi = v; }
