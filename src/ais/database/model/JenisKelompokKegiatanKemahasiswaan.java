...
/**
 * Entity master data <b>jenis kelompok kegiatan kemahasiswaan</b> pada tabel
 * {@code public.jenis_kelompok_kegiatan_kemahasiswaan}. Mengelompokkan
 * {@link KelompokKegiatanKemahasiswaan} ke dalam kategori (mis. "UKM", "BEM/Ormawa",
 * "Komunitas") yang dipakai layar {@code JenisKelompokKegiatanKemahasiswaanAction} dan
 * {@code KelompokKegiatanKemahasiswaanAction} sebagai daftar pilihan saat mendata kelompok
 * kegiatan mahasiswa.
 *
 * <p>Kelas ini murni tabel referensi: hanya {@link #getNama()} dan {@link #getKeterangan()}
 * sebagai data bisnis, tanpa sakelar {@code aktif}/{@code nomorUrut}/{@code kode} — berbeda
 * dari sejumlah master data sejenis lain di paket ini.</p>
 *
...
@Audited
@Table(schema = "public", name = "jenis_kelompok_kegiatan_kemahasiswaan")

public class JenisKelompokKegiatanKemahasiswaan extends GeneralValueObject {
	...
	/** Kunci utama tabel {@code public.jenis_kelompok_kegiatan_kemahasiswaan} ({@code IDENTITY}). */
	private Long id;
	...
	/** Nama jenis kelompok kegiatan kemahasiswaan (mis. "UKM"); wajib diisi. */
	private String nama;
	/** Catatan/keterangan bebas tentang jenis kelompok ini; boleh {@code null}. */
	private String keterangan;

	/** Konstruktor tanpa argumen yang diwajibkan Hibernate/JPA. */
	public JenisKelompokKegiatanKemahasiswaan() {
	}
	...
	/** @return nama jenis kelompok, di-trim; {@code null} bila belum pernah diisi. */
	@Column(name = "nama", nullable = false, length = 255)
	public String getNama() {
		return this.nama == null ? null : this.nama.trim();
	}

	/** @param nama nama jenis kelompok; disimpan apa adanya, trimming terjadi di {@link #getNama()}. */
	public void setNama(String nama) {
		this.nama = nama;
	}

	/** @return keterangan bebas jenis kelompok ini apa adanya, tanpa normalisasi. */
	@Column(name = "keterangan", nullable = true)
	public String getKeterangan() {
		return this.keterangan;
	}

	/** @param keterangan catatan/keterangan bebas untuk jenis kelompok ini. */
