...
/**
 * Entity master data <b>jabatan pada kepanitiaan/pelaksanaan kegiatan kemahasiswaan</b> pada
 * tabel {@code public.jabatan_kegiatan_kemahasiswaan} (mis. "Ketua Panitia", "Anggota",
 * "Penanggung Jawab"). Dipakai sebagai daftar pilihan jabatan mahasiswa dalam suatu
 * {@link KegiatanKemahasiswaan} — bukan jabatan organisasi (lihat
 * {@link JabatanOrganisasiIntraKampus} untuk itu).
 *
 * <p>Selain {@link #getNama()} (unik) dan {@link #getKeterangan()}, kelas ini punya sakelar
 * satu-arah {@link #getAktif()} (default {@code true} bila {@code null}) dan
 * {@link #getNomorUrut()} (default {@code 1} bila {@code null}) untuk urutan tampil pada
 * combobox layar {@code JabatanKegiatanKemahasiswaanAction}.</p>
 *
...
@Audited
@Table(schema = "public", name = "jabatan_kegiatan_kemahasiswaan")

public class JabatanKegiatanKemahasiswaan extends GeneralValueObject {
	...
	/** Kunci utama tabel {@code public.jabatan_kegiatan_kemahasiswaan} ({@code IDENTITY}). */
	private Long id;
	...
	/** Nama jabatan kegiatan (mis. "Ketua Panitia"); wajib diisi dan unik pada tabel. */
	private String nama;
	...
	public JabatanKegiatanKemahasiswaan() {
	}
	...
	/**
	 * @return nomor urut tampil jabatan ini pada daftar pilihan. <b>Efek samping:</b>
	...
	/**
	 * @return status aktif/non-aktif jabatan ini. <b>Efek samping:</b> {@code null} diganti
	...
	/** @param aktif {@code true} bila jabatan ini masih boleh dipilih. */
