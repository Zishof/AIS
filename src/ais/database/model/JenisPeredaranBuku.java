...
/**
 * Entity master data <b>jenis peredaran buku</b> pada tabel {@code public.jenis_peredaran_buku}.
 * Mendaftar kategori peredaran koleksi perpustakaan (mis. "Sirkulasi Umum", "Referensi/Tidak
 * Dipinjamkan", "Koleksi Cadangan") yang dipakai modul perpustakaan sebagai daftar pilihan saat
 * mendata jenis peredaran suatu item.
 *
...
@Audited
@Table(schema = "public", name = "jenis_peredaran_buku")

public class JenisPeredaranBuku extends GeneralValueObject {
	...
	/** Kunci utama tabel {@code public.jenis_peredaran_buku} ({@code IDENTITY}). */
	private Long id;
	...
	/** Nama jenis peredaran buku (mis. "Sirkulasi Umum"); wajib diisi. */
	private String nama;
	/** Catatan/keterangan bebas tentang jenis peredaran ini; boleh {@code null}. */
	private String keterangan;
	/** Status aktif/nonaktif; lihat {@link #getAktif()} untuk perilaku default. */
	private Boolean aktif;

	/** Konstruktor tanpa argumen yang diwajibkan Hibernate/JPA. */
	public JenisPeredaranBuku() {
	}
	...
	/** @return nama jenis peredaran buku, di-trim; {@code null} bila belum pernah diisi. */
	@Column(name = "nama", nullable = false, length = 255)
	public String getNama() {
		return this.nama == null ? null : this.nama.trim();
	}

	/** @param nama nama jenis peredaran buku; disimpan apa adanya, trimming terjadi di {@link #getNama()}. */
	public void setNama(String nama) {
		this.nama = nama;
	}

	/** @return keterangan bebas jenis peredaran ini apa adanya, tanpa normalisasi. */
	@Column(name = "keterangan", nullable = true)
	public String getKeterangan() {
		return this.keterangan;
	}

	/** @param keterangan catatan/keterangan bebas untuk jenis peredaran ini. */
	public void setKeterangan(String keterangan) {
		this.keterangan = keterangan;
	}

	/**
	 * @return status aktif jenis peredaran; default {@code true} bila belum pernah diisi (flag
	 *         aktif satu-arah — baris lama tanpa nilai eksplisit dianggap aktif, nilai default
	...
	/** @param aktif status aktif/nonaktif jenis peredaran ini. */
