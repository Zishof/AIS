...
/**
 * Entity JPA/Hibernate untuk tabel {@code surat.opsi_surat_masuk}: definisi/header opsi atau
 * checkbox dinamis yang bisa dilampirkan ke surat masuk (mis. "Perlu Tindak Lanjut", "Perlu
 * Disposisi ke Atasan") — dikelola lewat layar master data {@code OpsiSuratMasukAction}.
 *
 * <p>
 * Ini adalah sisi "header" dari pola header-value bersama {@link OpsiSuratMasukValue}: satu baris
 * {@code OpsiSuratMasuk} mendefinisikan satu opsi yang tersedia secara global, sementara setiap
 * kali opsi tersebut dicentang/dipilih pada surat masuk tertentu direkam sebagai baris
 * {@link OpsiSuratMasukValue} terpisah yang menunjuk balik ke sini. Pola yang sama dipakai paralel
 * untuk surat keluar lewat {@link OpsiSuratKeluar}/{@link OpsiSuratKeluarValue}.
 * </p>
 *
 * <p>
 ...
 * daftar itu yang akan melihat opsi ini ditawarkan saat mengisi surat masuk — keduanya disimpan
 ...
 * getter yang menulis kembali ke field saat dibaca</b>, konsisten dengan pola serupa di
 * {@link OpsiSuratKeluar}. {@code jenisPengguna} diprioritaskan: bila terisi, {@code
...
@Audited
@Table(schema = "surat", name = "opsi_surat_masuk")
public class OpsiSuratMasuk extends GeneralValueObject {
	...
	/**
	 * Mengambil nama/label opsi ini (mis. "Perlu Tindak Lanjut").
	 *
