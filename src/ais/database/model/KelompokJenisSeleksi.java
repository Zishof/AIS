...
/**
 * Entity master data <b>kelompok jenis seleksi</b> pada tabel
 * {@code public.kelompok_jenis_seleksi}. Mengelompokkan {@link JenisSeleksi} (jalur
 * penerimaan mahasiswa baru, mis. "SNMPTN", "Mandiri") ke dalam kategori yang lebih tinggi,
 * dipakai layar {@code KelompokJenisSeleksiAction} dan {@code JenisSeleksiAction} sebagai
 * daftar pilihan.
 *
 * <p>Berbeda dari kebanyakan master data sejenis di paket ini yang mengembalikan string
 * kosong, {@link #getKode()} di sini mengembalikan <b>{@code null}</b> bila kolomnya
 * {@code null}/kosong. Kelas ini juga punya sakelar satu-arah {@link #getAktif()} (default
 * {@code true} bila {@code null}), tetapi tidak memiliki {@code nomorUrut}.</p>
 *
...
@Audited
@Table(schema = "public", name = "kelompok_jenis_seleksi")
public class KelompokJenisSeleksi extends GeneralValueObject {
	...
	/** Kunci utama tabel {@code public.kelompok_jenis_seleksi} ({@code IDENTITY}). */
	private Long id;
	...
	/** Kode singkat kelompok jenis seleksi; boleh {@code null}. */
	private String kode;

	/** Nama kelompok jenis seleksi; wajib diisi. */
	private String nama;
	/** Catatan/keterangan bebas tentang kelompok ini; boleh {@code null}. */
	private String keterangan;
	/** Sakelar aktif/non-aktif satu-arah; {@code null} diperlakukan sebagai {@code true}. */
	private Boolean aktif;

	/** Konstruktor tanpa argumen yang diwajibkan Hibernate/JPA. */
	public KelompokJenisSeleksi() {
	}
	...
	/**
	 * @return kode singkat kelompok, di-trim; {@code null} bila kolom {@code null}/kosong.
	 *         Berbeda dari sejumlah master data sejenis di paket ini yang mengembalikan
	 *         string kosong sebagai gantinya.
	 */
	public String getKode() {
		return kode == null || kode.isEmpty() ? null : kode.trim();
	}

	/** @param kode kode singkat kelompok; disimpan apa adanya. */
	public void setKode(String kode) {
		this.kode = kode;
	}

	/** @return nama kelompok, di-trim; {@code null} bila belum pernah diisi. */
	@Column(name = "nama", nullable = false, length = 255)
	public String getNama() {
		return this.nama == null ? null : this.nama.trim();
	}

	/** @param nama nama kelompok; disimpan apa adanya, trimming terjadi di {@link #getNama()}. */
	public void setNama(String nama) {
		this.nama = nama;
	}

	/** @return keterangan bebas kelompok ini apa adanya, tanpa normalisasi. */
	...
	/**
	 * @return status aktif/non-aktif kelompok ini. <b>Efek samping:</b> {@code null} diganti
	...
	/** @param aktif {@code true} bila kelompok ini masih boleh dipilih. */
