...
/**
 * Entity master data <b>jenis kegiatan mahasiswa</b> pada tabel
 * {@code public.jenis_kegiatan_mahasiswa} — kategori tingkat tinggi untuk aktivitas mahasiswa
 * di luar KKN/PKL/skripsi (mis. "Kegiatan Kemahasiswaan", "Kegiatan Sertifikasi") yang dipakai
 * layar {@code JenisKegiatanMahasiswaAction} dan pelaporan Feeder/PDDikti.
 *
 * <p>Strukturnya identik dengan {@link GrupFormulirKegiatan}/{@link JenisFormulirKegiatan}:
 * {@link #getKode()} tidak pernah {@code null} (fallback string kosong) dan
 * {@link #getAktif()} default {@code true} bila {@code null}.</p>
 *
...
@Audited
@Table(schema = "public", name = "jenis_kegiatan_mahasiswa")
public class JenisKegiatanMahasiswa extends GeneralValueObject {
	...
	/** Kunci utama tabel {@code public.jenis_kegiatan_mahasiswa} ({@code IDENTITY}). */
	private Long id;
	...
	/** Kode singkat jenis kegiatan mahasiswa; boleh {@code null} pada kolom, tapi getter tidak pernah {@code null}. */
	private String kode;

	/** Nama jenis kegiatan mahasiswa; wajib diisi. */
	private String nama;
	/** Catatan/keterangan bebas tentang jenis ini; boleh {@code null}. */
	private String keterangan;
	/** Sakelar aktif/non-aktif satu-arah; {@code null} diperlakukan sebagai {@code true}. */
	private Boolean aktif;

	/** Konstruktor tanpa argumen yang diwajibkan Hibernate/JPA. */
	public JenisKegiatanMahasiswa() {
	}
	...
	/**
	 * @return kode singkat jenis kegiatan, di-trim; string kosong ({@code ""}) bila kolom
	...
	/** @param kode kode singkat jenis kegiatan; disimpan apa adanya. */
	public void setKode(String kode) {
		this.kode = kode;
	}

	/** @return nama jenis kegiatan, di-trim; {@code null} bila belum pernah diisi. */
	@Column(name = "nama", nullable = false, length = 255)
	public String getNama() {
		return this.nama == null ? null : this.nama.trim();
	}

	/** @param nama nama jenis kegiatan; disimpan apa adanya, trimming terjadi di {@link #getNama()}. */
