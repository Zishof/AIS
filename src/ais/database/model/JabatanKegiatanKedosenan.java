...
/**
 * Entity Hibernate untuk tabel {@code public.jabatan_kegiatan_kedosenan} &mdash; master
 * <b>peran dosen dalam sebuah kegiatan Tridharma</b> (mis. "Ketua", "Anggota",
 * "Narasumber"), salah satu dari dua master di dasar rantai modul "Kegiatan Dosen"
 * (lihat javadoc {@link KelompokKegiatanKedosenan} untuk gambaran hierarki penuh:
 * {@link JenisKelompokKegiatanKedosenan} &rarr; {@link KelompokKegiatanKedosenan} &rarr;
 * {@code DetailKelompokKegiatanKedosenan} &rarr; kelas ini / {@link SkalaKegiatanKedosenan}).
 *
 * <p>Direlasikan secara many-to-many dari sisi pemilik
 * {@code DetailKelompokKegiatanKedosenan#getJabatanKegiatanKedosenans()}: satu butir rincian
 * kegiatan bisa memperbolehkan lebih dari satu peran. Dipasangkan dengan
 * {@link SkalaKegiatanKedosenan} sebagai dua sumbu matriks pilihan (peran x tingkat) pada
 * layar yang sama; lihat javadoc method tersebut untuk rincian bagaimana
 * {@link #getNomorUrut()} dipakai menentukan kombinasi kunci pengurutan matriks itu.
 *
 * <p>Dikelola lewat CRUD master data sederhana; entitas ini <b>tidak</b> membawa relasi
 * balik ke induknya sendiri &mdash; navigasi selalu dari sisi
 * {@code DetailKelompokKegiatanKedosenan}. Diturunkan dari {@link GeneralValueObject};
 ...
 * &mdash; query mentah/laporan yang membaca kolom database langsung (tanpa lewat getter)
 * bisa salah tafsir baris yang kolomnya masih {@code null}.
 *
...
@Audited
@Table(schema = "public", name = "jabatan_kegiatan_kedosenan")

public class JabatanKegiatanKedosenan extends GeneralValueObject {
	...
	public JabatanKegiatanKedosenan() {
	}
	...
	/** @return nama peran dosen dalam kegiatan (unik, wajib diisi), sudah di-trim. */
	@Column(name = "nama", nullable = false, length = 255, unique = true)
	public String getNama() {
		return this.nama == null ? null : this.nama.trim();
	}

	/** @param nama nama peran dosen dalam kegiatan. */
	public void setNama(String nama) {
		this.nama = nama;
	}

	/** @return keterangan tambahan untuk peran ini, boleh {@code null}. */
	@Column(name = "keterangan", nullable = true)
	public String getKeterangan() {
		return this.keterangan;
	}

	/** @param keterangan keterangan tambahan untuk peran ini. */
	public void setKeterangan(String keterangan) {
		this.keterangan = keterangan;
	}

	/**
	 * @return nomor urut untuk pengurutan tampilan/kombinasi matriks peran x tingkat pada
	...
	/**
	 * @return {@code true} bila peran ini aktif dan boleh dipilih; {@code true} juga bila
