...
/**
 * Entity master data <b>operator seluler</b> pada tabel {@code public.operator_seluler}.
 * Mendaftar operator telekomunikasi seluler (mis. "Telkomsel", "Indosat", "XL") sebagai daftar
 * pilihan pada formulir yang mencatat nomor HP, umumnya untuk keperluan pengiriman
 * notifikasi/SMS gateway per operator.
 *
...
@Audited
@Table(schema = "public", name = "operator_seluler")

public class OperatorSeluler extends GeneralValueObject {
	...
	/** Kunci utama tabel {@code public.operator_seluler} ({@code IDENTITY}). */
	private Long id;
	...
	/**
	 * Kode singkat operator. <b>Tidak dipetakan sebagai kolom database</b> (tanpa {@code @Column})
	 * — murni state in-memory; lihat {@link #getKode()}.
	 */
	private String kode;

	/** Nama operator seluler (mis. "Telkomsel"); wajib diisi. */
	private String nama;
	/** Catatan/keterangan bebas tentang operator ini; boleh {@code null}. */
	private String keterangan;
	/** Status aktif/nonaktif; lihat {@link #getAktif()} untuk perilaku default. */
	private Boolean aktif;

	/** Konstruktor tanpa argumen yang diwajibkan Hibernate/JPA. */
	public OperatorSeluler() {
	}
	...
	/** @return kode singkat operator, di-trim; string kosong (bukan {@code null}) bila belum pernah diisi. */
	public String getKode() {
		return kode == null ? "" : kode.trim();
	}

	/** @param kode kode singkat operator; disimpan apa adanya, trimming terjadi di {@link #getKode()}. */
	public void setKode(String kode) {
		this.kode = kode;
	}

	/** @return nama operator seluler, di-trim; string kosong (bukan {@code null}) bila belum pernah diisi. */
	@Column(name = "nama", nullable = false, length = 255)
	public String getNama() {
		return this.nama == null ? "" : this.nama.trim();
	}

	/** @param nama nama operator seluler; disimpan apa adanya, trimming terjadi di {@link #getNama()}. */
	public void setNama(String nama) {
		this.nama = nama;
	}

	/** @return keterangan bebas operator ini apa adanya, tanpa normalisasi. */
	@Column(name = "keterangan", nullable = true)
	public String getKeterangan() {
		return this.keterangan;
	}

	/** @param keterangan catatan/keterangan bebas untuk operator ini. */
	public void setKeterangan(String keterangan) {
		this.keterangan = keterangan;
	}

	/**
	 * @return status aktif operator; default {@code true} bila belum pernah diisi (flag aktif
	...
	/** @param aktif status aktif/nonaktif operator ini. */
