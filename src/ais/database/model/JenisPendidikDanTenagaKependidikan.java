...
/**
 * Entity Hibernate untuk tabel {@code public.jenis_pendidik_dan_tenaga_kependidikan}
 * &mdash; master klasifikasi <b>PTK (Pendidik dan Tenaga Kependidikan)</b> menurut
 * kodifikasi PDDikti, dipakai untuk mengelompokkan {@link Dosen} pada pelaporan
 * ({@code Dosen#getJenisPendidikDanTenagaKependidikan()}, kolom
 * {@code jenis_pendidik_dan_tenaga_kependidikan}).
 *
 * <p>Berbeda dari {@link JenisTenagaKependidikan}, yang mengklasifikasikan jenis tenaga
 * kependidikan (staf non-dosen) di {@code Pegawai}, master ini dipakai pada level PDDikti
 * yang lebih umum (kategori pendidik vs. tenaga kependidikan) dan direferensikan dari
 * {@link Dosen}. Field {@link #getFeeder()} adalah kode pemetaan baris ini ke kodifikasi
 * Feeder PDDikti; dapat diisi langsung lewat {@link #JenisPendidikDanTenagaKependidikan(String)}.
 *
...
@Audited
@Table(schema = "public", name = "jenis_pendidik_dan_tenaga_kependidikan")

public class JenisPendidikDanTenagaKependidikan extends GeneralValueObject {
	...
	public JenisPendidikDanTenagaKependidikan() {
	}

	/** @param feeder kode pemetaan awal ke kodifikasi Feeder PDDikti. */
	public JenisPendidikDanTenagaKependidikan(String feeder) {
		this.feeder = feeder;
	}
	...
	/** @return nama klasifikasi PTK (wajib diisi), sudah di-trim. */
	@Column(name = "nama", nullable = false, length = 255)
	public String getNama() {
		return this.nama == null ? null : this.nama.trim();
	}

	/** @param nama nama klasifikasi PTK. */
	public void setNama(String nama) {
		this.nama = nama;
	}

	/** @return keterangan tambahan untuk klasifikasi ini, boleh {@code null}. */
	@Column(name = "keterangan", nullable = true)
	public String getKeterangan() {
		return this.keterangan;
	}

	/** @param keterangan keterangan tambahan untuk klasifikasi ini. */
	public void setKeterangan(String keterangan) {
		this.keterangan = keterangan;
	}

	/**
	 * @return kode pemetaan klasifikasi ini ke kodifikasi Feeder PDDikti, sudah di-trim;
	...
	/** @param feeder kode pemetaan klasifikasi ini ke kodifikasi Feeder PDDikti. */
	public void setFeeder(String feeder) {
		this.feeder = feeder;
	}

	/**
	 * @return {@code true} bila klasifikasi ini aktif dan boleh dipilih; {@code true} juga
	 *     bila kolom masih {@code null} (belum pernah diisi) &mdash; lihat catatan kelas
	 *     soal bendera satu arah.
	 */
