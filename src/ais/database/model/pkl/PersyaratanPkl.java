...
/**
 * Entity <b>katalog master syarat pendaftaran PKL</b> pada tabel {@code public.persyaratan_pkl}.
 * Satu baris mewakili SATU butir syarat (mis. "Fotokopi KTM", "Minimal SKS 100", "Minimal IPK
 * 2.75", atau syarat bebas/"Syarat Lain") yang lalu diikat ke satu atau lebih program {@link Pkl}
 * lewat {@link PklPunyaPersyaratan}, dan dijawab per mahasiswa di {@link MahasiswaPklPersyaratan}.
 * Katalog ini bersifat <b>global/dipakai bersama</b> antar program PKL — mengubah satu baris di
 * sini memengaruhi seluruh program yang mengaitkannya.
 *
 ...
 * {@code nilaiBoolean} pada {@link MahasiswaPklPersyaratan}).</p>
 *
 ...
 * meloloskan semua pendaftar. Bug identik ada di kembaran {@link ais.database.model.kkn.PersyaratanKkn};
 ...
 * {@link ais.database.model.kkn.PersyaratanKkn} — tidak ada satu pun divergensi field/method yang
