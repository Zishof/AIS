...
/**
 * Entity master data <b>matapelajaran sekolah</b> pada tabel {@code public.matapelajaran_sekolah}.
 * Mendaftar matapelajaran tingkat sekolah (K-12, bukan matakuliah perguruan tinggi) yang dipakai
 * modul sekolah, antara lain sebagai target relasi {@link PaketPunyaMatapelajaran} (paket
 * pendaftaran &rarr; matapelajaran).
 *
...
@Audited
@Table(schema = "public", name = "matapelajaran_sekolah")
public class MatapelajaranSekolah extends GeneralValueObject {
	...
	/** Kunci utama tabel {@code public.matapelajaran_sekolah} ({@code IDENTITY}). */
	private Long id;
	...
	/** Nama matapelajaran sekolah; wajib diisi. */
	private String nama;
	/** Catatan/keterangan bebas tentang matapelajaran ini; boleh {@code null}. */
	private String keterangan;
	/** Status aktif/nonaktif; lihat {@link #getAktif()} untuk perilaku default. */
	private Boolean aktif;

	/** Konstruktor tanpa argumen yang diwajibkan Hibernate/JPA. */
	public MatapelajaranSekolah() {
	}
	...
	/** @return nama matapelajaran, di-trim; {@code null} bila belum pernah diisi. */
	@Column(name = "nama", nullable = false, length = 255)
	public String getNama() {
		return this.nama == null ? null : this.nama.trim();
	}

	/** @param nama nama matapelajaran; disimpan apa adanya, trimming terjadi di {@link #getNama()}. */
	public void setNama(String nama) {
		this.nama = nama;
	}

	/** @return keterangan bebas matapelajaran ini apa adanya, tanpa normalisasi. */
	@Column(name = "keterangan", nullable = true)
	public String getKeterangan() {
		return this.keterangan;
	}

	/** @param keterangan catatan/keterangan bebas untuk matapelajaran ini. */
	public void setKeterangan(String keterangan) {
		this.keterangan = keterangan;
	}

	/**
	 * @return status aktif matapelajaran; default {@code true} bila belum pernah diisi (flag aktif
	...
	/** @param aktif status aktif/nonaktif matapelajaran. */
