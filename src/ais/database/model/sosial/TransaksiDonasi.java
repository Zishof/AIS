...
public class TransaksiDonasi extends SocialRecord { private static final long serialVersionUID=1L; private String transactionNumber,donorNameSnapshot,donorContactSnapshot,publicName,currency,sourceChannel,idempotencyKey,requestId,prayer,receiptStatus,accountingStatus,smartlinkCredentialCode; private SocialDonorIdentity donorIdentity; private JenisDanaSosial fundType; private PerhitunganZakat calculation; private BigDecimal grossDonationAmount,platformContribution,gatewayFee,totalPayable; private Boolean anonymous,publicPrayer; private Date expiresAt,paidAt;
