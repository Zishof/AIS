...
public class PembayaranDonasi extends SocialRecord { private static final long serialVersionUID=1L; private TransaksiDonasi transaction; private String gatewayId,gatewayOrderId,gatewayReference,paymentStatus,callbackTransactionId,callbackFingerprint,callbackPayloadRedacted,currency,paymentUrl,settlementBatch,reconciliationStatus,failureReason,requestId,smartlinkCredentialCode; private BigDecimal requestAmount,fee,total; private Date issuedAt,expiryAt,paidAt,lastInquiryAt; private Integer retryCount;
 ...
 @Column(name="smartlink_credential_code",length=80) public String getSmartlinkCredentialCode(){return smartlinkCredentialCode;} public void setSmartlinkCredentialCode(String v){smartlinkCredentialCode=trim(v);}
