...
/**
 * Entity master data <b>jenis formulir kegiatan</b> pada tabel
 * {@code public.jenis_formulir_kegiatan}. Mengategorikan {@link FormulirKegiatan} (mis. jenis
 * "Pengajuan", "Penilaian") dan dipakai sebagai daftar pilihan pada layar
 * {@code JenisFormulirKegiatanAction}/{@code FormulirKegiatanAction}.
 *
 * <p>Strukturnya sama persis dengan {@link GrupFormulirKegiatan}: {@link #getKode()} tidak
 * pernah {@code null} (fallback string kosong), dan {@link #getAktif()} default {@code true}
 * bila {@code null}. Perbedaannya, kolom {@link #getNama()} dan {@link #getKeterangan()} di
 * sini dipetakan sebagai {@code text} (bukan {@code varchar(255)}), mengizinkan isi lebih
 * panjang.</p>
 *
...
@Audited
@Table(schema = "public", name = "jenis_formulir_kegiatan")
public class JenisFormulirKegiatan extends GeneralValueObject {
	...
	/** Kunci utama tabel {@code public.jenis_formulir_kegiatan} ({@code IDENTITY}). */
	private Long id;
	...
	/** Kode singkat jenis formulir; boleh {@code null} pada kolom, tapi getter tidak pernah {@code null}. */
	private String kode;

	/** Nama jenis formulir kegiatan; wajib diisi, dipetakan sebagai kolom {@code text}. */
	private String nama;
	/** Catatan/keterangan bebas tentang jenis ini; boleh {@code null}, dipetakan sebagai {@code text}. */
	private String keterangan;
	/** Sakelar aktif/non-aktif satu-arah; {@code null} diperlakukan sebagai {@code true}. */
	private Boolean aktif;

	/** Konstruktor tanpa argumen yang diwajibkan Hibernate/JPA. */
	public JenisFormulirKegiatan() {
	}
	...
	/**
	 * @return kode singkat jenis formulir, di-trim; string kosong ({@code ""}) bila kolom
	...
	/** @param kode kode singkat jenis formulir; disimpan apa adanya. */
	public void setKode(String kode) {
		this.kode = kode;
	}

	/** @return nama jenis formulir, di-trim; {@code null} bila belum pernah diisi. */
	@Column(name = "nama", nullable = false, columnDefinition = "text")
	public String getNama() {
		return this.nama == null ? null : this.nama.trim();
	}

	/** @param nama nama jenis formulir; disimpan apa adanya, trimming terjadi di {@link #getNama()}. */
	public void setNama(String nama) {
		this.nama = nama;
	}

	/** @return keterangan bebas jenis ini apa adanya, tanpa normalisasi. */
	@Column(name = "keterangan", nullable = true, columnDefinition = "text")
	public String getKeterangan() {
		return this.keterangan;
	}

	/** @param keterangan catatan/keterangan bebas untuk jenis ini. */
	public void setKeterangan(String keterangan) {
		this.keterangan = keterangan;
	}

	/**
	 * @return status aktif/non-aktif jenis ini. <b>Efek samping:</b> {@code null} diganti
	...
	/** @param aktif {@code true} bila jenis ini masih boleh dipilih. */
