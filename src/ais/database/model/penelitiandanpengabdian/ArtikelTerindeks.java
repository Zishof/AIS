...
/**
 * Entitas referensi/lookup status indeksasi jurnal (tabel
 * {@code penelitiandanpengabdian.artikel_terindeks}) — daftar sistem pengindeks publikasi ilmiah
 * (mis. Scopus, SINTA, DOAJ, Google Scholar, atau pengindeks lain sesuai konfigurasi institusi)
 * yang dapat ditautkan ke sebuah {@link Artikel} untuk menandai bahwa artikel tersebut sudah
 * terindeks pada sistem yang bersangkutan. Ditautkan dari {@link Artikel} lewat relasi
 * banyak-ke-banyak {@link Artikel#getArtikelTerindekses()} (tabel penghubung
 * {@code artikel_has_terindeks}) — satu artikel dapat terindeks pada berapa pun sistem pengindeks
 * sekaligus, dan satu sistem pengindeks dapat menaungi berapa pun artikel.
 *
 * <p>Nama tampil (label) yang sebenarnya berasal dari data yang diinput pengelola lewat
 * {@link #getNama()} — nama kelas Java hanya menyatakan konsep umum "status terindeks", bukan
 * daftar nama sistem pengindeks yang tetap/hardcoded.</p>
 *
...
@Audited
@Table(schema = "penelitiandanpengabdian", name = "artikel_terindeks")



public class ArtikelTerindeks extends GeneralValueObject {
	...
	/**
	 * Representasi teks singkat status indeksasi ini, dipakai label bawaan komponen ZK dan
	 * penelusuran log.
	 *
	 * @return {@code "<id>-<nama>"}
	 */
	...
	/** Nama sistem pengindeks (mis. "Scopus", "SINTA 2", "DOAJ"); nilai tampil sebenarnya, ditentukan data, bukan oleh nama kelas Java. */
	private String nama;
	/** Keterangan tambahan mengenai status/sistem indeksasi ini. */
	private String keterangan;

	/** Flag aktif/nonaktif status indeksasi ini; {@code null} diperlakukan sebagai aktif oleh {@link #getAktif()}. */
	private Boolean aktif;

	/** Konstruktor tanpa argumen yang diwajibkan JPA/Hibernate. */
	public ArtikelTerindeks() {
	}
	...
	/**
	 * Mengembalikan nama sistem pengindeks ini (mis. "Scopus", "SINTA 2").
	 *
	...
	/**
	 * Menyetel nama sistem pengindeks ini.
	 *
	...
	/**
	 * Mengembalikan keterangan tambahan mengenai status/sistem indeksasi ini.
	 *
	...
	/**
	 * Menyetel keterangan tambahan mengenai status/sistem indeksasi ini.
	 *
	...
	/**
	 * Mengembalikan status aktif/nonaktif status indeksasi ini.
	 *
	...
	/**
	 * Menyetel status aktif/nonaktif status indeksasi ini.
	 *
