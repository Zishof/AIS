...
/**
 * Entity master data <b>jenis nilai huruf matakuliah</b> pada tabel
 * {@code public.jenis_nilai_huruf_matakuliah}. Mendaftar <i>skema/tabel huruf</i> alternatif untuk
 * konversi nilai angka &rarr; huruf pada matakuliah tertentu — baris di sini <b>bukan</b> nilai
 * hurufnya sendiri, melainkan nama skema yang menaungi sekumpulan baris {@code NilaiHuruf} (lihat
 * relasi {@code NilaiHuruf#getJenisNilaiHuruf()}). Jangan tertukar dengan
 * {@code ais.database.model.sekolah.JenisNilaiHuruf} (varian modul sekolah, master terpisah).
 *
...
@Audited
@Table(schema = "public", name = "jenis_nilai_huruf_matakuliah")
public class JenisNilaiHurufMatakuliah extends GeneralValueObject {
	...
	/** Kunci utama tabel {@code public.jenis_nilai_huruf_matakuliah} ({@code IDENTITY}). */
	private Long id;
	...
	/**
	 * Kode singkat skema nilai huruf. <b>Tidak dipetakan sebagai kolom database</b> (tanpa
	 * {@code @Column}) — murni state in-memory; lihat {@link #getKode()}.
	 */
	private String kode;

	/** Nama skema nilai huruf (mis. nama skema konversi khusus suatu matakuliah); wajib diisi. */
	private String nama;
	/** Catatan/keterangan bebas tentang skema ini; boleh {@code null}. */
	private String keterangan;
	/** Status aktif/nonaktif; lihat {@link #getAktif()} untuk perilaku default. */
	private Boolean aktif;

	/** Konstruktor tanpa argumen yang diwajibkan Hibernate/JPA. */
	public JenisNilaiHurufMatakuliah() {
	}
	...
	/** @return kode singkat, di-trim; string kosong (bukan {@code null}) bila belum pernah diisi. */
	public String getKode() {
		return kode == null || kode.isEmpty() ? "" : kode.trim();
	}

	/** @param kode kode singkat skema nilai huruf; disimpan apa adanya, trimming terjadi di {@link #getKode()}. */
	public void setKode(String kode) {
		this.kode = kode;
	}

	/** @return nama skema nilai huruf, di-trim; {@code null} bila belum pernah diisi. */
	@Column(name = "nama", nullable = false, length = 255)
	public String getNama() {
		return this.nama == null ? null : this.nama.trim();
	}

	/** @param nama nama skema nilai huruf; disimpan apa adanya, trimming terjadi di {@link #getNama()}. */
	public void setNama(String nama) {
		this.nama = nama;
	}

	/** @return keterangan bebas skema ini apa adanya, tanpa normalisasi. */
	@Column(name = "keterangan", nullable = true)
	public String getKeterangan() {
		return this.keterangan;
	}

	/** @param keterangan catatan/keterangan bebas untuk skema ini. */
	public void setKeterangan(String keterangan) {
		this.keterangan = keterangan;
	}

	/**
	 * @return status aktif skema; default {@code true} bila belum pernah diisi (flag aktif
	...
	/** @param aktif status aktif/nonaktif skema ini. */
