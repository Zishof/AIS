...
/**
 * Entitas katalog master jenis pembayaran medis pada schema {@code sirs}
 * (tabel {@code jenis_pembayaran_medis}) — mis. "Tunai", "Kartu Debit",
 * "Kartu Kredit", transfer, dsb. Struktur sekadar id/nama/keterangan,
 * tanpa relasi ke entitas lain. Dipakai sebagai daftar pilihan cara
 * pembayaran di modul transaksi/kasir SIRS (lihat
 * {@code ais.action.master.sirs.PembayaranAction} dan
 * {@code ais.action.master.sirs.JenisPembayaranAction}); tidak punya
 * static field acuan cepat di {@code ConstantValues} seperti sebagian
 * katalog {@code sirs} lain.
 */
@Entity
...
@Audited
@Table(schema = "sirs", name = "jenis_pembayaran_medis")
public class JenisPembayaranMedis extends GeneralValueObject {
	...
	/**
	 * Representasi ringkas jenis pembayaran medis ini untuk keperluan
	 * tampilan/log.
	 *
	 * @return nama jenis pembayaran medis.
	 */
	 ...
	 */
	public JenisPembayaranMedis() {
	}

	/**
	 * Primary key baris jenis pembayaran medis, auto-increment (IDENTITY)
	 * dan diisi database.
	 *
	 * @return ID unik jenis pembayaran medis ini.
	 */
	@Id
	...
	/**
	 * Menetapkan ID jenis pembayaran medis.
	 *
	 * @param id ID jenis pembayaran medis.
	 */
	...
	/**
	 * Mengambil nama jenis pembayaran medis (mis. "Tunai", "Kartu Debit").
	 *
	 * @return nama jenis pembayaran medis.
	 */
	...
	/**
	 * Menetapkan nama jenis pembayaran medis.
	 *
	 * @param nama nama jenis pembayaran medis.
	 */
	...
	/**
	 * Mengambil keterangan bebas jenis pembayaran medis ini.
	 *
	...
	/**
	 * Menetapkan keterangan bebas jenis pembayaran medis ini.
	 *
