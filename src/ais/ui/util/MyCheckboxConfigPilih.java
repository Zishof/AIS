...
/**
 * Komponen/konfigurasi ZK khusus AIS untuk my checkbox config pilih. Tipe ini membakukan default
 * dan perilaku tampilan di atas komponen induk supaya layar tidak mengulang konfigurasi widget
 * yang sama.
 *
 ...
 * setParent()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di atas.</p>
