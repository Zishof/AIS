...
/**
 * Tipe khusus untuk my label agak kecil bold. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * @see Label
 */
public class MyLabelAgakKecilBold extends Label {
	...
	public MyLabelAgakKecilBold() {
		super();
		setWidth("100%");
		setStyle("font-size:11px;font-weight: bolder;");
		// TODO Auto-generated constructor stub
	}

	public MyLabelAgakKecilBold(String value) throws WrongValueException {
		super(value);
		setWidth("100%");
		setStyle("font-size:11px;font-weight: bolder;");
		// TODO Auto-generated constructor stub
