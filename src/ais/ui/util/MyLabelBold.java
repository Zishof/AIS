...
/**
 * Tipe khusus untuk my label bold. Kelas ini memberi nama dan batas tanggung jawab yang eksplisit
 ...
 * @see Label
 */
public class MyLabelBold extends Label {
	...
	public MyLabelBold(String value) throws WrongValueException {
