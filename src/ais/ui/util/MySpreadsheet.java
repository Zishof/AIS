...
/**
 * Komponen/konfigurasi ZK khusus AIS untuk my spreadsheet. Tipe ini membakukan default dan
 * perilaku tampilan di atas komponen induk supaya layar tidak mengulang konfigurasi widget yang
 * sama.
 *
 * <p><b>Batas tanggung jawab:</b> perilaku umum, validasi, akses data, serta lifecycle tetap dimiliki {@link
 * Spreadsheet}. Kelas ini hanya boleh memuat perbedaan yang benar-benar spesifik untuk variasi ini; perubahan
 * yang berlaku bagi seluruh keluarga harus ditempatkan di kelas induk agar fungsi tidak bercabang atau tumpang
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Component pendingParent}, {@code
 * boolean bookSiap}, {@code boolean attachDijadwalkan}, {@code int maxRowsDiminta}; mutasi data ({@code
 * setParent()}, {@code setSrc()}, {@code setBook()}, {@code setBookFromStream()}, {@code
 * pasangKeParentSetelahInisialisasi()}, {@code setMaxcolumns()}); operasi domain lain ({@code
 * pasangSekarangJikaTertunda()}, {@code bungkusIsiRegion()}, {@code wadahAman()}, {@code aturTinggi()}). Bagian
