...
/**
 * Tipe khusus untuk my label bold merah. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * @see Label
 */
public class MyLabelBoldMerah extends Label {
	...
	public MyLabelBoldMerah(String value) throws WrongValueException {
