...
public final class ApiRouteRegistry {
    ...
    private static void registerAuthAndGeneral(Map<String, ApiRoute> routes) {
        ...
        register(routes, "daftarHakAksesGrupPengguna", new ApiRoute() { public JSONObject execute(HttpServletRequest req, JSONObject json, PerguruanTinggi pt) throws Exception { return GrupPenggunaAksesApi.daftar(req, json); } });
        register(routes, "simpanHakAksesGrupPengguna", new ApiRoute() { public JSONObject execute(HttpServletRequest req, JSONObject json, PerguruanTinggi pt) throws Exception { return GrupPenggunaAksesApi.simpan(req, json); } });
        register(routes, "ubahPasswordPengguna", new ApiRoute() { public JSONObject execute(HttpServletRequest req, JSONObject json, PerguruanTinggi pt) throws Exception { return PasswordSayaApi.ubahPengguna(req, json); } });
        ...
        register(routes, "biometrik_pin_simpan", new ApiRoute() { public JSONObject execute(HttpServletRequest req, JSONObject json, PerguruanTinggi pt) throws Exception { return BiometricApi.saveMemberPin(req, json); } });
        ...
        register(routes, "gerbang_kemampuan", new ApiRoute() { public JSONObject execute(HttpServletRequest req, JSONObject json, PerguruanTinggi pt) throws Exception { return GerbangPesantrenApi.capability(req, json); } });
        register(routes, "gerbang_izin_daftar", new ApiRoute() { public JSONObject execute(HttpServletRequest req, JSONObject json, PerguruanTinggi pt) throws Exception { return GerbangPesantrenApi.list(req, json); } });
        register(routes, "gerbang_izin_simpan", new ApiRoute() { public JSONObject execute(HttpServletRequest req, JSONObject json, PerguruanTinggi pt) throws Exception { return GerbangPesantrenApi.create(req, json); } });
        register(routes, "gerbang_izin_proses", new ApiRoute() { public JSONObject execute(HttpServletRequest req, JSONObject json, PerguruanTinggi pt) throws Exception { return GerbangPesantrenApi.process(req, json); } });
        register(routes, "gerbang_verifikasi", new ApiRoute() { public JSONObject execute(HttpServletRequest req, JSONObject json, PerguruanTinggi pt) throws Exception { return GerbangPesantrenApi.verifyGate(req, json); } });
    ...
    private static void registerKantin(Map<String, ApiRoute> routes) {
        ...
        register(routes, "kantin_meja_cek",         new ApiRoute() { public JSONObject execute(HttpServletRequest req, JSONObject json, PerguruanTinggi pt) throws Exception { return KantinMemberApi.mejaCek(req, json, pt); } });
