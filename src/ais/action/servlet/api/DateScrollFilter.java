...
/**
 * Komponen batas HTTP/servlet untuk date scroll filter. Tipe ini menerima input dari luar
 ...
 * <p>Perbedaan lokal yang dapat diamati adalah pembacaan/pencarian ({@code getFilteredDateData()}); operasi
 * domain lain ({@code main()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut
 * di atas.</p>
