...
/**
 * Servlet tampilan murni yang meneruskan (forward) permintaan ke halaman landing modul Kursus
 * ({@code /WEB-INF/baru/kursus.jsp}). Tidak melakukan pembacaan maupun penulisan apa pun ke
 ...
 * atau JSP tujuan.
 */
public class Kursus extends HttpServlet {
	...
	/**
	 * Meneruskan (forward) permintaan apa adanya ke halaman landing modul Kursus tanpa
	...
	private void process(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		request.getRequestDispatcher("/WEB-INF/baru/kursus.jsp").forward(request, response);
