...
/**
 * Controller/action ZK untuk psb. Tipe ini merupakan titik masuk UI yang menghubungkan event layar
 ...
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Div kopBox}, {@code Div container},
 * {@code Div footer}, {@code Row wacontainer}, {@code Toolbar menubar}, {@code MyToolbarbutton alur}, {@code
 * MyToolbarbutton formulir}, {@code MyToolbarbutton informasiPembayaran}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code initHeader()}, {@code initBg()}, {@code initFooter()}, {@code initPencarianMenu()},
 * {@code doAfterCompose()}); pembacaan/pencarian ({@code tampilWa()}, {@code onClickCariDataUjian()}, {@code
 * onClickCariPembayaran()}, {@code onClickCariDataDaftar()}, {@code tampilGelombang()}, {@code
 * tampilPengumumanUtama()}); operasi domain lain ({@code footer()}, {@code header()}, {@code headerBox()},
 * {@code onInfo()}, {@code onLihatOnline()}, {@code onClickPayment()}). Bagian lain dari kontrak tetap mengikuti
