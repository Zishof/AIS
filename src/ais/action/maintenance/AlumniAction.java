...
/**
 * Controller/action ZK untuk alumni. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * Borderlayout alumniLayout}, {@code MyWindow main}, {@code boolean tampilSederhana}, {@code Integer
 * desktopHeight}, {@code Integer desktopWidth}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code
 * initHeader()}, {@code doAfterCompose()}); operasi domain lain ({@code onInfo()}, {@code onLihatOnline()},
 * {@code onPengumuman()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di
 * atas.</p>
