...
//		}
		...
		if (dataToko != null) {
			try {
				// Pastikan Tbmuser benar-benar sudah ada sebelum dipakai sebagai FK Pedagang.
				// Jangan flush Pedagang kosong lalu baru mengisi toko seperti implementasi lama.
				sessionData.flush();
