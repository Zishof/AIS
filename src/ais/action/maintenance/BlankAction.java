...
/**
 * Controller/action ZK untuk blank. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Center center}, {@code LogLogin login},
 * {@code Rows myRows}, {@code Tbmuser tbmuser}, {@code Image utama_image}, {@code TreeSet menus}, {@code Textbox
 * cari}, {@code North north}; inisialisasi/lifecycle ({@code doAfterCompose()}, {@code initBigIcon()});
 * pembacaan/pencarian ({@code onCari()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface
