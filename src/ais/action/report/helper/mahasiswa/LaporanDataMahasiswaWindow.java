...
/**
 * Penyusun/penyaji laporan untuk laporan data mahasiswa window. Kelas ini mengubah data domain
 ...
 * Combobox searchjurusan}, {@code Decimalbox tahunangkatan}, {@code Spreadsheet spreadsheet}, {@code Center
 * center}, {@code List mahasiswas}; inisialisasi/lifecycle ({@code initFakultas()}, {@code init()}, {@code
 * initMahasiswa()}, {@code initSpreadsheet()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
...
public class LaporanDataMahasiswaWindow extends MyWindow {
	...
	private void initFakultas() {
		...
		/**
		 * Event listener lokal milik {@link LaporanDataMahasiswaWindow}. Kelas ini menangani event untuk komponen
		 * induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LaporanDataMahasiswaWindow} dan dapat
		 ...
		 *
		 * @see LaporanDataMahasiswaWindow
		 */
