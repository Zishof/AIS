...
/**
 * Penyusun/penyaji laporan untuk laporan nilai ujian sidang skripsi window. Kelas ini mengubah
 ...
 * {@code SimpleDateFormat dateFormat}, {@code AmbilDataMahasiswaBanbox bandboxMahasiswa}; inisialisasi/lifecycle
 * ({@code initNilaiUjianSidangSkripsi()}, {@code init()}); operasi domain lain ({@code onUjianSidangSkripsi()}).
