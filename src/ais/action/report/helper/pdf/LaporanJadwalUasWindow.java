...
public class LaporanJadwalUasWindow extends MyWindow {
	...
	private void initJadwalUAS() throws Exception {
		...
		/**
		 * Event listener lokal milik {@link LaporanJadwalUasWindow}. Kelas ini menangani event untuk komponen induk
		 * dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LaporanJadwalUasWindow} dan dapat mengakses
