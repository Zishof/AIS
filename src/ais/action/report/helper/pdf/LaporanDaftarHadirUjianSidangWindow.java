...
public class LaporanDaftarHadirUjianSidangWindow extends MyWindow {
	...
	private void initDaftarHadirUjianSidang() throws Exception {
		...
		/**
		 * Event listener lokal milik {@link LaporanDaftarHadirUjianSidangWindow}. Kelas ini menangani event untuk
		 * komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LaporanDaftarHadirUjianSidangWindow} dan dapat
		 ...
		 *
		 * @see LaporanDaftarHadirUjianSidangWindow
		 */
