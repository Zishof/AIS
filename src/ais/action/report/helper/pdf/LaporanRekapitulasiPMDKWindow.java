...
/**
 * Penyusun/penyaji laporan untuk laporan rekapitulasi pmdk window. Kelas ini mengubah data domain
 ...
 * Combobox reportType}; inisialisasi/lifecycle ({@code initJadwalPerkuliahan()}, {@code init()}); operasi domain
 * lain ({@code onLaporanPendaftarPMDK()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface
