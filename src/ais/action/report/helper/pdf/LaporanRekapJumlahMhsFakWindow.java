...
/**
 * Penyusun/penyaji laporan untuk laporan rekap jumlah mhs fak window. Kelas ini mengubah data
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Tabpanel rekapJumlahMahasiswa}, {@code
 * Tabpanel rekapJumlahMahasiswaAngkatan}; inisialisasi/lifecycle ({@code init()}); operasi domain lain ({@code
 * onRekapJumlahMahasiswa()}, {@code onRekapJumlahMahasiswaAngkatan()}). Bagian lain dari kontrak tetap mengikuti
