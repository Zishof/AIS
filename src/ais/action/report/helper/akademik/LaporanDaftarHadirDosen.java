...
/**
 * Penyusun/penyaji laporan untuk laporan daftar hadir dosen. Kelas ini mengubah data domain
 ...
 * searchsemester}, {@code Combobox searchhari}, {@code Combobox searchprogram}, {@code Label angkatan};
...
public class LaporanDaftarHadirDosen extends MyWindow {
	...
	private void initFakultas() {
		...
		/**
		 * Event listener lokal milik {@link LaporanDaftarHadirDosen}. Kelas ini menangani event untuk komponen induk
		 * dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LaporanDaftarHadirDosen} dan dapat mengakses
