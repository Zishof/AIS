...
/**
 * Penyusun/penyaji laporan untuk laporan rekap host to host cicilan per item window. Kelas ini
 ...
 * @see MyWindow
 */
public class LaporanRekapHostToHostCicilanPerItemWindow extends MyWindow {
	...
	public LaporanRekapHostToHostCicilanPerItemWindow() {
		super();
		try {
			init();
		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Rekap Host To Host Cicilan Per Item Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanRekapHostToHostCicilanPerItemWindow(String title, String border, boolean closable) {
	...
	private void init() {
		...
		try {
			...
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanPerItemWindow.java:369");
			PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Rekap Host To Host Cicilan Per Item Window", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
				new String[] {
	...
	private void initSpreadsheet() throws Exception {
		...
		final JenisKegiatan jenisPembayaran = (JenisKegiatan) (LaporanRekapHostToHostCicilanPerItemWindow.this.jenisPembayaran
				.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanPerItemWindow.this.jenisPembayaran.getSelectedItem().getValue());
		final JenisSeleksi jenisSeleksi = (JenisSeleksi) (LaporanRekapHostToHostCicilanPerItemWindow.this.jenisSeleksi
				.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanPerItemWindow.this.jenisSeleksi.getSelectedItem().getValue());

		final String tahunAkademik = (String) (LaporanRekapHostToHostCicilanPerItemWindow.this.tahunAkademik
				.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanPerItemWindow.this.tahunAkademik.getSelectedItem().getValue());
		final String semester = (String) (LaporanRekapHostToHostCicilanPerItemWindow.this.semesterAbsensi
				.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanPerItemWindow.this.semesterAbsensi.getSelectedItem().getValue());
		...
		final Jenjang jenjang = (Jenjang) (LaporanRekapHostToHostCicilanPerItemWindow.this.jenjang
				.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanPerItemWindow.this.jenjang.getSelectedItem().getValue());

		final Integer smt = (Integer) (LaporanRekapHostToHostCicilanPerItemWindow.this.semester.getValue() == null
				|| LaporanRekapHostToHostCicilanPerItemWindow.this.semester.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanPerItemWindow.this.semester.getSelectedItem().getValue());

		final TreeMap<String, Object[]> jurusans = new TreeMap<String, Object[]>();
		final Set<Long> itemBiayas = new TreeSet<Long>();
			...
			public void onEvent(Event arg0) throws Exception {
				...
				try {
					...
					for (Long itemBiayaId : itemBiayas) {
						ItemBiaya itemBiaya = (ItemBiaya) ConstantValues.ambil(ItemBiaya.class.getName(), itemBiayaId);
					...
					for (Object[] objects : jurusans.values()) {
						try {
							...
							e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanPerItemWindow.java:699");
							PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Rekap Host To Host Cicilan Per Item Window", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
								new String[] {
									"Periksa kembali data/parameter/filter yang Bapak/Ibu masukkan pada layar ini.",
									"Ulangi kembali proses yang tadi dijalankan beberapa saat lagi.",
					...
					e4.printStackTrace(); ais.common.ErrorAuditUtil.record(e4, "auto-audit src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanPerItemWindow.java:743");
				}
			}
		});
			...
			public void run() {
				...
				try {
					...
					try {
						...
						e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanPerItemWindow.java:786");
						PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Rekap Host To Host Cicilan Per Item Window", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
							new String[] {
								"Periksa kembali data/parameter/filter yang Bapak/Ibu masukkan pada layar ini.",
								"Ulangi kembali proses yang tadi dijalankan beberapa saat lagi.",
					...
					System.out.println("cicilanPembayarans -> " + cicilanPembayarans.size() + " ids " + ids);
					...
					for (Long cicilanPembayaranId : cicilanPembayarans) {
						try {
											...
											if (jenisPembayaran == null || jenisPembayaran.getId()
												...
												if (tahunAngkatan == null
														...
														|| (mahasiswa != null && mahasiswa.getTahunangkatan() != null
																&& tahunAngkatan.equals(mahasiswa.getTahunangkatan()))
													...
													if (program == null
															|| (biodataCalonMahasiswa != null
																	...
																	&& program
																			.equals(biodataCalonMahasiswa.getProgram()))
																...
																if (fakultas == null || fakultas.getId().equals(-1L)
																	...
																	if (jurusan == null || jurusan.getId().equals(-1L)
																		...
																		if (jenjang == null
																			...
																			Double total = dataTotal
																					.get(cicilanPembayaran
																							.getItemBiaya().getId());
																			if (total == null) {
																				total = 0.0;
																			}
																			total += cicilanPembayaran.getNilai();
																			dataTotal.put(cicilanPembayaran
																					.getItemBiaya().getId(), total);
																			...
																			itemBiayas.add(cicilanPembayaran
																					.getItemBiaya().getId());
																		}
																	}
																}
							...
							e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanPerItemWindow.java:1005");
							PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Rekap Host To Host Cicilan Per Item Window", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
								new String[] {
									"Periksa kembali data/parameter/filter yang Bapak/Ibu masukkan pada layar ini.",
									"Ulangi kembali proses yang tadi dijalankan beberapa saat lagi.",
					...
					e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanPerItemWindow.java:1012");
					PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Rekap Host To Host Cicilan Per Item Window", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
						new String[] {
							"Periksa kembali data/parameter/filter yang Bapak/Ibu masukkan pada layar ini.",
							"Ulangi kembali proses yang tadi dijalankan beberapa saat lagi.",
				...
				System.out.println("Selesai ........." + itemBiayas.size());
			}
		}).start();
