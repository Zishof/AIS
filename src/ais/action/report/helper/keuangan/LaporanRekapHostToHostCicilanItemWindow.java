...
/**
 * Penyusun/penyaji laporan untuk laporan rekap host to host cicilan item window. Kelas ini
 ...
 * @see MyWindow
 */
public class LaporanRekapHostToHostCicilanItemWindow extends MyWindow {
	...
	public LaporanRekapHostToHostCicilanItemWindow() {
		super();
		try {
			init();
		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Rekap Host To Host Cicilan Item Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanRekapHostToHostCicilanItemWindow(String title, String border, boolean closable) {
	...
	private void init() {
		...
		try {
			...
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanItemWindow.java:363");
			PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Rekap Host To Host Cicilan Item Window", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
				new String[] {
...
//		}
		...
		final JenisKegiatan jenisPembayaran = (JenisKegiatan) (LaporanRekapHostToHostCicilanItemWindow.this.jenisPembayaran
				.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanItemWindow.this.jenisPembayaran.getSelectedItem().getValue());
		final JenisSeleksi jenisSeleksi = (JenisSeleksi) (LaporanRekapHostToHostCicilanItemWindow.this.jenisSeleksi
				.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanItemWindow.this.jenisSeleksi.getSelectedItem().getValue());

		final String tahunAkademik = (String) (LaporanRekapHostToHostCicilanItemWindow.this.tahunAkademik
				.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanItemWindow.this.tahunAkademik.getSelectedItem().getValue());
		final String semester = (String) (LaporanRekapHostToHostCicilanItemWindow.this.semesterAbsensi
				.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanItemWindow.this.semesterAbsensi.getSelectedItem().getValue());
		...
		final Jenjang jenjang = (Jenjang) (LaporanRekapHostToHostCicilanItemWindow.this.jenjang
				.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanItemWindow.this.jenjang.getSelectedItem().getValue());

		final Integer smt = (Integer) (LaporanRekapHostToHostCicilanItemWindow.this.semester.getValue() == null
				|| LaporanRekapHostToHostCicilanItemWindow.this.semester.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanItemWindow.this.semester.getSelectedItem().getValue());
		...
		final Label label = Common.displayLoadBar(new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				...
				for (String col : new String[] { "Tanggal", "Validator", "NIM", "Nama", "Prodi", "Program", "Angkatan",
						"Item Biaya", "Untuk pembayaran", "Nominal Pembayaran", "Jml.Pemb.\nPer Tanggal",
						"Nilai.Pemb.\nPer Tanggal" }) {
				...
				for (Object[] objects : jurusans.values()) {
					...
					if (!tanggal.equals(objects[0].toString())) {
						...
						if (rowIndex != 3) {
							...
							cell.setCellStyle(hlink_style);
							if (format.isChecked()) {
								cell.setCellValue(Common.numberFormat.get().format(jmlPerTgl));
							} else {
								cell.setCellValue(jmlPerTgl);
							}
					...
					GeneralValueObject generalValueObject = (GeneralValueObject) objects[2];
					if (generalValueObject instanceof Mahasiswa) {
						...
						cell.setCellStyle(bodystyle);
						cell.setCellValue(jurusan == null ? "" : jurusan.getNama());
					...
					ItemBiaya itemBiaya = (ItemBiaya) objects[5];

					cell = row.createCell(7);
					cell.setCellStyle(bodystyle);
					cell.setCellValue(itemBiaya == null ? "" : itemBiaya.getNama());

					cell = row.createCell(8);
					cell.setCellStyle(bodystyle);
					cell.setCellValue(objects[3] == null ? "" : objects[3].toString());
				...
				for (int i = 0; i < spreadsheet.getMaxcolumns(); i++) {
					...
					} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanItemWindow.java:798");
			...
			public void run() {
				...
				try {
					...
					try {
						...
						e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanItemWindow.java:844");
						PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Rekap Host To Host Cicilan Item Window", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
							new String[] {
								"Periksa kembali data/parameter/filter yang Bapak/Ibu masukkan pada layar ini.",
								"Ulangi kembali proses yang tadi dijalankan beberapa saat lagi.",
					...
					for (Long cicilanPembayaranId : cicilanPembayarans) {
						try {
																		...
																		if (jurusan == null
																			...
																			if (jenjang == null
																				...
																				if (objSbm == null) {
																					...
																					total = (Double) objSbm[4];
																					keterangan = (String) objSbm[3];
																				}

																				total += cicilanPembayaran.getNilai();

																				keterangan += keterangan.isEmpty()
																						? cicilanPembayaran
																								.getKeterangan()
																						: "; " + cicilanPembayaran
																								.getKeterangan();
																				...
																				Object[] objects = new Object[] {
																						...
																						generalValueObject, keterangan,

																						total, cicilanPembayaran
																								.getItemBiaya() };
							...
							e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanItemWindow.java:1108");
							PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Rekap Host To Host Cicilan Item Window", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
								new String[] {
									"Periksa kembali data/parameter/filter yang Bapak/Ibu masukkan pada layar ini.",
									"Ulangi kembali proses yang tadi dijalankan beberapa saat lagi.",
					...
					e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanItemWindow.java:1114");
					PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Rekap Host To Host Cicilan Item Window", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
						new String[] {
							"Periksa kembali data/parameter/filter yang Bapak/Ibu masukkan pada layar ini.",
							"Ulangi kembali proses yang tadi dijalankan beberapa saat lagi.",
