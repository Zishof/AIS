...
/**
 * Penyusun/penyaji laporan untuk laporan rekap host to host cicilan window. Kelas ini mengubah
 ...
 * @see MyWindow
 */
public class LaporanRekapHostToHostCicilanWindow extends MyWindow {
	...
	public LaporanRekapHostToHostCicilanWindow() {
		super();
		try {
			init();
		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Rekap Host To Host Cicilan Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanRekapHostToHostCicilanWindow(String title, String border, boolean closable) {
	...
	private void init() {
		...
		try {
			...
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanWindow.java:362");
			PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Rekap Host To Host Cicilan Window", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
				new String[] {
...
//		}
		...
		final JenisKegiatan jenisPembayaran = (JenisKegiatan) (LaporanRekapHostToHostCicilanWindow.this.jenisPembayaran
				.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanWindow.this.jenisPembayaran.getSelectedItem().getValue());
		final JenisSeleksi jenisSeleksi = (JenisSeleksi) (LaporanRekapHostToHostCicilanWindow.this.jenisSeleksi
				.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanWindow.this.jenisSeleksi.getSelectedItem().getValue());

		final String tahunAkademik = (String) (LaporanRekapHostToHostCicilanWindow.this.tahunAkademik
				.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanWindow.this.tahunAkademik.getSelectedItem().getValue());
		final String semester = (String) (LaporanRekapHostToHostCicilanWindow.this.semesterAbsensi
				.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanWindow.this.semesterAbsensi.getSelectedItem().getValue());
		...
		final Jenjang jenjang = (Jenjang) (LaporanRekapHostToHostCicilanWindow.this.jenjang.getSelectedItem() == null
				? null
				: LaporanRekapHostToHostCicilanWindow.this.jenjang.getSelectedItem().getValue());

		final Integer smt = (Integer) (LaporanRekapHostToHostCicilanWindow.this.semester.getValue() == null
				|| LaporanRekapHostToHostCicilanWindow.this.semester.getSelectedItem() == null ? null
						: LaporanRekapHostToHostCicilanWindow.this.semester.getSelectedItem().getValue());
		...
		final Label label = Common.displayLoadBar(new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				...
				try {
					...
					for (String col : new String[] { "Tanggal", "Validator", "NIM", "Nama", "Prodi", "Program",
							"Angkatan", "Untuk pembayaran", "Nominal Pembayaran", "Jml.Pemb.\nPer Tanggal",
							"Nilai.Pemb.\nPer Tanggal" }) {
			...
			public void run() {
				...
				try {
					...
					try {
						...
						e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanWindow.java:881");
						PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Rekap Host To Host Cicilan Window", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
							new String[] {
								"Periksa kembali data/parameter/filter yang Bapak/Ibu masukkan pada layar ini.",
								"Ulangi kembali proses yang tadi dijalankan beberapa saat lagi.",
					...
					for (Long cicilanPembayaranId : cicilanPembayarans) {
						try {
							...
							e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanWindow.java:1142");
							PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Rekap Host To Host Cicilan Window", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
								new String[] {
									"Periksa kembali data/parameter/filter yang Bapak/Ibu masukkan pada layar ini.",
									"Ulangi kembali proses yang tadi dijalankan beberapa saat lagi.",
					...
					e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/helper/keuangan/LaporanRekapHostToHostCicilanWindow.java:1148");
					PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Rekap Host To Host Cicilan Window", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
						new String[] {
							"Periksa kembali data/parameter/filter yang Bapak/Ibu masukkan pada layar ini.",
							"Ulangi kembali proses yang tadi dijalankan beberapa saat lagi.",
