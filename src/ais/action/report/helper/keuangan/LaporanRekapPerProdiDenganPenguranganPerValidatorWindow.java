...
/**
 * Penyusun/penyaji laporan untuk laporan rekap per prodi dengan pengurangan per validator window.
 ...
 * jenisPembayaran}, {@code Center center}, {@code PembayaranUtil pembayaranUtil}; inisialisasi/lifecycle ({@code
 * init()}, {@code initSpreadsheet()}); validasi/perhitungan ({@code generateValidator()}). Bagian lain dari
