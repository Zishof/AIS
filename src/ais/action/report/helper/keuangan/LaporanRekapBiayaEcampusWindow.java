...
/**
 * Penyusun/penyaji laporan untuk laporan rekap biaya ecampus window. Kelas ini mengubah data
 ...
 * MyDatebox start}, {@code MyDatebox end}, {@code MyDoublebox biaya}, {@code Center center};
 * inisialisasi/lifecycle ({@code init()}, {@code initSpreadsheet()}); pembacaan/pencarian ({@code
 * ambilBiayaTransaksiEcampusDefault()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface
