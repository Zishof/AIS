...
/**
 * Penyusun/penyaji laporan untuk laporan nilai kpi. Kelas ini mengubah data domain menjadi bentuk
 ...
 * toolbar}, {@code PenilaianKpi penilaianKpi}, {@code ItemKpiTreeModel itemKpiTreeModel}, {@code Map
 * mapNilaiKpi}; inisialisasi/lifecycle ({@code init()}); pembacaan/pencarian ({@code getStrings()});
 * pelaporan/ekspor ({@code onReport()}); operasi domain lain ({@code generateParameter()}, {@code
 * generateParameter()}); konfigurasi constructor: {@code itemKpiTreeModel}. Bagian lain dari kontrak tetap
