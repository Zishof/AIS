...
/**
 * Penyusun/penyaji laporan untuk laporan lembar hasil verifikasi bkd window. Kelas ini mengubah
 ...
 * @see MyWindow
 */
public class LaporanLembarHasilVerifikasiBkdWindow extends MyWindow {
	...
	public LaporanLembarHasilVerifikasiBkdWindow() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Lembar Hasil Verifikasi Bkd Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanLembarHasilVerifikasiBkdWindow(String title, String border, boolean closable) throws Exception {
	...
	private void init() {
		...
		}, "summary_hasil_verifikasi_bkd", null, new EventListener() {
	...
	public void onLaporanAngketDosenPerDosen(Event event) throws Exception {
		...
		Common.createDefaultTimer(new EventListener() {
			...
			@Override
			public void onEvent(Event arg0) throws Exception {
				File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "summary_hasil_verifikasi_bkd",
