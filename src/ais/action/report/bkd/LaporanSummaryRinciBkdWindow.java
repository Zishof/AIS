...
/**
 * Penyusun/penyaji laporan untuk laporan summary rinci bkd window. Kelas ini mengubah data domain
 ...
 * @see MyWindow
 */
public class LaporanSummaryRinciBkdWindow extends MyWindow {
	...
	public LaporanSummaryRinciBkdWindow() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Summary Rinci Bkd Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanSummaryRinciBkdWindow(String title, String border, boolean closable) throws Exception {
	...
	private void init() {
		...
		}, "summary_kinerja_dosen_rinci", null, new EventListener() {
	...
	public void onLaporanAngketDosenPerDosen(Event event) throws Exception {
		...
		Common.createDefaultTimer(new EventListener() {
			...
			@Override
			public void onEvent(Event arg0) throws Exception {
				File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "summary_kinerja_dosen_rinci",
