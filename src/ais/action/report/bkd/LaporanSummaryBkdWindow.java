...
/**
 * Penyusun/penyaji laporan untuk laporan summary bkd window. Kelas ini mengubah data domain
 ...
 * @see MyWindow
 */
public class LaporanSummaryBkdWindow extends MyWindow {
	...
	public LaporanSummaryBkdWindow() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Summary Bkd Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanSummaryBkdWindow(String title, String border, boolean closable) throws Exception {
	...
	private void init() {
		...
		}, "summary_kinerja_dosen", null, new EventListener() {
	...
	private Map generateParameter() throws Exception {
		...
		// FIX NPE: TA/Semester wajib dipilih; getSelectedItem() null -> NPE saat .getValue().
		if (tahunAkademik.getSelectedItem() == null) {
			throw new Exception("Silakan pilih Tahun Akademik terlebih dahulu.");
		}
		if (semesterAbsensi.getSelectedItem() == null) {
			throw new Exception("Silakan pilih Semester terlebih dahulu.");
		}
	...
	public void onLaporanAngketDosenPerDosen(Event event) throws Exception {
		...
		Common.createDefaultTimer(new EventListener() {
			...
			@Override
			public void onEvent(Event arg0) throws Exception {
				File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "summary_kinerja_dosen",
