...
/**
 * Penyusun/penyaji laporan untuk laporan daftar riwayat hidup. Kelas ini mengubah data domain
 ...
 * {@code Center center}, {@code Toolbar toolbar}; inisialisasi/lifecycle ({@code initTranskripAkademik()},
 * {@code init()}); operasi domain lain ({@code generateParameter()}, {@code onTranskrip()}). Bagian lain dari
