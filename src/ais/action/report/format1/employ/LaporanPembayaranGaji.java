...
/**
 * Penyusun/penyaji laporan untuk laporan pembayaran gaji. Kelas ini mengubah data domain menjadi
 ...
 * toolbar}, {@code PembayaranGaji pembayaranGaji}, {@code Map parameters}, {@code Collection pangkats};
 * inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code onReport()}). Bagian lain dari kontrak tetap
