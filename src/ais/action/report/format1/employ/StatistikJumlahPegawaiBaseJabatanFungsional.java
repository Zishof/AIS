...
/**
 * Penyusun/penyaji laporan untuk statistik jumlah pegawai base jabatan fungsional. Kelas ini
 ...
 * searchfakultas}, {@code Combobox searchjurusan}, {@code Combobox angkatan}, {@code Combobox status}, {@code
 * Combobox searchprogram}; inisialisasi/lifecycle ({@code initPegawai()}, {@code init()}, {@code initChart()}).
...
public class StatistikJumlahPegawaiBaseJabatanFungsional extends MyWindow {
	...
	private void initPegawai() {
		...
		/**
		 * Event listener lokal milik {@link StatistikJumlahPegawaiBaseJabatanFungsional}. Kelas ini menangani event
		 * untuk komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link StatistikJumlahPegawaiBaseJabatanFungsional}
		 ...
		 *
		 * @see StatistikJumlahPegawaiBaseJabatanFungsional
		 */
