...
/**
 * Penyusun/penyaji laporan untuk laporan kunjungan pasien umum5 window. Kelas ini mengubah data
 ...
 * {@code Combobox bulan}, {@code Combobox jenisPasien}, {@code Combobox poli1}, {@code Combobox poli2}, {@code
 * Combobox poli3}, {@code Combobox poli4}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code
 ...
 * @see Window
 */
public class LaporanKunjunganPasienUmum5Window extends Window {
	...
	public LaporanKunjunganPasienUmum5Window() {
		super();
		try {

			init();
		} catch (Exception e) {
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/format1/sirs/rajal/LaporanKunjunganPasienUmum5Window.java:58");
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Kunjungan Pasien Umum5 Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, unit/ruangan, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
				new String[] {
	...
	public LaporanKunjunganPasienUmum5Window(String title, String border, boolean closable) throws Exception {
	...
	public void onCetak(Event event) {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress("sirs/rajal_laporan_kunjungan_pasien_umum_5", Report.PDF, parameters,
					"sirs/rajal_laporan_kunjungan_pasien_umum_5", new Date());
			CommonReport.tampilkanReportPDF(center, file);

		} catch (Exception e) {
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/format1/sirs/rajal/LaporanKunjunganPasienUmum5Window.java:256");
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Kunjungan Pasien Umum5 Window", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
				new String[] {
