...
/**
 * Penyusun/penyaji laporan untuk laporan ranap dinas per ruangan. Kelas ini mengubah data domain
 ...
 * {@code Combobox bulan}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code onCetak()}); operasi
 ...
 * @see Window
 */
public class LaporanRanapDinasPerRuangan extends Window {
	...
	public LaporanRanapDinasPerRuangan() {
		super();
		try {

			init();
		} catch (Exception e) {
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/format1/sirs/ranap/LaporanRanapDinasPerRuangan.java:46");
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Ranap Dinas Per Ruangan", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, unit/ruangan, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
				new String[] {
	...
	public LaporanRanapDinasPerRuangan(String title, String border, boolean closable) throws Exception {
	...
	private void init() {
		...
		}, "sirs/laporan_ranap_pasien_dinas"));
	...
	public void onCetak(Event event) {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress("sirs/laporan_ranap_pasien_dinas", Report.PDF, parameters,
					"sirs/laporan_ranap_pasien_dinas", new Date());
			CommonReport.tampilkanReportPDF(center, file);

		} catch (Exception e) {
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/format1/sirs/ranap/LaporanRanapDinasPerRuangan.java:166");
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Ranap Dinas Per Ruangan", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
				new String[] {
