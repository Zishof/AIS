...
/**
 * Penyusun/penyaji laporan untuk laporan10 penyakit window. Kelas ini mengubah data domain menjadi
 ...
 * {@code Combobox bulan}, {@code Combobox jenisPasien}, {@code Combobox apakahMenular}, {@code Combobox
 * instalasi}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code onCetak()}). Bagian lain dari
