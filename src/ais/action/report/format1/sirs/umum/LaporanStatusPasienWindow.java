...
/**
 * Penyusun/penyaji laporan untuk laporan status pasien window. Kelas ini mengubah data domain
 ...
 * {@code Center center}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code
