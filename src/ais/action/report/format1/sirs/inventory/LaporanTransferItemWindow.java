...
/**
 * Penyusun/penyaji laporan untuk laporan transfer item window. Kelas ini mengubah data domain
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Combobox lokasiAsal}, {@code Combobox
 * lokasiTujuan}, {@code MyDatebox tanggalMulai}, {@code MyDatebox tanggalSampai}, {@code Center center}, {@code
 * Lokasi lokasi1}, {@code Lokasi lokasi2}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code
 * onCetakStatusPasien()}); operasi domain lain ({@code generateParameter()}). Bagian lain dari kontrak tetap
