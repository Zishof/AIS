...
/**
 * Penyusun/penyaji laporan untuk laporan tracer window. Kelas ini mengubah data domain menjadi
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code AmbilDataPendaftaranRawatJalanBanbox
 * pendaftaranRawatJalanBanbox}, {@code Center center}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor
 * ({@code onCetakTracer()}); operasi domain lain ({@code generateParameter()}). Bagian lain dari kontrak tetap
