...
/**
 * Penyusun/penyaji laporan untuk laporan kas besar. Kelas ini mengubah data domain menjadi bentuk
 ...
 * toolbar}, {@code KasBesar kasBesar}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code
