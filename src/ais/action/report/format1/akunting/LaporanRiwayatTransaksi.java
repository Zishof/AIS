...
/**
 * Penyusun/penyaji laporan untuk laporan riwayat transaksi. Kelas ini mengubah data domain menjadi
 ...
 * @see MyWindow
 */
public class LaporanRiwayatTransaksi extends MyWindow {
	...
	public LaporanRiwayatTransaksi() {
		super();
		try {
			init();
		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Riwayat Transaksi", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanRiwayatTransaksi(String title, String border, boolean closable) throws Exception {
	...
	public void onReport(Event event) {
		...
		try {
			...
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Riwayat Transaksi", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
