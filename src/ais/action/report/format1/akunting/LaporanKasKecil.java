...
/**
 * Penyusun/penyaji laporan untuk laporan kas kecil. Kelas ini mengubah data domain menjadi bentuk
 ...
 * toolbar}, {@code KasKecil kasKecil}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code
 * onReport()}, {@code cetakPdf()}); operasi domain lain ({@code generateParameter()}, {@code parameter()}).
...
public class LaporanKasKecil extends MyWindow {
	 ...
	 */
	public static Map parameter(KasKecil kasKecil) throws Exception {
	 ...
	 */
	public static java.io.File cetakPdf(KasKecil kasKecil) throws Exception {
		return Report.generateFileReport(Report.PDF, parameter(kasKecil), "akunting/kasKecil",
