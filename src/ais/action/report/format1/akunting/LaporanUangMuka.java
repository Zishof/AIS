...
/**
 * Penyusun/penyaji laporan untuk laporan uang muka. Kelas ini mengubah data domain menjadi bentuk
 ...
 * toolbar}, {@code UangMuka uangMuka}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code
 * cetakPdf()}, {@code onReport()}); operasi domain lain ({@code parameter()}, {@code generateParameter()}).
