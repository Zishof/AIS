...
/**
 * Tipe khusus untuk laporan akunting saldo bulan 2. Kelas ini memberi nama dan batas tanggung
 ...
 */
public class LaporanAkuntingSaldoBulan_2 extends LaporanAkuntingSaldoBulanMaster {
	...
	public LaporanAkuntingSaldoBulan_2() {
		super();
		super.jenisLaporan.setSelectedIndex(1);
		super.jenisLaporan.setDisabled(true);
		try {
			super.eventListener2.onEvent(null);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/format1/akunting/LaporanAkuntingSaldoBulan_2.java:23");
		}
	...
	public LaporanAkuntingSaldoBulan_2(String title, String border, boolean closable) throws Exception {
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/format1/akunting/LaporanAkuntingSaldoBulan_2.java:42");
		}
		Common.createDefaultTimer(new EventListener() {
