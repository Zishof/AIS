...
/**
 * Penyusun/penyaji laporan untuk laporan jurnal harian simple. Kelas ini mengubah data domain
 ...
 * sampai}, {@code Center center}, {@code Toolbar toolbar}, {@code Rows rowsAkun}, {@code String pencarianAkun},
 * {@code AmbilDataSatuanKerjaBanbox searchsatuanKerja}; inisialisasi/lifecycle ({@code init()});
 ...
 * @see MyWindow
 */
public class LaporanJurnalHarianSimple extends MyWindow {
	...
	public LaporanJurnalHarianSimple() {
		super();
		try {
			init();
		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Jurnal Harian Simple", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanJurnalHarianSimple(String title, String border, boolean closable) throws Exception {
	...
	private void init() throws Exception {
		...
		final EventListener cariAkun = new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				...
				List<Akun> akuns = session.createCriteria(Transaksi.class).createAlias("grupTransaksi", "grupTransaksi")
						.add(Restrictions.sqlRestriction("date(tanggal_transaksi) between date('"
		...
		}, "akunting/jurnal_harian", null, new EventListener() {
	...
	public void onReport(Event event) {
		...
		try {
			...
			// akunting/jurnal_harian

			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "akunting/jurnal_harian",
					ais.ui.util.WaktuUtil.getDate(), toolbar);
			CommonReport.tampilkanReportPDF(center, file);

		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Jurnal Harian Simple", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
