...
/**
 * Penyusun/penyaji laporan untuk laporan sks dosen. Kelas ini mengubah data domain menjadi bentuk
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Combobox sksDosenFakultas}, {@code
 * Combobox sksDosenJurusan}, {@code Combobox sksDosenSemester}, {@code Combobox tahunAkademik}, {@code
 * AmbilDataDosenBanbox dosen}, {@code AmbilDataMasaPerkuliahanBanbox masaPerkuliahan}, {@code MyCheckboxConfig
 * semesterPendek}, {@code MyCheckboxConfig ekstrakurikuler}; inisialisasi/lifecycle ({@code initSksDosen()},
 * {@code init()}); operasi domain lain ({@code generateParameter()}, {@code onSksDosen()}). Bagian lain dari
