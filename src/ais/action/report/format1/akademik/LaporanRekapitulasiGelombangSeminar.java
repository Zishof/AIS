...
/**
 * Penyusun/penyaji laporan untuk laporan rekapitulasi gelombang seminar. Kelas ini mengubah data
 ...
 * @see MyWindow
 */
public class LaporanRekapitulasiGelombangSeminar extends MyWindow {
	...
	public LaporanRekapitulasiGelombangSeminar() {
		super();
		try {
	...
	public LaporanRekapitulasiGelombangSeminar(JadwalSeminarTugasAkhir jadwalSeminarTugasAkhir) {
		super();
	...
	public LaporanRekapitulasiGelombangSeminar(String title, String border, boolean closable) throws Exception {
	...
	private void init() throws Exception {
		...
		}, "Rekap_seminar_mahasiswa", null, new EventListener() {
	...
	public void onLaporan(Event event) throws Exception {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "Rekap_seminar_mahasiswa",
