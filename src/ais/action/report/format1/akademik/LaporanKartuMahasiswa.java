...
/**
 * Penyusun/penyaji laporan untuk laporan kartu mahasiswa. Kelas ini mengubah data domain menjadi
 ...
 * pembacaan/pencarian ({@code onSearchDefault()}, {@code ambilMasaBerlakuKartuMahasiswa()}); pelaporan/ekspor
 * ({@code onReport()}); operasi domain lain ({@code generateParameter()}, {@code
 * parseMasaBerlakuKartuMahasiswa()}, {@code siapkanParemeterGambar()}, {@code siapkanParemeter()}). Bagian lain
...
public class LaporanKartuMahasiswa extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link LaporanKartuMahasiswa}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LaporanKartuMahasiswa} dan dapat mengakses
