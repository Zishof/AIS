...
/**
 * Penyusun/penyaji laporan untuk laporan qr code absensi pegawai. Kelas ini mengubah data domain
 ...
 * sampai}, {@code Center center}, {@code Toolbar toolbar}, {@code String location}, {@code Date date}, {@code
 * List maps}, {@code MyCheckboxConfig haris}; inisialisasi/lifecycle ({@code init()}); operasi domain lain
