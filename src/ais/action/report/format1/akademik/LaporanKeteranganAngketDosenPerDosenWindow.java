...
/**
 * Penyusun/penyaji laporan untuk laporan keterangan angket dosen per dosen window. Kelas ini
 ...
 * @see MyWindow
 */
public class LaporanKeteranganAngketDosenPerDosenWindow extends MyWindow {
	...
	public LaporanKeteranganAngketDosenPerDosenWindow() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Keterangan Angket Dosen Per Dosen Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanKeteranganAngketDosenPerDosenWindow(Dosen dsn) {
		super();
		this.dsn = dsn;
		try {
	...
	public LaporanKeteranganAngketDosenPerDosenWindow(String title, String border, boolean closable) throws Exception {
...
//		semesterAbsensi.appendChild(comboitem);
		...
		}, "rekap_keterangan_angket_dosen_per_dosen", null, new EventListener() {
		...
		Common.createDefaultTimer(new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
						"rekap_keterangan_angket_dosen_per_dosen", ais.ui.util.WaktuUtil.getDate(), toolbar);
