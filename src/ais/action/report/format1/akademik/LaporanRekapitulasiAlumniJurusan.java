...
/**
 * Penyusun/penyaji laporan untuk laporan rekapitulasi alumni jurusan. Kelas ini mengubah data
 ...
 * @see MyWindow
 */
public class LaporanRekapitulasiAlumniJurusan extends MyWindow {
	...
	public LaporanRekapitulasiAlumniJurusan(String title, String border, boolean closable) throws Exception {
	...
	private void init() {
		...
		north.appendChild(toolbar = CommonReport.exportReport(new ParameterListener() {
			...
			public Map<String, Serializable> generateParameters() throws Exception {
				if (dari.getValue() == null) {
					MyMessageboxConfig.show("Isi Dari tahun angkatan", "Peringatan", MyMessageboxConfig.OK,
							MyMessageboxConfig.INFORMATION);
					return null;
				}
				if (sampai.getValue() == null) {
					MyMessageboxConfig.show("Isi sampai tahun angkatan", "Peringatan", MyMessageboxConfig.OK,
							MyMessageboxConfig.INFORMATION);
					return null;
				}
		...
		}, "Rekapitulasi_alumni_jurusan", null, new EventListener() {
	...
	public void onRekap(Event event) {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, parameters, "Rekapitulasi_alumni_jurusan", ais.ui.util.WaktuUtil.getDate(),
					toolbar);
		...
		//
		// } catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/report/format1/akademik/LaporanRekapitulasiAlumniJurusan.java:215");
