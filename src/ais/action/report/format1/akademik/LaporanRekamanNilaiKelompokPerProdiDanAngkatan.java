...
/**
 * Penyusun/penyaji laporan untuk laporan rekaman nilai kelompok per prodi dan angkatan. Kelas ini
 ...
 * jurusan}, {@code Combobox semester}, {@code Intbox angkatan}, {@code Center center}, {@code Toolbar toolbar},
 * {@code MyDatebox tanggal}; inisialisasi/lifecycle ({@code initKHS()}, {@code init()}); validasi/perhitungan
 * ({@code validasiInput()}); operasi domain lain ({@code generateParameter()}, {@code onKHS()}). Bagian lain
