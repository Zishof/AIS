...
/**
 * Penyusun/penyaji laporan untuk laporan keterangan angket umum per jurusan window. Kelas ini
 ...
 * @see MyWindow
 */
public class LaporanKeteranganAngketUmumPerJurusanWindow extends MyWindow {
	...
	public LaporanKeteranganAngketUmumPerJurusanWindow() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Keterangan Angket Umum Per Jurusan Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanKeteranganAngketUmumPerJurusanWindow(String title, String border, boolean closable) throws Exception {
		...
		Common.createDefaultTimer(new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
						"rekap_keterangan_angket_umum_per_jurusan", ais.ui.util.WaktuUtil.getDate(),
						toolbar);
