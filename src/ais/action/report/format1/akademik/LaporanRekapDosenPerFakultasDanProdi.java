...
/**
 * Penyusun/penyaji laporan untuk laporan rekap dosen per fakultas dan prodi. Kelas ini mengubah
 ...
 * {@code MyDatebox tanggal}, {@code AmbilDataDosenBanbox dosen}, {@code SimpleDateFormat dateFormat}, {@code
 * Combobox fakultas}, {@code Combobox jurusan}; inisialisasi/lifecycle ({@code initDaftarHadirDosen()}, {@code
 * init()}); operasi domain lain ({@code generateParameter()}, {@code onDaftarHadirDosenSemua()}). Bagian lain
