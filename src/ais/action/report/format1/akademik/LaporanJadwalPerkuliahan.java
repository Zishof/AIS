...
/**
 * Penyusun/penyaji laporan untuk laporan jadwal perkuliahan. Kelas ini mengubah data domain
 ...
 * AmbilDataKelasBanbox kelas}, {@code AmbilDataMasaPerkuliahanBanbox masaPerkuliahan}, {@code MyCheckboxConfig
 ...
 * @see MyWindow
 */
public class LaporanJadwalPerkuliahan extends MyWindow {
	...
	public LaporanJadwalPerkuliahan() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Jadwal Perkuliahan", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanJadwalPerkuliahan(String title, String border, boolean closable) throws Exception {
	...
	private void init() {
		...
		}, "format1/laporan_jadwal_perkuliahan", null, new EventListener() {
	...
	public void onCetak(Event event) {
		...
		try {
			...
			Common.createDefaultTimer(new EventListener() {
				...
				public void onEvent(Event arg0) throws Exception {
					File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
							"format1/laporan_jadwal_perkuliahan", ais.ui.util.WaktuUtil.getDate(), 
							toolbar);
			...
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Jadwal Perkuliahan", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
