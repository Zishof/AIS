...
/**
 * Penyusun/penyaji laporan untuk laporan rekapitulasi asrama. Kelas ini mengubah data domain
 ...
 * jurusan}, {@code Intbox angkatan}, {@code Combobox status}, {@code AmbilDataAsramaBanbox searchasrama}, {@code
 * Center center}, {@code Toolbar toolbar}, {@code AmbilDataMahasiswaBanbox searchmahasiswa};
 ...
 * @see MyWindow
 */
public class LaporanRekapitulasiAsrama extends MyWindow {
	...
	private AmbilDataAsramaBanbox searchasrama;
	...
	public LaporanRekapitulasiAsrama() {
		super();
		try {
	...
	public LaporanRekapitulasiAsrama(String title, String border, boolean closable) throws Exception {
	...
	private void init() throws Exception {
		...
		row.appendChild(searchasrama = new AmbilDataAsramaBanbox());
		...
		}, "Rekap_asrama", null, new EventListener() {
	...
	private Map generateParameter() throws Exception {
		Asrama asrama = (Asrama) searchasrama.getAttribute("asrama");
	...
	public void onLaporan(Event event) throws Exception {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "Rekap_asrama", ais.ui.util.WaktuUtil.getDate(),
					toolbar);
