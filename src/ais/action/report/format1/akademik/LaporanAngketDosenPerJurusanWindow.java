...
/**
 * Penyusun/penyaji laporan untuk laporan angket dosen per jurusan window. Kelas ini mengubah data
 ...
 * @see MyWindow
 */
public class LaporanAngketDosenPerJurusanWindow extends MyWindow {
	...
	public LaporanAngketDosenPerJurusanWindow() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Angket Dosen Per Jurusan Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanAngketDosenPerJurusanWindow(String title, String border, boolean closable) throws Exception {
	...
	private void init() {
		...
		}, "rekap_angket_dosen_per_prodi", null, new EventListener() {
	...
	public void onLaporanAngketDosenPerDosen(Event event) throws Exception {
		...
		Common.createDefaultTimer(new EventListener() {
			...
			@Override
			public void onEvent(Event arg0) throws Exception {
				File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "rekap_angket_dosen_per_prodi",
