...
public class LaporanRekapitulasiMahasiswaYangMengambilMatakuliah extends MyWindow {
	...
	public LaporanRekapitulasiMahasiswaYangMengambilMatakuliah() {
		...
		try {
			...
			/**
			 * Event listener lokal milik {@link LaporanRekapitulasiMahasiswaYangMengambilMatakuliah}. Kelas ini menangani
			 * event untuk komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
			 *
			 * <p><b>Scope:</b> setiap instance terikat pada instance {@link
			 * LaporanRekapitulasiMahasiswaYangMengambilMatakuliah} dan dapat mengakses state kelas induk. Jangan menyimpan
			 ...
			 *
			 * @see LaporanRekapitulasiMahasiswaYangMengambilMatakuliah
			 */
