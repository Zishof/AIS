...
/**
 * Penyusun/penyaji laporan untuk laporan format emis riwayat mahasiswa. Kelas ini mengubah data
 ...
 * ganjilGenap}, {@code Decimalbox tahunAngkatan}, {@code Decimalbox tahunAngkatanSd}; inisialisasi/lifecycle
 * ({@code init()}); pelaporan/ekspor ({@code onCetak()}). Bagian lain dari kontrak tetap mengikuti kelas induk
