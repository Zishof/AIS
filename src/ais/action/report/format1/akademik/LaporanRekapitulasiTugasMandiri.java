...
/**
 * Penyusun/penyaji laporan untuk laporan rekapitulasi tugas mandiri. Kelas ini mengubah data
 ...
 * perkuliahan}, {@code Toolbar toolbar}, {@code Set selectedPertemuan}, {@code Tbmuser tbmuser};
 * inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code onCetak()}); operasi domain lain ({@code
 * generateParameter()}); konfigurasi constructor: {@code selectedPertemuan}. Bagian lain dari kontrak tetap
