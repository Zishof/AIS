...
/**
 * Penyusun/penyaji laporan untuk laporan angket dosen per matakuliah window. Kelas ini mengubah
 ...
 * @see MyWindow
 */
public class LaporanAngketDosenPerMatakuliahWindow extends MyWindow {
	...
	public LaporanAngketDosenPerMatakuliahWindow() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Angket Dosen Per Matakuliah Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanAngketDosenPerMatakuliahWindow(String title, String border, boolean closable) throws Exception {
	...
	private void init() {
		...
		}, "rekap_angket_dosen_per_matakuliah", null, new EventListener() {
		...
		Common.createDefaultTimer(new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
						"rekap_angket_dosen_per_matakuliah", ais.ui.util.WaktuUtil.getDate(),
						toolbar);
