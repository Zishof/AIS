...
/**
 * Penyusun/penyaji laporan untuk laporan angket dosen per dosen jenis lain window. Kelas ini
 ...
 * @see MyWindow
 */
public class LaporanAngketDosenPerDosenJenisLainWindow extends MyWindow {
	...
	public LaporanAngketDosenPerDosenJenisLainWindow() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Angket Dosen Per Dosen Jenis Lain Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanAngketDosenPerDosenJenisLainWindow(Dosen dsn) {
		super();
		this.dsn = dsn;
		try {
	...
	public LaporanAngketDosenPerDosenJenisLainWindow(String title, String border, boolean closable) throws Exception {
...
//		semesterAbsensi.appendChild(comboitem);
		...
		}, "rekap_keseluruhan_per_dosen", null, new EventListener() {
	...
	private Map generateParameter() throws Exception {
		...
		if (jurusan == null && dosen == null) {
			MyMessageboxConfig.show(Common.getBahasaConfig("Jurusan") + " atau Dosen harus dipilih, jika "
					+ Common.getBahasaConfig("Jurusan")
					+ " tidak dipilih, maka Dosen wajib dipilih, begitu juga sebalik-nya, atau juga bisa memilih dua-dua-nya",
	...
	public void onLaporanAngketDosenPerDosen(Event event) throws Exception {
		...
		Common.createDefaultTimer(new EventListener() {
			...
			@Override
			public void onEvent(Event arg0) throws Exception {
				File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "rekap_keseluruhan_per_dosen",
