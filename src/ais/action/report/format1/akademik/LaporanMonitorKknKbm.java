...
/**
 * Penyusun/penyaji laporan untuk laporan monitor kkn kbm. Kelas ini mengubah data domain menjadi
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Center center}, {@code KelompokKkn
 * kelompokKkn}, {@code Toolbar toolbar}, {@code List kelompokKkns}; inisialisasi/lifecycle ({@code init()});
