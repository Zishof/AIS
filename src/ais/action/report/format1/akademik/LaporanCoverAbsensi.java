...
/**
 * Penyusun/penyaji laporan untuk laporan cover absensi. Kelas ini mengubah data domain menjadi
 ...
 * Combobox semesterAbsensi}, {@code Combobox perkuliahan}, {@code Combobox fakultas}, {@code Combobox prodi},
 * {@code Center center}, {@code Combobox program}, {@code Textbox kelas}; inisialisasi/lifecycle ({@code
 * initPerkuliahan()}, {@code init()}); operasi domain lain ({@code generateParameter()}, {@code
 * onLaporanCoverAbsensi()}); konfigurasi constructor: {@code fakultas}, {@code prodi}, {@code program}. Bagian
...
public class LaporanCoverAbsensi extends MyWindow {
	...
	/**
	 * Event listener lokal milik {@link LaporanCoverAbsensi}. Kelas ini menangani event untuk komponen induk dan
	 * meneruskan pekerjaan domain ke method/service yang sudah tersedia.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LaporanCoverAbsensi} dan dapat mengakses state
