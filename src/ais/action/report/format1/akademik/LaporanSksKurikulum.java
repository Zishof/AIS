...
/**
 * Penyusun/penyaji laporan untuk laporan sks kurikulum. Kelas ini mengubah data domain menjadi
 ...
 * @see MyWindow
 */
public class LaporanSksKurikulum extends MyWindow {
	...
	public LaporanSksKurikulum() {
		super();
		try {
			init();
		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Sks Kurikulum", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanSksKurikulum(String title, String border, boolean closable) {
	...
	private void initSpreadsheet() throws Exception {
		...
		} catch (Exception e4) { ais.common.ErrorAuditUtil.record(e4, "auto-audit(empty-catch) src/ais/action/report/format1/akademik/LaporanSksKurikulum.java:216");

		}

		ais.ui.util.EcampusUtil.setCellValue(sheet, 1, 0, "DATA SKS KURIKULUM");
		...
		int rowIndex = 2;
		int colIndex = 0;
		ais.ui.util.EcampusUtil.setCellValue(sheet, rowIndex, 0, "Kurikulum");
		ais.ui.util.EcampusUtil.setCellValue(sheet, rowIndex, 1, "Total SKS");
		...
		for (Long key : matakuliahsMap.keySet()) {
			...
			Kurikulum kurikulum = matakuliahsData.get(key);
			...
			ais.ui.util.EcampusUtil.setCellValue(sheet, rowIndex, 0, kurikulum.getNama());
		...
		Utils.setColumnWidth(sheet, 0, 550);
