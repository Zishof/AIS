...
/**
 * Penyusun/penyaji laporan untuk laporan rekap dosen per fakultas dan per prodi. Kelas ini
 ...
 * jurusan}, {@code Combobox tahunAkademik}, {@code Combobox genapGanjil}, {@code Center center}, {@code Toolbar
 * toolbar}; inisialisasi/lifecycle ({@code initKHS()}, {@code init()}); operasi domain lain ({@code
 ...
 * @see MyWindow
 */
public class LaporanRekapDosenPerFakultasDanPerProdi extends MyWindow {
	...
	public LaporanRekapDosenPerFakultasDanPerProdi() {
		super();
		try {
			initKHS();
			init();
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Rekap Dosen Per Fakultas Dan Per Prodi", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanRekapDosenPerFakultasDanPerProdi(String title, String border, boolean closable) throws Exception {
	...
	private void init() throws Exception {
		...
		}, "rekap_dosen_per_prodi_fakultas", null, new EventListener() {
	...
	public void onKHS(Event event) throws Exception {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "rekap_dosen_per_prodi_fakultas",
					ais.ui.util.WaktuUtil.getDate(), toolbar);
			CommonReport.tampilkanReportPDF(center, file);

		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e); 
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Rekap Dosen Per Fakultas Dan Per Prodi", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
