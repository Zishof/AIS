...
/**
 * Penyusun/penyaji laporan untuk laporan rekapitulasi seminar. Kelas ini mengubah data domain
 ...
 * @see MyWindow
 */
public class LaporanRekapitulasiSeminar extends MyWindow {
	...
	public LaporanRekapitulasiSeminar() {
		super();
		try {
	...
	public LaporanRekapitulasiSeminar(JadwalSeminarTugasAkhir jadwalSeminarTugasAkhir) {
		super();
	...
	public LaporanRekapitulasiSeminar(String title, String border, boolean closable) throws Exception {
