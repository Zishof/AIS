...
/**
 * Penyusun/penyaji laporan untuk laporan ruangan dosen. Kelas ini mengubah data domain menjadi
 ...
 * jurusan}, {@code Textbox dosen}, {@code Center center}, {@code Toolbar toolbar}; inisialisasi/lifecycle
 * ({@code initDaftarHadirDosen()}, {@code init()}); operasi domain lain ({@code generateParameter()}, {@code
 * onDaftarHadirDosen()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di
 * atas.</p>
