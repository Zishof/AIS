...
/**
 * Penyusun/penyaji laporan untuk laporan rekap angket dosen window. Kelas ini mengubah data domain
 ...
 * Combobox fakultas}, {@code Combobox jurusan}, {@code Combobox semesterAbsensi}, {@code Toolbar toolbar},
 * {@code Center center}, {@code Combobox program}; inisialisasi/lifecycle ({@code init()}); operasi domain lain
 * ({@code generateParameter()}, {@code onLaporanAngketDosenPerDosen()}). Bagian lain dari kontrak tetap
 ...
 * @see MyWindow
 */
public class LaporanRekapAngketDosenWindow extends MyWindow {
	...
	public LaporanRekapAngketDosenWindow() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Rekap Angket Dosen Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanRekapAngketDosenWindow(String title, String border, boolean closable) throws Exception {
	...
	private void init() {
		...
		hbox.appendChild(LaporanRekapAngketDosenPerJurusanWindow.hitungUlangAngket(tahunAkademik, semesterAbsensi, null));
		...
		}, "rangking_angket_dosen_per_dosen", null, new EventListener() {
	...
	private Map generateParameter() throws Exception {
		...
		String genapGanjil = (String) (semesterAbsensi.getSelectedItem() == null || semesterAbsensi.getSelectedItem().getValue() == null ? "Semua"
				: semesterAbsensi.getSelectedItem().getValue());

		String tahunAkademik = (String) (this.tahunAkademik.getSelectedItem() == null || this.tahunAkademik.getSelectedItem().getValue() == null ? "Semua"
		...
		String program = (String) (this.program.getSelectedItem() == null||this.program.getSelectedItem().getValue() == null ? null
		...
		Common.createDefaultTimer(new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
						"rangking_angket_dosen_per_dosen", ais.ui.util.WaktuUtil.getDate(), toolbar);
