...
/**
 * Penyusun/penyaji laporan untuk laporan kurikulum. Kelas ini mengubah data domain menjadi bentuk
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Combobox kurikulumFakultas}, {@code
 * Combobox kurikulumJurusan}, {@code Combobox kurikulumJenis}, {@code Center center}, {@code Toolbar toolbar},
 * {@code Combobox smt}, {@code Integer s}, {@code Kurikulum k}; inisialisasi/lifecycle ({@code initKurikulum()},
 * {@code init()}); operasi domain lain ({@code generateParameter()}, {@code onKurikulum()}). Bagian lain dari
...
public class LaporanKurikulum extends MyWindow {
	...
	private void initKurikulum() throws Exception {
		...
		/**
		 * Event listener lokal milik {@link LaporanKurikulum}. Kelas ini menangani event untuk komponen induk dan
		 * meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LaporanKurikulum} dan dapat mengakses state
