...
/**
 * Penyusun/penyaji laporan untuk laporan khs type1. Kelas ini mengubah data domain menjadi bentuk
 ...
 * AmbilDataMahasiswaBanbox bandboxMahasiswa}, {@code Center center}, {@code Toolbar toolbar}, {@code MyDatebox
 * tanggal}; inisialisasi/lifecycle ({@code initKHS()}, {@code init()}); operasi domain lain ({@code
