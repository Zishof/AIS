...
/**
 * Penyusun/penyaji laporan untuk laporan beasiswa mahasiswa. Kelas ini mengubah data domain
 ...
 * bandboxMahasiswa}, {@code Center center}, {@code Toolbar toolbar}, {@code MyDatebox tanggal};
 ...
 * @see MyWindow
 */
public class LaporanBeasiswaMahasiswa extends MyWindow {
	...
	public LaporanBeasiswaMahasiswa() {
		super();
		try {
			init();
		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Beasiswa Mahasiswa", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanBeasiswaMahasiswa(String title, String border, boolean closable) throws Exception {
	...
	private void init() throws Exception {
		...
		north.appendChild(toolbar = CommonReport.exportReport(new ParameterListener() {
			...
			public Map<String, Serializable> generateParameters() throws Exception {
				...
				if (bandboxMahasiswa.getAttribute("mahasiswa") == null) {
					MyMessageboxConfig.show("Mohon maaf, Mahasiswa belum dipilih. Langkah yang dapat dilakukan: (1) Ketik NIM atau nama mahasiswa pada kolom pencarian lalu pilih dari hasil yang muncul; (2) Pastikan data mahasiswa terdaftar di sistem; (3) Ulangi proses cetak laporan beasiswa. Jika masih mengalami kendala, hubungi Administrator atau tim teknis.", "Peringatan", MyMessageboxConfig.OK,
		...
		}, "Beasiswa_Mahasiswa", null, new EventListener() {
	...
	public void onKHS(Event event) throws Exception {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF,
					...
					"Beasiswa_Mahasiswa", ais.ui.util.WaktuUtil.getDate(), toolbar);
			CommonReport.tampilkanReportPDF(center, file);

		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Beasiswa Mahasiswa", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
