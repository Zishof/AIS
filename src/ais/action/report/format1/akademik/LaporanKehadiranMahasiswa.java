...
/**
 * Penyusun/penyaji laporan untuk laporan kehadiran mahasiswa. Kelas ini mengubah data domain
 ...
 * @see MyWindow
 */
public class LaporanKehadiranMahasiswa extends MyWindow {
	...
	public LaporanKehadiranMahasiswa() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Kehadiran Mahasiswa", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanKehadiranMahasiswa(String title, String border, boolean closable) throws Exception {
	...
	private void init() {
		...
		row.appendChild(this.mahasiswa = new AmbilDataMahasiswaBanbox());
		...
		}, "LaporanAbsensiMahasiswa", null, new EventListener() {
	...
	private Map generateParameter() throws Exception {
		...
		List<Map<String, Serializable>> maps = CommonReportHelper.generateParameterMapAbsensiRinciMahasiswa(myFakultas,
				...
				(Mahasiswa) mahasiswa.getAttribute("mahasiswa"), matakuliah.getValue().trim(),
				(Matakuliah) matkul.getAttribute("matakuliah"), mulai.getValue(), sampai.getValue(),
				hanyaYgStatusMasuk.isChecked(), statusPertemuans);
	...
	public void onCetak(Event event) {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "LaporanAbsensiMahasiswa",
					ais.ui.util.WaktuUtil.getDate(), toolbar);
			CommonReport.tampilkanReportPDF(center, file);

		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Kehadiran Mahasiswa", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
