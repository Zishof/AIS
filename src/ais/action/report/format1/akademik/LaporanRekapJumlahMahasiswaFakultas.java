...
/**
 * Penyusun/penyaji laporan untuk laporan rekap jumlah mahasiswa fakultas. Kelas ini mengubah data
 ...
 * @see MyWindow
 */
public class LaporanRekapJumlahMahasiswaFakultas extends MyWindow {
	...
	public LaporanRekapJumlahMahasiswaFakultas() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Rekap Jumlah Mahasiswa Fakultas", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanRekapJumlahMahasiswaFakultas(String title, String border, boolean closable) {
			...
			public void onEvent(Event event) throws Exception {
				...
				try {
					Filedownload.save(new FileInputStream(file),
							...
							"REKAPITULASI JUMLAH MAHASISWA FAKULTAS.xlsx");
				} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/report/format1/akademik/LaporanRekapJumlahMahasiswaFakultas.java:173");
					PesanFormalHelper.tampilkanGagalException("pembuatan berkas Excel Laporan Rekap Jumlah Mahasiswa Fakultas", "Sistem mengalami kendala teknis saat menyusun berkas Excel laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap atau format datanya tidak sesuai dengan yang diharapkan oleh template ekspor.", e,
						new String[] {
						...
						for (Fakultas fakultas : fakultases) {
							...
							try {
								...
								Integer jmlLaki = ((Number) session.createCriteria(HistoryStatusMahasiswa.class)
										...
										.add(Restrictions.eq("jurusan.fakultas", fakultas))

										.add(Restrictions.ilike("mahasiswa.kelamin", "Laki-laki", MatchMode.ANYWHERE))
								...
								Integer jmlPerempuan = ((Number) session.createCriteria(HistoryStatusMahasiswa.class)
										...
										.add(Restrictions.ilike("mahasiswa.kelamin", "Perempuan", MatchMode.ANYWHERE))
								...
								Common.tampilErrorJikaAdmin(e);
								PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Rekap Jumlah Mahasiswa Fakultas", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
										new String[] {
