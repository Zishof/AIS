...
/**
 * Penyusun/penyaji laporan untuk laporan rekap jumlah dosen. Kelas ini mengubah data domain
 ...
 * fakultas}, {@code Combobox jurusan}, {@code Combobox tahunAkademik}, {@code Combobox genapGanjil}, {@code
 * Toolbar toolbar}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code onCetak()}); operasi
 ...
 * @see MyWindow
 */
public class LaporanRekapJumlahDosen extends MyWindow {
	...
	public LaporanRekapJumlahDosen() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Rekap Jumlah Dosen", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanRekapJumlahDosen(String title, String border,
	...
	public void onCetak(Event event) {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF,
					generateParameter(), "rekap_jumlah_dosen_semua",
					ais.ui.util.WaktuUtil.getDate(), toolbar);
			CommonReport.tampilkanReportPDF(center, file);

		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e); 
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Rekap Jumlah Dosen", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
