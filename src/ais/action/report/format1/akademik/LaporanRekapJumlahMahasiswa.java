...
/**
 * Penyusun/penyaji laporan untuk laporan rekap jumlah mahasiswa. Kelas ini mengubah data domain
 ...
 * fakultas}, {@code Combobox jurusan}, {@code Combobox program}, {@code Toolbar toolbar}, {@code Combobox
 * tahunAjaran}, {@code Combobox ganjilGenap}, {@code ArrayList maps}; inisialisasi/lifecycle ({@code init()});
 * pelaporan/ekspor ({@code onCetak()}); operasi domain lain ({@code generateParameter()}, {@code
