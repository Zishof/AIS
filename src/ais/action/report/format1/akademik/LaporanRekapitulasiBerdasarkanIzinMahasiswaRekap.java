...
/**
 * Penyusun/penyaji laporan untuk laporan rekapitulasi berdasarkan izin mahasiswa rekap. Kelas ini
 ...
 * @see MyWindow
 */
public class LaporanRekapitulasiBerdasarkanIzinMahasiswaRekap extends MyWindow {
	...
	public LaporanRekapitulasiBerdasarkanIzinMahasiswaRekap() {
		super();
		try {
	...
	public LaporanRekapitulasiBerdasarkanIzinMahasiswaRekap(String title, String border, boolean closable)
			throws Exception {
	...
	private void init() throws Exception {
		...
		}, "Rekap_pengajuan_berdasrkan_mhs_rekap", null, new EventListener() {
	...
	public void onLaporan(Event event) throws Exception {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
					"Rekap_pengajuan_berdasrkan_mhs_rekap", ais.ui.util.WaktuUtil.getDate(),
					toolbar);
