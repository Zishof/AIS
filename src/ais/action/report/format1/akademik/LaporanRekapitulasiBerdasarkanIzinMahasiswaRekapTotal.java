...
/**
 * Penyusun/penyaji laporan untuk laporan rekapitulasi berdasarkan izin mahasiswa rekap total.
 ...
 * @see MyWindow
 */
public class LaporanRekapitulasiBerdasarkanIzinMahasiswaRekapTotal extends MyWindow {
	...
	public LaporanRekapitulasiBerdasarkanIzinMahasiswaRekapTotal() {
		super();
		try {
	...
	public LaporanRekapitulasiBerdasarkanIzinMahasiswaRekapTotal(String title, String border, boolean closable)
			throws Exception {
	...
	private void init() throws Exception {
		...
		}, "Rekap_pengajuan_berdasrkan_mhs_rekap_total", null, new EventListener() {
	...
	public void onLaporan(Event event) throws Exception {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
					"Rekap_pengajuan_berdasrkan_mhs_rekap_total", ais.ui.util.WaktuUtil.getDate(),
					toolbar);
