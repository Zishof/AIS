...
/**
 * Penyusun/penyaji laporan untuk laporan angket umum diis oleh window. Kelas ini mengubah data
 ...
 * Combobox semesterAbsensi}, {@code Combobox fakultas}, {@code Combobox jurusan}, {@code Toolbar toolbar},
 * {@code Center center}, {@code Combobox searchdiperuntukkan}; inisialisasi/lifecycle ({@code init()}); operasi
 * domain lain ({@code generateParameter()}, {@code onLaporanAngketDosenPerDosen()}). Bagian lain dari kontrak
 ...
 * @see MyWindow
 */
public class LaporanAngketUmumDiisOlehWindow extends MyWindow {
	...
	public LaporanAngketUmumDiisOlehWindow() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Angket Umum Diis Oleh Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanAngketUmumDiisOlehWindow(String title, String border, boolean closable) throws Exception {
	...
	private void init() {
		...
		}, "rangking_angket_umum_per_diisi_oleh", null, new EventListener() {
		...
		try {
			...
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Angket Umum Diis Oleh Window", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
					new String[] {
		...
		Common.createDefaultTimer(new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
						"rangking_angket_umum_per_diisi_oleh", ais.ui.util.WaktuUtil.getDate(),
						toolbar);
