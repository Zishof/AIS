...
/**
 * Penyusun/penyaji laporan untuk laporan jadwal perkuliahan per matakuliah. Kelas ini mengubah
 ...
 * AmbilDataRuangBanbox ruang}, {@code AmbilDataMasaPerkuliahanBanbox masaPerkuliahan}, {@code MyCheckboxConfig
 * semesterPendek}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code onCetak()}); operasi domain
 ...
 * @see MyWindow
 */
public class LaporanJadwalPerkuliahanPerMatakuliah extends MyWindow {
	...
	public LaporanJadwalPerkuliahanPerMatakuliah() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Jadwal Perkuliahan Per Matakuliah", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanJadwalPerkuliahanPerMatakuliah(String title, String border, boolean closable) throws Exception {
	...
	private void init() {
		...
		}, "laporan_jadwal_perkuliahan_per_matakuliah", null, new EventListener() {
	...
	public void onCetak(Event event) {
		...
		try {
			Common.createDefaultTimer(new EventListener() {
				...
				public void onEvent(Event arg0) throws Exception {
					File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
							"laporan_jadwal_perkuliahan_per_matakuliah", ais.ui.util.WaktuUtil.getDate(),
							toolbar);
			...
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Jadwal Perkuliahan Per Matakuliah", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
