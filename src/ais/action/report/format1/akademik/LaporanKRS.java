...
/**
 * Penyusun/penyaji laporan untuk laporan krs. Kelas ini mengubah data domain menjadi bentuk
 ...
 * semesterPendek}; inisialisasi/lifecycle ({@code initKHS()}, {@code init()}); operasi domain lain ({@code
