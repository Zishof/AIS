...
/**
 * Penyusun/penyaji laporan untuk laporan rekap angket per mahasiswa window. Kelas ini mengubah
 ...
 * {@code Center center}, {@code Combobox program}, {@code Decimalbox tahunAngkatan}; inisialisasi/lifecycle
 * ({@code init()}); operasi domain lain ({@code generateParameter()}, {@code onLaporanAngketDosenPerDosen()}).
 ...
 * @see MyWindow
 */
public class LaporanRekapAngketPerMahasiswaWindow extends MyWindow {
	...
	public LaporanRekapAngketPerMahasiswaWindow() {
		super();
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Rekap Angket Per Mahasiswa Window", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanRekapAngketPerMahasiswaWindow(String title, String border, boolean closable) throws Exception {
	...
	private void init() {
		...
		}, "rangking_angket_dosen_per_mahasiswa", null, new EventListener() {
	...
	private Map generateParameter() throws Exception {
		...
		parameters.put("tahunangkatan", tahunAngkatan.getValue() == null ? 0 : tahunAngkatan.getValue().intValue());
		parameters.put("tahunangkatan_sd",
				tahunAngkatanSd.getValue() == null ? 2200 : tahunAngkatanSd.getValue().intValue());
		...
		Common.createDefaultTimer(new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
						"rangking_angket_dosen_per_mahasiswa", ais.ui.util.WaktuUtil.getDate(),
						toolbar);
