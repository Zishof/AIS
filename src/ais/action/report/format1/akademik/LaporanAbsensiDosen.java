...
/**
 * Penyusun/penyaji laporan untuk laporan absensi dosen. Kelas ini mengubah data domain menjadi
 ...
 * jurusan}, {@code MyCheckboxConfig haris}, {@code AmbilDataDosenBanbox searchdosen}, {@code Combobox bulan},
 * {@code Center center}, {@code Toolbar toolbar}, {@code Combobox tahun}; inisialisasi/lifecycle ({@code
 * initKHS()}, {@code init()}); operasi domain lain ({@code generateParameter()}, {@code onKHS()}). Bagian lain
