...
/**
 * Penyusun/penyaji laporan untuk laporan catatan mahasiswa. Kelas ini mengubah data domain menjadi
 ...
 * bandboxMahasiswa}, {@code Center center}, {@code MyDatebox tanggal}, {@code MyDatebox sampai}, {@code Combobox
 * jenisCatatanMahasiswa}, {@code Combobox tahunAkademik}, {@code Combobox searchsmt}; inisialisasi/lifecycle
 * ({@code init()}, {@code initData()}); pelaporan/ekspor ({@code cetak()}); operasi domain lain ({@code
