...
/**
 * Penyusun/penyaji laporan untuk laporan format emis riwayat dosen. Kelas ini mengubah data domain
 ...
 * fakultas}, {@code Combobox jurusan}, {@code Combobox tahunAjaran}, {@code Combobox ganjilGenap}, {@code
 * Spreadsheet excelku}, {@code MyToolbarbuttonConfig search}, {@code Combobox program}; inisialisasi/lifecycle
 * ({@code init()}, {@code initCriteria()}); pelaporan/ekspor ({@code onCetak()}). Bagian lain dari kontrak tetap
