...
/**
 * Penyusun/penyaji laporan untuk laporan per kegiatan mahasiswa. Kelas ini mengubah data domain
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Textbox nama}, {@code Checkbox
 * hanyaAktif}, {@code Checkbox hanyaTidakAktif}, {@code Center center}, {@code Toolbar toolbar};
 * inisialisasi/lifecycle ({@code init()}); operasi domain lain ({@code generateParameter()}, {@code onKHS()}).
 ...
 * @see MyWindow
 */
public class LaporanPerKegiatanMahasiswa extends MyWindow {
	...
	public LaporanPerKegiatanMahasiswa() {
		super();
		try {
			init();
		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Per Kegiatan Mahasiswa", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanPerKegiatanMahasiswa(String title, String border, boolean closable) throws Exception {
	...
	private void init() throws Exception {
		...
		MyTabConfig tab1 = new MyTabConfig("Daftar Kegiatan Mahasiswa");
		tab1.setParent(tabs);

		MyTabConfig tab2 = new MyTabConfig("Angka Kredit Mahasiswa");
		tab2.setParent(tabs);
		...
		tab2.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				if (tabpanel2.getChildren().size() == 0) {
					LaporanKegiatanKemahasiswaan laporan = new LaporanKegiatanKemahasiswaan();
		...
		}, "Per_Kegiatan_Mahasiswa", null, new EventListener() {
	...
	public void onKHS(Event event) throws Exception {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "Per_Kegiatan_Mahasiswa", ais.ui.util.WaktuUtil.getDate(),
					toolbar);
			CommonReport.tampilkanReportPDF(center, file);

		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Per Kegiatan Mahasiswa", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
