...
/**
 * Penyusun/penyaji laporan untuk laporan transkip akademik. Kelas ini mengubah data domain menjadi
 ...
 * AmbilDataMahasiswaBanbox bandboxMahasiswa}, {@code MyCheckboxConfig ambilDariKurikulum}, {@code
 * MyCheckboxConfig hitungUlang}, {@code Center center}, {@code Toolbar toolbar}, {@code String namaFile}, {@code
 * MyDatebox tanggalDicetak}; inisialisasi/lifecycle ({@code initTranskripAkademik()}, {@code init()}); operasi
 * domain lain ({@code generateParameter()}, {@code generateParameter()}, {@code onTranskrip()}). Bagian lain
