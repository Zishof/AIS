...
/**
 * Penyusun/penyaji laporan untuk laporan rekaman nilai per prodi dan angkatan. Kelas ini mengubah
 ...
 * jurusan}, {@code Intbox angkatan}, {@code MyTextbox kelas}, {@code Center center}, {@code Toolbar toolbar},
 * {@code MyDatebox tanggal}; inisialisasi/lifecycle ({@code initKHS()}, {@code init()}); operasi domain lain
 * ({@code generateParameter()}, {@code onKHS()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
