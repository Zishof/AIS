...
/**
 * Penyusun/penyaji laporan untuk laporan pendidikan lingkungan kampus. Kelas ini mengubah data
 ...
 * bandboxMahasiswa}, {@code AmbilDataDosenBanbox bandboxDosen}, {@code AmbilDataSiswaBanbox bandboxSiswa},
 * {@code AmbilDataGuruBanbox bandboxGuru}, {@code Radiogroup formulirKegiatan}, {@code Center center}, {@code
 * Toolbar toolbar}, {@code FormulirKegiatanPeserta formulirKegiatanPeserta}; inisialisasi/lifecycle ({@code
 * init()}); operasi domain lain ({@code chek()}, {@code generateParameter()}, {@code belumMemilihDataLaporan()},
