...
/**
 * Penyusun/penyaji laporan untuk laporan kartu pegawai. Kelas ini mengubah data domain menjadi
 ...
 * tanggal}, {@code AmbilDataSatuanKerjaBanbox satker}; inisialisasi/lifecycle ({@code init()}, {@code
 * initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}); pelaporan/ekspor ({@code onReport()});
 * operasi domain lain ({@code generateParameter()}, {@code siapkanParemeterGambar()}, {@code
 * siapkanParemeter()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di
 * atas.</p>
...
public class LaporanKartuPegawai extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link LaporanKartuPegawai}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LaporanKartuPegawai} dan dapat mengakses state
