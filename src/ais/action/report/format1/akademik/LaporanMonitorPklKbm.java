...
/**
 * Penyusun/penyaji laporan untuk laporan monitor pkl kbm. Kelas ini mengubah data domain menjadi
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Center center}, {@code KelompokPkl
 * kelompokPkl}, {@code Toolbar toolbar}, {@code List kelompokPkls}; inisialisasi/lifecycle ({@code init()});
