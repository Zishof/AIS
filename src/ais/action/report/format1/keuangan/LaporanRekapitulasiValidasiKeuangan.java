...
/**
 * Penyusun/penyaji laporan untuk laporan rekapitulasi validasi keuangan. Kelas ini mengubah data
 ...
 * Combobox kurikulumJurusan}, {@code Combobox tahunAkademik}, {@code Center center}, {@code Toolbar toolbar};
 * inisialisasi/lifecycle ({@code initRekapitulasi()}, {@code init()}); operasi domain lain ({@code
 * generateParameter()}, {@code onRekap()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface
