...
/**
 * Penyusun/penyaji laporan untuk laporan rekapitulasi item biaya. Kelas ini mengubah data domain
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Combobox jenisKegiatan}, {@code
 * Combobox tahunAkademik}, {@code Center center}, {@code Toolbar toolbar}, {@code MyDatebox mulai}, {@code
 * MyDatebox sampai}; inisialisasi/lifecycle ({@code init()}); operasi domain lain ({@code generateParameter()},
 * {@code onRekap()}); konfigurasi constructor: {@code jenisKegiatan}. Bagian lain dari kontrak tetap mengikuti
