...
/**
 * Penyusun/penyaji laporan untuk laporan deposit. Kelas ini mengubah data domain menjadi bentuk
 ...
 * toolbar}, {@code Intbox angkatanMulai}, {@code Intbox angkatanSampai}, {@code MyDatebox mulai}, {@code
 * MyDatebox sampai}, {@code AmbilDataMahasiswaBanbox mahasiswa}, {@code AmbilDataCalonMahasiswaBanbox
 * calonMahasiswa}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code onReport()}); operasi
