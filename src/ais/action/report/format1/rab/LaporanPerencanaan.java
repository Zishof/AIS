...
/**
 * Penyusun/penyaji laporan untuk laporan perencanaan. Kelas ini mengubah data domain menjadi
 ...
 * {@code SatuanKerja mysatuanKerja}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code
 ...
 * @see MyWindow
 */
public class LaporanPerencanaan extends MyWindow {
	...
	private Integer thn = null;

	public LaporanPerencanaan() {
		super();
		try {
			init();
		} catch (Exception e) {
	...
	public LaporanPerencanaan(SatuanKerja satuanKerja, Integer thn) {
		super();
		try {
	...
	public LaporanPerencanaan(String title, String border, boolean closable) throws Exception {
	...
	private void init() throws Exception {
		...
		if (thn != null) {
			Common.selectComboItem(tahun, thn);
		...
		}, "rab/Rencana_Anggaran", null, new EventListener() {
	...
	public void onReport(Event event) {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "rab/Rencana_Anggaran",
