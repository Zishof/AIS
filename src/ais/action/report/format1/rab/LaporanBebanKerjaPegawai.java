...
/**
 * Penyusun/penyaji laporan untuk laporan beban kerja pegawai. Kelas ini mengubah data domain
 ...
 * toolbar}, {@code Combobox tahun}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code
