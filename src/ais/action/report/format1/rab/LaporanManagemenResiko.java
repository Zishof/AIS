...
/**
 * Penyusun/penyaji laporan untuk laporan managemen resiko. Kelas ini mengubah data domain menjadi
 ...
 * @see MyWindow
 */
public class LaporanManagemenResiko extends MyWindow {
	...
	public LaporanManagemenResiko() {
		super();
		try {
			init();
		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e); 
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Managemen Resiko", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanManagemenResiko(String title, String border, boolean closable)
			throws Exception {
	...
	private void init() throws Exception {
		...
		north.appendChild(CommonReport.exportReport(
	...
	public void onReport(Event event) {
		...
		try {
			...
			File file = new File(Sessions.getCurrent().getWebApp()
					.getRealPath("/Manajemen_Resiko.pdf"));
			CommonReport.tampilkanReportPDF(center, file);

		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e); 
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Managemen Resiko", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
