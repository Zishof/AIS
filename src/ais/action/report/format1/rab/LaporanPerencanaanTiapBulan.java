...
/**
 * Penyusun/penyaji laporan untuk laporan perencanaan tiap bulan. Kelas ini mengubah data domain
 ...
 * @see MyWindow
 */
public class LaporanPerencanaanTiapBulan extends MyWindow {
	...
	public LaporanPerencanaanTiapBulan(String title, String border, boolean closable) throws Exception {
	...
	private void init() throws Exception {
		...
		}, "rab/Rencana_Anggaran_Tiap_Bulan", null, new EventListener() {
	...
	private Map generateParameter() throws Exception {
		...
		for (final Workspace workspace : workspaces) {
			if ((selectedWorkspace != null && selectedWorkspace.getId().equals(workspace.getId()))
				...
				List<Object[]> numbers = workspaceTreeModel.getHargaTotalPerencanaanTiapBulan(childsId, tahun1);
				...
				maps.add(map);
				rabReportHelper.generateRencanaTiapBulanAnggaran(workspace.getParentId(), workspaceTreeModel,
	...
	public void onReport(Event event) {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "rab/Rencana_Anggaran_Tiap_Bulan",
