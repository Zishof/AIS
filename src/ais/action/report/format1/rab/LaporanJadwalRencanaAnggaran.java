...
/**
 * Penyusun/penyaji laporan untuk laporan jadwal rencana anggaran. Kelas ini mengubah data domain
 ...
 * AmbilDataSatuanKerjaBanbox satuanKerja}, {@code AmbilDataSumberDanaBanbox sumberDana}, {@code Combobox level},
 * {@code Center center}, {@code Toolbar toolbar}, {@code AmbilDataWorkspaceBanbox workspace}, {@code SatuanKerja
 * mysatuanKerja}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code onReport()}); operasi domain
 ...
 * @see MyWindow
 */
public class LaporanJadwalRencanaAnggaran extends MyWindow {
	...
	public LaporanJadwalRencanaAnggaran() {
		super();
		try {
			init();
		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Jadwal Rencana Anggaran", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanJadwalRencanaAnggaran(SatuanKerja satuanKerja) {
		super();
		try {
	...
	public LaporanJadwalRencanaAnggaran(String title, String border, boolean closable) throws Exception {
	...
	private void init() throws Exception {
		...
		}, "rab/Jadwal_Anggaran", null, new EventListener() {
	...
	private Map generateParameter() throws Exception {
		...
		for (final Workspace workspace : workspaces) {
			if ((selectedWorkspace != null && selectedWorkspace.getId().equals(workspace.getId()))
				...
				map.put("perulangan", workspace.getPerulangan() == null ? "" : workspace.getPerulangan());
	...
	public void onReport(Event event) {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "rab/Jadwal_Anggaran",
					ais.ui.util.WaktuUtil.getDate(), toolbar);
			CommonReport.tampilkanReportPDF(center, file);

		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Jadwal Rencana Anggaran", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
