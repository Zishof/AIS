...
/**
 * Penyusun/penyaji laporan untuk laporan checklist. Kelas ini mengubah data domain menjadi bentuk
 ...
 * toolbar}, {@code ChecklistLaporan checklistLaporan}; inisialisasi/lifecycle ({@code init()});
 * pembacaan/pencarian ({@code getStrings()}); pelaporan/ekspor ({@code fillReport()}, {@code onReport()});
