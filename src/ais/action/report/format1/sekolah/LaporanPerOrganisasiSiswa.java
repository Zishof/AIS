...
/**
 * Penyusun/penyaji laporan untuk laporan per organisasi siswa. Kelas ini mengubah data domain
 ...
 * @see MyWindow
 */
public class LaporanPerOrganisasiSiswa extends MyWindow {
	...
	public LaporanPerOrganisasiSiswa() {
		super();
		try {
			init();
		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e); 
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Per Organisasi Siswa", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanPerOrganisasiSiswa(String title, String border, boolean closable) throws Exception {
	...
	private void init() throws Exception {
		...
		MyTabConfig tab1 = new MyTabConfig("Daftar Organisasi Siswa");
		tab1.setParent(tabs);

		MyTabConfig tab2 = new MyTabConfig("Data Organisasi Siswa");
		tab2.setParent(tabs);
		...
		tab2.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				if (tabpanel2.getChildren().size() == 0) {
					LaporanOrganisasiSiswa laporan = new LaporanOrganisasiSiswa();
		...
		}, "Per_Organisasi_Siswa", null, new EventListener() {
	...
	public void onKHS(Event event) throws Exception {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "Per_Organisasi_Siswa",
					ais.ui.util.WaktuUtil.getDate(), toolbar);
			CommonReport.tampilkanReportPDF(center, file);

		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e); 
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Per Organisasi Siswa", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
