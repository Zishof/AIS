...
/**
 * Penyusun/penyaji laporan untuk laporan rekap total nilai. Kelas ini mengubah data domain menjadi
 ...
 * AmbilDataKelasSiswaSemuaBanbox searchnama}, {@code Center center}, {@code MyToolbarbuttonConfig printAmbil},
 * {@code Set masukGrup}, {@code Set masukSubgrup}, {@code Combobox searchsmt}, {@code Rows rowsData};
 * inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code onCetak()}); operasi domain lain ({@code
 * siswaMk()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di atas.</p>
