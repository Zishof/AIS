...
/**
 * Penyusun/penyaji laporan untuk laporan catatan kelas siswa. Kelas ini mengubah data domain
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code AmbilDataKelasSiswaBanbox
 * bandboxKelasSiswa}, {@code Center center}, {@code MyDatebox tanggal}, {@code MyDatebox sampai}, {@code
 * Combobox jenisCatatanKelasSiswa}, {@code Combobox tahunAkademik}, {@code Combobox searchsmt};
 * inisialisasi/lifecycle ({@code init()}, {@code initData()}); pelaporan/ekspor ({@code cetak()}); operasi
 * domain lain ({@code generateParameter()}, {@code onKHS()}). Bagian lain dari kontrak tetap mengikuti kelas
		...
		for (KelompokParameterTambahanCatatanKelasSiswa kelompokParameterTambahanCatatanKelasSiswa : ja
			...
			for (ParameterTambahan parameterTambahan : parameterTambahans) {
				String jenis = LampiranLain.resolveJenisParameterTambahan(CatatanKelasSiswa.class,
						...
						kelompokParameterTambahanCatatanKelasSiswa.getId() + "->" + parameterTambahan.getId());
