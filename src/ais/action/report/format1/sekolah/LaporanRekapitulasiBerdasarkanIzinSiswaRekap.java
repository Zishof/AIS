...
/**
 * Penyusun/penyaji laporan untuk laporan rekapitulasi berdasarkan izin siswa rekap. Kelas ini
 ...
 * @see MyWindow
 */
public class LaporanRekapitulasiBerdasarkanIzinSiswaRekap extends MyWindow {
	...
	public LaporanRekapitulasiBerdasarkanIzinSiswaRekap() {
		super();
		try {
	...
	public LaporanRekapitulasiBerdasarkanIzinSiswaRekap(String title, String border, boolean closable)
			throws Exception {
	...
	private void init() throws Exception {
		...
		}, "Rekap_pengajuan_berdasrkan_siswa_rekap", null, new EventListener() {
	...
	public void onLaporan(Event event) throws Exception {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
					"Rekap_pengajuan_berdasrkan_siswa_rekap", ais.ui.util.WaktuUtil.getDate(), toolbar);
