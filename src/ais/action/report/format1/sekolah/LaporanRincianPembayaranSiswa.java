...
/**
 * Penyusun/penyaji laporan untuk laporan rincian pembayaran siswa. Kelas ini mengubah data domain
 ...
 * siswa}, {@code MyDatebox mulai}, {@code MyDatebox sampai}; inisialisasi/lifecycle ({@code init()}); operasi
 * domain lain ({@code generatePerItem()}, {@code generatePerItemVa()}, {@code generatePerItemRinci()}, {@code
 * generatePerItemRinciDetail()}, {@code generatePerItemRinciTagihan()}, {@code generatePerItemSummary()}).
