...
/**
 * Penyusun/penyaji laporan untuk laporan saldo siswa. Kelas ini mengubah data domain menjadi
 ...
 * @see MyWindow
 */
public class LaporanSaldoSiswa extends MyWindow {
	...
	public LaporanSaldoSiswa() throws Exception {
		super();
		init();
	}

	public LaporanSaldoSiswa(String title, String border, boolean closable) throws Exception {
	...
	private void init() throws Exception {
		...
		MyTabConfig tab1 = new MyTabConfig("Saldo Siswa");
		tab1.setParent(tabs);

		// MyTabConfig tab2 = new MyTabConfig("Saldo Siswa Rinci");
		// tab2.setParent(tabs);

		MyTabConfig tab3 = new MyTabConfig("Saldo Per Kelas");
		tab3.setVisible(selectedSiswa == null);
		tab3.setParent(tabs);
		//
		MyTabConfig tab4 = new MyTabConfig("Rekap Saldo");
		tab4.setVisible(selectedSiswa == null);
		tab4.setParent(tabs);
		...
		if (selectedSiswa == null) {
			tabpanel1.setAttribute("report", "sekolah/pembayaran/laporan_saldo_asli");
		} else {
			tabpanel1.setAttribute("report", "sekolah/pembayaran/laporan_saldo");
		}
		tabpanel1.setParent(tabpanels);
		tabpanel1.setHeight("100%");
		// tabpanel1 = new ais.ui.util.MyTabpanel();
		// tabpanel1.setVisible(selectedSiswa == null);
		// tabpanel1.setAttribute("report",
		// "sekolah/pembayaran/laporan_saldo_rinci");
		// tabpanel1.setParent(tabpanels);

		tabpanel1 = new ais.ui.util.MyTabpanel();
		tabpanel1.setVisible(selectedSiswa == null);
		tabpanel1.setAttribute("report", "sekolah/pembayaran/laporan_saldo_rekap");
		tabpanel1.setParent(tabpanels);
		tabpanel1.setHeight("100%");
		//
		tabpanel1 = new ais.ui.util.MyTabpanel();
		tabpanel1.setVisible(selectedSiswa == null);
		tabpanel1.setAttribute("report", "sekolah/pembayaran/laporan_saldo_rekap_plus_minus");
		tabpanel1.setParent(tabpanels);
		tabpanel1.setHeight("100%");
		...
		}, "sekolah/pembayaran/laporan_saldo", null, new EventListener() {
		...
		try {
			...
			if (Common.isMobile()) {
				File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
						"sekolah/pembayaran/laporan_saldo", ais.ui.util.WaktuUtil.getDate(), toolbar);
			...
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Saldo Siswa", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
