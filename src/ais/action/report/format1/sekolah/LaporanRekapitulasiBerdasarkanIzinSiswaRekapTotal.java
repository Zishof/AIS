...
/**
 * Penyusun/penyaji laporan untuk laporan rekapitulasi berdasarkan izin siswa rekap total. Kelas
 * ini mengubah data domain menjadi bentuk laporan yang dipakai UI, ekspor, atau proses cetak tanpa
 ...
 * sekolah}, {@code Intbox angkatan}, {@code Combobox searchasrama}, {@code Center center}, {@code Toolbar
 * toolbar}, {@code AmbilDataSiswaBanbox searchsiswa}, {@code MyDatebox mulai}; inisialisasi/lifecycle ({@code
 * init()}); operasi domain lain ({@code generateParameter()}, {@code onLaporan()}); konfigurasi constructor:
 * {@code sekolah}, {@code yayasan}. Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang
 * disebut di atas.</p>
 ...
 * @see MyWindow
 */
public class LaporanRekapitulasiBerdasarkanIzinSiswaRekapTotal extends MyWindow {
	...
	public LaporanRekapitulasiBerdasarkanIzinSiswaRekapTotal() {
		super();
		try {
	...
	public LaporanRekapitulasiBerdasarkanIzinSiswaRekapTotal(String title, String border, boolean closable)
			throws Exception {
	...
	private void init() throws Exception {
		...
		}, "Rekap_pengajuan_berdasrkan_siswa_rekap_total", null, new EventListener() {
	...
	public void onLaporan(Event event) throws Exception {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
					"Rekap_pengajuan_berdasrkan_siswa_rekap_total", ais.ui.util.WaktuUtil.getDate(),
					toolbar);
