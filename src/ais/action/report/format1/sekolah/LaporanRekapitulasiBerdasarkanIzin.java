...
/**
 * Penyusun/penyaji laporan untuk laporan rekapitulasi berdasarkan izin. Kelas ini mengubah data
...
public class LaporanRekapitulasiBerdasarkanIzin extends MyWindow {
	...
	private void init() throws Exception {
		...
		}, "Rekap_pengajuan_siswa", null, new EventListener() {
	...
	public void onLaporan(Event event) throws Exception {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "Rekap_pengajuan_siswa",
