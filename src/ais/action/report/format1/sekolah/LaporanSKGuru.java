...
/**
 * Penyusun/penyaji laporan untuk laporan sk guru. Kelas ini mengubah data domain menjadi bentuk
 ...
 * tahunAkademikUjianAkhirSemester}, {@code Combobox genapGanjilUjianAkhirSemester}, {@code MyDatebox tanggal},
 * {@code AmbilDataGuruBanbox guru}, {@code Combobox searchTahap}, {@code SimpleDateFormat dateFormat}, {@code
 * Combobox yayasan}, {@code Combobox sekolah}; inisialisasi/lifecycle ({@code initDaftarHadirGuru()}, {@code
 * init()}); operasi domain lain ({@code generateParameter()}, {@code onDaftarHadirGuruSemua()}). Bagian lain
