...
/**
 * Penyusun/penyaji laporan untuk laporan jadwal pelajaran. Kelas ini mengubah data domain menjadi
 ...
 * {@code Textbox cari}, {@code MyGrid grid}, {@code Map map}, {@code MyDatebox tanggal}, {@code Combobox
 ...
 * ({@code generateParameter()}, {@code masukkanData()}). Bagian lain dari kontrak tetap mengikuti kelas induk
...
public class LaporanJadwalPelajaran extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link LaporanJadwalPelajaran}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LaporanJadwalPelajaran} dan dapat mengakses
