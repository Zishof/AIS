...
/**
 * Penyusun/penyaji laporan untuk laporan bukti pembelian anggota koperasi window. Kelas ini
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code AmbilDataPembelianAnggotaKoperasiBanbox
 * pembelianAnggotaKoperasi}, {@code Center center}, {@code PembelianAnggotaKoperasi mPembelianAnggotaKoperasi},
 * {@code Toolbar toolbar}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code
 * onCetakStatusPasien()}); operasi domain lain ({@code generateParameter()}, {@code dataPembelian()}). Bagian
