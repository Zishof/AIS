...
/**
 * Penyusun/penyaji laporan untuk laporan item gaji pegawai. Kelas ini mengubah data domain menjadi
 ...
 * toolbar}, {@code FormatItemGaji formatGaji}, {@code ItemGajiPegawaiTreeModel itemGajiPegawaiTreeModel}, {@code
 * Combobox bulan}, {@code Combobox tahun}, {@code Pegawai pegawai}; inisialisasi/lifecycle ({@code init()});
 * pembacaan/pencarian ({@code getStrings()}); pelaporan/ekspor ({@code onReport()}); operasi domain lain ({@code
 * generateParameter()}, {@code generateParameter()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
