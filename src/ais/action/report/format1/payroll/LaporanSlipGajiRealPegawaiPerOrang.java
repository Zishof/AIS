...
/**
 * Penyusun/penyaji laporan untuk laporan slip gaji real pegawai per orang. Kelas ini mengubah data
 ...
 * pegawai}, {@code Integer nilaiBulan}, {@code Combobox pilihFormat}; inisialisasi/lifecycle ({@code initKHS()},
 * {@code init()}); operasi domain lain ({@code generateParameter()}, {@code generateDataDanImageAlbum()}, {@code
