...
/**
 * Penyusun/penyaji laporan untuk laporan uang makan pegawai. Kelas ini mengubah data domain
 ...
 * searchparent}, {@code Combobox bulan}, {@code Center center}, {@code Toolbar toolbar}, {@code Combobox tahun},
 * {@code Pegawai pegawai}, {@code Combobox jenisTenagaKependidikan}, {@code Combobox statusKepegawaian};
 * inisialisasi/lifecycle ({@code initKHS()}, {@code init()}); operasi domain lain ({@code generateParameter()},
 * {@code onKHS()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di
 * atas.</p>
 ...
 * @see MyWindow
 */
public class LaporanUangMakanPegawai extends MyWindow {
	...
	public LaporanUangMakanPegawai() {
		super();
		try {
			initKHS();
			init();
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Uang Makan Pegawai", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanUangMakanPegawai(Pegawai pegawai) {
		super();
	...
	public LaporanUangMakanPegawai(String title, String border, boolean closable) throws Exception {
	...
	private void init() throws Exception {
		...
		}, "payroll/Rekapitulasi_Uang_Makan_Report", null, new EventListener() {
	...
	private Map generateParameter() throws Exception {
		...
		} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/report/format1/payroll/LaporanUangMakanPegawai.java:286");
	...
	// ItemGajiPegawaiTreeModel itemGajiPegawaiTreeModel = new
	// ItemGajiPegawaiTreeModel(false,
	// pegawai.getFormatItemGaji(), pegawai);
	// itemGajiPegawaiTreeModel.populateData(list, calendar.getTime(), bulan,
	// tahun);
	// return list;
	// }
	...
	public void onKHS(Event event) throws Exception {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
					"payroll/Rekapitulasi_Uang_Makan_Report", ais.ui.util.WaktuUtil.getDate(), toolbar);

			CommonReport.tampilkanReportPDF(center, file);

		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Uang Makan Pegawai", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
