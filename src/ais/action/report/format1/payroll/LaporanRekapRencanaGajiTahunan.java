...
/**
 * Penyusun/penyaji laporan untuk laporan rekap rencana gaji tahunan. Kelas ini mengubah data
 ...
 * searchnama}, {@code Intbox tahun}, {@code AmbilDataSatuanKerjaBanbox searchparent}, {@code
 * SatuanKerjaTreeModel satuanKerjaTreeModel}, {@code Center center}, {@code MyToolbarbuttonConfig printAmbil},
 * {@code List datas}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code onCetak()}). Bagian lain
