...
/**
 * Penyusun/penyaji laporan untuk laporan cuti absen. Kelas ini mengubah data domain menjadi bentuk
 ...
 * {@code MyCheckboxConfig haris}, {@code Center center}, {@code Toolbar toolbar}, {@code Combobox tahun}, {@code
 * Pegawai pegawai}, {@code AmbilDataSatuanKerjaBanbox searchSatker}, {@code MyCheckboxConfig hanyaDosen};
 * inisialisasi/lifecycle ({@code initKHS()}, {@code init()}); operasi domain lain ({@code generateParameter()},
 * {@code generateDataDanImageAlbum()}, {@code onKHS()}). Bagian lain dari kontrak tetap mengikuti kelas induk
