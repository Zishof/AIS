...
/**
 * Penyusun/penyaji laporan untuk laporan rekap pembayaran gaji per satuan kerja. Kelas ini
 ...
 * @see MyWindow
 */
public class LaporanRekapPembayaranGajiPerSatuanKerja extends MyWindow {
	...
	public LaporanRekapPembayaranGajiPerSatuanKerja() throws Exception {
		super();
		init();
	}

	public LaporanRekapPembayaranGajiPerSatuanKerja(String title, String border, boolean closable) throws Exception {
			...
			new Thread(new Runnable() {
				...
				public void run() {
					...
					for (PembayaranGajiPunyaPegawai pembayaranGajiPunyaPegawai : pembayaranGajiPunyaPegawais) {
								...
								if (itemGaji != null) {
									...
									if (!blmMasukGrup.contains(kode)) {
										...
										try {
											...
											e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/format1/payroll/LaporanRekapPembayaranGajiPerSatuanKerja.java:363");
						...
						} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/report/format1/payroll/LaporanRekapPembayaranGajiPerSatuanKerja.java:368");
					...
					for (PembayaranGajiPunyaPegawai pembayaranGajiPunyaPegawai : pembayaranGajiPunyaPegawais) {
						...
						String n = (pembayaranGajiPunyaPegawai.getPegawai().getSatuanKerja() == null ? "Tanpa Unit"
								: pembayaranGajiPunyaPegawai.getPegawai().getSatuanKerja().getNama()) + " bulan "
						...
						if (currentCaraPembayaranGaji == null || !currentCaraPembayaranGaji.equals(n)) {
							...
							} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/report/format1/payroll/LaporanRekapPembayaranGajiPerSatuanKerja.java:466");
								// TODO: handle exception
							}
						...
						try {
							...
							sub.add(pegawai.getBank() == null ? "" : pegawai.getBank().getNama());
							sub.add(pegawai.getNorek());
							sub.add(pegawai.getDitransferAtasNama());
