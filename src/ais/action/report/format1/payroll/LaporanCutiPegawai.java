...
/**
 * Penyusun/penyaji laporan untuk laporan cuti pegawai. Kelas ini mengubah data domain menjadi
 ...
 * toolbar}, {@code List maps}, {@code AmbilDataPegawaiBanbox searchparent}, {@code AmbilDataSatuanKerjaBanbox
 * searchSatker}, {@code MyCheckboxConfig hanyaDosen}, {@code Combobox tahun}, {@code MyCheckboxConfig
 * hanyaPegawai}; inisialisasi/lifecycle ({@code init()}); operasi domain lain ({@code generateParameter()},
 * {@code generateDataDanImageAlbum()}, {@code generateCutiDanIzinParameter()}, {@code onKHS()}). Bagian lain
