...
/**
 * Penyusun/penyaji laporan untuk laporan absensi pegawai per pegawai. Kelas ini mengubah data
 ...
 * @see MyWindow
 */
public class LaporanAbsensiPegawaiPerPegawai extends MyWindow {
	...
	public LaporanAbsensiPegawaiPerPegawai() {
		super();
		try {
			initKHS();
			init();
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Absensi Pegawai Per Pegawai", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	public LaporanAbsensiPegawaiPerPegawai(Pegawai pegawai) {
		super();
	...
	public LaporanAbsensiPegawaiPerPegawai(String title, String border, boolean closable) throws Exception {
	...
	private void init() throws Exception {
		...
		} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/report/format1/payroll/LaporanAbsensiPegawaiPerPegawai.java:210");
			PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Absensi Pegawai Per Pegawai", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
				new String[] {
		...
		}, "LPresensi2", null, new EventListener() {
	...
	public void generateDataDanImageAlbum(final Label label) throws Exception {
		...
		// 1. MANAJEMEN SESSION KETAT (Mencegah Kebocoran Memori)
		try {
			...
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/format1/payroll/LaporanAbsensiPegawaiPerPegawai.java:394");
			throw e;
		} finally {
		...
		// 2. PRE-PROCESSING O(1) MEMORY MAP
		if (cbData == null)
		...
		// 3. EKSEKUSI MULTI-THREAD TERKONTROL
		try {
			...
			public void execute(final Integer idx) throws Exception {
				...
				if (label != null && desktop != null) {
					if (currentCount % 5 == 0 || currentCount == totalPegawai) {
						...
						} catch (Exception ex) { ais.common.ErrorAuditUtil.record(ex, "auto-audit(empty-catch) src/ais/action/report/format1/payroll/LaporanAbsensiPegawaiPerPegawai.java:465");
						}
					}
				}
				...
				try {
					...
					// AMANKAN PARAMETER GLOBAL JASPER
					if (parameters != null) {
					...
					long tidakAbsenPulang = 0L, jumlahHariEfektif = 0L, tepatWaktu = 0L, tepatWaktuBanget = 0L;
					long terlambat = 0L, pulangcepat = 0L, aktif = 0L, tidakHadir = 0L, tidakHadirTanpaHoliday = 0L;
					long tidak_hadir = 0L, cuti_memotong = 0L, jumlahTerlambatTotal = 0L, jumlahCepatKeluarTotal = 0L;
					...
					while (cDaily.getTime().before(sDaily.getTime())) {
						...
						// Memajukan kalender sebelum perintah continue
						...
						for (String ss : d) {
							...
							} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/report/format1/payroll/LaporanAbsensiPegawaiPerPegawai.java:767");
								PesanFormalHelper.tampilkanGagalException("pemrosesan Laporan Absensi Pegawai Per Pegawai", "Sistem mengalami kendala teknis saat memproses permintaan pada layar laporan ini, kemungkinan disebabkan oleh data yang tidak lengkap, parameter/filter yang tidak sesuai, atau gangguan sementara pada sistem.", e,
									new String[] {
										"Periksa kembali data/parameter/filter yang Bapak/Ibu masukkan pada layar ini.",
										"Ulangi kembali proses yang tadi dijalankan beberapa saat lagi.",
					...
					for (Object o : ConstantValues.ambilBerdasarClass(Statusabsensi.class).values()) {
						...
						} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/report/format1/payroll/LaporanAbsensiPegawaiPerPegawai.java:827");
						}
					}
	...
	public void onKHS(Event event) throws Exception {
		...
		final Label label = Common.displayLoadBar(new EventListener() {
			...
			@Override
			public void onEvent(Event arg0) throws Exception {
				File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(), "LPresensi2",
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/report/format1/payroll/LaporanAbsensiPegawaiPerPegawai.java:916");
					PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Absensi Pegawai Per Pegawai", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
						new String[] {
