...
/**
 * Penyusun/penyaji laporan untuk laporan stok item. Kelas ini mengubah data domain menjadi bentuk
 ...
 * perpustakaan}, {@code MyDatebox mulai}, {@code Center center}, {@code Toolbar toolbar}, {@code Perpustakaan
 * myperpustakaan}, {@code Item item}, {@code MyDatebox sampai}; inisialisasi/lifecycle ({@code init()});
 * pelaporan/ekspor ({@code onReport()}); operasi domain lain ({@code generateParameter()}, {@code
 * namaTemplateLaporanJsp()}, {@code generateParameterJsp()}, {@code generateParameterDariRequestJsp()});
 * konfigurasi constructor: {@code myperpustakaan}. Bagian lain dari kontrak tetap mengikuti kelas induk atau
