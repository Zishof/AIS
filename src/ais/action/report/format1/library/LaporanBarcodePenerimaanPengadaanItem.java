...
/**
 * Penyusun/penyaji laporan untuk laporan barcode penerimaan pengadaan item. Kelas ini mengubah
 ...
 * toolbar}, {@code PenerimaanPengadaanItem penerimaanPengadaanItem}; inisialisasi/lifecycle ({@code init()});
 ...
 * @see MyWindow
 */
public class LaporanBarcodePenerimaanPengadaanItem extends MyWindow {
	...
	public LaporanBarcodePenerimaanPengadaanItem(PenerimaanPengadaanItem penerimaanPengadaanItem) {
		super();
		...
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Barcode Penerimaan Pengadaan Item", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	private Map generateParameter() throws Exception {
		...
		for (PenerimaanPengadaanItemDetail penerimaanPengadaanItemDetail : penerimaanPengadaanItemDetails) {
			List<ItemPunyaBarcode> itemPunyaBarcodes = session.createCriteria(ItemPunyaBarcode.class)
					...
					.add(Restrictions.eq("item", penerimaanPengadaanItemDetail.getItem())).add(Restrictions
							.eq("batchItemPunyaBarcode", penerimaanPengadaanItemDetail.getBatchItemPunyaBarcode()))
					.list();
	...
	public void onReport(Event event) {
		...
		try {
			...
			Common.tampilErrorJikaAdmin(e); 
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Barcode Penerimaan Pengadaan Item", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
