...
/**
 * Penyusun/penyaji laporan untuk laporan kartu anggota. Kelas ini mengubah data domain menjadi
 ...
 * toolbar}, {@code Paging paging}, {@code Textbox cari}, {@code MyCheckboxConfig depan}, {@code MyCheckboxConfig
 * belakang}, {@code MyGrid grid}, {@code Map map}; inisialisasi/lifecycle ({@code init()}, {@code
...
public class LaporanKartuAnggota extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link LaporanKartuAnggota}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LaporanKartuAnggota} dan dapat mengakses state
