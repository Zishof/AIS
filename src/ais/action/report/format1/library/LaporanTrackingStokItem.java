...
/**
 * Penyusun/penyaji laporan untuk laporan tracking stok item. Kelas ini mengubah data domain
 ...
 * toolbar}, {@code ArrayList selectedItems}, {@code Perpustakaan myperpustakaan}, {@code Item item};
 * inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code onReport()}); operasi domain lain ({@code
 * generateParameter()}); konfigurasi constructor: {@code myperpustakaan}. Bagian lain dari kontrak tetap
