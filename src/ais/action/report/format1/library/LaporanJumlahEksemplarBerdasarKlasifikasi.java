...
/**
 * Penyusun/penyaji laporan untuk laporan jumlah eksemplar berdasar klasifikasi. Kelas ini mengubah
 ...
 * perpustakaan}, {@code Center center}, {@code Toolbar toolbar}, {@code Textbox isbn}, {@code Textbox judul},
 * {@code Textbox klasifikasi}; inisialisasi/lifecycle ({@code init()}); pelaporan/ekspor ({@code onReport()});
 ...
 * @see MyWindow
 */
public class LaporanJumlahEksemplarBerdasarKlasifikasi extends MyWindow {
	...
	public LaporanJumlahEksemplarBerdasarKlasifikasi() {
		super();
		try {
			init();
		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Jumlah Eksemplar Berdasar Klasifikasi", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	private void init() throws Exception {
		...
		}, "library/jumlah_eksemplar_per_clasfikasi", null, new EventListener() {
	...
	public void onReport(Event event) {
		...
		try {
			...
			File file = Report.generateFileReportWithProgress(Report.PDF, generateParameter(),
					"library/jumlah_eksemplar_per_clasfikasi", ais.ui.util.WaktuUtil.getDate(), toolbar);
			CommonReport.tampilkanReportPDF(center, file);

		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e);
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Jumlah Eksemplar Berdasar Klasifikasi", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
