...
/**
 * Penyusun/penyaji laporan untuk laporan barcode semua saldo awal. Kelas ini mengubah data domain
 ...
 * @see MyWindow
 */
public class LaporanBarcodeSemuaSaldoAwal extends MyWindow {
	...
	public LaporanBarcodeSemuaSaldoAwal() {
		super();
		...
		try {
			...
			PesanFormalHelper.tampilkanGagalException("pemuatan data awal layar Laporan Barcode Semua Saldo Awal", "Sistem mengalami kendala teknis saat memuat data awal untuk layar laporan ini, kemungkinan karena data referensi (mis. periode, program studi/unit, atau parameter filter terkait) belum lengkap, atau terjadi gangguan sementara pada koneksi ke basis data.", e,
					new String[] {
	...
	private Map generateParameter() throws Exception {
		...
		List<SaldoAwalDetail> saldoAwalDetails = session.createCriteria(SaldoAwalDetail.class)
				...
				.add(Restrictions.isNotNull("saldoAwal.disetujuiOleh"))
				.add(Restrictions.isNotNull("saldoAwal.tanggalPersetujuan"))
	...
	public void onReport(Event event) {
		...
		try {
			...
			Common.tampilErrorJikaAdmin(e); 
			PesanFormalHelper.tampilkanGagalException("pembuatan berkas PDF Laporan Barcode Semua Saldo Awal", "Sistem mengalami kendala teknis saat menyusun berkas PDF laporan ini, kemungkinan karena salah satu data sumber laporan tidak lengkap, format datanya tidak sesuai dengan yang diharapkan oleh template laporan, atau terjadi gangguan sementara pada proses pembuatan berkas.", e,
					new String[] {
