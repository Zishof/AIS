...
/**
 * Tipe khusus untuk ambil data referensi lulusan banyak. Kelas ini memberi nama dan batas tanggung
 ...
 * referensiLulusans}, {@code List referensiLulusansHanyaDitampilkan}, {@code MyTextbox nama}, {@code Set ids},
 * {@code MyTextbox keterangan}; pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()},
 * {@code getEventListener()}); operasi domain lain ({@code display()}). Bagian lain dari kontrak tetap mengikuti
...
public class AmbilDataReferensiLulusanBanyak extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataReferensiLulusanBanyak}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataReferensiLulusanBanyak} dan dapat
	 ...
	 *
	 * @see AmbilDataReferensiLulusanBanyak
	 */
