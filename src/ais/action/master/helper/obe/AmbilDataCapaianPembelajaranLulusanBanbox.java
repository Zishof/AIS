 ...
 * @see Bandbox
 */
public class AmbilDataCapaianPembelajaranLulusanBanbox extends Bandbox implements GetEventListener {
	...
	class CapaianPembelajaranLulusanRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(Row arg0, Object arg1) throws Exception {
			...
			// checkbox.setId(capaianPembelajaranLulusan.getId() + "");

			checkbox.addEventListener("onCheck", new EventListener() {
				@Override
				public void onEvent(Event event) throws Exception {
					AmbilDataCapaianPembelajaranLulusanBanbox.this.setOpen(false);
					AmbilDataCapaianPembelajaranLulusanBanbox.this.setAttribute("capaianPembelajaranLulusan",
							capaianPembelajaranLulusan);
					AmbilDataCapaianPembelajaranLulusanBanbox.this.setValue(
							capaianPembelajaranLulusan.getKode() + "-" + capaianPembelajaranLulusan.getNama());
	...
	public void onSearchDefault(Event event) {
		...
		List<CapaianPembelajaranLulusan> capaianPembelajaranLulusan = session
				.createCriteria(CapaianPembelajaranLulusan.class).createAlias("jurusan", "jurusan")
		...
		System.out.println(capaianPembelajaranLulusan);
