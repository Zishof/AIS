...
/**
 * Tipe khusus untuk download nilai mahasiswa. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * searchprogram}, {@code Combobox searchkurikulum}, {@code Combobox searchsemester}, {@code Textbox
 * kodeMatakuliah}; inisialisasi/lifecycle ({@code init()}, {@code initSpreadsheet()}); operasi domain lain
...
public class DownloadNilaiMahasiswa extends MyWindow {
	...
	public DownloadNilaiMahasiswa() {
		...
		try {
			...
			/**
			 * Event listener lokal milik {@link DownloadNilaiMahasiswa}. Kelas ini menangani event untuk komponen induk
			 * dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
			 *
			 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DownloadNilaiMahasiswa} dan dapat mengakses
