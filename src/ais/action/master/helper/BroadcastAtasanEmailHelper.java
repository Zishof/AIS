 ...
 *
 * <p>
 * Kelas ini hanya penyusun teks (subjek + body HTML), TIDAK melakukan pengiriman apa pun sendiri.
 * Pemanggil satu-satunya di codebase saat ini adalah {@code MahasiswaAction}, yang memakai
 * {@link #buildSubject}/{@link #buildBody} lalu mengirim hasilnya langsung lewat
 * {@code ais.delivery.email.sender.MailSender.sendMailLampiranTagihan(...)} per atasan. Berbeda
 * dari {@link BroadcastHelper} (mesin broadcast email/WA umum untuk pengumuman akademik dan surat
 * masuk/keluar, dengan resolusi daftar penerima dan pengiriman massal sendiri), kelas ini TIDAK
 * dipanggil oleh dan tidak berbagi mesin pengiriman dengan {@link BroadcastHelper} — keduanya
 * independen; kesamaan nama "Broadcast" hanya menunjukkan keduanya sama-sama bagian dari fitur
 * pengiriman email massal AIS, bukan relasi pemanggilan.
 * </p>
 */
public class BroadcastAtasanEmailHelper {
    ...
    /** @return {@code s} apa adanya, atau string kosong bila {@code s} {@code null}; menjaga hasil gabungan teks tidak pernah menampilkan {@code "null"}. */
