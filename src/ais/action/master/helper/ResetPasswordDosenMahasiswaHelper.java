...
/**
 * Helper terfokus untuk reset password dosen mahasiswa. Tipe ini membungkus satu variasi kecil
 ...
 * {@code Mahasiswa mahasiswa}, {@code Tbmuser tbmuser}; inisialisasi/lifecycle ({@code doBeforeCompose()},
 * {@code doAfterCompose()}); pembacaan/pencarian ({@code onCari()}); mutasi data ({@code onReset()}). Bagian
