...
public class PengecualianPklMahasiswaHelper implements DataLoader {
	...
	class PengecualianPklMahasiswaRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(final Row arg0, Object arg1) throws Exception {arg0.setValign("top");
			...
			final PengecualianPklMahasiswa pengecualianPklMahasiswa = (PengecualianPklMahasiswa) arg1;

			Mahasiswa mahasiswa = pengecualianPklMahasiswa.getMahasiswa();
			...
			final MyTextbox keterangan = new MyTextbox(pengecualianPklMahasiswa.getKeterangan());
			...
			keterangan.addEventListener("onChange", new EventListener() {
				...
				public void onEvent(Event arg0) throws Exception {
					...
					pengecualianPklMahasiswa.setKeterangan(keterangan.getValue());
					Common.refreshSaveOrUpdate(session, pengecualianPklMahasiswa);
				}
			});
						...
						public void onEvent(Event event) throws Exception {
							...
							if (i == MyMessageboxConfig.OK) {
								try {
									...
									Common.refreshDelete(session, pengecualianPklMahasiswa);

									loadData(null);
								} catch (Exception e) {
									Common.tampilErrorJikaAdmin(e);
									PesanFormalHelper.tampilkanGagalException(
											"menghapus data pengecualian PKL mahasiswa",
											e,
											new String[] {
													"Periksa apakah data ini masih berelasi dengan data lain (misalnya data kelompok atau penilaian PKL) sehingga tidak dapat dihapus.",
	...
	public void loadData(Object value) {
		...
		List<PengecualianPklMahasiswa> mahasiswa = session.createCriteria(PengecualianPklMahasiswa.class)
				.add(Restrictions.eq("pkl", pkl)).addOrder(Order.desc("id")).createCriteria("mahasiswa")
		...
		grid.setRowRenderer(new PengecualianPklMahasiswaRenderer());
					...
					public void onEvent(Event arg0) throws Exception {
						...
						if (mahasiswas != null) {
							...
							for (Mahasiswa mahasiswa : mahasiswas) {
								PengecualianPklMahasiswa pengecualianPklMahasiswa = new PengecualianPklMahasiswa();
								pengecualianPklMahasiswa.setMahasiswa(mahasiswa);
								pengecualianPklMahasiswa.setPkl(pkl);
								pengecualianPklMahasiswa.setKeterangan("");

								session.save(pengecualianPklMahasiswa);
							}
