 ...
 * {@link ais.database.model.JadwalSeminarTugasAkhir} — lihat {@link ais.ui.util.GetEventListener}
 * untuk arsitektur kerangka umum (constructor/display/onSearchDefault/renderer/callback).
 * {@code JadwalSeminarTugasAkhir} adalah entity JADWAL (bukan entity master biasa): satu baris
 * mewakili satu periode/jadwal penyelenggaraan seminar tugas akhir (nama, rentang tanggal
 * mulai-sampai, tahun akademik, serta jurusan/fakultas pemilik jadwal).
 *
 * <p>
 ...
 * manajemen data jadwal): constructor {@link #AmbilJadwalSeminarTugasAkhirBanbox(Jurusan)} dapat
 ...
 * {@link JadwalSeminarTugasAkhirAction#onAddExternal} / {@code onDelete}, sehingga Bandbox ini
...
public class AmbilJadwalSeminarTugasAkhirBanbox extends Bandbox implements GetEventListener {
	...
	/**
	 * Membangun Bandbox tanpa pembatasan jurusan — semua jadwal seminar tugas akhir dapat dicari.
	 */
	 ...
	 * {@code JadwalSeminarTugasAkhir} terpilih disimpan sebagai attribute {@code
	 * "jadwalSeminarTugasAkhir"}/{@code "myValue"} pada Bandbox, teks tampilan diisi nama jadwal,
	 * lalu {@link #eventListener} (bila terpasang) diberi tahu. Tombol ubah membuka layar edit lewat
	 * {@link JadwalSeminarTugasAkhirAction#onAddExternal}, lalu memperbarui pilihan Bandbox dengan
	 * hasil edit. Tombol hapus meminta konfirmasi, memanggil
	 * {@link JadwalSeminarTugasAkhirAction#onDelete}, mengosongkan pilihan Bandbox bila jadwal yang
	...
	/**
	 * Membangun popup pencarian jadwal seminar tugas akhir (form filter nama/tahun akademik/
	 * fakultas/prodi + tombol "Cari" + grid hasil paging client-side dibungkus
	 * {@link org.zkoss.zul.Radiogroup}), termasuk tombol "Tambah Jadwal" pada toolbar bila hak
	 * {@code edit} dimiliki, lalu memanggil {@link #onSearchDefault(Event)} agar grid terisi.
	...
	/**
	 * Menjalankan {@code Session.createCriteria(JadwalSeminarTugasAkhir.class)} dengan filter tahun
	 ...
	 * {@link JadwalSeminarTugasAkhirRenderer}.
	 *
