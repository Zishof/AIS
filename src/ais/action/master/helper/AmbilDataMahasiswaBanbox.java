...
/**
 * Tipe khusus untuk ambil data mahasiswa banbox. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * AmbilDataPagingHelper pagingHelper}, {@code EventListener eventListener}, {@code Boolean hanyaYangAktif},
 * {@code List indsMhsPerkuliahan}, {@code PerguruanTinggi perguruanTinggi}, {@code Boolean hanyaAlumni}, {@code
 * boolean tidakMelihatDosen}; inisialisasi/lifecycle ({@code initCriteria()}); pembacaan/pencarian ({@code
...
public class AmbilDataMahasiswaBanbox extends Bandbox implements GetEventListener {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataMahasiswaBanbox}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataMahasiswaBanbox} dan dapat mengakses
