...
public class AmbilDataMahasiswaForKegiatanKemahasiswaanHelper {
	...
	public AmbilDataMahasiswaForKegiatanKemahasiswaanHelper(KegiatanKemahasiswaan kegiatanKemahasiswaan) {
		...
		/**
		 * Event listener lokal milik {@link AmbilDataMahasiswaForKegiatanKemahasiswaanHelper}. Kelas ini menangani
		 ...
		 * AmbilDataMahasiswaForKegiatanKemahasiswaanHelper} dan dapat mengakses state kelas induk. Jangan menyimpan
		 ...
		 *
		 * @see AmbilDataMahasiswaForKegiatanKemahasiswaanHelper
		 */
