...
public class AmbilDataMatakuliahKonversiHelper {
	...
	public void display(final Mahasiswa mahasiswa, final Integer semester, final String tahunAjaran,
		...
		/**
		 * Event listener lokal milik {@link AmbilDataMatakuliahKonversiHelper}. Kelas ini menangani event untuk
		 * komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataMatakuliahKonversiHelper} dan dapat
		 ...
		 *
		 * @see AmbilDataMatakuliahKonversiHelper
		 */
