...
/**
 * Tipe khusus untuk download tagihan mahasiswa bank bjb. Kelas ini memberi nama dan batas tanggung
 ...
 * Center center}, {@code Intbox searchangkatan}, {@code Combobox jenisPembayaran}, {@code Intbox searchbulan},
 * {@code Combobox searchTahunAjaran}, {@code Combobox searchJenisSemester}, {@code Textbox nims};
 * inisialisasi/lifecycle ({@code init()}, {@code initSpreadsheet()}); pembacaan/pencarian ({@code
 * downloadData()}, {@code downloadData()}); operasi domain lain ({@code createData()}). Bagian lain dari kontrak
