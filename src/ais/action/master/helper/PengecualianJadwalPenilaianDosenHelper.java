...
public class PengecualianJadwalPenilaianDosenHelper implements DataLoader {
	...
	class PengecualianJadwalPenilaianDosenRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(final Row arg0, Object arg1) throws Exception {
			...
			// new Label(pengecualianJadwalPenilaianDosen.getTahunAkademik())
			// .setParent(arg0);
			...
			// new Label(pengecualianJadwalPenilaianDosen.getJenisSemester())
			// .setParent(arg0);
			...
			// new Label(
			// pengecualianJadwalPenilaianDosen.getTanggalMulai() == null ? ""
			// : Common.dateFormat2
			// .get().format(pengecualianJadwalPenilaianDosen
			// .getTanggalMulai()))
			// .setParent(arg0);
					...
					public void onEvent(Event arg0) throws Exception {
						...
						if (dosens != null) {
							...
							for (Dosen dosen : dosens) {
								...
								pengecualianJadwalPenilaianDosen.setDosen(dosen);
