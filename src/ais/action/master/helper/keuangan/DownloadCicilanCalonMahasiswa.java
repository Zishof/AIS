...
/**
 * Tipe khusus untuk download cicilan calon mahasiswa. Kelas ini memberi nama dan batas tanggung
 ...
 * searchangkatansd}, {@code Combobox searchprogram}, {@code Combobox searchsemester}, {@code
 * AmbilDataItemBiayaBanbox itemBiaya}; inisialisasi/lifecycle ({@code init()}, {@code initSpreadsheet()});
 * operasi domain lain ({@code createData()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
