...
/**
 * Tipe khusus untuk ambil data pegawai banyak. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * eventListener}, {@code List pegawais}, {@code List pegawaisHanyaDitampilkan}, {@code Set ids}, {@code
 * SatuanKerja satker}, {@code MyTextbox kodePegawaian}, {@code MyTextbox nama}; pembacaan/pencarian ({@code
 * onSearchDefault()}, {@code setEventListener()}, {@code getEventListener()}); mutasi data ({@code setCabang()},
 * {@code setDepartemen()}, {@code setLevelJabatan()}); operasi domain lain ({@code display()}); konfigurasi
 * constructor: {@code searchparent}. Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang
 * disebut di atas.</p>
...
public class AmbilDataPegawaiBanyak extends Window {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataPegawaiBanyak}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataPegawaiBanyak} dan dapat mengakses
