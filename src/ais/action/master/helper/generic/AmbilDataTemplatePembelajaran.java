...
/**
 * Tipe khusus untuk ambil data template pembelajaran. Kelas ini memberi nama dan batas tanggung
 ...
 * eventListener}, {@code MyTextbox nama}, {@code Perkuliahan perkuliahan}, {@code KelompokKkn kelompokKkn},
 * {@code KelompokPkl kelompokPkl}, {@code MahasiswaRequestTugasAkhir mahasiswaRequestTugasAkhir}, {@code Skripsi
 * skripsi}; pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()}, {@code
 * getEventListener()}); operasi domain lain ({@code labelTemplatePembelajaran()}, {@code safeText()}, {@code
...
public class AmbilDataTemplatePembelajaran extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataTemplatePembelajaran}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataTemplatePembelajaran} dan dapat
	 ...
	 *
	 * @see AmbilDataTemplatePembelajaran
	 */
