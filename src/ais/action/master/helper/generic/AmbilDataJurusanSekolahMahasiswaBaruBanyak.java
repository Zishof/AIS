...
/**
 * Tipe khusus untuk ambil data jurusan sekolah mahasiswa baru banyak. Kelas ini memberi nama dan
 ...
 * jurusanSekolahMahasiswaBarus}, {@code List jurusanSekolahMahasiswaBarusHanyaDitampilkan}, {@code Set ids},
 * {@code MyTextbox nama}; pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()}, {@code
...
public class AmbilDataJurusanSekolahMahasiswaBaruBanyak extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataJurusanSekolahMahasiswaBaruBanyak}. Kelas ini
	 * menerjemahkan satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik
	 * kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataJurusanSekolahMahasiswaBaruBanyak}
	 ...
	 *
	 * @see AmbilDataJurusanSekolahMahasiswaBaruBanyak
	 */
