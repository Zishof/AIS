...
/**
 * Tipe khusus untuk ambil data donatur banyak. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * ais.ui.util.AmbilDataPagingHelper pagingHelper}, {@code EventListener eventListener}, {@code List donaturs},
 * {@code List donatursHanyaDitampilkan}, {@code MyTextbox nama}, {@code MyTextbox namagelombang}, {@code Set
 * ids}; pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()}, {@code getEventListener()});
...
public class AmbilDataDonaturBanyak extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataDonaturBanyak}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataDonaturBanyak} dan dapat mengakses
