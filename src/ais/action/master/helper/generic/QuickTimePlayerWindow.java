...
/**
 * Tipe khusus untuk quick time player window. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal: {@code url}; operasi lokal: {@code display}().
