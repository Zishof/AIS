...
/**
 * Tipe khusus untuk ambil data tbmuser banyak. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * ais.ui.util.AmbilDataPagingHelper pagingHelper}, {@code EventListener eventListener}, {@code List tbmusers},
 * {@code List tbmusersHanyaDitampilkan}, {@code Set ids}, {@code Tbmrole bukanRole}, {@code Boolean
 * sekaliClick}; pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()}, {@code
...
public class AmbilDataTbmuserBanyak extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataTbmuserBanyak}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataTbmuserBanyak} dan dapat mengakses
