...
/**
 * Tipe khusus untuk ambil data artikel banyak. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * ais.ui.util.AmbilDataPagingHelper pagingHelper}, {@code EventListener eventListener}, {@code List artikels},
 * {@code List artikelsHanyaDitampilkan}, {@code Set ids}, {@code MyTextbox kodeArtikelan}, {@code MyTextbox
 * judul}; pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()}, {@code
...
public class AmbilDataArtikelBanyak extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataArtikelBanyak}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataArtikelBanyak} dan dapat mengakses
