...
/**
 * Tipe khusus untuk ambil data calon siswa banyak. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * calonSiswas}, {@code List calonSiswasHanyaDitampilkan}, {@code Set ids}, {@code MyTextbox nama}, {@code
 * MyTextbox searchnoreg}; pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()}, {@code
...
public class AmbilDataCalonSiswaBanyak extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataCalonSiswaBanyak}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataCalonSiswaBanyak} dan dapat mengakses
