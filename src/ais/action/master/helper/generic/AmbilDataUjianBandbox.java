...
/**
 * Tipe khusus untuk ambil data ujian bandbox. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * {@code Combobox searchjenis}, {@code String jenis}, {@code Combobox searchlevel}, {@code MyTextbox
 * keterangan}; inisialisasi/lifecycle ({@code initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()},
...
public class AmbilDataUjianBandbox extends Bandbox {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataUjianBandbox}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataUjianBandbox} dan dapat mengakses
