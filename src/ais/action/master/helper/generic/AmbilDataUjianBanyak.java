...
/**
 * Tipe khusus untuk ambil data ujian banyak. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * ais.ui.util.AmbilDataPagingHelper pagingHelper}, {@code EventListener eventListener}, {@code List ujians},
 * {@code List ujiansHanyaDitampilkan}, {@code MyTextbox nama}, {@code Combobox searchfakultas}, {@code Combobox
 * searchjurusan}; inisialisasi/lifecycle ({@code initCriteria()}); pembacaan/pencarian ({@code
...
public class AmbilDataUjianBanyak extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataUjianBanyak}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataUjianBanyak} dan dapat mengakses
