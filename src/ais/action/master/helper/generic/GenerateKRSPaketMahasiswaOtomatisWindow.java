...
/**
 * Tipe khusus untuk generate krs paket mahasiswa otomatis window. Kelas ini memberi nama dan batas
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code PaketPerkuliahan paketPerkuliahan},
 * {@code Intbox nimMulai}, {@code Intbox nimSampai}, {@code Textbox kelas}, {@code Intbox semester}; mutasi data
 * ({@code save()}); operasi domain lain ({@code display()}, {@code onGenerate()}). Bagian lain dari kontrak
