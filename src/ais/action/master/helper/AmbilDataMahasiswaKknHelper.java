...
public class AmbilDataMahasiswaKknHelper {
	...
	/** KKN tujuan pendaftaran calon peserta, ditetapkan di {@link #display(Kkn, DataLoader, MyWindow)}. */
	private Kkn kkn;
	...
	class MahasiswaRenderer extends ais.ui.util.MyRowRenderer {
		...
		/** DAO {@link MahasiswaDapatKkn} dipakai untuk memperoleh {@link #session} Hibernate aktif. */
		private MahasiswaDapatKknDao mahasiswaDapatKknDao = DaoFactory.getInstance().getMahasiswaDapatKknDao();

		/** Sesi Hibernate aktif, dipakai untuk mengecek status pendaftaran tiap kandidat mahasiswa. */
		 ...
		 * (tercentang bila mahasiswa sudah terdaftar sebagai calon peserta {@link #kkn} ini), NIM,
		 * nama, dan tahun angkatan.
		 */
		@Override
