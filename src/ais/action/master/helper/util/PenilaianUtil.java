...
/**
 * Tipe khusus untuk penilaian util. Kelas ini memberi nama dan batas tanggung jawab yang eksplisit
 * pada perilaku yang diwarisi atau kontrak yang diimplementasikannya.
 *
 * <p><b>Batas tanggung jawab:</b> gunakan tipe ini hanya untuk state dan operasi yang sesuai dengan nama
 * domainnya. Logika lintas domain harus didelegasikan ke service atau helper bersama supaya tidak muncul
 * implementasi paralel dengan hasil berbeda.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah pembacaan/pencarian ({@code downloadPenilaianKonversi()}, {@code
 * downloadSemuaKRS()}, {@code downloadSemuaKRS()}, {@code downloadPenilaian()}, {@code
 * uploadPenilaianKonversi()}, {@code uploadPenilaian()}); operasi domain lain ({@code pindahkanSemuaKRS()},
 * {@code bacaNilaiSel()}, {@code normalisasiNamaKolom()}). Bagian lain dari kontrak tetap mengikuti kelas induk
