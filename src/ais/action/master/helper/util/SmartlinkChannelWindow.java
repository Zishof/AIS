...
/**
 * Tipe khusus untuk smartlink channel window. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code String WAKTU_15_MENIT}, {@code String
 * WAKTU_30_MENIT}, {@code String WAKTU_1_JAM}, {@code String WAKTU_3_JAM}, {@code String WAKTU_6_JAM}, {@code
 * String WAKTU_24_JAM}, {@code String WAKTU_3_HARI}, {@code String WAKTU_1_MINGGU}; inisialisasi/lifecycle
 * ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code init()}, {@code init()}); operasi
 * domain lain ({@code parseEntriKanal()}, {@code isiRadioKanal()}). Bagian lain dari kontrak tetap mengikuti
