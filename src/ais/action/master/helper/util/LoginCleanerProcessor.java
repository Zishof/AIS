...
/**
 * Tipe khusus untuk login cleaner processor. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code long jam}, {@code String localIp};
 * operasi domain lain ({@code run()}, {@code doProcess()}); konfigurasi constructor: {@code localIp}, {@code
 * thisIp}. Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di atas.</p>
