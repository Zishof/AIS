	...
	public void display(final OrganisasiDosen organisasiDosen, final Component component, final MyWindow window) {
		...
		EventListener dataAdding = new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				...
				/**
				 * Helper implementasi bersarang milik {@link OrganisasiDosenPunyaDosenHelper} untuk data adding helper. Kelas
				 * ini mengemas langkah lokal yang dipakai kelas induk dan bukan service domain alternatif.
				 *
				 * <p><b>Scope:</b> setiap instance terikat pada instance {@link OrganisasiDosenPunyaDosenHelper} dan dapat
				 ...
				 *
				 * @see OrganisasiDosenPunyaDosenHelper
				 */
