...
public class ProgramMahasiswaDetailAction extends MyDetail implements DataCriteria {
	...
	public ProgramMahasiswaDetailAction(Program program) {
		...
		this.addEventListener(Events.ON_OPEN, new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				Common.clear(ProgramMahasiswaDetailAction.this);
				if (isOpen()) {
					display();
				}
			}
	...
	class MahasiswaRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(final Row arg0, Object data) throws Exception {
			...
			button.setVisible(mahasiswa.getProgram() != null);
	...
	public void loadData(Object value) {
		...
		List<Mahasiswa> mahasiswas = ConstantValues.simpleList(initCriteria(true).setMaxResults(Common.MAX_RESULT_1000),
				Mahasiswa.class);
	...
	public void display() {
		...
		groupbox.appendChild(new MyCaptionStyled("Daftar mahasiswa yang masuk kelompok " + program.getNama()));
							...
							public void onEvent(Event arg0) throws Exception {
								...
								if (mahasiswas != null) {
									...
									for (Mahasiswa mahasiswa : mahasiswas) {
										mahasiswa.setProgram(program.getNama());
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					e1.printStackTrace(); ais.common.ErrorAuditUtil.record(e1, "auto-audit src/ais/action/master/helper/ProgramMahasiswaDetailAction.java:446");
				}
