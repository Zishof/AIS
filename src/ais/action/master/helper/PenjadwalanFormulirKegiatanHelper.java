...
public class PenjadwalanFormulirKegiatanHelper {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PenjadwalanFormulirKegiatanHelper}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PenjadwalanFormulirKegiatanHelper} dan dapat
	 ...
	 *
	 * @see PenjadwalanFormulirKegiatanHelper
	 */
	class PertemuanRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(Row arg0, Object arg1) throws Exception {
			...
			} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/helper/PenjadwalanFormulirKegiatanHelper.java:107");
			...
			} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/helper/PenjadwalanFormulirKegiatanHelper.java:119");
									...
									if (i == MyMessageboxConfig.OK) {
										try {
											...
											PesanFormalHelper.tampilkanGagalException(
													"menghapus data penjadwalan formulir kegiatan",
													e,
													new String[] {
															"Periksa apakah data pertemuan ini masih berelasi dengan data lain (misalnya data peserta atau absensi) sehingga tidak dapat dihapus.",
	...
	public boolean save() throws InterruptedException {
		...
		formulirKegiatan.reInitPertemuan(session);
	...
	public void display(final FormulirKegiatan formulirKegiatan, final DataLoader dataLoader) {
		...
		window.setTitle(formulirKegiatan.infoSimple());
		...
		cari.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				Common.createDefaultTimer(new EventListener() {
					...
					@Override
					public void onEvent(Event arg0) throws Exception {
						formulirKegiatan.reInitPertemuan(HibernateUtil.currentSession());
		...
		// PenjadwalanHelper.tampilTombol(toolbar, null, formulirKegiatan, null,
		// null, null);
		PenjadwalanHelper.tampilTombolAmbil(toolbar, null, null, null, null, null, formulirKegiatan, null, null);

		PenjadwalanHelper.tampilTombolAturUlangWaktu(toolbar, null, null, null, null, null, null, formulirKegiatan,
		...
		PenjadwalanHelper.tampilTombolDownload(toolbar, contents, null, null, null, null, null, null, formulirKegiatan,
				null);

		PenjadwalanHelper.tampilTombolHapus(toolbar, null, null, null, null, null, null, formulirKegiatan, null,
				new EventListener() {
