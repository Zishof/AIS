...
/**
 * Controller/action ZK untuk biodata pegawai keluarga. Tipe ini merupakan titik masuk UI yang
 ...
 * @see MyWindow
 */
public class BiodataPegawaiKeluargaAction extends MyWindow {
	/**
	 * 
	 */
	...
	public BiodataPegawaiKeluargaAction() throws Exception {
		super();
		init(null);
	}

	public BiodataPegawaiKeluargaAction(SatuanKerja satuanKerjaOnSession) throws Exception {
		super();
		init(null);
	}

	public BiodataPegawaiKeluargaAction(String title, String border, boolean closable) throws Exception {
		super(title, border, closable);
		init(null);
	}

	public BiodataPegawaiKeluargaAction(String title, String border, boolean closable, SatuanKerja satuanKerjaOnSession)
			throws Exception {
		super(title, border, closable);
		init(null);
	}

	public BiodataPegawaiKeluargaAction(Pegawai pegawai) throws Exception {
		super();
		init(pegawai);
	}

	public BiodataPegawaiKeluargaAction(Pegawai pegawai, SatuanKerja satuanKerjaOnSession) throws Exception {
		super();
		init(pegawai);
	}

	public BiodataPegawaiKeluargaAction(Pegawai pegawai, SatuanKerja satuanKerjaOnSession, Boolean tampilLogin,
	...
	public BiodataPegawaiKeluargaAction(Pegawai pegawai, String title, String border, boolean closable)
			throws Exception {
		super(title, border, closable);
		init(pegawai);
	...
	private void init(final Pegawai pegawai) throws Exception {
		...
		if (pegawai == null) {
			PesanFormalHelper.tampilkanGagal("penampilan data biodata keluarga pegawai",
					"Sesi Bapak/Ibu saat ini tidak terhubung dengan data Pegawai. Halaman Riwayat Keluarga Pegawai "
							+ "hanya dapat diakses oleh pengguna yang login sebagai Pegawai, sedangkan akun yang "
							+ "sedang digunakan tidak memiliki data Pegawai yang terkait.",
					new String[] {
		...
		tabs.appendChild(tab2 = new MyTabConfig("Data Identitas"));
		KeluargaPegawaiHelper keluargaPegawaiHelper = new KeluargaPegawaiHelper(pegawai);
		...
		tab2.addEventListener(Events.ON_CLICK, new EventListener() {
			...
			@Override
			public void onEvent(Event event) throws Exception {
				RiwayatKartuIdentitasPegawaiHelper riwayatKartuIdentitasPegawaiHelper = new RiwayatKartuIdentitasPegawaiHelper(
						pegawai);
		...
		cancel.addEventListener("onClick", new EventListener() {
			@Override
			public void onEvent(Event event) throws Exception {
				BiodataPegawaiKeluargaAction.this.setVisible(false);
			}
		});
