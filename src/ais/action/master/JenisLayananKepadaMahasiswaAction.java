...
/**
 * Controller/action ZK untuk jenis layanan kepada mahasiswa. Tipe ini merupakan titik masuk UI
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaJenisLayananKepadaMahasiswa()}); mutasi data
...
public class JenisLayananKepadaMahasiswaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisLayananKepadaMahasiswaAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisLayananKepadaMahasiswaAction} dan dapat
	 ...
	 *
	 * @see JenisLayananKepadaMahasiswaAction
	 */
