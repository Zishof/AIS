...
/**
 * Controller/action ZK untuk label bahasa. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Textbox searchnamabahasa}, {@code
 * org.zkoss.zul.Combobox searchStatusTerjemah}, {@code Textbox nama}, {@code Textbox keterangan};
 ...
 * checkNamaLabelBahasa()}); mutasi data ({@code onResetKeDefault()}, {@code jalankanResetKeDefault()}, {@code
 * onSave()}); penghapusan/pembatalan ({@code onHapusTakBermakna()}, {@code mulaiHapusTakBermakna()}); operasi
 * domain lain ({@code terjemahUlangSatuBaris()}, {@code onAdd()}, {@code onTerjemahkanOtomatis()}, {@code
 * onTerjemahkanUlangAiSaja()}, {@code onTerjemahkanUlang()}, {@code mulaiTerjemahMassal()}). Bagian lain dari
...
public class LabelBahasaAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link LabelBahasaAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LabelBahasaAction} dan dapat mengakses state
