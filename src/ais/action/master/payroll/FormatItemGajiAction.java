...
/**
 * Controller/action ZK untuk format item gaji. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code Paging paging}, {@code MyTextbox searchnama}, {@code Combobox searchcabang}, {@code Combobox
 * searchdepartemen}, {@code Combobox searchlevelJabatan}, {@code AmbilDataSatuanKerjaBanbox searchparent};
 * inisialisasi/lifecycle ({@code doAfterCompose()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian
 * ({@code onSearchDefault()}); validasi/perhitungan ({@code checkNamaFormatItemGaji()}); mutasi data ({@code
...
public class FormatItemGajiAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link FormatItemGajiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link FormatItemGajiAction} dan dapat mengakses
