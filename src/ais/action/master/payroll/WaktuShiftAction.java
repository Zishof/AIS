...
/**
 * Controller/action ZK untuk waktu shift. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaWaktuShift()}); mutasi data ({@code onSave()});
...
public class WaktuShiftAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link WaktuShiftAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link WaktuShiftAction} dan dapat mengakses state
