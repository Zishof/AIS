...
/**
 * Controller/action ZK untuk libur nasional. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * {@code Paging paging}, {@code MyTextbox searchnama}, {@code Combobox searchtahun}, {@code MyTextbox nama},
 * {@code MyDatebox tanggal}, {@code MyTextbox keterangan}; inisialisasi/lifecycle ({@code doAfterCompose()},
 * {@code init()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()});
...
public class LiburNasionalAction extends GenericAutowireComposer implements DataInitDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link LiburNasionalAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LiburNasionalAction} dan dapat mengakses state
