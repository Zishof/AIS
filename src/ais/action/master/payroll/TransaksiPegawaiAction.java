...
/**
 * Controller/action ZK untuk transaksi pegawai. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code Paging paging}, {@code MyTextbox searchnama}, {@code AmbilDataPegawaiNotDefaultBanbox searchpegawai},
 * {@code Combobox searchJenisTransaksi}, {@code MyDatebox searchMulai}, {@code MyDatebox searchSampai};
 * inisialisasi/lifecycle ({@code doAfterCompose()}, {@code init()}, {@code init()}, {@code initCriteria()});
...
public class TransaksiPegawaiAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link TransaksiPegawaiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link TransaksiPegawaiAction} dan dapat mengakses
