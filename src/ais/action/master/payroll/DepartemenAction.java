...
/**
 * Controller/action ZK untuk departemen. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * validasi/perhitungan ({@code checkNamaDepartemen()}); mutasi data ({@code onSave()}); operasi domain lain
...
public class DepartemenAction extends GenericAutowireComposer implements DataInitDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link DepartemenAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DepartemenAction} dan dapat mengakses state
