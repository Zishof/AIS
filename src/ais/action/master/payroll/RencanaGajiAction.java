...
/**
 * Controller/action ZK untuk rencana gaji. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * {@code MyTextbox searchnama}, {@code MyWindow addWindow}, {@code RencanaGaji rencanaGaji}, {@code Intbox
 * thnByr}, {@code Textbox keterangan}, {@code boolean delete}; inisialisasi/lifecycle ({@code doAfterCompose()},
 * {@code initCriteria()}, {@code init()}); pembacaan/pencarian ({@code onSearchDefault()}); validasi/perhitungan
 * ({@code check()}); mutasi data ({@code onSave()}); operasi domain lain ({@code onAdd()}). Bagian lain dari
...
public class RencanaGajiAction extends GenericAutowireComposer implements DataInitDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link RencanaGajiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link RencanaGajiAction} dan dapat mengakses state
