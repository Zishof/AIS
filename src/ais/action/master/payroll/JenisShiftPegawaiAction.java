...
/**
 * Controller/action ZK untuk jenis shift pegawai. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code Paging paging}, {@code MyTextbox searchnama}, {@code Row hbFakultasLabel}, {@code Row hbYayasan},
 * {@code boolean pt}, {@code boolean ya}; inisialisasi/lifecycle ({@code doAfterCompose()}, {@code init()},
 * {@code initShiftDetail()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian ({@code
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaJenisShiftPegawai()}); mutasi data ({@code
...
//	private Rows rowsShift;
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisShiftPegawaiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisShiftPegawaiAction} dan dapat mengakses
