...
/**
 * Controller/action ZK untuk posting transaksi pegawai. Tipe ini merupakan titik masuk UI yang
 ...
 * searchnama}, {@code AmbilDataPegawaiNotDefaultBanbox searchpegawai}, {@code Combobox searchJenisTransaksi},
 * {@code MyDatebox searchMulai}, {@code MyDatebox searchSampai}, {@code boolean approve}, {@code boolean
 * delete}; inisialisasi/lifecycle ({@code doAfterCompose()}, {@code initCriteria()}); pembacaan/pencarian
 * ({@code onSearchDefaultTanpaProgress()}, {@code onSearchDefault()}, {@code loadDataDenganProgressPosting()});
 * mutasi data ({@code onBatalkanPostingSemua()}, {@code onPostingSemua()}, {@code postingSemua()}, {@code
 * batalkanPostingSemua()}); operasi domain lain ({@code kriteriaTransaksiPegawaiStatic()}). Bagian lain dari
...
public class PostingTransaksiPegawaiAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PostingTransaksiPegawaiAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PostingTransaksiPegawaiAction} dan dapat
	 ...
	 *
	 * @see PostingTransaksiPegawaiAction
	 */
