...
/**
 * Tipe khusus untuk ambil data format item gaji banbox. Kelas ini memberi nama dan batas tanggung
 ...
 * {@code Combobox searchcabang}, {@code Combobox searchdepartemen}, {@code Combobox searchlevelJabatan};
 * pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()}, {@code getEventListener()});
 * mutasi data ({@code setCabang()}, {@code setDepertemen()}, {@code setLevelJabatan()}); operasi domain lain
...
public class AmbilDataFormatItemGajiBanbox extends Bandbox {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataFormatItemGajiBanbox}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataFormatItemGajiBanbox} dan dapat
	 ...
	 *
	 * @see AmbilDataFormatItemGajiBanbox
	 */
