...
/**
 * Controller/action ZK untuk level jabatan punya pegawai. Tipe ini merupakan titik masuk UI yang
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code LevelJabatan levelJabatan}, {@code
 * Paging paging}, {@code MyGrid grid}, {@code MyTextbox kode}, {@code MyTextbox nama}; inisialisasi/lifecycle
 * ({@code initCriteria()}); pembacaan/pencarian ({@code loadData()}); operasi domain lain ({@code display()}).
...
public class LevelJabatanPunyaPegawaiAction extends MyDetail {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link LevelJabatanPunyaPegawaiAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LevelJabatanPunyaPegawaiAction} dan dapat
	 ...
	 *
	 * @see LevelJabatanPunyaPegawaiAction
	 */
