...
/**
 * Controller/action ZK untuk pembayaran gaji punya pegawai. Tipe ini merupakan titik masuk UI yang
 ...
 * Paging paging}, {@code MyGrid grid}, {@code boolean persetujuan}, {@code MyTextbox kode}, {@code MyTextbox
 * nama}; inisialisasi/lifecycle ({@code initCriteria()}); pembacaan/pencarian ({@code loadData()}); operasi
...
public class PembayaranGajiPunyaPegawaiAction extends MyDetail {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PembayaranGajiPunyaPegawaiAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PembayaranGajiPunyaPegawaiAction} dan dapat
	 ...
	 *
	 * @see PembayaranGajiPunyaPegawaiAction
	 */
