...
/**
 * Komponen dashboard khusus untuk dashboard s1. Kelas ini memilih variasi data atau tampilan
 ...
 * {@code TreeMap menus}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}). Bagian
