...
/**
 * Controller/action ZK untuk kategori penghargaan. Tipe ini merupakan titik masuk UI yang
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaKategoriPenghargaan()}); mutasi data ({@code
...
public class KategoriPenghargaanAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KategoriPenghargaanAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KategoriPenghargaanAction} dan dapat mengakses
