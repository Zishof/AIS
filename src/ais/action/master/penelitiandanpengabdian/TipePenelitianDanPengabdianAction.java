...
/**
 * Controller/action ZK untuk tipe penelitian dan pengabdian. Tipe ini merupakan titik masuk UI
...
public class TipePenelitianDanPengabdianAction extends GenericAutowireComposer implements DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link TipePenelitianDanPengabdianAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link TipePenelitianDanPengabdianAction} dan dapat
	 ...
	 *
	 * @see TipePenelitianDanPengabdianAction
	 */
