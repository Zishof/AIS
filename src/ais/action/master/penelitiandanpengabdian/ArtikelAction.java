...
/**
 * Controller/action ZK untuk artikel. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code DetailArtikelHelper
 * detailArtikelHelper}, {@code boolean edit}, {@code boolean delete}; pembacaan/pencarian ({@code
 * tampilkanKutipan()}); operasi domain lain ({@code generateCSLItemData()}); konfigurasi constructor: {@code
