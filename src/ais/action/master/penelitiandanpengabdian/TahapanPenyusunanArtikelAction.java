...
/**
 * Controller/action ZK untuk tahapan penyusunan artikel. Tipe ini merupakan titik masuk UI yang
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaTahapanPenyusunanArtikel()}); mutasi data ({@code
 * onSave()}); operasi domain lain ({@code isiDataDefault()}, {@code onAdd()}). Bagian lain dari kontrak tetap
...
public class TahapanPenyusunanArtikelAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link TahapanPenyusunanArtikelAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link TahapanPenyusunanArtikelAction} dan dapat
	 ...
	 *
	 * @see TahapanPenyusunanArtikelAction
	 */
