...
/**
 * Controller/action ZK untuk matakuliah prasyarat. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Textbox searchprasyarat}, {@code Checkbox
 * searchaktif}, {@code AmbilDataMatakuliahBanbox prasyarat}, {@code AmbilDataMatakuliahBanbox matakuliah};
 * inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code
 * initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}, {@code tampilPrasyarat()}); mutasi data
...
public class MatakuliahPrasyaratAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link MatakuliahPrasyaratAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link MatakuliahPrasyaratAction} dan dapat mengakses
