...
/**
 * Controller/action ZK untuk bukti pembayaran. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code MyDatebox searchmulai}, {@code MyDatebox searchsampai}, {@code Combobox searchJenisKegiatan};
 * inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code
 * initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}, {@code ambilBukti()}, {@code ambilBukti()});
 * mutasi data ({@code onSave()}); operasi domain lain ({@code onAddExternal()}, {@code onAdd()}, {@code
 * safeDateboxValue()}, {@code masukkanBukti()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
...
public class BuktiPembayaranAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link BuktiPembayaranAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link BuktiPembayaranAction} dan dapat mengakses
