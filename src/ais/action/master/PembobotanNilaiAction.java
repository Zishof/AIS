...
/**
 * Controller/action ZK untuk pembobotan nilai. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Textbox searchdibuat}, {@code
 * MyCheckboxConfig hanyaDibuatOlehAdmin}, {@code Checkbox searchaktif}, {@code MyDoublebox absen};
 ...
 * domain lain ({@code onStatusPertemuan()}, {@code onAddExternal()}, {@code onAdd()}, {@code nz()}). Bagian lain
...
public class PembobotanNilaiAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PembobotanNilaiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PembobotanNilaiAction} dan dapat mengakses
