...
/**
 * Controller/action ZK untuk penghargaan mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code AmbilDataMahasiswaBanbox searchmahasiswa},
 * {@code MyDatebox searchmulai}, {@code MyDatebox searchsampai}, {@code Combobox searchstatus};
 * inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code
 * initCriteria()}); pembacaan/pencarian ({@code getDspace()}, {@code getDspaceTipePenghargaanMahasiswa()},
 * {@code ambilTanggalValid()}, {@code onSearchDefault()}); mutasi data ({@code onSave()}); operasi domain lain
 * ({@code onKategoriPenghargaan()}, {@code onAdd()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
...
public class PenghargaanMahasiswaAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PenghargaanMahasiswaAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PenghargaanMahasiswaAction} dan dapat
	 ...
	 *
	 * @see PenghargaanMahasiswaAction
	 */
				...
				EventListener eventListener = new EventListener() {
					...
					public void onEvent(Event arg0) throws Exception {
						...
						if (aksiBoxRef[0] != null) {
							aksiBoxRef[0]
									.setVisible(!penghargaanMahasiswa.getStatus().equals(PenghargaanMahasiswa.DISETUJUI));
						}
