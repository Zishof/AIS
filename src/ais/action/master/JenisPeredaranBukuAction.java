...
/**
 * Controller/action ZK untuk jenis peredaran buku. Tipe ini merupakan titik masuk UI yang
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaJenisPeredaranBuku()}); mutasi data ({@code
...
public class JenisPeredaranBukuAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisPeredaranBukuAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisPeredaranBukuAction} dan dapat mengakses
