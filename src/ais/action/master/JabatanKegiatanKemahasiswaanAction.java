...
/**
 * Controller/action ZK untuk jabatan kegiatan kemahasiswaan. Tipe ini merupakan titik masuk UI
 ...
 * validasi/perhitungan ({@code checkNamaJabatanKegiatanKemahasiswaan()}); mutasi data ({@code onSave()});
...
public class JabatanKegiatanKemahasiswaanAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JabatanKegiatanKemahasiswaanAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JabatanKegiatanKemahasiswaanAction} dan dapat
	 ...
	 *
	 * @see JabatanKegiatanKemahasiswaanAction
	 */
