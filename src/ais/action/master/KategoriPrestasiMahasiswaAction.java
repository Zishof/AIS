...
/**
 * Controller/action ZK untuk kategori prestasi mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaKategoriPrestasiMahasiswa()}); mutasi data ({@code
...
public class KategoriPrestasiMahasiswaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KategoriPrestasiMahasiswaAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KategoriPrestasiMahasiswaAction} dan dapat
	 ...
	 *
	 * @see KategoriPrestasiMahasiswaAction
	 */
