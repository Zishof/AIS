...
/**
 * Controller/action ZK untuk judusium. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * {@code MyDoublebox nilaiMulai}, {@code MyDoublebox nilaiSampai}; inisialisasi/lifecycle ({@code
...
public class JudusiumAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JudusiumAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JudusiumAction} dan dapat mengakses state
