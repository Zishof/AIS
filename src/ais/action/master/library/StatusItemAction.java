...
/**
 * Controller/action ZK untuk status item. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * validasi/perhitungan ({@code checkNamaStatusItem()}); mutasi data ({@code onSave()}); operasi domain lain
...
public class StatusItemAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link StatusItemAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link StatusItemAction} dan dapat mengakses state
