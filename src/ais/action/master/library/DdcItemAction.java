...
/**
 * Controller/action ZK untuk ddc item. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * searchversi}, {@code MyCheckboxConfig aktif}, {@code Textbox kode}; inisialisasi/lifecycle ({@code
...
public class DdcItemAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link DdcItemAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DdcItemAction} dan dapat mengakses state kelas
