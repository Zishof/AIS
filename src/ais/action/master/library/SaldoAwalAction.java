...
/**
 * Controller/action ZK untuk saldo awal. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * grid}, {@code Paging paging}, {@code Textbox searchkode}, {@code Textbox searchbarcode}, {@code Textbox
 * searchjudul}, {@code AmbilDataPerpustakaanBanbox searchperpustakaan}, {@code MyTextbox kode};
...
public class SaldoAwalAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link SaldoAwalAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link SaldoAwalAction} dan dapat mengakses state
