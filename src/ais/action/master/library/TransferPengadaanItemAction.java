...
/**
 * Controller/action ZK untuk transfer pengadaan item. Tipe ini merupakan titik masuk UI yang
 ...
 * pelaporan/ekspor ({@code onCetak()}, {@code cetak()}); operasi domain lain ({@code onAdd()}). Bagian lain dari
...
public class TransferPengadaanItemAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link TransferPengadaanItemAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link TransferPengadaanItemAction} dan dapat
	 ...
	 *
	 * @see TransferPengadaanItemAction
	 */
