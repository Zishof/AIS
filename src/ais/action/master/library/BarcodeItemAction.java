...
/**
 * Controller/action ZK untuk barcode item. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchbahasa}, {@code Textbox searchisbn}, {@code Textbox
 * searchissn}, {@code Textbox searchnama}, {@code Textbox searchtema}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code initCriteria()}, {@code initCriteria()});
 * pembacaan/pencarian ({@code onSearchDefault()}, {@code onSearchDefault()}); validasi/perhitungan ({@code
 * check()}); mutasi data ({@code onSave()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface
...
public class BarcodeItemAction extends GenericAutowireComposer implements DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link BarcodeItemAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link BarcodeItemAction} dan dapat mengakses state
