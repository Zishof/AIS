...
/**
 * Controller/action ZK untuk jenis item. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * validasi/perhitungan ({@code checkNamaJenisItem()}); mutasi data ({@code onSave()}); operasi domain lain
...
public class JenisItemAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisItemAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisItemAction} dan dapat mengakses state
