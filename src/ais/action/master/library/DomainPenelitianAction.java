...
/**
 * Controller/action ZK untuk domain penelitian. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code AmbilDataDomainPenelitianBanbox
 * searchparent}, {@code AmbilDataPenerbitBanbox searchpenerbit}, {@code MyCheckboxConfig aktif}, {@code Textbox
 * nama}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code initDetail()},
...
public class DomainPenelitianAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link DomainPenelitianAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DomainPenelitianAction} dan dapat mengakses
