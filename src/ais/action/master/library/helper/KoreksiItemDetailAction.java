...
/**
 * Controller/action ZK untuk koreksi item detail. Tipe ini merupakan titik masuk UI yang
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code KoreksiItem koreksiItem}, {@code MyGrid
 * grid}, {@code List kodeTransaksis}, {@code Textbox barcode}; pembacaan/pencarian ({@code loadData()}, {@code
 * loadBarcode()}); operasi domain lain ({@code display()}). Bagian lain dari kontrak tetap mengikuti kelas induk
...
public class KoreksiItemDetailAction extends MyDetail {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KoreksiItemDetailAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KoreksiItemDetailAction} dan dapat mengakses
