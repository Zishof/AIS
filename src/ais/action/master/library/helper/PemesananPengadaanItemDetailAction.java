...
/**
 * Controller/action ZK untuk pemesanan pengadaan item detail. Tipe ini merupakan titik masuk UI
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code PemesananPengadaanItem
 * pemesananPengadaanItem}, {@code MyGrid grid}, {@code boolean edit}, {@code boolean delete}, {@code Paging
 * paging}, {@code Textbox barcode}, {@code Textbox cari}; inisialisasi/lifecycle ({@code initCriteria()});
 * pembacaan/pencarian ({@code loadData()}, {@code loadBarcode()}); operasi domain lain ({@code display()});
 * konfigurasi constructor: {@code delete}, {@code edit}, {@code paging}. Bagian lain dari kontrak tetap
...
public class PemesananPengadaanItemDetailAction extends MyDetail {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PemesananPengadaanItemDetailAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PemesananPengadaanItemDetailAction} dan dapat
	 ...
	 *
	 * @see PemesananPengadaanItemDetailAction
	 */
