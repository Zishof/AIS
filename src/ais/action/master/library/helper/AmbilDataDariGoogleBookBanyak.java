...
public class AmbilDataDariGoogleBookBanyak extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataDariGoogleBookBanyak}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataDariGoogleBookBanyak} dan dapat
	 ...
	 *
	 * @see AmbilDataDariGoogleBookBanyak
	 */
				...
				myButtonConfig.addEventListener("onClick", new EventListener() {
					...
					public void onEvent(Event arg0) throws Exception {
						if (Common.isMobile()) {
							...
							Clients.evalJavaScript("popupCenter({url: '" + Common.jsEscape(volumeInfo.getPreviewLink())
