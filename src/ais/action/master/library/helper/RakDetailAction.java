...
/**
 * Controller/action ZK untuk rak detail. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Rak rak}, {@code MyGrid grid}, {@code
 * boolean edit}, {@code boolean delete}, {@code Textbox barcode}, {@code Textbox kode}, {@code Textbox judul};
...
public class RakDetailAction extends MyDetail {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link RakDetailAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link RakDetailAction} dan dapat mengakses state
