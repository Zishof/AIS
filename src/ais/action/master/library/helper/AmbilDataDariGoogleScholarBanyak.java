...
/**
 * Tipe khusus untuk ambil data dari google scholar banyak. Kelas ini memberi nama dan batas
 ...
 * eventListener}, {@code JsonFactory jsonFactory}, {@code Set ids}, {@code List itemselected}, {@code String
 * katakunci}, {@code MyTextbox title}, {@code Paging paging}; inisialisasi/lifecycle ({@code initCriteria()});
...
public class AmbilDataDariGoogleScholarBanyak extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataDariGoogleScholarBanyak}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataDariGoogleScholarBanyak} dan dapat
	 ...
	 *
	 * @see AmbilDataDariGoogleScholarBanyak
	 */
