...
/**
 * Controller/action ZK untuk transfer pengadaan item detail. Tipe ini merupakan titik masuk UI
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code TransferPengadaanItem
 * transferPengadaanItem}, {@code MyGrid grid}, {@code boolean edit}, {@code boolean delete}, {@code Textbox
...
public class TransferPengadaanItemDetailAction extends MyDetail {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link TransferPengadaanItemDetailAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link TransferPengadaanItemDetailAction} dan dapat
	 ...
	 *
	 * @see TransferPengadaanItemDetailAction
	 */
