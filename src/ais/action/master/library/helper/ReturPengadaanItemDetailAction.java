...
/**
 * Controller/action ZK untuk retur pengadaan item detail. Tipe ini merupakan titik masuk UI yang
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code ReturPengadaanItem returPengadaanItem},
 * {@code MyGrid grid}, {@code boolean edit}, {@code boolean delete}; pembacaan/pencarian ({@code loadData()});
...
public class ReturPengadaanItemDetailAction extends MyDetail {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link ReturPengadaanItemDetailAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link ReturPengadaanItemDetailAction} dan dapat
	 ...
	 *
	 * @see ReturPengadaanItemDetailAction
	 */
