...
/**
 * Tipe khusus untuk ambil data item publish banyak. Kelas ini memberi nama dan batas tanggung
 ...
 * {@code List itemsHanyaDitampilkan}, {@code Set ids}, {@code SatuanKerjaTreeModel satuanKerjaTreeModel}, {@code
 * MyTextbox nama}; pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()}, {@code
...
public class AmbilDataItemPublishBanyak extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataItemPublishBanyak}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataItemPublishBanyak} dan dapat
	 ...
	 *
	 * @see AmbilDataItemPublishBanyak
	 */
