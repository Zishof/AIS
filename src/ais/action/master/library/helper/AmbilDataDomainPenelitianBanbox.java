...
/**
 * Tipe khusus untuk ambil data domain penelitian banbox. Kelas ini memberi nama dan batas tanggung
 ...
 * eventListener}, {@code DomainPenelitianTreeModel domainPenelitianTreeModel}, {@code Boolean chooseAll}, {@code
 * Penerbit penerbit}, {@code boolean hasDisplayed}; pembacaan/pencarian ({@code onSearchDefault()}, {@code
 * setEventListener()}, {@code getEventListener()}); mutasi data ({@code setChooseAll()}, {@code setPenerbit()});
 * operasi domain lain ({@code display()}); konfigurasi constructor: {@code domainPenelitianTreeModel}. Bagian
 ...
 * @see Bandbox
 */
public class AmbilDataDomainPenelitianBanbox extends Bandbox implements
		GetEventListener {
	...
	protected DomainPenelitianTreeModel domainPenelitianTreeModel;

	private Boolean chooseAll = false;
	private Penerbit penerbit;
	private boolean hasDisplayed = false;

	public AmbilDataDomainPenelitianBanbox() throws Exception {
		this(true);
	}

	public AmbilDataDomainPenelitianBanbox(Boolean chooseAll) throws Exception {
		super();
		domainPenelitianTreeModel = new DomainPenelitianTreeModel(false, null);
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataDomainPenelitianBanbox}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataDomainPenelitianBanbox} dan dapat
	 ...
	 *
	 * @see AmbilDataDomainPenelitianBanbox
	 */
	class DomainPenelitianTreeRenderer extends ais.ui.util.MyTreeitemRenderer {
		...
		public void render(final Treeitem treeitem, Object arg1) {
			...
			try {
				...
				new Label(domainPenelitian.toString()).setParent(arg0);
				...
				checkbox.setVisible(chooseAll
						|| domainPenelitianTreeModel
								.getChildCount(domainPenelitian) == 0);
				checkbox.setParent(arg0);arg0.setAttribute("checkbox", checkbox);
				checkbox.setAttribute("domainPenelitian", domainPenelitian);

				checkbox.addEventListener("onCheck", new EventListener() {
					@Override
					public void onEvent(Event event) throws Exception {
						AmbilDataDomainPenelitianBanbox.this.setOpen(false);
						AmbilDataDomainPenelitianBanbox.this.setAttribute(
								"domainPenelitian", domainPenelitian);
						AmbilDataDomainPenelitianBanbox.this
								.setValue(domainPenelitian.toString());
						...
						Long count = (Long) session
								...
								.add(Restrictions.idEq(domainPenelitian.getId()))
								.uniqueResult();
						count = count == null ? 0L : count;
						domainPenelitian.setJmlDipakai(++count);
						Common.refreshUpdate(session,(domainPenelitian));
	...
	public void display(Radiogroup radiogroup) throws Exception {
		...
		column = new Treecol();
		column.setParent(columns);
		column.setLabel("Penerbit / Instansi");
		...
		tabpanelUtama.setParent(tabpanels);
		tabpanelUtama.appendChild(new DomainPenelitianSeringDipakai());
	...
	public void onSearchDefault(Event event) throws Exception {
		...
		try {
			...
			tree.setItemRenderer(new DomainPenelitianTreeRenderer());
		} catch (Exception e) {
			Common.tampilErrorJikaAdmin(e); 
		}
	}
	...
	public void setPenerbit(Penerbit penerbit) throws Exception {
		this.penerbit = penerbit;
		if (penerbit != null) {
			setValue("");
			setAttribute("domainPenelitian", null);
			// Common.clear(this);
			domainPenelitianTreeModel = new DomainPenelitianTreeModel(false,
					penerbit);
			onSearchDefault(null);
			// display();
		}
	...
	/**
	 * Tipe implementasi bersarang {@link DomainPenelitianSeringDipakai} milik {@link
	 * AmbilDataDomainPenelitianBanbox}. Kelas ini memberi nama pada state atau perilaku lokal agar tanggung
	 ...
	 * @see AmbilDataDomainPenelitianBanbox
	 */
	private class DomainPenelitianSeringDipakai extends Borderlayout {
	...
	private final ais.ui.util.AmbilDataPagingHelper pagingHelper = new ais.ui.util.AmbilDataPagingHelper();
		public DomainPenelitianSeringDipakai() throws Exception {
			super();
			display();
		}
		...
		/**
		 * Renderer lokal untuk layar/komponen {@link DomainPenelitianSeringDipakai}. Kelas ini menerjemahkan satu item
		 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DomainPenelitianSeringDipakai} dan dapat
		 * mengakses state kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
		 * <p>Kontrak yang tampak dari deklarasi ini meliputi operasi lokal: {@code render}(). Aturan bisnis bersama
		 * tetap berada pada kelas induk atau service yang dipanggilnya.</p>
		 * <p><b>Efek samping:</b> operasi dapat mengubah komponen ZK dan memanggil alur kelas induk. Jalankan pada
		 ...
		 * renderer/listener ini.</p>
		 *
		 * @see DomainPenelitianSeringDipakai
		 */
		class DomainPenelitianRenderer extends ais.ui.util.MyRowRenderer {
			...
			public void render(Row arg0, Object arg1) throws Exception {arg0.setValign("top");
				...
				new Label(domainPenelitian.getNama()).setParent(arg0);
		...
		public void onSearchDefault(Event event) throws Exception {
			...
			ListModel strset = new SimpleListModel(domainPenelitians);
