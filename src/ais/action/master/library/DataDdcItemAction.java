...
/**
 * Controller/action ZK untuk data ddc item. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * grid}, {@code Paging paging}, {@code Textbox searchddc}, {@code MyTextbox keterangan}, {@code
 * AmbilDataDdcItemBanbox ddcItem}, {@code boolean edit}, {@code boolean delete}; inisialisasi/lifecycle ({@code
...
public class DataDdcItemAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link DataDdcItemAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DataDdcItemAction} dan dapat mengakses state
