...
/**
 * Controller/action ZK untuk anggota yang diblokir. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code AmbilDataPerpustakaanBanbox
 * searchperpustakaan}, {@code AmbilDataAnggotaBanbox searchanggota}, {@code MyDatebox mulai}, {@code MyDatebox
 * sampai}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code
 * initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}); mutasi data ({@code onSave()});
 * pelaporan/ekspor ({@code onCetak()}); operasi domain lain ({@code onAdd()}). Bagian lain dari kontrak tetap
...
public class AnggotaYangDiblokirAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AnggotaYangDiblokirAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AnggotaYangDiblokirAction} dan dapat mengakses
