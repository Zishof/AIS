...
/**
 * Tipe khusus untuk online book explorer. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Iframe iframe}, {@code Tree tree},
 * {@code OnlineBookTreeModel onlineBookTreeModel}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code
 * doAfterCompose()}, {@code init()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang
 * disebut di atas.</p>
