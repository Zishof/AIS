...
/**
 * Controller/action ZK untuk kunjungan anggota. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code AmbilDataPerpustakaanBanbox searchperpustakaan}, {@code
 * AmbilDataAnggotaBanbox searchanggota}, {@code MyDatebox tanggal}, {@code AmbilDataAnggotaBanbox anggota},
 * {@code Textbox nama}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code
 * init()}, {@code initCriteria()}); pembacaan/pencarian ({@code getPerpustakaanKunjunganDariFilter()}, {@code
 * getPerpustakaanKunjunganDariForm()}, {@code onSearchDefault()}); mutasi data ({@code onSave()}); operasi
 * domain lain ({@code onAdd()}, {@code onKodeAnggota()}). Bagian lain dari kontrak tetap mengikuti kelas induk
...
public class KunjunganAnggotaAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KunjunganAnggotaAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KunjunganAnggotaAction} dan dapat mengakses
