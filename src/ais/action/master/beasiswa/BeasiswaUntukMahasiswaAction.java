...
/**
 * Controller/action ZK untuk beasiswa untuk mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code MyWindow daftar_beasiswa_window},
 * {@code Paging paging}, {@code MyGrid grid}, {@code Mahasiswa mahasiswa}, {@code Toolbar toolbarData}, {@code
 * Boolean memenuhiSyarat}, {@code EventListener eventListener}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code initCriteria()}, {@code init()}); pembacaan/pencarian
 * ({@code onSearchDefault()}, {@code tampilkanPersyaratan()}, {@code tampilkanPersyaratan()}); operasi domain
 * lain ({@code daftar()}, {@code onAddExternal()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
...
public class BeasiswaUntukMahasiswaAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link BeasiswaUntukMahasiswaAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link BeasiswaUntukMahasiswaAction} dan dapat
	 ...
	 *
	 * @see BeasiswaUntukMahasiswaAction
	 */
