...
/**
 * Controller/action ZK untuk cimb request. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * {@code Textbox searchtrxId}, {@code Textbox searchnim}, {@code Combobox tahunAkademik}, {@code
 * MyToolbarbuttonConfig find}, {@code MyDatebox searchmulai}, {@code MyDatebox searchsampai};
...
public class CimbRequestAction extends GenericAutowireComposer implements DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link CimbRequestAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link CimbRequestAction} dan dapat mengakses state
