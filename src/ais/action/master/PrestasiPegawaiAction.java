...
/**
 * Controller/action ZK untuk prestasi pegawai. Tipe ini merupakan titik masuk UI yang
 ...
 * AmbilDataPegawaiBanbox searchpegawai}, {@code MyDatebox searchmulai}, {@code MyDatebox searchsampai};
 ...
 * domain lain ({@code onDasbor()}, {@code onKategoriPrestasiPegawai()}, {@code onCabangPrestasiPegawai()},
 * {@code onRekapCabang()}, {@code onRekapKategori()}, {@code onAdd()}). Bagian lain dari kontrak tetap mengikuti
...
public class PrestasiPegawaiAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PrestasiPegawaiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PrestasiPegawaiAction} dan dapat mengakses
