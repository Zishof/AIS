...
/**
 * Controller/action ZK untuk pelanggaran mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * searchfakultas}, {@code Combobox searchjurusan}, {@code Textbox keterangan}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code init()}, {@code initCriteria()});
 * pembacaan/pencarian ({@code checkDanTampil()}, {@code loadHukuman()}, {@code loadPelanggaran()}, {@code
 * onSearchDefault()}); mutasi data ({@code onSave()}); operasi domain lain ({@code info()}, {@code onDasbor()},
...
public class PelanggaranMahasiswaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PelanggaranMahasiswaAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PelanggaranMahasiswaAction} dan dapat
	 ...
	 *
	 * @see PelanggaranMahasiswaAction
	 */
