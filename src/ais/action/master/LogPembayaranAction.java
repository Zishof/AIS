...
/**
 * Controller/action ZK untuk log pembayaran. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * searchnama}, {@code Combobox searchfakultas}, {@code Combobox jenissemester}, {@code Combobox searchjurusan};
...
public class LogPembayaranAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link LogPembayaranAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LogPembayaranAction} dan dapat mengakses state
