...
/**
 * Controller/action ZK untuk checklist penilaian oleh dosen. Tipe ini merupakan titik masuk UI
 ...
 * paging}, {@code MyGrid grid}, {@code South south}, {@code Dosen dosen}, {@code boolean masukan_hasuk_diisi};
 ...
 * onIsiAngketDosenSelesai()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut
 * di atas.</p>
...
public class ChecklistPenilaianOlehDosenAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link ChecklistPenilaianOlehDosenAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link ChecklistPenilaianOlehDosenAction} dan dapat
	 ...
	 *
	 * @see ChecklistPenilaianOlehDosenAction
	 */
