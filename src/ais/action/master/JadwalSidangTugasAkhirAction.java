...
/**
 * Controller/action ZK untuk jadwal sidang tugas akhir. Tipe ini merupakan titik masuk UI yang
 ...
 * ({@code doAfterCompose()}, {@code initJadwal()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian
 * ({@code onSearchDefault()}); mutasi data ({@code onSave()}); penghapusan/pembatalan ({@code onDelete()});
 * operasi domain lain ({@code onAddExternal()}, {@code onAdd()}, {@code formatTanggalJadwal()}). Bagian lain
...
public class JadwalSidangTugasAkhirAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JadwalSidangTugasAkhirAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JadwalSidangTugasAkhirAction} dan dapat
	 ...
	 *
	 * @see JadwalSidangTugasAkhirAction
	 */
