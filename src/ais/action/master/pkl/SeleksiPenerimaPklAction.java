...
/**
 * Controller/action ZK untuk seleksi penerima pkl. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code boolean approve}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code
 * initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}). Bagian lain dari kontrak tetap mengikuti
...
public class SeleksiPenerimaPklAction extends GenericAutowireComposer implements DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link SeleksiPenerimaPklAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link SeleksiPenerimaPklAction} dan dapat mengakses
	 * state kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi state utama: {@code PendaftarPklHelper
	 * pendaftarPklHelper}, {@code java.util.Map petaInfo}; operasi lokal: {@code render}(). Aturan bisnis bersama
	 * tetap berada pada kelas induk atau service yang dipanggilnya.</p>
	 * <p><b>Efek samping:</b> operasi dapat mengubah komponen ZK dan memanggil alur kelas induk. Jalankan pada
	 * event thread dengan konteks pengguna/session aktif; jangan menyalin query atau validasi domain ke
	 * renderer/listener ini.</p>
	 *
	 * @see SeleksiPenerimaPklAction
	 */
