...
/**
 * Controller/action ZK untuk kelompok pkl. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * searchpkl}, {@code AmbilDataDosenBanbox searchdosen1}, {@code AmbilDataMahasiswaBanbox searchmahasiswa};
 ...
 * onSearchDefault()}, {@code getDspacePkl()}, {@code getDspace()}); mutasi data ({@code onSave()});
...
public class KelompokPklAction extends GenericAutowireComposer implements DataSearchDefault, DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KelompokPklAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KelompokPklAction} dan dapat mengakses state
