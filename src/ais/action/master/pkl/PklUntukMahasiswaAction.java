...
/**
 * Controller/action ZK untuk pkl untuk mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code MyWindow daftar_pkl_window}, {@code
 * Paging paging}, {@code MyGrid grid}, {@code Mahasiswa mahasiswa}, {@code Tabpanel pkl}, {@code Boolean
 ...
 * onSearchDefault()}, {@code tampilkanPersyaratan()}); operasi domain lain ({@code onPKL()}, {@code daftar()},
...
public class PklUntukMahasiswaAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PklUntukMahasiswaAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PklUntukMahasiswaAction} dan dapat mengakses
