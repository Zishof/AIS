...
/**
 * Controller/action ZK untuk persyaratan pkl. Tipe ini merupakan titik masuk UI yang menghubungkan
...
public class PersyaratanPklAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PersyaratanPklAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PersyaratanPklAction} dan dapat mengakses
