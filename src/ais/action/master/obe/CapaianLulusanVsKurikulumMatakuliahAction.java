...
/**
 * Controller/action ZK untuk capaian lulusan vs kurikulum matakuliah. Tipe ini merupakan titik
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Center center}, {@code java.util.List
 * loadedCpl}, {@code java.util.List loadedKpm}, {@code PerguruanTinggi perguruanTinggi}, {@code Textbox nama},
 * {@code Textbox nama1}, {@code AmbilDataKurikulumBanbox searchkurikulum}; inisialisasi/lifecycle ({@code
 * init()}); operasi domain lain ({@code onKHS()}, {@code showMatriks()}, {@code createTransferAdapter()}, {@code
 * esc()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di atas.</p>
