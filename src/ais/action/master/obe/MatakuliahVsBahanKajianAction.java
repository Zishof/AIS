...
/**
 * Controller/action ZK untuk matakuliah vs bahan kajian. Tipe ini merupakan titik masuk UI yang
 ...
 * jurusan}, {@code Center center}, {@code java.util.List loadedMk}, {@code java.util.List loadedBk}, {@code
 * PerguruanTinggi perguruanTinggi}, {@code Textbox nama}, {@code Textbox nama1}; inisialisasi/lifecycle ({@code
 * initKHS()}, {@code init()}); operasi domain lain ({@code onKHS()}, {@code createTransferAdapter()}). Bagian
