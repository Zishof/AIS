...
/**
 * Controller/action ZK untuk matakuliah vs kurikulum. Tipe ini merupakan titik masuk UI yang
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code AmbilDataKurikulumBanbox
 * searchkurikulum}, {@code Center center}, {@code Textbox nama}, {@code Bandbox semester};
 * inisialisasi/lifecycle ({@code init()}); pembacaan/pencarian ({@code ambilJumlahSemester()}, {@code
 * ambilKurikulumDefault()}, {@code tampilkanInfoAwal()}); operasi domain lain ({@code bangunPopupSemester()},
 * {@code tambahPilihanSemester()}, {@code onKHS()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
...
public class MatakuliahVsKurikulumAction extends MyWindow {
	...
	private void init() throws Exception {
		...
		Div obeNorth = ObePageHelpHelper.pasangPadaNorth(west, "Mata Kuliah dalam Kurikulum",
				"Masukkan mata kuliah ke kurikulum dan tentukan semester penempatannya. Gunakan filter kurikulum sebelum menambah atau mengubah data.");
