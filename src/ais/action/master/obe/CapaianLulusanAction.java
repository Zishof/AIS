...
/**
 * Controller/action ZK untuk capaian lulusan. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * {@code Textbox keterangan}, {@code Combobox fakultas}, {@code Combobox jurusan}, {@code Combobox cbKategori},
 * {@code AmbilDataMatakuliahBanbox khususBuatMk}, {@code HashMap selectedProfilLulusan}; inisialisasi/lifecycle
 * ({@code doAfterCompose()}, {@code init()}, {@code initForm()}, {@code initCriteria()}); pembacaan/pencarian
 * ({@code loadCheckboxes()}, {@code onSearchDefault()}); mutasi data ({@code onSave()}); operasi domain lain
 * ({@code onProfil()}, {@code onBahanKajian()}, {@code onCpmk()}, {@code bangunButtonTabboxUtama()}, {@code
 * siapkanPanelRelasi()}, {@code tambahPenjelasanTab()}). Bagian lain dari kontrak tetap mengikuti kelas induk
...
public class CapaianLulusanAction extends ObeBaseAction {
    ...
    /**
     * Renderer lokal untuk layar/komponen {@link CapaianLulusanAction}. Kelas ini menerjemahkan satu item data
     * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
     *
     * <p><b>Scope:</b> setiap instance terikat pada instance {@link CapaianLulusanAction} dan dapat mengakses
