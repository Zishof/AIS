...
/**
 * Controller/action ZK untuk bahan kajian vs capaian lulusan vs matakuliah. Tipe ini merupakan
 ...
 * jurusan}, {@code Center center}, {@code PerguruanTinggi perguruanTinggi}, {@code Textbox nama}, {@code Textbox
 * nama1}; inisialisasi/lifecycle ({@code initKHS()}, {@code init()}); operasi domain lain ({@code onKHS()}).
