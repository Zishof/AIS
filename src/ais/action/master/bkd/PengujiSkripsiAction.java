...
/**
 * Controller/action ZK untuk penguji skripsi. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * {@code AmbilDataDosenBanbox searchdosen}, {@code Combobox searchprogram}, {@code Combobox searchfakultas},
 * {@code Combobox searchjurusan}, {@code Dosen dosenTerpilih}, {@code AktifitasSkripsiHelper
 * aktifitasSkripsiHelper}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code
 * initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}); operasi domain lain ({@code displayRow()},
 * {@code displayRow()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di
 * atas.</p>
...
public class PengujiSkripsiAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PengujiSkripsiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PengujiSkripsiAction} dan dapat mengakses
