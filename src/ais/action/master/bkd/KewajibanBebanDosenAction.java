...
/**
 * Controller/action ZK untuk kewajiban beban dosen. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Combobox searchstatus}, {@code Combobox statusKewajibanBebanDosen},
 * {@code MyDoublebox minimalSks}, {@code MyDoublebox minimalSksPendidikan}, {@code MyDoublebox
 * minimalSksPenelitian}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code
...
public class KewajibanBebanDosenAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KewajibanBebanDosenAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KewajibanBebanDosenAction} dan dapat mengakses
