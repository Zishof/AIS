...
/**
 * Controller/action ZK untuk asesor penunjang kinerja dosen. Tipe ini merupakan titik masuk UI
 ...
 * searchfakultas}, {@code Combobox searchjurusan}, {@code Textbox kode}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian
 * ({@code onSearchDefault()}); validasi/perhitungan ({@code checkKodeAsesorPenunjangKinerjaDosen()}, {@code
...
//	
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AsesorPenunjangKinerjaDosenAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AsesorPenunjangKinerjaDosenAction} dan dapat
	 ...
	 *
	 * @see AsesorPenunjangKinerjaDosenAction
	 */
