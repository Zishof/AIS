...
/**
 * Controller/action ZK untuk assesor. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code AsesorPenunjangKinerjaDosen
 * asesorPenunjangKinerjaDosen}, {@code MyGrid grid}, {@code boolean edit}, {@code boolean add}, {@code boolean
 * delete}, {@code MyCheckboxConfig hanyaYgAktif}; pembacaan/pencarian ({@code loadData()}, {@code
 * onSearchDefault()}); operasi domain lain ({@code display()}); konfigurasi constructor: {@code add}, {@code
...
public class AssesorAction extends MyDetail implements DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AssesorAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AssesorAction} dan dapat mengakses state kelas
