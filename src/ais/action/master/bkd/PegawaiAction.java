 ...
 * {@code Textbox searchcode}, {@code Textbox searchnama}, {@code Combobox searchstatus}, {@code Checkbox
 * searchbukanDosen}, {@code Checkbox searchaktif}, {@code boolean edit}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code initCriteria()}, {@code initCriteria()});
 * pembacaan/pencarian ({@code onLoadData()}, {@code onSearchDefault()}). Bagian lain dari kontrak tetap
