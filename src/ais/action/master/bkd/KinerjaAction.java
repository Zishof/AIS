...
/**
 * Controller/action ZK untuk kinerja. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code ManagingProdiYangDiajar
 * managingProdiYangDiajar}, {@code AmbilDataPegawaiBanbox pegawai}, {@code North pilihDosen}, {@code Tabpanel
 * ringkasan}, {@code Tabpanel bidangPendidikan}, {@code Tabpanel bidangPenelitian}, {@code Tabpanel
 * bidangPengabdian}, {@code Tabpanel bidangPenunjang}; inisialisasi/lifecycle ({@code doAfterCompose()});
 * pembacaan/pencarian ({@code tampilRingkasan()}); operasi domain lain ({@code onBidangPenunjang()}, {@code
 * onBidangPendidikan()}, {@code onBidangPenelitian()}, {@code onBidangPengabdian()}). Bagian lain dari kontrak
