...
/**
 * Controller/action ZK untuk bimbingan skripsi. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code AmbilDataDosenBanbox searchdosen}, {@code Combobox searchTahunAjaran}, {@code Combobox
 * searchJenisSemester}, {@code Combobox searchprogram}, {@code Combobox searchfakultas}, {@code Combobox
 * searchjurusan}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code
...
public class BimbinganSkripsiAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link BimbinganSkripsiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link BimbinganSkripsiAction} dan dapat mengakses
