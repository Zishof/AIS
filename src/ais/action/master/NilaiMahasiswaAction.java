...
/**
 * Controller/action ZK untuk nilai mahasiswa. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * searchfakultas}, {@code Label searchangkatan}, {@code Checkbox searchtampilin}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}); pembacaan/pencarian ({@code onTampilKHS()}, {@code
 * onTampilTranskripAkademik()}, {@code onTampilRekamanNilai()}, {@code onSearchDefaultKeDatabase()}, {@code
 * onSearchDefault()}); operasi domain lain ({@code onNilaiSp()}, {@code onAsisten()}). Bagian lain dari kontrak
...
public class NilaiMahasiswaAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link NilaiMahasiswaAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link NilaiMahasiswaAction} dan dapat mengakses
