...
/**
 * Controller/action ZK untuk kelompok parameter tambahan calon mahasiswa. Tipe ini merupakan titik
 ...
 * validasi/perhitungan ({@code checkNamaKelompokParameterTambahanCalonMahasiswa()}); mutasi data ({@code
...
public class KelompokParameterTambahanCalonMahasiswaAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KelompokParameterTambahanCalonMahasiswaAction}. Kelas ini
	 * menerjemahkan satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik
	 * kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KelompokParameterTambahanCalonMahasiswaAction}
	 ...
	 *
	 * @see KelompokParameterTambahanCalonMahasiswaAction
	 */
