...
/**
 * Controller/action ZK untuk pertemuan. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * {@code AmbilDataMatakuliahBanbox searchmatakuliah}, {@code AmbilDataDosenBanbox searchdosen}, {@code Textbox
 * searchkelas}, {@code MyCheckboxConfig searchparalel}, {@code MyCheckboxConfig searchtanpakelas}, {@code
 * AmbilDataRuangBanbox searchruang}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code
 * doAfterCompose()}, {@code initCriteria()}, {@code initCriteria()}); pembacaan/pencarian ({@code
 * onTampilPanelIkut()}, {@code onDownloadLampiran()}, {@code tampilanExportKeFeeder()}, {@code getDspace()},
 * {@code loadData()}, {@code onSearchDefault()}); operasi domain lain ({@code onRekapPertemuanPerkuliahan()},
 * {@code onKegiatanMahasiswa()}, {@code onPerkuliahanSp()}, {@code onEkstrakurikuler()}, {@code
 * onParameterPertemuanPerkuliahan()}, {@code onPraPerkuliahan()}). Bagian lain dari kontrak tetap mengikuti
