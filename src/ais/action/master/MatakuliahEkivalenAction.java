...
/**
 * Controller/action ZK untuk matakuliah ekivalen. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Textbox searchekivalen}, {@code
 * AmbilDataMatakuliahBanbox ekivalen}, {@code AmbilDataMatakuliahBanbox matakuliah}, {@code Textbox
 * khususUntukNim}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()},
 * {@code initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}); mutasi data ({@code onSave()});
 * operasi domain lain ({@code bersihkanKrsMahasiswaDouble()}, {@code onAdd()}). Bagian lain dari kontrak tetap
...
public class MatakuliahEkivalenAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link MatakuliahEkivalenAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link MatakuliahEkivalenAction} dan dapat mengakses
