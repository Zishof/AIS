...
/**
 * Komponen dashboard khusus untuk dashboard statistik jumlah alumni. Kelas ini memilih variasi
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code MyChart mychart}, {@code Center
 * center}, {@code CategoryModel categoryModel}, {@code Combobox angkatan}, {@code Combobox angkatansd}, {@code
 * Combobox kelulusan}, {@code Combobox kelulusansd}, {@code boolean tampilRinci}; inisialisasi/lifecycle ({@code
 * reinit()}, {@code initFakultas()}, {@code init()}, {@code initChart()}); konfigurasi constructor: {@code
 * tampilRinci}. Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di atas.</p>
...
public class DashboardStatistikJumlahAlumni extends MyWindow {
	...
	/**
	 * Event listener lokal milik {@link DashboardStatistikJumlahAlumni}. Kelas ini menangani event untuk komponen
	 * induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DashboardStatistikJumlahAlumni} dan dapat
	 * mengakses state kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi state utama: {@code String kelamin}, {@code Long
	 ...
	 *
	 * @see DashboardStatistikJumlahAlumni
	 */
