 ...
 */
/**
 * Tipe khusus untuk mahasiswa resource. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * pembacaan/pencarian ({@code getXml()}, {@code getMasuk()}, {@code getLogin()}, {@code getLoginNim()}, {@code
 * getLoginNim()}, {@code checkAmbilKrs()}); penghapusan/pembatalan ({@code hapusKrs()}); pelaporan/ekspor
 * ({@code reportLog()}); operasi domain lain ({@code lihatKrs()}, {@code lihatNilai()}, {@code
 * lihatDetailPembayaran()}, {@code lihatPembayaran()}, {@code jenisPembayaran()}, {@code bayar()}). Bagian lain
