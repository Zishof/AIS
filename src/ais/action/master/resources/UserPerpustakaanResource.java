 ...
 */
/**
 * Tipe khusus untuk user perpustakaan resource. Kelas ini memberi nama dan batas tanggung jawab
 * yang eksplisit pada perilaku yang diwarisi atau kontrak yang diimplementasikannya.
 *
 * <p><b>Batas tanggung jawab:</b> perilaku umum, validasi, akses data, serta lifecycle tetap dimiliki {@link
 * PerpustakaanResource}. Kelas ini hanya boleh memuat perbedaan yang benar-benar spesifik untuk variasi ini;
 * perubahan yang berlaku bagi seluruh keluarga harus ditempatkan di kelas induk agar fungsi tidak bercabang atau
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah pembacaan/pencarian ({@code getXml()}); validasi/perhitungan
 * ({@code checkPesanItem()}, {@code checkKeanggotaan()}, {@code checkPengguna()}); mutasi data ({@code
 * ubahStatus()}); penghapusan/pembatalan ({@code batalkanPesanItem()}); operasi domain lain ({@code
 * ajukanJurnal()}, {@code daftarPesanItem()}, {@code pesanItem()}, {@code daftarPenerbit()}, {@code
 * daftarPengarang()}, {@code daftarItemJurnal()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
