...
/**
 * Controller/action ZK untuk mahasiswa request tugas akhir minta pembimbing. Tipe ini merupakan
 ...
 * validasi/perhitungan ({@code checkNamaMahasiswaRequestTugasAkhirMintaPembimbing()}); mutasi data ({@code
...
public class MahasiswaRequestTugasAkhirMintaPembimbingAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link MahasiswaRequestTugasAkhirMintaPembimbingAction}. Kelas ini
	 ...
	 * MahasiswaRequestTugasAkhirMintaPembimbingAction} dan dapat mengakses state kelas induk. Jangan menyimpan
	 ...
	 *
	 * @see MahasiswaRequestTugasAkhirMintaPembimbingAction
	 */
