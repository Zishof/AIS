...
/**
 * Controller/action ZK untuk kelompok status keluar mahasiswa. Tipe ini merupakan titik masuk UI
 ...
 * nama}, {@code Combobox statusKeluar}, {@code Textbox keterangan}; inisialisasi/lifecycle ({@code
...
//	private MyDatebox tanggalSk;
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KelompokStatusKeluarMahasiswaAction}. Kelas ini menerjemahkan
	 * satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KelompokStatusKeluarMahasiswaAction} dan dapat
	 ...
	 *
	 * @see KelompokStatusKeluarMahasiswaAction
	 */
