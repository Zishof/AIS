...
/**
 * Controller/action ZK untuk pengecekan pendaftaran wisuda perpustakaan fakultas. Tipe ini
 ...
 */
public class PengecekanPendaftaranWisudaPerpustakaanFakultasAction extends GenericAutowireComposer {
	...
	public void onPilihMahasiswa() throws Exception {
		...
		if (pendaftaranWisuda == null) {
			...
			String wisuda_perpustakaan = "Mengembalikan semua buku perpustakaan fakultas;Tidak ada denda pengembalian buku perpustakaan fakultas";

			jsonObject = new JSONObject(pendaftaranWisuda.getStatusPendaftaran());

			for (String konf : Common.getKonfigurasi("wisuda_perpustakaan_perpustakaan", wisuda_perpustakaan).getNilai()
					.split(";")) {
			...
			if (pendaftaranWisuda.getStatusPersetujuanPerpustakaanFakultas() != null
	...
	public void onSetuju() throws Exception {
		...
		MyMessageboxConfig.show("Apakah anda yakin, mahasiswa ini tidak ada masalah menyangkut perpustakaan fakultas ?",
				...
				new EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						...
						if (i == MyMessageboxConfig.CANCEL)
							...
							pendaftaranWisuda.setStatusPersetujuanPerpustakaanFakultas(1);
	...
	public void onTolak() throws InterruptedException {
		...
		MyMessageboxConfig.show(
				"Apakah anda yakin, mahasiswa ini belum menyelesaikan masalah menyangkut perpustakaan fakultas ?",
				"Pertanyaan", MyMessageboxConfig.OK | MyMessageboxConfig.CANCEL, MyMessageboxConfig.QUESTION,
				new EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						...
						if (i == MyMessageboxConfig.CANCEL)
							...
							pendaftaranWisuda.setStatusPersetujuanPerpustakaanFakultas(0);
