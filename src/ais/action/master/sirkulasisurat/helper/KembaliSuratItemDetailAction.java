...
/**
 * Controller/action ZK untuk kembali surat item detail. Tipe ini merupakan titik masuk UI yang
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code KembaliSuratItem kembaliSuratItem},
 * {@code MyGrid grid}, {@code boolean edit}; pembacaan/pencarian ({@code loadData()}); operasi domain lain
 * ({@code display()}); konfigurasi constructor: {@code edit}. Bagian lain dari kontrak tetap mengikuti kelas
...
public class KembaliSuratItemDetailAction extends MyDetail {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KembaliSuratItemDetailAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KembaliSuratItemDetailAction} dan dapat
	 ...
	 *
	 * @see KembaliSuratItemDetailAction
	 */
