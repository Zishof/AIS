...
/**
 * Controller/action ZK untuk peminjam surat. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchkode}, {@code AmbilDataMahasiswaBanbox mahasiswa}, {@code
 * AmbilDataDosenBanbox dosen}, {@code AmbilDataPegawaiBanbox pegawai}, {@code Textbox kode};
...
public class PeminjamSuratAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PeminjamSuratAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PeminjamSuratAction} dan dapat mengakses state
