...
/**
 * Controller/action ZK untuk format nilai proposal skripsi. Tipe ini merupakan titik masuk UI yang
...
public class FormatNilaiProposalSkripsiAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link FormatNilaiProposalSkripsiAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link FormatNilaiProposalSkripsiAction} dan dapat
	 ...
	 *
	 * @see FormatNilaiProposalSkripsiAction
	 */
