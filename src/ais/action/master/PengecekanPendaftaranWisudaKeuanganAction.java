...
/**
 * Controller/action ZK untuk pengecekan pendaftaran wisuda keuangan. Tipe ini merupakan titik
 ...
 */
public class PengecekanPendaftaranWisudaKeuanganAction extends GenericAutowireComposer {
	...
	public void onPilihMahasiswa() throws Exception {
		...
		if (pendaftaranWisuda == null) {
			...
			String wisuda_keuangan = "Melunasi Biaya Kelulusan;Melunasi Biaya UKT;Melunasi Biaya Ujian";
			jsonObject = new JSONObject(pendaftaranWisuda.getStatusPendaftaran());
			for (String konf : Common.getKonfigurasi("wisuda_keuangan", wisuda_keuangan).getNilai().split(";")) {
			...
			if (pendaftaranWisuda.getStatusPersetujuanKeuangan() != null
	...
	public void onSetuju() throws Exception {
		...
		MyMessageboxConfig.show("Apakah anda yakin, mahasiswa ini tidak ada masalah menyangkut keuangan ?",
				...
				new EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						...
						if (i == MyMessageboxConfig.CANCEL)
							...
							pendaftaranWisuda.setStatusPersetujuanKeuangan(1);
	...
	public void onTolak() throws InterruptedException {
		...
		MyMessageboxConfig.show("Apakah anda yakin, mahasiswa ini belum menyelesaikan masalah menyangkut keuangan ?",
				"Pertanyaan", MyMessageboxConfig.OK | MyMessageboxConfig.CANCEL, MyMessageboxConfig.QUESTION,
				new EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						...
						if (i == MyMessageboxConfig.CANCEL)
							...
							pendaftaranWisuda.setStatusPersetujuanKeuangan(0);
