...
/**
 * Controller/action ZK untuk badan hukum. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code BadanHukum badanHukum}, {@code Textbox
 * kode}, {@code Textbox nama}, {@code Textbox alamat1}, {@code Textbox alamat2}, {@code Textbox kota}, {@code
 * Textbox kodePos}, {@code Textbox telepon}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code
 * doAfterCompose()}, {@code init()}); pembacaan/pencarian ({@code loadDataBadanHukum()}); mutasi data ({@code
 * onSave()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di atas.</p>
