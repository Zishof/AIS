...
public class GenerateNimCalonMahasiswaAkademikAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link GenerateNimCalonMahasiswaAkademikAction}. Kelas ini menerjemahkan
	 * satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link GenerateNimCalonMahasiswaAkademikAction} dan
	 ...
	 *
	 * @see GenerateNimCalonMahasiswaAkademikAction
	 */
