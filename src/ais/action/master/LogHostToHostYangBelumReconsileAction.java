...
/**
 * Controller/action ZK untuk log host to host yang belum reconsile. Tipe ini merupakan titik masuk
 ...
 * {@code Textbox searchbank}, {@code Textbox searchkode}, {@code Textbox searchketerangan}, {@code Textbox
 * searchnama}, {@code MyToolbarbuttonConfig find}, {@code MyDatebox searchmulai}; inisialisasi/lifecycle ({@code
...
public class LogHostToHostYangBelumReconsileAction extends GenericAutowireComposer implements DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link LogHostToHostYangBelumReconsileAction}. Kelas ini menerjemahkan
	 * satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link LogHostToHostYangBelumReconsileAction} dan
	 ...
	 *
	 * @see LogHostToHostYangBelumReconsileAction
	 */
