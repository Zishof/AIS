...
/**
 * Controller/action ZK untuk jenis pembayaran. Tipe ini merupakan titik masuk UI yang
...
//		// add.setDisabled((Common.getCurrentUser().getRoot() == null || !Common.getCurrentUser().getRoot()));
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisPembayaranAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisPembayaranAction} dan dapat mengakses
