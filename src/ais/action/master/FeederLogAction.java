...
public class FeederLogAction extends GenericAutowireComposer implements DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link FeederLogAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link FeederLogAction} dan dapat mengakses state
