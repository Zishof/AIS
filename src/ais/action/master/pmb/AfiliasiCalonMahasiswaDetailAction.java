...
/**
 * Controller/action ZK untuk afiliasi calon mahasiswa detail. Tipe ini merupakan titik masuk UI
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code AfiliasiCalonMahasiswa
 * afiliasiCalonMahasiswa}, {@code MyGrid grid}, {@code Textbox pencarian}, {@code Combobox searchTahunAjaran};
...
public class AfiliasiCalonMahasiswaDetailAction extends MyDetail implements DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AfiliasiCalonMahasiswaDetailAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AfiliasiCalonMahasiswaDetailAction} dan dapat
	 ...
	 *
	 * @see AfiliasiCalonMahasiswaDetailAction
	 */
