...
/**
 * Controller/action ZK untuk afiliasi calon mahasiswa pegawai detail. Tipe ini merupakan titik
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Pegawai afiliasiPegawai}, {@code MyGrid
 * grid}, {@code Textbox pencarian}, {@code Combobox searchTahunAjaran}; inisialisasi/lifecycle ({@code
 ...
 * @see MyDetail
 */
public class AfiliasiCalonMahasiswaPegawaiDetailAction extends MyDetail implements DataCriteria {
	...
	public AfiliasiCalonMahasiswaPegawaiDetailAction(Pegawai afiliasiPegawai, Combobox searchTahunAjaran) {
		super();
		...
		this.addEventListener(Events.ON_OPEN, new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				Common.clear(AfiliasiCalonMahasiswaPegawaiDetailAction.this);
				if (isOpen()) {
					display();
				}
			}
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AfiliasiCalonMahasiswaPegawaiDetailAction}. Kelas ini
	 * menerjemahkan satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik
	 * kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AfiliasiCalonMahasiswaPegawaiDetailAction} dan
	 ...
	 *
	 * @see AfiliasiCalonMahasiswaPegawaiDetailAction
	 */
	...
	public void display() {
		...
		groupbox.appendChild(
				new MyCaptionStyled("Daftar calon mahasiswa yang masuk afiliasi " + afiliasiPegawai.getNama()));
							...
							public void onEvent(Event arg0) throws Exception {
								...
								if (biodataCalonMahasiswas != null) {
									...
									for (BiodataCalonMahasiswa biodataCalonMahasiswa : biodataCalonMahasiswas) {
										biodataCalonMahasiswa.setAfiliasiPegawai(afiliasiPegawai);
	...
	public Criteria initCriteria(boolean order) {
		...
		return session.createCriteria(BiodataCalonMahasiswa.class).add(Restrictions.or(Restrictions.isNull("aktif"), Restrictions.eq("aktif", true)))
				...
				.addOrder(Order.desc("id")).add(Restrictions.eq("afiliasiPegawai", afiliasiPegawai));
	}
