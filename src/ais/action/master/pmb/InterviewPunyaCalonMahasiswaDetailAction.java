...
/**
 * Controller/action ZK untuk interview punya calon mahasiswa detail. Tipe ini merupakan titik
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code InterviewCalonMahasiswa
 * interviewCalonMahasiswa}, {@code MyGrid grid}, {@code Textbox nama}, {@code boolean edit};
...
public class InterviewPunyaCalonMahasiswaDetailAction extends MyDetail implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link InterviewPunyaCalonMahasiswaDetailAction}. Kelas ini
	 * menerjemahkan satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik
	 * kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link InterviewPunyaCalonMahasiswaDetailAction} dan
