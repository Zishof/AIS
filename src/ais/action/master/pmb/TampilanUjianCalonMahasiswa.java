...
/**
 * Tipe khusus untuk tampilan ujian calon mahasiswa. Kelas ini memberi nama dan batas tanggung
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code AktifitasJadwalUjianPMBHelper
 * aktifitasJadwalUjianPMBHelper}, {@code boolean tampilTutup}, {@code boolean materiBol}, {@code boolean
 * ujianBol}, {@code boolean tugasBol}; inisialisasi/lifecycle ({@code init()}). Bagian lain dari kontrak tetap
