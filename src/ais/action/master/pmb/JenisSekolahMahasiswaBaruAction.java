...
/**
 * Controller/action ZK untuk jenis sekolah mahasiswa baru. Tipe ini merupakan titik masuk UI yang
 ...
 * grid}, {@code Textbox searchnama}, {@code Textbox searchkode}, {@code Textbox nama}, {@code Textbox
 * keterangan}, {@code Textbox kode}, {@code boolean edit}; inisialisasi/lifecycle ({@code doBeforeCompose()},
 * {@code doAfterCompose()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian ({@code
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaAgama()}); mutasi data ({@code onSave()}); operasi
...
public class JenisSekolahMahasiswaBaruAction extends GenericAutowireComposer implements DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisSekolahMahasiswaBaruAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisSekolahMahasiswaBaruAction} dan dapat
	 ...
	 *
	 * @see JenisSekolahMahasiswaBaruAction
	 */
