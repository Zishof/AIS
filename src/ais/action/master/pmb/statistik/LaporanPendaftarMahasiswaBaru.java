...
/**
 * Penyusun/penyaji laporan untuk laporan pendaftar mahasiswa baru. Kelas ini mengubah data domain
 ...
 * searchjenjang}, {@code Combobox searchjenisseleksi}, {@code Combobox searchpaket}, {@code MyCheckboxConfig
 * searchpeserta}; inisialisasi/lifecycle ({@code initFakultas()}, {@code init()}, {@code initSpreadsheet()}).
