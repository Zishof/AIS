...
/**
 * Controller/action ZK untuk paket punya program. Tipe ini merupakan titik masuk UI yang
 ...
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code PaketPunyaProgram paketPunyaProgram},
 * {@code MyWindow addWindow}, {@code MyGrid grid}, {@code Combobox program}, {@code Combobox searchprogram},
 * {@code Combobox paket}, {@code Combobox searchpaket}, {@code boolean edit}; inisialisasi/lifecycle ({@code
...
public class PaketPunyaProgramAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PaketPunyaProgramAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PaketPunyaProgramAction} dan dapat mengakses
