...
/**
 * Controller/action ZK untuk input pmdk. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * grid}, {@code Textbox searchnama}, {@code Textbox searchsekolah}, {@code Combobox searchtahun}, {@code Textbox
 * nama}, {@code MyDatebox tanggalLahir}, {@code Combobox asalSekolah}; inisialisasi/lifecycle ({@code
...
public class InputPMDKAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link InputPMDKAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link InputPMDKAction} dan dapat mengakses state
