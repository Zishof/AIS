...
public class RuangPMBAction extends GenericAutowireComposer implements FormSop {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link RuangPMBAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link RuangPMBAction} dan dapat mengakses state
