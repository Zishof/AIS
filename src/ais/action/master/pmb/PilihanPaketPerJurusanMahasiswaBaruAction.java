...
/**
 * Controller/action ZK untuk pilihan paket per jurusan mahasiswa baru. Tipe ini merupakan titik
 ...
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code PilihanPaketPerJurusanMhsBaru
 * pilihanPaketPerJurusanMhsBaru}, {@code MyWindow addWindow}, {@code MyGrid grid}, {@code Combobox
 * jurusanSekolah}, {@code Combobox searchjurusansekolah}, {@code Combobox paket}, {@code Combobox searchpaket},
 * {@code boolean edit}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code
...
public class PilihanPaketPerJurusanMahasiswaBaruAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PilihanPaketPerJurusanMahasiswaBaruAction}. Kelas ini
	 * menerjemahkan satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik
	 * kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PilihanPaketPerJurusanMahasiswaBaruAction} dan
	 ...
	 *
	 * @see PilihanPaketPerJurusanMahasiswaBaruAction
	 */
