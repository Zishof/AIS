...
/**
 * Controller/action ZK untuk attachment pengumuman akademis. Tipe ini merupakan titik masuk UI
 ...
 * {@code MyGrid grids}, {@code Boolean readonly}, {@code MyWindow addWindowAttachment}; inisialisasi/lifecycle
 * ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}); pembacaan/pencarian ({@code
 * loadDataAttachment()}, {@code getReadonly()}); mutasi data ({@code setReadonly()}). Bagian lain dari kontrak
...
public class AttachmentPengumumanAkademisAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AttachmentPengumumanAkademisAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AttachmentPengumumanAkademisAction} dan dapat
	 ...
	 *
	 * @see AttachmentPengumumanAkademisAction
	 */
