...
/**
 * Controller/action ZK untuk rencana dan realisasi output kegiatan. Tipe ini merupakan titik masuk
 ...
 * {@code Combobox outputKegiatan}, {@code Combobox satuan}, {@code AmbilDataSatuanKerjaBanbox satuanKerja};
...
public class RencanaDanRealisasiOutputKegiatanAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link RencanaDanRealisasiOutputKegiatanAction}. Kelas ini menerjemahkan
	 * satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link RencanaDanRealisasiOutputKegiatanAction} dan
	 ...
	 *
	 * @see RencanaDanRealisasiOutputKegiatanAction
	 */
