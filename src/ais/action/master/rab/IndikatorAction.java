...
/**
 * Controller/action ZK untuk indikator. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * {@code Textbox kode}, {@code Textbox nama}, {@code AmbilDataSatuanKerjaBanbox satuanKerja};
...
public class IndikatorAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link IndikatorAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link IndikatorAction} dan dapat mengakses state
