...
/**
 * Controller/action ZK untuk jenis parameter. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Textbox nama}, {@code Combobox typedata},
 ...
 * validasi/perhitungan ({@code checkNamaJenisParameter()}); mutasi data ({@code onSave()}); operasi domain lain
...
public class JenisParameterAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisParameterAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisParameterAction} dan dapat mengakses
