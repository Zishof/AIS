...
import ais.action.master.helper.impor.ImportFromRKAKLHelper;
import ais.common.Common;

/**
 * Controller/action ZK untuk import from rkakl. Tipe ini merupakan titik masuk UI yang
 ...
 */
public class ImportFromRKAKLAction extends GenericAutowireComposer {
	...
	public void onImport(Event event) {
		...
		Runnable runnable = new Runnable() {
			...
			@Override
			public void run() {
				ImportFromRKAKLHelper.importData(dir, myProgressmeter,
