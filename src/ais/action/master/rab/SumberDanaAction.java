...
/**
 * Controller/action ZK untuk sumber dana. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * AmbilDataSatuanKerjaBanbox searchparent}, {@code Checkbox searchaktif}, {@code Intbox tahun};
...
public class SumberDanaAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link SumberDanaAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link SumberDanaAction} dan dapat mengakses state
