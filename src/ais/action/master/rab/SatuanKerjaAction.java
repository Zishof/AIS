 ...
 * AmbilDataSatuanKerjaBanbox searchparent}, {@code Textbox kode}, {@code Textbox nama}; inisialisasi/lifecycle
 * ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code initCriteria()});
 * pembacaan/pencarian ({@code onSearchDefault()}); validasi/perhitungan ({@code checkKodeSatuanKerja()}); mutasi
