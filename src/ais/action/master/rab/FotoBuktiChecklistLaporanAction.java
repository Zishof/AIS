...
/**
 * Controller/action ZK untuk foto bukti checklist laporan. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code Textbox searchnama}, {@code boolean delete}, {@code ChecklistLaporanDetail checklistLaporanDetail},
 * {@code MyToolbarbuttonConfig add}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code
 * doAfterCompose()}, {@code initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}, {@code
 * onUploadFile()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di
 * atas.</p>
...
public class FotoBuktiChecklistLaporanAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link FotoBuktiChecklistLaporanAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link FotoBuktiChecklistLaporanAction} dan dapat
	 ...
	 *
	 * @see FotoBuktiChecklistLaporanAction
	 */
