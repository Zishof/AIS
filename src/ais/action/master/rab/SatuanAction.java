...
/**
 * Controller/action ZK untuk satuan. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaSatuan()}); mutasi data ({@code onSave()}); operasi
...
public class SatuanAction extends GenericAutowireComposer implements DataInitDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link SatuanAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link SatuanAction} dan dapat mengakses state kelas
