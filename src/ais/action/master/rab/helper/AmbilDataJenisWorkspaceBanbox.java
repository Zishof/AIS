...
/**
 * Tipe khusus untuk ambil data jenis workspace banbox. Kelas ini memberi nama dan batas tanggung
 ...
 * eventListener}, {@code JenisWorkspaceTreeModel jenisWorkspaceTreeModel}, {@code Boolean chooseAll};
 * pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()}, {@code getEventListener()});
 * operasi domain lain ({@code display()}); konfigurasi constructor: {@code jenisWorkspaceTreeModel}. Bagian lain
 ...
 * @see Bandbox
 */
public class AmbilDataJenisWorkspaceBanbox extends Bandbox implements
		GetEventListener {
	...
	protected JenisWorkspaceTreeModel jenisWorkspaceTreeModel;

	private Boolean chooseAll = false;

	public AmbilDataJenisWorkspaceBanbox() throws Exception {
		this(true);
	}

	public AmbilDataJenisWorkspaceBanbox(Boolean chooseAll) throws Exception {
		super();
		jenisWorkspaceTreeModel = new JenisWorkspaceTreeModel(false);
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataJenisWorkspaceBanbox}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataJenisWorkspaceBanbox} dan dapat
	 ...
	 *
	 * @see AmbilDataJenisWorkspaceBanbox
	 */
	class JenisWorkspaceTreeRenderer extends ais.ui.util.MyTreeitemRenderer {
		...
		public void render(final Treeitem treeitem, Object arg1) {
			...
			try {
				...
				treerow.setStyle(jenisWorkspace == null ? treerow.getStyle()
						: (jenisWorkspace.getWarna() != null ? "background-color:"
								+ jenisWorkspace.getWarna() + ";"
								: "")
								+ (jenisWorkspace.getWarnaText() != null ? "color:"
										+ jenisWorkspace.getWarnaText() + ";"
										: ""));

				Treecell arg0 = new Treecell();
				arg0.setParent(treerow);

				new Label(jenisWorkspace.toString()).setParent(arg0);

				arg0 = new Treecell();
				arg0.setParent(treerow);
				MyRadioConfig checkbox = new MyRadioConfig();
				checkbox.setVisible(chooseAll
						|| jenisWorkspaceTreeModel
								.getChildCount(jenisWorkspace) == 0);
				checkbox.setParent(arg0);arg0.setAttribute("checkbox", checkbox);
				checkbox.setAttribute("jenisWorkspace", jenisWorkspace);

				checkbox.addEventListener("onCheck", new EventListener() {
					@Override
					public void onEvent(Event event) throws Exception {
						AmbilDataJenisWorkspaceBanbox.this.setOpen(false);
						AmbilDataJenisWorkspaceBanbox.this.setAttribute(
								"jenisWorkspace", jenisWorkspace);
						AmbilDataJenisWorkspaceBanbox.this
								.setValue(jenisWorkspace.toString());
						...
						Long count = (Long) session
								...
								.add(Restrictions.idEq(jenisWorkspace.getId()))
								.uniqueResult();
						count = count == null ? 0L : count;
						jenisWorkspace.setJmlDipakai(++count);
						Common.refreshUpdate(session,(jenisWorkspace));
	...
	public void display() throws Exception {
		...
		tabpanelUtama.setParent(tabpanels);
		tabpanelUtama.appendChild(new JenisWorkspaceSeringDipakai());
	...
	public void onSearchDefault(Event event) throws Exception {
		...
		tree.setItemRenderer(new JenisWorkspaceTreeRenderer());
	}
	...
	/**
	 * Tipe implementasi bersarang {@link JenisWorkspaceSeringDipakai} milik {@link AmbilDataJenisWorkspaceBanbox}.
	 ...
	 * ais.ui.util.AmbilDataPagingHelper pagingHelper}, {@code Textbox kodeJenisWorkspacean}, {@code Textbox nama};
	 ...
	 * @see AmbilDataJenisWorkspaceBanbox
	 */
	private class JenisWorkspaceSeringDipakai extends Borderlayout {
	...
	private final ais.ui.util.AmbilDataPagingHelper pagingHelper = new ais.ui.util.AmbilDataPagingHelper();
		public JenisWorkspaceSeringDipakai() throws Exception {
			super();
			display();
		}

		private Textbox kodeJenisWorkspacean;
		private Textbox nama;

		/**
		 * Renderer lokal untuk layar/komponen {@link JenisWorkspaceSeringDipakai}. Kelas ini menerjemahkan satu item
		 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisWorkspaceSeringDipakai} dan dapat
		 * mengakses state kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
		 * <p>Kontrak yang tampak dari deklarasi ini meliputi operasi lokal: {@code render}(). Aturan bisnis bersama
		 * tetap berada pada kelas induk atau service yang dipanggilnya.</p>
		 * <p><b>Efek samping:</b> operasi dapat mengubah komponen ZK dan memanggil alur kelas induk. Jalankan pada
		 ...
		 * renderer/listener ini.</p>
		 *
		 * @see JenisWorkspaceSeringDipakai
		 */
		class JenisWorkspaceRenderer extends ais.ui.util.MyRowRenderer {
			...
			public void render(Row arg0, Object arg1) throws Exception {arg0.setValign("top");
				...
				new Label(jenisWorkspace.getNama()).setParent(arg0);
		...
		rowUtama.setParent(rowsUtama);
			...
			row.appendChild(kodeJenisWorkspacean = new Textbox());
			kodeJenisWorkspacean.setWidth("90%");
		...
		public void onSearchDefault(Event event) throws Exception {
			...
			ListModel strset = new SimpleListModel(jenisWorkspaces);
