...
/**
 * Tipe khusus untuk ambil data jenis tugas window. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * eventListener}, {@code JenisTugasTreeModel jenisTugasTreeModel}, {@code Boolean chooseAll};
 * pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()}, {@code getEventListener()});
 * operasi domain lain ({@code display()}); konfigurasi constructor: {@code jenisTugasTreeModel}. Bagian lain
 ...
 * @see MyWindow
 */
public class AmbilDataJenisTugasWindow extends MyWindow implements
		GetEventListener {
	...
	public AmbilDataJenisTugasWindow() throws Exception {
		this(false);
	}

	public AmbilDataJenisTugasWindow(Boolean chooseAll) throws Exception {
		super();
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataJenisTugasWindow}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataJenisTugasWindow} dan dapat mengakses
			...
			try {
				...
				checkbox.addEventListener("onCheck", new EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						AmbilDataJenisTugasWindow.this.setAttribute(
	...
	/**
	 * Tipe implementasi bersarang {@link JenisTugasSeringDipakai} milik {@link AmbilDataJenisTugasWindow}. Kelas
