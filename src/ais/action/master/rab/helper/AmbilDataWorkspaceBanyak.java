...
/**
 * Tipe khusus untuk ambil data workspace banyak. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * AmbilDataSatuanKerjaBanbox satuanKerja}, {@code AmbilDataSumberDanaBanbox sumberDana}, {@code Integer
 * debetCredit}, {@code Boolean chooseAll}; pembacaan/pencarian ({@code onRefreshRealisasi()}, {@code
...
public class AmbilDataWorkspaceBanyak extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataWorkspaceBanyak}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataWorkspaceBanyak} dan dapat mengakses
