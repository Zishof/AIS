...
/**
 * Tipe khusus untuk ambil data indikator banyak. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * ais.ui.util.AmbilDataPagingHelper pagingHelper}, {@code EventListener eventListener}, {@code List indikators},
 * {@code List indikatorsHanyaDitampilkan}, {@code SatuanKerjaTreeModel satuanKerjaTreeModel}, {@code Set ids},
 * {@code MyTextbox kodeIndikatoran}; pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()},
 * {@code getEventListener()}); operasi domain lain ({@code display()}); konfigurasi constructor: {@code
...
public class AmbilDataIndikatorBanyak extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataIndikatorBanyak}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataIndikatorBanyak} dan dapat mengakses
