...
//		}
	...
	/**
	 * Tipe implementasi bersarang {@link PercabanganDetail} milik {@link WorkspaceRevisiBulananAction}. Kelas ini
	 * memberi nama pada state atau perilaku lokal agar tanggung jawabnya tidak tersebar sebagai blok anonim.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link WorkspaceRevisiBulananAction} dan dapat
	 ...
	 * workspace}, {@code Label total}, {@code EventListener eventListener}, {@code MyWindow window}; operasi
	 * lokal: {@code hitungTotal()}, {@code init}(). Aturan bisnis bersama tetap berada pada kelas induk atau
	 * service yang dipanggilnya.</p>
	 * <p><b>Efek samping:</b> operasi dapat mengubah state lokal dan, sesuai nama methodnya, komponen UI atau
	 * persistence melalui konteks kelas induk. Gunakan transaksi, otorisasi, dan session milik alur induk;
	 * tambahkan perilaku lintas domain pada service bersama.</p>
	 *
	 * @see WorkspaceRevisiBulananAction
	 */
