...
/**
 * Controller/action ZK untuk satuan kerja tree. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code Textbox kode}, {@code Textbox nama}, {@code AmbilDataKppnBanbox kppn}, {@code
 * AmbilDataSatuanLokasiBanbox satuanLokasi}, {@code Textbox keterangan}, {@code Textbox domain};
 ...
 * {@code reloadTotal()}); validasi/perhitungan ({@code checkKodeSatuanKerja()}); mutasi data ({@code onSave()});
