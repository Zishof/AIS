...
/**
 * Controller/action ZK untuk mahasiswa ikuti perkuliahan. Tipe ini merupakan titik masuk UI yang
 ...
 * grid}, {@code Mahasiswa mahasiswa}, {@code Integer semesterPendek}, {@code Combobox semesterMulai}, {@code
 * Combobox semesterSampai}, {@code Center rowData}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code
 * doAfterCompose()}); pembacaan/pencarian ({@code onSearchDefault()}, {@code load()}). Bagian lain dari kontrak
