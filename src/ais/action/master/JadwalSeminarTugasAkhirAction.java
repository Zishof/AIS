...
/**
 * Controller/action ZK untuk jadwal seminar tugas akhir. Tipe ini merupakan titik masuk UI yang
 ...
 * ({@code doAfterCompose()}, {@code init()}, {@code initJadwal()}, {@code initCriteria()}); pembacaan/pencarian
 * ({@code onSearchDefault()}); mutasi data ({@code onSave()}); penghapusan/pembatalan ({@code onDelete()});
 * operasi domain lain ({@code onAddExternal()}, {@code onAdd()}). Bagian lain dari kontrak tetap mengikuti kelas
 ...
 */
public class JadwalSeminarTugasAkhirAction extends GenericAutowireComposer {
	...
	private AmbilDataRuangBanbox ruangSeminar;
	...
	public static void onAddExternal(Event event, EventListener eventListener,
			JadwalSeminarTugasAkhir jadwalSeminarTugasAkhir) throws Exception {
		JadwalSeminarTugasAkhirAction jadwalSeminarTugasAkhirAction = new JadwalSeminarTugasAkhirAction();
		jadwalSeminarTugasAkhirAction.eventListener = eventListener;
		jadwalSeminarTugasAkhirAction.addWindow = new MyWindow();

		ExecutionsCtrl.getCurrentCtrl().getCurrentPage().getFirstRoot()
				.appendChild(jadwalSeminarTugasAkhirAction.addWindow);
		jadwalSeminarTugasAkhirAction.addWindow.setHeight("350px");
		jadwalSeminarTugasAkhirAction.addWindow.setWidth("550px");

		jadwalSeminarTugasAkhirAction.init(jadwalSeminarTugasAkhir);

		jadwalSeminarTugasAkhirAction.addWindow.setVisible(true);
		jadwalSeminarTugasAkhirAction.addWindow.onModal();
	}

	/**
	 * Renderer lokal untuk layar/komponen {@link JadwalSeminarTugasAkhirAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JadwalSeminarTugasAkhirAction} dan dapat
	 ...
	 *
	 * @see JadwalSeminarTugasAkhirAction
	 */
	class JadwalSeminarTugasAkhirRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(final Row arg0, Object arg1) throws Exception {
			...
			detail.setOpen(true);
			detail.appendChild(initJadwal(jadwalSeminarTugasAkhir));

			RevisiHelper.createNewRevisi(JadwalSeminarTugasAkhir.class, jadwalSeminarTugasAkhir,
					jadwalSeminarTugasAkhir.getNama()).setParent(arg0);

			new Label(jadwalSeminarTugasAkhir.getMulai() == null ? ""
					: Common.dateFormat.get().format(jadwalSeminarTugasAkhir.getMulai())).setParent(arg0);
			new Label(jadwalSeminarTugasAkhir.getSampai() == null ? ""
					: Common.dateFormat.get().format(jadwalSeminarTugasAkhir.getSampai())).setParent(arg0);
			new Label(jadwalSeminarTugasAkhir.getTahunAkademik()).setParent(arg0);
			new Label(jadwalSeminarTugasAkhir.getRuangSeminar() == null ? ""
					: jadwalSeminarTugasAkhir.getRuangSeminar().getNama()).setParent(arg0);
			new Label(jadwalSeminarTugasAkhir.getProgram() == null ? "Semua" : jadwalSeminarTugasAkhir.getProgram())
					.setParent(arg0);
			new Label(jadwalSeminarTugasAkhir.getJurusan() == null ? "Semua"
					: jadwalSeminarTugasAkhir.getJurusan().getNama()).setParent(arg0);
			new Label(jadwalSeminarTugasAkhir.getFakultas() == null ? "Semua"
					: jadwalSeminarTugasAkhir.getFakultas().getNama()).setParent(arg0);

			new Label(jadwalSeminarTugasAkhir.getKeterangan()).setParent(arg0);
			...
			button.addEventListener("onClick", new EventListener() {
				...
				public void onEvent(Event event) throws Exception {
					LaporanSeminar laporanRekapitulasiSeminar = new LaporanSeminar(jadwalSeminarTugasAkhir);
					laporanRekapitulasiSeminar.setClosable(true);
					laporanRekapitulasiSeminar.setTitle("Laporan Jadwal Seminar");
					laporanRekapitulasiSeminar.setHeight("97%");
					laporanRekapitulasiSeminar.setWidth("97%");
					laporanRekapitulasiSeminar.setParent(page.getFirstRoot());
					laporanRekapitulasiSeminar.onModal();
				}
			...
			button.setVisible(edit && tbmuser != null && tbmuser.getMahasiswa() == null && tbmuser.getSiswa() == null
					&& tbmuser.ambilDosen() == null);
			button.addEventListener("onClick", new EventListener() {
				@Override
				public void onEvent(Event event) throws Exception {
					init(jadwalSeminarTugasAkhir);
							...
							new EventListener() {
								...
								public void onEvent(Event event) throws Exception {
									...
									if (i == MyMessageboxConfig.OK) {
										try {
											onDelete(jadwalSeminarTugasAkhir);
	...
	public static void onDelete(JadwalSeminarTugasAkhir jadwalSeminarTugasAkhir) {

		Common.refreshDelete(jadwalSeminarTugasAkhir);
	}

	public void onAdd(Event event) throws Exception {
		init(new JadwalSeminarTugasAkhir());
		addWindow.setVisible(true);
		addWindow.onModal();
	}

	@SuppressWarnings("deprecation")
	private void init(final JadwalSeminarTugasAkhir jadwalSeminarTugasAkhir) {
		...
		addWindow.setTitle(jadwalSeminarTugasAkhir.getId() == null ? "Tambah Jadwal Seminar" : "Ubah Jadwal Seminar");
		...
		row.appendChild(
				nama = new Textbox(jadwalSeminarTugasAkhir.getNama() == null ? "" : jadwalSeminarTugasAkhir.getNama()));
		nama.setWidth("90%");
		nama.setRows(2);
		...
		row.appendChild(mulai = new MyDatebox(jadwalSeminarTugasAkhir.getMulai()));
		mulai.setWidth("90%");
		...
		row.appendChild(sampai = new MyDatebox(jadwalSeminarTugasAkhir.getSampai()));
		sampai.setWidth("90%");
		...
		row.appendChild(ruangSeminar = new AmbilDataRuangBanbox());
		ruangSeminar.setValue(jadwalSeminarTugasAkhir == null || jadwalSeminarTugasAkhir.getRuangSeminar() == null ? ""
				: jadwalSeminarTugasAkhir.getRuangSeminar().getKodeRuangan() + " - "
						+ jadwalSeminarTugasAkhir.getRuangSeminar().getNama());
		ruangSeminar.setAttribute("ruang", jadwalSeminarTugasAkhir.getRuangSeminar());
		ruangSeminar.setWidth("90%");
		...
		Common.selectComboItem(fakultas, jadwalSeminarTugasAkhir.getFakultas() == null ? tbmuser.ambilFakultas()
				: jadwalSeminarTugasAkhir.getFakultas());
		...
		Common.pilihJurusan(jurusan, jadwalSeminarTugasAkhir.getJurusan() == null ? tbmuser.ambilJurusan()
				: jadwalSeminarTugasAkhir.getJurusan());
		...
		Common.selectComboItem(program, jadwalSeminarTugasAkhir.getProgram());
		program.setWidth("90%");
		...
		row.appendChild(keterangan = new Textbox(
				jadwalSeminarTugasAkhir.getKeterangan() == null ? "" : jadwalSeminarTugasAkhir.getKeterangan()));
		...
		Grid subGrid = initJadwal(jadwalSeminarTugasAkhir);
				...
				if (onSave(event)) {
					...
					if (eventListener != null) {
						eventListener.onEvent(
								new Event("", addWindow, JadwalSeminarTugasAkhirAction.this.jadwalSeminarTugasAkhir));
					}
	...
	@SuppressWarnings("deprecation")
	private Grid initJadwal(final JadwalSeminarTugasAkhir jadwalSeminarTugasAkhir) {
		...
		List<Object[]> list = jadwalSeminarTugasAkhir.daftarJadwal();
						...
						MyMessageboxConfig.show("Apakah yakin ingin menghapus data ini ?", "Pertanyaan",
								...
								new EventListener() {
									...
									public void onEvent(Event event) throws Exception {
										int i = Integer.parseInt(event.getData().toString());
										if (i == MyMessageboxConfig.OK) {
											if (jadwalSeminarTugasAkhir.getId() != null) {
												jadwalSeminarTugasAkhir.hapusJadwal(n);
												Common.refreshUpdate(jadwalSeminarTugasAkhir);
											}
											subrow.detach();
										}
			...
			public void onEvent(Event event) throws Exception {
				...
				if (jadwalSeminarTugasAkhir.getId() != null) {
					EventListener eventListener = new EventListener() {
						...
						@Override
						public void onEvent(Event arg0) throws Exception {
							jadwalSeminarTugasAkhir.populateJadwal(nama.getValue(), mulai.getValue(), sampai.getValue(),
									keterangan.getValue());
							Common.refreshUpdate(jadwalSeminarTugasAkhir);
						}
					};
				...
				subrow.setValign("top");
				subrow.setAttribute("mulai", mulai);
				subrow.setValign("top");
				subrow.setAttribute("sampai", sampai);
				subrow.setValign("top");
						...
						MyMessageboxConfig.show("Apakah yakin ingin menghapus data ini ?", "Pertanyaan",
								...
								new EventListener() {
									...
									public void onEvent(Event event) throws Exception {
										...
										if (i == MyMessageboxConfig.OK) {
											if (jadwalSeminarTugasAkhir.getId() != null) {
												jadwalSeminarTugasAkhir.hapusJadwal(nama.getValue());
												Common.refreshUpdate(jadwalSeminarTugasAkhir);
											}
											subrow.detach();
										}
	...
	public boolean onSave(Event event) throws Exception {
		...
		if (jadwalSeminarTugasAkhir.getId() != null) {
			jadwalSeminarTugasAkhir = (JadwalSeminarTugasAkhir) session.load(JadwalSeminarTugasAkhir.class,
					jadwalSeminarTugasAkhir.getId());

		}
		jadwalSeminarTugasAkhir.setProgram(
				(String) (program.getSelectedItem() == null || program.getSelectedItem().getValue() == null ? null
						: program.getSelectedItem().getValue()));
		jadwalSeminarTugasAkhir.setRuangSeminar((Ruang) ruangSeminar.getAttribute("ruang"));
		jadwalSeminarTugasAkhir.setTahunAkademik((String) tahunAkademik.getSelectedItem().getValue());
		jadwalSeminarTugasAkhir.setNama(nama.getValue());
		jadwalSeminarTugasAkhir.setKeterangan(keterangan.getValue());
		jadwalSeminarTugasAkhir.setJurusan(
				(Jurusan) (jurusan.getSelectedItem() == null || jurusan.getSelectedItem().getValue() == null ? null
						: jurusan.getSelectedItem().getValue()));
		jadwalSeminarTugasAkhir.setFakultas(
				(Fakultas) (fakultas.getSelectedItem() == null || fakultas.getSelectedItem().getValue() == null ? null
						: fakultas.getSelectedItem().getValue()));
		jadwalSeminarTugasAkhir.setMulai(mulai.getValue());
		jadwalSeminarTugasAkhir.setSampai(sampai.getValue());

		if (subrows != null) {
			jadwalSeminarTugasAkhir.setJadwalRinci("");
			...
			for (Row row : rows) {
				if (row.getAttribute("nama") != null) {
					...
					jadwalSeminarTugasAkhir.populateJadwal((String) o[0], (Date) o[1], (Date) o[2], (String) o[3]);
				}
			}
		}

		Common.refreshSaveOrUpdate(session, jadwalSeminarTugasAkhir);
	...
	public void onSearchDefault(Event event) {
		...
		List<JadwalSeminarTugasAkhir> jadwalSeminarTugasAkhir = initCriteria(true)
