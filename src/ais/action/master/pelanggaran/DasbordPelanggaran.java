...
public class DasbordPelanggaran extends Div {
    ...
    /**
     * Enum lokal {@link Lingkup} yang mendefinisikan pilihan/status untuk alur DasbordPelanggaran. Nilainya
     * berlaku dalam konteks kelas induk dan tidak dimaksudkan sebagai status domain global.
     *
     * <p><b>Scope:</b> setiap instance terikat pada instance {@link DasbordPelanggaran} dan dapat mengakses state
     * kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
     * <p>Kontrak yang tampak dari deklarasi ini meliputi operasi lokal: {@code getNamaModul}(); nilai: {@code
     * SEMUA}, {@code MAHASISWA}, {@code SISWA}, {@code PEGAWAI}. Aturan bisnis bersama tetap berada pada kelas
     * induk atau service yang dipanggilnya.</p>
     * <p><b>Efek samping:</b> operasi dapat mengubah state lokal dan, sesuai nama methodnya, komponen UI atau
     * persistence melalui konteks kelas induk. Gunakan transaksi, otorisasi, dan session milik alur induk;
     * tambahkan perilaku lintas domain pada service bersama.</p>
     *
     * @see DasbordPelanggaran
     */
    public enum Lingkup {
    ...
    /**
     * Tipe implementasi bersarang {@link PelEntry} milik {@link DasbordPelanggaran}. Kelas ini memberi nama pada
     * state atau perilaku lokal agar tanggung jawabnya tidak tersebar sebagai blok anonim.
     *
     * <p><b>Scope:</b> tipe bersifat {@code static}; instance tidak menangkap object {@link DasbordPelanggaran}.
    ...
    /**
     * Pembawa data/helper lokal milik {@link DasbordPelanggaran} untuk dash data. Tipe ini mengelompokkan nilai
