...
/**
 * Tipe khusus untuk ambil data asset banyak berdasarkan stok. Kelas ini memberi nama dan batas
 ...
 * eventListener}, {@code List masterAssets}, {@code SatuanKerja satuanKerja}, {@code Set ids}, {@code String
 * orderBy}, {@code Boolean disableStokHabis}, {@code MyTextbox kodeMasterAssetan}; pembacaan/pencarian ({@code
...
public class AmbilDataAssetBanyakBerdasarkanStok extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataAssetBanyakBerdasarkanStok}. Kelas ini menerjemahkan
	 * satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataAssetBanyakBerdasarkanStok} dan dapat
	 ...
	 *
	 * @see AmbilDataAssetBanyakBerdasarkanStok
	 */
