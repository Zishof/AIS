...
/**
 * Tipe khusus untuk ambil data penerimaan pengadaan aset banbox. Kelas ini memberi nama dan batas
 ...
 * eventListener}, {@code Paging paging}, {@code MyTextbox kode}, {@code MyTextbox nama}, {@code MyTextbox
 * penyedia}; inisialisasi/lifecycle ({@code initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()},
 * {@code setEventListener()}, {@code getEventListener()}); operasi domain lain ({@code display()}); konfigurasi
 * constructor: {@code paging}. Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut
 * di atas.</p>
...
public class AmbilDataPenerimaanPengadaanAsetBanbox extends Bandbox {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataPenerimaanPengadaanAsetBanbox}. Kelas ini menerjemahkan
	 * satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataPenerimaanPengadaanAsetBanbox} dan
	 ...
	 *
	 * @see AmbilDataPenerimaanPengadaanAsetBanbox
	 */
