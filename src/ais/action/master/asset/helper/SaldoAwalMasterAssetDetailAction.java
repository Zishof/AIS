...
/**
 * Controller/action ZK untuk saldo awal master asset detail. Tipe ini merupakan titik masuk UI
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code SaldoAwalMasterAsset
 * saldoAwalMasterAsset}, {@code MyGrid grid}, {@code boolean edit}, {@code boolean delete}, {@code String
 * contents}, {@code Textbox nama}, {@code boolean terimaTagihan}, {@code Footer footerTotalSemua};
 * inisialisasi/lifecycle ({@code initCriteria()}); pembacaan/pencarian ({@code reloadNilaiTimer()}, {@code
 * loadData()}, {@code reloadNilai()}, {@code uploadDataMasterAsset()}); operasi domain lain ({@code isEmpty()},
 * {@code doubleValue()}, {@code safeText()}, {@code formatNumber()}, {@code isReadonly()}, {@code
 * nilaiPphAman()}); konfigurasi constructor: {@code delete}, {@code edit}. Bagian lain dari kontrak tetap
...
public class SaldoAwalMasterAssetDetailAction extends MyDetail implements DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link SaldoAwalMasterAssetDetailAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link SaldoAwalMasterAssetDetailAction} dan dapat
	 ...
	 *
	 * @see SaldoAwalMasterAssetDetailAction
	 */
