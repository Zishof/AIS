...
public class AmbilDataAssetDetailBanbox extends Bandbox implements GetEventListener {
	...
	class AssetDetailRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(Row arg0, Object arg1) throws Exception {
			...
			Radio checkbox = new Radio(assetDetail.getBarcode());
			checkbox.setParent(arg0);
			arg0.setAttribute("checkbox", checkbox);
			// checkbox.setId(assetDetail.getId() + "");

			checkbox.addEventListener("onCheck", new EventListener() {
				@Override
				public void onEvent(Event event) throws Exception {
					AmbilDataAssetDetailBanbox.this.setOpen(false);
					AmbilDataAssetDetailBanbox.this.setAttribute("assetDetail", assetDetail);
					AmbilDataAssetDetailBanbox.this.setValue(assetDetail.toString());
	...
	public void onSearchDefault(Event event) {
		...
		List<AssetDetail> assetDetail = session.createCriteria(AssetDetail.class)
