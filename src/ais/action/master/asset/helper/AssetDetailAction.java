...
/**
 * Controller/action ZK untuk asset detail. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Asset asset}, {@code MyGrid grid},
 * {@code boolean add}, {@code boolean edit}, {@code boolean delete}, {@code EventListener eventListener}, {@code
 * List assetDetails}, {@code Combobox searchlokasi}; inisialisasi/lifecycle ({@code initCriteria()});
 * pembacaan/pencarian ({@code loadData()}, {@code onSearchDefault()}); operasi domain lain ({@code display()});
 * konfigurasi constructor: {@code add}, {@code delete}, {@code edit}, {@code gambar}, {@code
 * satuanKerjaTreeModel}, {@code selectedLokasi}, {@code selectedPemilikAsset}, {@code selectedRuang}. Bagian
...
public class AssetDetailAction extends MyDetail implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AssetDetailAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AssetDetailAction} dan dapat mengakses state
