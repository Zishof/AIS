...
/**
 * Controller/action ZK untuk kegiatan. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * updateBatasStudiMahasiswa()}, {@code prosesTagihan()}); operasi domain lain ({@code onCicilan()}, {@code
 * onSejarah()}, {@code onTunggakan()}, {@code onPerbandinganPembayaran()}, {@code onBelumBayar()}, {@code
 * onSudahBayar()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di
 * atas.</p>
