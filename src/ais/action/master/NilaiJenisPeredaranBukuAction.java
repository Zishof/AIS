...
/**
 * Controller/action ZK untuk nilai jenis peredaran buku. Tipe ini merupakan titik masuk UI yang
...
public class NilaiJenisPeredaranBukuAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link NilaiJenisPeredaranBukuAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link NilaiJenisPeredaranBukuAction} dan dapat
	 * mengakses state kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi state utama: {@code List tahapanPenyusunanBukus}; operasi
	 * lokal: {@code tampilRow()}, {@code render}(). Aturan bisnis bersama tetap berada pada kelas induk atau
	 * service yang dipanggilnya.</p>
	 * <p><b>Efek samping:</b> operasi dapat mengubah komponen ZK dan memanggil alur kelas induk. Jalankan pada
	 * event thread dengan konteks pengguna/session aktif; jangan menyalin query atau validasi domain ke
	 * renderer/listener ini.</p>
	 *
	 * @see NilaiJenisPeredaranBukuAction
	 */
