    ...
    public void onCetak(Event event) {
        ...
        try {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                	try {
                    String jenisJurusan = selectedJurusan == null ? "" : selectedJurusan.getJenisJurusan();

                    List<List> datas = new ArrayList<List>();
                    for (int i = 0; i < 9; i++) datas.add(new ArrayList());
                    ArrayList jenisRow = new ArrayList();
                    jenisRow.add(""); jenisRow.add(""); jenisRow.add("");
                    jenisRow.add(jenisJurusan == null ? "" : jenisJurusan);
                    datas.add(jenisRow);
            ...
            EventListener onCellClick = new EventListener() {
                ...
                public void onEvent(Event arg0) throws Exception {
                    ...
                    } catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/sapto/LaporanProfileDosen_A_4_3_2.java:130"); /* ignore */ }
                }
            };
