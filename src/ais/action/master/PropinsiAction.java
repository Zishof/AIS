...
public class PropinsiAction extends GenericCrudAction<Propinsi> {
    ...
    /**
     * Renderer lokal untuk layar/komponen {@link PropinsiAction}. Kelas ini menerjemahkan satu item data menjadi
     * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
     *
     * <p><b>Scope:</b> setiap instance terikat pada instance {@link PropinsiAction} dan dapat mengakses state
