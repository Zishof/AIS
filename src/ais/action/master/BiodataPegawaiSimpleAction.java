...
/**
 * Controller/action ZK untuk biodata pegawai simple. Tipe ini merupakan titik masuk UI yang
 ...
 * commonOnSearchdefault}, {@code ManagingPegawai managingPegawai}, {@code SatuanKerja satuanKerjaOnSession},
 * {@code Boolean tampilBatal}; inisialisasi/lifecycle ({@code init()}); pembacaan/pencarian ({@code
 * setCommonOnSearchdefault()}, {@code getCommonOnSearchdefault()}). Bagian lain dari kontrak tetap mengikuti
 ...
 * @see MyWindow
 */
public class BiodataPegawaiSimpleAction extends MyWindow {
	/**
	 * 
	 */
	...
	public BiodataPegawaiSimpleAction() throws Exception {
		super();
		init(null);
	}

	public BiodataPegawaiSimpleAction(SatuanKerja satuanKerjaOnSession) throws Exception {
		super();
		this.satuanKerjaOnSession = satuanKerjaOnSession;
		init(null);
	}

	public BiodataPegawaiSimpleAction(String title, String border, boolean closable) throws Exception {
		super(title, border, closable);
		init(null);
	}

	public BiodataPegawaiSimpleAction(String title, String border, boolean closable, SatuanKerja satuanKerjaOnSession)
			throws Exception {
		super(title, border, closable);
		this.satuanKerjaOnSession = satuanKerjaOnSession;
		init(null);
	...
	public BiodataPegawaiSimpleAction(Pegawai pegawai) throws Exception {
		super();
		init(pegawai);
	}

	public BiodataPegawaiSimpleAction(Pegawai pegawai, SatuanKerja satuanKerjaOnSession) throws Exception {
		super();
		this.satuanKerjaOnSession = satuanKerjaOnSession;
		init(pegawai);
	}

	public BiodataPegawaiSimpleAction(Pegawai pegawai, SatuanKerja satuanKerjaOnSession, Boolean tampilLogin,
	...
	public BiodataPegawaiSimpleAction(Pegawai pegawai, String title, String border, boolean closable) throws Exception {
		super(title, border, closable);
		init(pegawai);
	...
	private void init(Pegawai pegawai) throws Exception {
		...
		tabs.appendChild(new MyTabConfig("Data Pegawai"));
		...
		cancel.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				BiodataPegawaiSimpleAction.this.setVisible(false);
			}
		});
	...
	/**
	 * Tipe implementasi bersarang {@link ManagingPegawai} milik {@link BiodataPegawaiSimpleAction}. Kelas ini
	 * memberi nama pada state atau perilaku lokal agar tanggung jawabnya tidak tersebar sebagai blok anonim.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link BiodataPegawaiSimpleAction} dan dapat
	 ...
	 *
	 * @see BiodataPegawaiSimpleAction
	 */
	private class ManagingPegawai {
		...
		public Tabpanel init(final Pegawai pegawai) throws Exception {
			...
			alamatrow.appendChild(new MyLabelConfig("Jalan"));
			...
			// pegawai.getJurusan() == null ? tbmuser.getFakultas()
			// : pegawai.getJurusan().getFakultas());
			// row.appendChild(fakultas);
			// fakultas.setWidth("90%");
			//
			// if (Common.getCurrentUser() != null
			// && Common.getCurrentUser().getFakultas() != null) {
			// fakultas.setDisabled(fakultas.getSelectedItem() != null);
			// }
			//
			// if (Common.getCurrentUser() != null
			...
			// },
			// "jenjang", Jurusan.class, Restrictions.or(Restrictions.isNull("aktif"),
			// Restrictions.eq("aktif", true)), Restrictions.eq(
			// "fakultas",
			// pegawai.getJurusan() == null ? tbmuser
			// .getFakultas() : pegawai.getJurusan()
			// .getFakultas()));
			//
			// row = new MyFormRow();
			//			// row.setParent(rows);
			...
			// pegawai.getJurusan() == null ? tbmuser.getJurusan()
			// : pegawai.getJurusan());
			// row.appendChild(jurusan);
			// jurusan.setWidth("90%");
			//
			// if (Common.getCurrentUser() != null
			// && Common.getCurrentUser().getJurusan() != null) {
			// jurusan.setDisabled(jurusan.getSelectedItem() != null);
			// }
			//
			// if (Common.getCurrentUser() != null
			// && Common.getCurrentUser().ambilPegawai() != null)
	...
	/**
	 * Tipe implementasi bersarang {@link ManagingBiodataPegawai} milik {@link BiodataPegawaiSimpleAction}. Kelas
