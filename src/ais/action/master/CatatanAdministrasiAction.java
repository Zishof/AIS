...
/**
 * Controller/action ZK untuk catatan administrasi. Tipe ini merupakan titik masuk UI yang
 ...
 * AmbilDataSatuanKerjaBanbox searchparent}, {@code boolean edit}, {@code boolean delete}; inisialisasi/lifecycle
 ...
 * domain lain ({@code onDasbor()}, {@code onLaporan()}, {@code onJenisCatatanAdministrasi()}, {@code
 * onManajemenParameter()}, {@code onAdd()}, {@code form()}). Bagian lain dari kontrak tetap mengikuti kelas
...
//		add.getParent().appendChild(upload);
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link CatatanAdministrasiAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link CatatanAdministrasiAction} dan dapat mengakses
