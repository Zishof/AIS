...
/**
 * Controller/action ZK untuk tunggakan mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * onTampilRekapTunggakanMahasiswa()}, {@code onTampilRekapTunggakanMahasiswaDetail()}, {@code
 * onSearchDefault()}, {@code loadData()}); mutasi data ({@code onProsesUlangTunggakan()}, {@code
 * onProsesUlangTunggakanMahasiswaBaru()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface
