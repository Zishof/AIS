...
/**
 * Controller/action ZK untuk detail biaya. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * paging}, {@code MyGrid grid}, {@code Combobox tahunAkademik}, {@code Combobox jenisBiaya}, {@code Combobox
 * itemBiaya}, {@code Combobox wnaAtauWni}, {@code Combobox jenisSeleksi}; inisialisasi/lifecycle ({@code
...
public class DetailBiayaAction extends GenericAutowireComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		/**
		 * Event listener lokal milik {@link DetailBiayaAction}. Kelas ini menangani event untuk komponen induk dan
		 * meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DetailBiayaAction} dan dapat mengakses state
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link DetailBiayaAction}. Kelas ini menerjemahkan satu item data
