...
/**
 * Controller/action ZK untuk formulir kegiatan. Tipe ini merupakan titik masuk UI yang
 ...
 * searchfakultas}, {@code Combobox searchyayasan}, {@code Combobox searchsekolah}; inisialisasi/lifecycle
 * ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code init()}, {@code initReferensi()},
 * {@code initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}, {@code getKodeItemBiaya()}); mutasi
 * data ({@code onSave()}, {@code setKodeItemBiaya()}); operasi domain lain ({@code
 * loginSebagaiPesertaAtauPengajar()}, {@code onGrupFormulirKegiatan()}, {@code onSertifikat()}, {@code
 * onJenisFormulirKegiatan()}, {@code onAdd()}, {@code addReferensi()}). Bagian lain dari kontrak tetap mengikuti
...
//		Common.selectComboItem(searchsmt, Common.isNowSemensterGanjil() ? 1 : 2);
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link FormulirKegiatanAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link FormulirKegiatanAction} dan dapat mengakses
