...
/**
 * Controller/action ZK untuk scan berhasil. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * messageVideo}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()});
 * pembacaan/pencarian ({@code tampilanError()}); mutasi data ({@code proses()}, {@code simpanStatusKehadiran()},
 * {@code simpanPertemuanAbsensi()}); operasi domain lain ({@code rollbackQuietly()}). Bagian lain dari kontrak
