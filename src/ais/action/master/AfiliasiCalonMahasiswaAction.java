...
/**
 * Controller/action ZK untuk afiliasi calon mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Textbox searchcalon}, {@code Checkbox
 * searchaktif}, {@code Combobox searchTahunAjaran}, {@code Textbox nama}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code init()}, {@code initCriteria()});
 * pembacaan/pencarian ({@code tampilkanSemuaDownload()}, {@code onSearchDefault()}); mutasi data ({@code
 * onSave()}); operasi domain lain ({@code onDosen()}, {@code onMahasiswa()}, {@code onAdd()}). Bagian lain dari
...
public class AfiliasiCalonMahasiswaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AfiliasiCalonMahasiswaAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AfiliasiCalonMahasiswaAction} dan dapat
	 ...
	 *
	 * @see AfiliasiCalonMahasiswaAction
	 */
