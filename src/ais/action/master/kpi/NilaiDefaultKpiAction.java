...
/**
 * Controller/action ZK untuk nilai default kpi. Tipe ini merupakan titik masuk UI yang
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaNilaiDefaultKpi()}); mutasi data ({@code
...
public class NilaiDefaultKpiAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link NilaiDefaultKpiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link NilaiDefaultKpiAction} dan dapat mengakses
