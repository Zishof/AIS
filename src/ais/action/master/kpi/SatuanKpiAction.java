...
/**
 * Controller/action ZK untuk satuan kpi. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaSatuanKpi()}); mutasi data ({@code onSave()});
...
public class SatuanKpiAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link SatuanKpiAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link SatuanKpiAction} dan dapat mengakses state
