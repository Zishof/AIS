...
public class SkorKpiAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault, DataInitDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link SkorKpiAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link SkorKpiAction} dan dapat mengakses state kelas
