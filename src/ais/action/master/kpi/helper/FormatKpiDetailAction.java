...
/**
 * Controller/action ZK untuk format kpi detail. Tipe ini merupakan titik masuk UI yang
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code FormatKpi formatKpi}, {@code Paging
...
public class FormatKpiDetailAction extends MyDetail {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link FormatKpiDetailAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link FormatKpiDetailAction} dan dapat mengakses
