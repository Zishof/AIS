...
/**
 * Tipe khusus untuk ambil data format kpi detail banbox. Kelas ini memberi nama dan batas tanggung
 ...
 * @see Bandbox
 */
public class AmbilDataFormatKpiDetailBanbox extends Bandbox {
	...
	public AmbilDataFormatKpiDetailBanbox() {
		super();
		setReadonly(true);
		try {
			display();
		} catch (Exception e) {
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/kpi/helper/AmbilDataFormatKpiDetailBanbox.java:70");
		}
		...
		if (tbmuser != null && tbmuser.ambilPegawai() != null) {
			FormatKpiDetail formatKpiDetail = (FormatKpiDetail) ConstantValues
					.simpleObject(HibernateUtil.currentSession().createCriteria(FormatKpiDetail.class)
							.add(Restrictions.or(Restrictions.isNull("aktif"), Restrictions.eq("aktif", true))).setMaxResults(1).createAlias("formatKpi", "formatKpi")
							.add(Restrictions.eq("formatKpi.aktif", true))
							.add(Restrictions.eq("pegawai", tbmuser.ambilPegawai())), FormatKpiDetail.class);

			if (formatKpiDetail != null) {
				AmbilDataFormatKpiDetailBanbox.this.setAttribute("formatKpiDetail", formatKpiDetail);
				AmbilDataFormatKpiDetailBanbox.this.setValue(formatKpiDetail.getFormatKpi().getNama());
				AmbilDataFormatKpiDetailBanbox.this.setDisabled(true);
			}
		}
	}
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataFormatKpiDetailBanbox}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataFormatKpiDetailBanbox} dan dapat
	 ...
	 *
	 * @see AmbilDataFormatKpiDetailBanbox
	 */
	public class FormatKpiRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(Row arg0, Object arg1) throws Exception {
			...
			final FormatKpiDetail formatKpiDetail = (FormatKpiDetail) arg1;
			FormatKpi formatKpi = formatKpiDetail.getFormatKpi();
			arg0.addEventListener("onClick", new EventListener() {
				@Override
				public void onEvent(Event event) throws Exception {
					AmbilDataFormatKpiDetailBanbox.this.setOpen(false);
					AmbilDataFormatKpiDetailBanbox.this.setAttribute("formatKpiDetail", formatKpiDetail);
					AmbilDataFormatKpiDetailBanbox.this.setValue(formatKpiDetail.getFormatKpi().getNama());
			...
			new Label(formatKpiDetail.getPegawai() == null ? "" : formatKpiDetail.getPegawai().getNama())
					.setParent(arg0);
	...
	public void onSearchDefault(Event event) {
		...
		List<FormatKpiDetail> formatKpiDetails = session.createCriteria(FormatKpiDetail.class)

				.createAlias("formatKpi", "formatKpi")

				.add(satuanKerjas.size() == 0 ? Restrictions.sqlRestriction("1=1")
						: Restrictions.or(Restrictions.isNull("formatKpi.satuanKerja"),
								Restrictions.or(
										parent == null ? Restrictions.isNull("formatKpi.satuanKerja")
												: Restrictions.sqlRestriction("false"),
										Restrictions.in("formatKpi.satuanKerja", satuanKerjas))))

				.add(searchjurusan.getSelectedItem() == null || searchjurusan.getSelectedItem().getValue() == null
						|| searchjurusan.getSelectedItem().getValue() == null ? Restrictions.sqlRestriction("1=1")
								: CommonSearchFilterHelper.eqSelectedWithId("formatKpi.jurusan", searchjurusan, false))

				.add(searchfakultas.getSelectedItem() == null || searchfakultas.getSelectedItem().getValue() == null
						|| searchfakultas.getSelectedItem().getValue() == null ? Restrictions.sqlRestriction("1=1")
								: CommonSearchFilterHelper.eqSelectedWithId("formatKpi.fakultas", searchfakultas, false))

				.add(searchsekolah.getSelectedItem() == null || searchsekolah.getSelectedItem().getValue() == null
						|| searchsekolah.getSelectedItem().getValue() == null ? Restrictions.sqlRestriction("1=1")
								: CommonSearchFilterHelper.eqSelectedWithId("formatKpi.sekolah", searchsekolah, false))

				.add(searchyayasan.getSelectedItem() == null || searchyayasan.getSelectedItem().getValue() == null
						|| searchyayasan.getSelectedItem().getValue() == null ? Restrictions.sqlRestriction("1=1")
								: CommonSearchFilterHelper.eqSelectedWithId("formatKpi.yayasan", searchyayasan, false))

				.addOrder(Order.desc("id"))
				.add(nama.getValue().trim().isEmpty() ? Restrictions.sqlRestriction("true")
						: Restrictions.ilike("formatKpi.nama", nama.getValue().trim(), MatchMode.ANYWHERE))
