...
public class ReimbursementPegawaiAction extends GenericAutowireComposer {
    ...
    public void onSubmit(Event event) throws Exception {
        ...
        if (pengaju == null || approver == null || deskripsi.getValue().trim().isEmpty()
                || nominal.getValue() == null || nominal.getValue().doubleValue() <= 0
                || tanggalPengeluaran.getValue() == null) {
            warn("Pegawai, deskripsi, nominal, tanggal pengeluaran, dan atasan wajib diisi."); return;
        }
