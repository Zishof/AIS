...
/**
 * Tipe khusus untuk ambil data banyak akun. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * eventListener}, {@code AkunTreeModel akunTreeModel}, {@code Integer debetCredit}, {@code List akuns}, {@code
 * Map checkes}, {@code boolean bolehPilihLihatSemuaAkun}; pembacaan/pencarian ({@code onSearchDefault()}, {@code
...
public class AmbilDataBanyakAkun extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataBanyakAkun}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataBanyakAkun} dan dapat mengakses state
	...
	/**
	 * Tipe implementasi bersarang {@link AkunSeringDipakai} milik {@link AmbilDataBanyakAkun}. Kelas ini memberi
	 ...
	 * ais.ui.util.AmbilDataPagingHelper pagingHelper}, {@code Textbox kodeAkunan}, {@code Textbox nama}, {@code
	 * AmbilDataSatuanKerjaBanbox satuanKerja}; operasi lokal: {@code display()}, {@code onSearchDefault}(). Aturan
	...
	private final ais.ui.util.AmbilDataPagingHelper pagingHelper = new ais.ui.util.AmbilDataPagingHelper();
		...
		/**
		 * Renderer lokal untuk layar/komponen {@link AkunSeringDipakai}. Kelas ini menerjemahkan satu item data
		 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AkunSeringDipakai} dan dapat mengakses state
		 * kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
		 * <p>Kontrak yang tampak dari deklarasi ini meliputi operasi lokal: {@code render}(). Aturan bisnis bersama
		 * tetap berada pada kelas induk atau service yang dipanggilnya.</p>
		 * <p><b>Efek samping:</b> operasi dapat mengubah komponen ZK dan memanggil alur kelas induk. Jalankan pada
