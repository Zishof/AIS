...
/**
 * Tipe khusus untuk ambil data standing instruction banyak. Kelas ini memberi nama dan batas
 ...
 * standingInstructions}, {@code List standingInstructionsHanyaDitampilkan}, {@code MyTextbox nama}, {@code Set
...
public class AmbilDataStandingInstructionBanyak extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataStandingInstructionBanyak}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataStandingInstructionBanyak} dan dapat
	 ...
	 *
	 * @see AmbilDataStandingInstructionBanyak
	 */
