...
/**
 * Tipe khusus untuk ambil data akun pajak banyak. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * ais.ui.util.AmbilDataPagingHelper pagingHelper}, {@code EventListener eventListener}, {@code List akunPajaks},
 * {@code List akunPajaksHanyaDitampilkan}, {@code Double nilai}, {@code Set ids}, {@code MyTextbox nama};
 * pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()}, {@code getEventListener()});
 * operasi domain lain ({@code display()}); konfigurasi constructor: {@code nilai}. Bagian lain dari kontrak
...
public class AmbilDataAkunPajakBanyak extends MyWindow {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataAkunPajakBanyak}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataAkunPajakBanyak} dan dapat mengakses
