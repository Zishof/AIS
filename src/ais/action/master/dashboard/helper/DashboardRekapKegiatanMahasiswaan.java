...
/**
 * Komponen dashboard khusus untuk dashboard rekap kegiatan mahasiswaan. Kelas ini memilih variasi
 ...
 * @see MyWindow
 */
public class DashboardRekapKegiatanMahasiswaan extends MyWindow {
	...
	public DashboardRekapKegiatanMahasiswaan(String namaKolom, String kolomGroup) {
		super();
	...
	private void initSpreadsheet() {
		...
		List<GeneralValueObject> generalValueObjects = session.createCriteria(KegiatanKemahasiswaanPunyaMahasiswa.class)
		...
		sql += " sum(case when " + namaKolom + " is not null then 1 else 0 end) as total "
				+ " from kegiatan_kemahasiswaan_punya_mahasiswa aaa  "
				+ " inner join kegiatan_kemahasiswaan k on (aaa.kegiatan_kemahasiswaan = k.id  )    "
		...
		for (Object[] objects : jurusans) {
			...
			} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/dashboard/helper/DashboardRekapKegiatanMahasiswaan.java:394");
			}
		...
		} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/dashboard/helper/DashboardRekapKegiatanMahasiswaan.java:426");
		}
		...
		} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/dashboard/helper/DashboardRekapKegiatanMahasiswaan.java:436");
		}
