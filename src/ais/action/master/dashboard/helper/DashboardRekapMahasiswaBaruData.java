...
/**
 * Komponen dashboard khusus untuk dashboard rekap mahasiswa baru data. Kelas ini memilih variasi
 ...
 * @see MyWindow
 */
public class DashboardRekapMahasiswaBaruData extends MyWindow {
	...
	public DashboardRekapMahasiswaBaruData(String namaKolom, String kolomGroup) {
		super();
	...
	private void initSpreadsheet() {
		...
		for (Object generalValueObject : generalValueObjects) {
			if (generalValueObject != null && !generalValueObject.toString().isEmpty()) {
				sql += "sum(case when aaa." + namaKolom
						+ (generalValueObject instanceof String
								? " ilike '" + org.apache.commons.lang3.StringUtils.replace(
										org.apache.commons.lang3.StringUtils.replace(generalValueObject.toString(), "\'", "''"), "\"", "") + "'"
								: " = " + generalValueObject.toString())
						+ " and aaa.jenis_kelamin='Laki-laki' then 1 else 0 end) as \"" + generalValueObject
						+ " Laki-laki\", ";
				sql += "sum(case when aaa." + namaKolom
						+ (generalValueObject instanceof String
								? " ilike '" + org.apache.commons.lang3.StringUtils.replace(
										org.apache.commons.lang3.StringUtils.replace(generalValueObject.toString(), "\'", "''"), "\"", "") + "'"
								: " = " + generalValueObject.toString())
						+ " and aaa.jenis_kelamin='Perempuan' then 1 else 0 end) as \"" + generalValueObject
						+ " Perempuan\", ";
				sql += "sum(case when aaa." + namaKolom
						+ (generalValueObject instanceof String
								? " ilike '" + org.apache.commons.lang3.StringUtils.replace(
										org.apache.commons.lang3.StringUtils.replace(generalValueObject.toString(), "\'", "''"), "\"", "") + "'"
								: " = " + generalValueObject.toString())
						+ " then 1 else 0 end) as \"" + generalValueObject + "\", ";
			}
		}
		...
		for (Object generalValueObject : generalValueObjects) {
			if (generalValueObject != null && !generalValueObject.toString().isEmpty()) {
				ais.ui.util.EcampusUtil.setCellValue(sheet, rowIndex, colIndex, generalValueObject);
				ais.ui.util.EcampusUtil.setCellValue(sheet, rowIndex, colIndex + 1, generalValueObject);
				ais.ui.util.EcampusUtil.setCellValue(sheet, rowIndex, colIndex + 2, generalValueObject);
		...
		for (Object[] objects : jurusans) {
			...
			} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/dashboard/helper/DashboardRekapMahasiswaBaruData.java:484");
			}
		...
		try {
			...
			ais.ui.util.EcampusUtil.setCellValue(sheet, rowIndex, colIndex + 2, total);
		} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/dashboard/helper/DashboardRekapMahasiswaBaruData.java:510");
		...
		} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/dashboard/helper/DashboardRekapMahasiswaBaruData.java:520");
		...
		} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/dashboard/helper/DashboardRekapMahasiswaBaruData.java:531");
		}
