 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Center center}, {@code int width},
 * {@code int height}, {@code Grid grid}, {@code Combobox searchyayasan}, {@code Combobox searchsekolah}, {@code
 * MyIntbox mulai}, {@code MyIntbox sampai}; inisialisasi/lifecycle ({@code init()}); pembacaan/pencarian ({@code
 * reload()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di atas.</p>
