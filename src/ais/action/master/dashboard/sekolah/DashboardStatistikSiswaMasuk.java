...
/**
 * Komponen dashboard khusus untuk dashboard statistik siswa masuk. Kelas ini memilih variasi data
...
public class DashboardStatistikSiswaMasuk extends MyWindow {
	...
	/**
	 * Event listener lokal milik {@link DashboardStatistikSiswaMasuk}. Kelas ini menangani event untuk komponen
	 * induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DashboardStatistikSiswaMasuk} dan dapat
	 * mengakses state kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi state utama: {@code Integer tahunMasuk}, {@code Long
	 ...
	 *
	 * @see DashboardStatistikSiswaMasuk
	 */
