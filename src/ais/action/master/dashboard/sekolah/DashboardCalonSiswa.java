...
/**
 * Komponen dashboard khusus untuk dashboard calon siswa. Kelas ini memilih variasi data atau
 ...
 * {@code Center center}, {@code Combobox searchyayasan}, {@code Combobox searchsekolah}, {@code Grid grid},
 * {@code int width}, {@code int height}; inisialisasi/lifecycle ({@code init()}); pembacaan/pencarian ({@code
