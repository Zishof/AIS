...
/**
 * Komponen dashboard khusus untuk dasboard surat masuk loker surat. Kelas ini memilih variasi data
 ...
 * satuanKerjaTreeModel}, {@code Grid grid}, {@code MyDatebox start}, {@code MyDatebox end};
...
public class DasboardSuratMasukLokerSurat extends MyWindow {
	...
	/**
	 * Pembawa data/helper lokal milik {@link DasboardSuratMasukLokerSurat} untuk html category model. Tipe ini
	 * mengelompokkan nilai antara agar perhitungan atau rendering tidak memakai array/map tanpa kontrak yang
	 * jelas.
	 *
	 * <p><b>Scope:</b> tipe bersifat {@code static}; instance tidak menangkap object {@link
	 * DasboardSuratMasukLokerSurat}. Dependensi yang diperlukan harus diberikan secara eksplisit agar aman
	 ...
	 *
	 * @see DasboardSuratMasukLokerSurat
	 */
