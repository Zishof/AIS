...
/**
 * Komponen dashboard khusus untuk dashboard data sekolah. Kelas ini memilih variasi data atau
 ...
 * inisialisasi/lifecycle ({@code init()}); pembacaan/pencarian ({@code tampilkanGagalMuat()}). Bagian lain dari
