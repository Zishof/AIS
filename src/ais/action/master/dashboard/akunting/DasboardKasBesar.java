...
/**
 * Komponen dashboard khusus untuk dasboard kas besar. Kelas ini memilih variasi data atau tampilan
 ...
 * @see MyWindow
 */
public class DasboardKasBesar extends MyWindow {
	...
	public DasboardKasBesar(String title, String border, boolean closable) {
	...
	private void init() throws Exception {
		...
		toolbarbutton.addEventListener("onClick", new EventListener() {
			...
			@Override
			public void onEvent(Event arg0) throws Exception {
				UIUtil.downloadGrid(DasboardKasBesar.this.grid);
			}
		});
	}
	...
	private void reload() {
		...
		for (final SatuanKerja satuanKerja : satuanKerjas) {
			...
			for (Integer status : treeMap.keySet()) {
				...
				Criteria criteria = HibernateUtil.currentSession().createCriteria(KasBesar.class)
					...
					a.addEventListener("onClick", new EventListener() {
						...
						public void onEvent(Event arg0) throws Exception {
							EventListener eventListener = (EventListener) Common
									.cetakDataCustomButton(KasBesar.class, new DataCriteriaWithColumn() {
										...
										public Object[] initCriteria(boolean order) {
											...
											try {
												...
												return new Object[] { criteria, KasBesarAction.contents };
		...
		row.appendChild(DashboardModernHtmlUtil.createAnyChart(categoryModel, "Dasbor Kas Besar", "Perbandingan data dibuat ringkas agar kelompok terbesar dan terkecil mudah terlihat.", String.valueOf("bar")));
}
}
