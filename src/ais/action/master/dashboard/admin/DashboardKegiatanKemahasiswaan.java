...
/**
 * Komponen dashboard khusus untuk dashboard kegiatan kemahasiswaan. Kelas ini memilih variasi data
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Mahasiswa mahasiswa};
 * inisialisasi/lifecycle ({@code init()}); konfigurasi constructor: {@code mahasiswa}. Bagian lain dari kontrak
