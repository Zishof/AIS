...
/**
 * Komponen dashboard khusus untuk dashboard sks dan ipk mahasiswa. Kelas ini memilih variasi data
 ...
 * @see MyWindow
 */
public class DashboardSKSDanIPKMahasiswa extends MyWindow {
	...
	public DashboardSKSDanIPKMahasiswa() {
		super();
		try {
	...
	public DashboardSKSDanIPKMahasiswa(String title, String border, boolean closable) {
	...
	private void initSpreadsheet() throws Exception {
		...
		Common.createDefaultTimer(new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				Common.clear(center);
				final String tahunAkademik = (String) (DashboardSKSDanIPKMahasiswa.this.tahunAkademik
						.getSelectedItem() == null ? null
								: DashboardSKSDanIPKMahasiswa.this.tahunAkademik.getSelectedItem().getValue());
				...
				final String filename = Sessions.getCurrent().getWebApp().getRealPath(
						"/tmp/data_" + URLEncoder.encode(Common.datetimeFormat2s.get().format(ais.ui.util.WaktuUtil.getDate()), "UTF-8") + ".xlsx");

				(file = new File(filename)).createNewFile();

				final Intbox sizedata = new Intbox(30);
				final Label label = Common.displayLoadBar(DashboardSKSDanIPKMahasiswa.this, file, center, sizedata);
				...
				new Thread(new Runnable() {
					...
					public void run() {
						...
						rowhead.createCell(8).setCellValue("SKS KUMULATIF");
						rowhead.createCell(9).setCellValue("IP KUMULATIF");

						rowhead.createCell(10).setCellValue("SKS SEMESTER");
						rowhead.createCell(11).setCellValue("IP SEMESTER");
