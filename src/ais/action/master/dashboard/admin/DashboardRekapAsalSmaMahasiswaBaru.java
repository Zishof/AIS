...
/**
 * Komponen dashboard khusus untuk dashboard rekap asal sma mahasiswa baru. Kelas ini memilih
 ...
 */
public class DashboardRekapAsalSmaMahasiswaBaru extends DashboardRekapMahasiswaBaru {
	...
	public DashboardRekapAsalSmaMahasiswaBaru() {
		super("nama_sekolah_asal", "namaSekolahAsal");
	}
