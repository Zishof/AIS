...
/**
 * Komponen dashboard khusus untuk dashboard rekap agama mahasiswa baru. Kelas ini memilih variasi
 ...
 */
public class DashboardRekapAgamaMahasiswaBaru extends DashboardRekapMahasiswaBaru {
	...
	public DashboardRekapAgamaMahasiswaBaru() {
		super("agama", "agama");
	}
