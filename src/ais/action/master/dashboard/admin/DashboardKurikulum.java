...
/**
 * Komponen dashboard khusus untuk dashboard kurikulum. Kelas ini memilih variasi data atau
 ...
 * {@code Div center}, {@code Combobox searchfakultas}, {@code Combobox searchjurusan}, {@code int width}, {@code
 * int height}; inisialisasi/lifecycle ({@code init()}); pembacaan/pencarian ({@code reload()}). Bagian lain dari
