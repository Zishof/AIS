...
/**
 * Komponen dashboard khusus untuk dashboard penelitian dan pengabdian. Kelas ini memilih variasi
 ...
 * {@code Intbox sampai}, {@code Combobox searchfakultas}, {@code Combobox searchjurusan}, {@code
 * TipePenelitianDanPengabdian jenis}, {@code int width}, {@code int height}; inisialisasi/lifecycle ({@code
 ...
 * @see MyWindow
 */
public class DashboardPenelitianDanPengabdian extends MyWindow {
	...
	public DashboardPenelitianDanPengabdian(TipePenelitianDanPengabdian jenis) {
		super();
		try {
			this.jenis = jenis;
			init();
	...
	public DashboardPenelitianDanPengabdian(TipePenelitianDanPengabdian jenis, String title, String border,
			boolean closable) {
	...
	private void init() throws Exception {
		...
		org.zkoss.zk.ui.Component[] hostPortal = ais.ui.util.DasborResponsifHelper.saringanDanIsi(this,
				...
				"Rekap penelitian dan pengabdian dosen, beserta grafiknya.");
	...
	private void reload() {
											...
											public Object[] initCriteria(boolean order) {
												...
												try {
													...
													Criteria criteria = HibernateUtil.currentSession()
															...
															.createAlias("penelitianDanPengabdian",
																	"penelitianDanPengabdian")
															.add(Restrictions.eq(
																	"penelitianDanPengabdian.tipePenelitianDanPengabdian",
																	jenis))
															...
															.add(Restrictions.eq("penelitianDanPengabdian.tahun",
																	tahunAjaran));

													return new Object[] { criteria,
															new String[] { "tbmuser.dosen.nidn", "tbmuser.dosen.nama",
																	"judul", "keyword", "tujuan", "jumlahDana",
																	"keterangan", "penelitianDanPengabdian.tahun",
																	"penelitianDanPengabdian.judul",
																	"penelitianDanPengabdian.diperuntukkan",
																	"penelitianDanPengabdian.tanggalMulaiPengajuan",
																	"penelitianDanPengabdian.tanggalSampaiPengajuan",
																	"penelitianDanPengabdian.semester",
																	"penelitianDanPengabdian.tahunAkademik",
																	"penelitianDanPengabdian.sks", "tahapPengajuan",
																	"status", "masaPenugasan" } };
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				List<Object[]> data = session.createCriteria(PengajuanPenelitianDanPengabdian.class)
						.createAlias("penelitianDanPengabdian", "penelitianDanPengabdian")
						.add(Restrictions.eq("penelitianDanPengabdian.tipePenelitianDanPengabdian", jenis))
						...
						.setProjection(Projections.projectionList().add(Projections.groupProperty("dosen.fakultas"))
								...
								.add(Projections.groupProperty("penelitianDanPengabdian.tahun"))
						...
						.add(Restrictions.in("penelitianDanPengabdian.tahun", tas))
						...
						.addOrder(Order.asc("penelitianDanPengabdian.tahun"))
