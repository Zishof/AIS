...
/**
 * Komponen dashboard khusus untuk dashboard rekap silabus perkuliahan. Kelas ini memilih variasi
 ...
 * Combobox searchjurusan}, {@code Combobox searchsemester}, {@code Combobox searchprogram}, {@code Spreadsheet
 * spreadsheet}, {@code Div center}; inisialisasi/lifecycle ({@code initFakultas()}, {@code init()}, {@code
 * initSpreadsheetdata()}); operasi domain lain ({@code generateWhere()}). Bagian lain dari kontrak tetap
