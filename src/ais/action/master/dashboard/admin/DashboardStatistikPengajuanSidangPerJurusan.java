...
/**
 * Komponen dashboard khusus untuk dashboard statistik pengajuan sidang per jurusan. Kelas ini
...
public class DashboardStatistikPengajuanSidangPerJurusan extends MyWindow {
	...
	/**
	 * Event listener lokal milik {@link DashboardStatistikPengajuanSidangPerJurusan}. Kelas ini menangani event
	 * untuk komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DashboardStatistikPengajuanSidangPerJurusan}
	 * dan dapat mengakses state kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi state utama: {@code Integer telahSidang}, {@code Long
	 ...
	 *
	 * @see DashboardStatistikPengajuanSidangPerJurusan
	 */
