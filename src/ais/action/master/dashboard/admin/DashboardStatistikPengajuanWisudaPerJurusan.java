...
/**
 * Komponen dashboard khusus untuk dashboard statistik pengajuan wisuda per jurusan. Kelas ini
 ...
 * center}, {@code Combobox angkatan}, {@code Combobox angkatansd}, {@code boolean tampilRinci}, {@code Combobox
 * searchjenis}, {@code int width}, {@code int height}; inisialisasi/lifecycle ({@code reinit()}, {@code
 * initFakultas()}, {@code init()}, {@code initChart()}); konfigurasi constructor: {@code tampilRinci}. Bagian
...
public class DashboardStatistikPengajuanWisudaPerJurusan extends MyWindow {
	...
	/**
	 * Event listener lokal milik {@link DashboardStatistikPengajuanWisudaPerJurusan}. Kelas ini menangani event
	 * untuk komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DashboardStatistikPengajuanWisudaPerJurusan}
	 * dan dapat mengakses state kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi state utama: {@code Boolean persetujuanWisuda}, {@code
	 * Long jurusanId}; operasi lokal: {@code onEvent}(). Aturan bisnis bersama tetap berada pada kelas induk atau
	 * service yang dipanggilnya.</p>
	 * <p><b>Efek samping:</b> operasi dapat mengubah komponen ZK dan memanggil alur kelas induk. Jalankan pada
	 * event thread dengan konteks pengguna/session aktif; jangan menyalin query atau validasi domain ke
	 * renderer/listener ini.</p>
	 *
	 * @see DashboardStatistikPengajuanWisudaPerJurusan
	 */
