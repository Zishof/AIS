...
import ais.action.master.dashboard.helper.DashboardRekapPrestasiPegawai;

/**
 * Komponen dashboard khusus untuk dashboard rekap prestasi pegawai berdasar kategori. Kelas ini
 * memilih variasi data atau tampilan dashboard sambil memakai lifecycle dan mekanisme pemuatan
 * dari kelas induknya.
 *
 * <p><b>Batas tanggung jawab:</b> perilaku umum, validasi, akses data, serta lifecycle tetap dimiliki {@link
 * DashboardRekapPrestasiPegawai}. Kelas ini hanya boleh memuat perbedaan yang benar-benar spesifik untuk variasi
 ...
 * memang berbeda.</p>
 *
 * @see DashboardRekapPrestasiPegawai
 */
public class DashboardRekapPrestasiPegawaiBerdasarKategori extends DashboardRekapPrestasiPegawai {
	...
	public DashboardRekapPrestasiPegawaiBerdasarKategori() {
		super("kategori_prestasi_pegawai", "kategoriPrestasiPegawai");
	}
