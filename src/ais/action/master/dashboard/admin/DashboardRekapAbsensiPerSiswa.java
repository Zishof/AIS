...
/**
 * Komponen dashboard khusus untuk dashboard rekap absensi per siswa. Kelas ini memilih variasi
 ...
 * searchGuru}; inisialisasi/lifecycle ({@code initYayasan()}, {@code init()}, {@code initSpreadsheet()}). Bagian
