...
/**
 * Komponen dashboard khusus untuk dashboard statistik status mahasiswa. Kelas ini memilih variasi
 ...
 * searchjurusan}, {@code Combobox angkatan}, {@code Combobox angkatansd}, {@code Combobox searchprogram};
 * inisialisasi/lifecycle ({@code reinit()}, {@code initFakultas()}, {@code init()}, {@code initChart()});
 * konfigurasi constructor: {@code tampilRinci}. Bagian lain dari kontrak tetap mengikuti kelas induk atau
