...
public class DashboardStatistikStatusDosenPerJurusan extends MyWindow {
	...
	/**
	 * Event listener lokal milik {@link DashboardStatistikStatusDosenPerJurusan}. Kelas ini menangani event untuk
	 * komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DashboardStatistikStatusDosenPerJurusan} dan
	 * dapat mengakses state kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi state utama: {@code Long ikatanKerjaId}, {@code Long
	 ...
	 *
	 * @see DashboardStatistikStatusDosenPerJurusan
	 */
