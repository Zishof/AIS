...
/**
 * Komponen dashboard khusus untuk dashboard mahasiswa yang sudah mengambil krs. Kelas ini memilih
 ...
 * @see MyWindow
 */
public class DashboardMahasiswaYangSudahMengambilKRS extends MyWindow {
	...
	public DashboardMahasiswaYangSudahMengambilKRS() {
		super();
		try {
	...
	public DashboardMahasiswaYangSudahMengambilKRS(String title, String border, boolean closable) {
	...
	private void initSpreadsheet() throws Exception {
		...
		Common.createDefaultTimer(new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				...
				Common.clear(center);
				final String tahunAkademik = (String) (DashboardMahasiswaYangSudahMengambilKRS.this.tahunAkademik
						.getSelectedItem() == null ? null
								: DashboardMahasiswaYangSudahMengambilKRS.this.tahunAkademik.getSelectedItem()
										.getValue());
				...
				final Label label = Common.displayLoadBar(DashboardMahasiswaYangSudahMengambilKRS.this, file, center,
						sizedata);
