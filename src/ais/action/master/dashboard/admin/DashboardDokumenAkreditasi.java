...
/**
 * Komponen dashboard khusus untuk dashboard dokumen akreditasi. Kelas ini memilih variasi data
 ...
 * Combobox searchjurusan}, {@code Textbox cari}, {@code Row rowUtama}, {@code Combobox searchjenis}, {@code
 * Tabpanel tabpanel1}, {@code Tabpanel tabpanel2}, {@code Paging paging}; inisialisasi/lifecycle ({@code
 * init()}, {@code initCriteria()}, {@code initCriteria2()}); pembacaan/pencarian ({@code reload()}, {@code
 * reload1()}, {@code reload2()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang
 * disebut di atas.</p>
