...
/**
 * Komponen dashboard khusus untuk dashboard statistik jumlah mahasiswa. Kelas ini memilih variasi
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code org.zkoss.zul.Html mychart}, {@code
 * Center center}, {@code CategoryModel categoryModel}, {@code Combobox searchfakultas}, {@code Combobox
 * searchjurusan}, {@code Combobox angkatan}, {@code Combobox status}, {@code Combobox searchprogram};
 * inisialisasi/lifecycle ({@code initFakultas()}, {@code init()}, {@code initChart()}); operasi domain lain
 * ({@code persen()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di
 * atas.</p>
