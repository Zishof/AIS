...
/**
 * Komponen dashboard khusus untuk dashboard rekap jadwal perkulaiahan per matakuliah. Kelas ini
 ...
 * @see MyWindow
 */
public class DashboardRekapJadwalPerkulaiahanPerMatakuliah extends MyWindow {
	...
	public DashboardRekapJadwalPerkulaiahanPerMatakuliah() {
		super();
		try {
			init();
			initFakultas();
	...
	public DashboardRekapJadwalPerkulaiahanPerMatakuliah(String title, String border, boolean closable) {
	...
	private void initSpreadsheet() {
		...
		Common.createDefaultTimer(new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				...
				Common.clear(center);
				String tahunAkademik = (String) (DashboardRekapJadwalPerkulaiahanPerMatakuliah.this.tahunAkademik
						.getSelectedItem() == null ? null
								: DashboardRekapJadwalPerkulaiahanPerMatakuliah.this.tahunAkademik.getSelectedItem()
										.getValue());
				...
				String sql = "select max(y.nama) as fakultas, max(x.nama) as jurusan, "
						...
						+ (statusAwalMahasiswa != null
								...
								: "")
						+ " and matkul.matakuliah is not null " + "group by x.fakultas,a.jurusan, matkul.matakuliah "
						+ "order by max(y.nama), max(x.nama), max(matkul.nama_matakuliah)";
				...
				ais.ui.util.EcampusUtil.setCellValue(sheet, 1, 0,
						"REKAPITULASI PENGAMBILAN KRS MAHASISWA PER MATAKULIAH \n " + Common.getBahasaConfig("Fakultas")
				...
				ais.ui.util.EcampusUtil.setCellValue(sheet, rowIndex, 2, "Matakuliah");
				...
				for (Object[] objects : jurusans) {
					...
					} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/dashboard/admin/DashboardRekapJadwalPerkulaiahanPerMatakuliah.java:531");
					}
				...
				try {
					...
					ais.ui.util.EcampusUtil.setBold(sheet,
							...
							true);
				} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/dashboard/admin/DashboardRekapJadwalPerkulaiahanPerMatakuliah.java:560");
				}
			}
		});
	}
