...
/**
 * Komponen dashboard khusus untuk dashboard statistik pengajuan beasiswa per jurusan. Kelas ini
 ...
 * @see MyWindow
 */
public class DashboardStatistikPengajuanBeasiswaPerJurusan extends MyWindow {
	...
	public DashboardStatistikPengajuanBeasiswaPerJurusan() {
		super();
		initFakultas();
		init();
	...
	public DashboardStatistikPengajuanBeasiswaPerJurusan(int width, int height) throws Exception {
		super();
		tampilRinci = true;
		reinit(width, height);
	}
	...
	public DashboardStatistikPengajuanBeasiswaPerJurusan(String title, String border, boolean closable) {
	...
	/**
	 * Event listener lokal milik {@link DashboardStatistikPengajuanBeasiswaPerJurusan}. Kelas ini menangani event
	 * untuk komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DashboardStatistikPengajuanBeasiswaPerJurusan}
	 ...
	 *
	 * @see DashboardStatistikPengajuanBeasiswaPerJurusan
	 */
	...
	private void init() {
		...
		Component[] hostPortal = ais.ui.util.DasborResponsifHelper.saringanDanIsi(this,
				...
				"Statistik Pengajuan Beasiswa per Program Studi",
				"Jumlah pengajuan beasiswa yang sudah dan belum disetujui di tiap program studi, beserta grafiknya.");
		...
		try {
			...
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/dashboard/admin/DashboardStatistikPengajuanBeasiswaPerJurusan.java:317");
		}
	...
	private void initChart() {
		...
		mychart = null;
        mychart = DashboardModernHtmlUtil.createAnyChart(model, "Dasbor Statistik Pengajuan Beasiswa Per Jurusan", "Perbandingan data dibuat ringkas agar kelompok terbesar dan terkecil mudah terlihat.", "pie");
