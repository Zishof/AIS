...
/**
 * Komponen dashboard khusus untuk dashboard statistik status mahasiswa per jurusan. Kelas ini
 ...
 * Combobox angkatansd}, {@code boolean tampilRinci}, {@code int width}; inisialisasi/lifecycle ({@code
...
public class DashboardStatistikStatusMahasiswaPerJurusan extends MyWindow {
	...
	/**
	 * Event listener lokal milik {@link DashboardStatistikStatusMahasiswaPerJurusan}. Kelas ini menangani event
	 * untuk komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DashboardStatistikStatusMahasiswaPerJurusan}
	 * dan dapat mengakses state kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi state utama: {@code Long statusId}, {@code Long
	 ...
	 *
	 * @see DashboardStatistikStatusMahasiswaPerJurusan
	 */
