...
import ais.action.master.dashboard.helper.DashboardRekapMahasiswaBaruData;

/**
 * Komponen dashboard khusus untuk dashboard rekap jenis info pertanyaan mahasiswa baru. Kelas ini
 * memilih variasi data atau tampilan dashboard sambil memakai lifecycle dan mekanisme pemuatan
 * dari kelas induknya.
 *
 * <p><b>Batas tanggung jawab:</b> perilaku umum, validasi, akses data, serta lifecycle tetap dimiliki {@link
 * DashboardRekapMahasiswaBaruData}. Kelas ini hanya boleh memuat perbedaan yang benar-benar spesifik untuk
 ...
 * memang berbeda.</p>
 *
 * @see DashboardRekapMahasiswaBaruData
 */
public class DashboardRekapJenisInfoPertanyaanMahasiswaBaru extends DashboardRekapMahasiswaBaruData {
	...
	public DashboardRekapJenisInfoPertanyaanMahasiswaBaru() {
		super("infokampusdarimana", "infoKampusDariMana");
	}
