...
/**
 * Komponen dashboard khusus untuk dashboard beban sks dosen. Kelas ini memilih variasi data atau
 ...
 * searchjurusan}, {@code int width}, {@code int height}; inisialisasi/lifecycle ({@code init()});
