...
/**
 * Komponen dashboard khusus untuk dashboard publikasi ilmiah. Kelas ini memilih variasi data atau
 ...
 * @see MyWindow
 */
public class DashboardPublikasiIlmiah extends MyWindow {
	...
	public DashboardPublikasiIlmiah() {
		super();
		try {
	...
	public DashboardPublikasiIlmiah(String title, String border, boolean closable) {
	...
	private void init() throws Exception {
		...
		org.zkoss.zk.ui.Component[] hostPortal = ais.ui.util.DasborResponsifHelper.saringanDanIsi(this,
				...
				"Publikasi Ilmiah",
				"Rekap publikasi ilmiah dosen, beserta grafiknya.");
	...
	private void reload() {
										...
										.cetakDataCustomButton(Artikel.class, new DataCriteriaWithColumn() {
											...
											public Object[] initCriteria(boolean order) {
												...
												try {
													...
													return new Object[] { criteria, new String[] { "tbmuser.dosen.nidn",
															"tbmuser.dosen.nama", "judul", "keyword", "referensi",
															"sitasi", "tahun", "tanggalPublikasi", "abstrak", "issn",
															"eIssn", "vol", "nomor", "licenseURL", "copyrightYear",
															"copyrightHolder", "sponsor", "anggota", "previewJurnal",
															"plagiatChecker", "peerReview", "bahasa", "status",
															"jurnalPenelitian.judul", "tahapanPenyusunanArtikel.nama",
															"semester", "tahunAkademik", "masaPenugasan",
															"editorDanKontributor" } };
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				List<Object[]> data = session.createCriteria(Artikel.class).createAlias("tbmuser", "tbmuser")
						.createAlias("tbmuser.dosen", "dosen")
