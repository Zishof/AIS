...
import ais.action.master.dashboard.helper.DashboardRekapKegiatanKesiswaan;

/**
 * Komponen dashboard khusus untuk dashboard rekap kegiatan kesiswaan berdasar kelompok. Kelas ini
 * memilih variasi data atau tampilan dashboard sambil memakai lifecycle dan mekanisme pemuatan
 * dari kelas induknya.
 *
 * <p><b>Batas tanggung jawab:</b> perilaku umum, validasi, akses data, serta lifecycle tetap dimiliki {@link
 * DashboardRekapKegiatanKesiswaan}. Kelas ini hanya boleh memuat perbedaan yang benar-benar spesifik untuk
 ...
 * memang berbeda.</p>
 *
 * @see DashboardRekapKegiatanKesiswaan
 */
public class DashboardRekapKegiatanKesiswaanBerdasarKelompok extends DashboardRekapKegiatanKesiswaan {
	...
	public DashboardRekapKegiatanKesiswaanBerdasarKelompok() {
		super("kelompok_kegiatan_kesiswaan", "kegiatanKesiswaan.kelompokKegiatanKesiswaan");
	}
