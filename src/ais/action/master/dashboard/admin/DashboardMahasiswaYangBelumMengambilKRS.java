...
/**
 * Komponen dashboard khusus untuk dashboard mahasiswa yang belum mengambil krs. Kelas ini memilih
 ...
 * @see MyWindow
 */
public class DashboardMahasiswaYangBelumMengambilKRS extends MyWindow {
	...
	public DashboardMahasiswaYangBelumMengambilKRS() {
		super();
		try {
	...
	public DashboardMahasiswaYangBelumMengambilKRS(String title, String border, boolean closable) {
			...
			public void onEvent(Event event) throws Exception {
				try {
					Filedownload.save(new FileInputStream(file), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
							"KRS_BELUM_DISETUJUI_SEMUA.xlsx");
				} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/dashboard/admin/DashboardMahasiswaYangBelumMengambilKRS.java:315");
	...
	private void initSpreadsheet() throws Exception {
		...
		Common.createDefaultTimer(new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				...
				Common.clear(center);
				final String tahunAkademik = (String) (DashboardMahasiswaYangBelumMengambilKRS.this.tahunAkademik
						.getSelectedItem() == null ? null
								: DashboardMahasiswaYangBelumMengambilKRS.this.tahunAkademik.getSelectedItem()
										.getValue());
				...
				final Label label = Common.displayLoadBar(DashboardMahasiswaYangBelumMengambilKRS.this, file, center,
						sizedata);
				...
				new Thread(new Runnable() {
					...
					public void run() {
						...
						String sql = " (select a.mahasiswa from "
								...
								+ " group by aa.mahasiswa) a where a.persetujuan = 0) ";
