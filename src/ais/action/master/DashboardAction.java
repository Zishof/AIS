...
/**
 * Komponen dashboard khusus untuk dashboard. Kelas ini memilih variasi data atau tampilan
 ...
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Center center}, {@code West west},
 * {@code Tabpanel dataKuantitatifSarjana}, {@code TreeMap menus}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}); operasi domain lain ({@code onSarjana()}). Bagian lain dari
