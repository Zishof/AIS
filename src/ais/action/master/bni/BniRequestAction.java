...
/**
 * Controller/action ZK untuk bni request. Tipe ini merupakan titik masuk UI yang menghubungkan
...
public class BniRequestAction extends GenericAutowireComposer implements DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link BniRequestAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link BniRequestAction} dan dapat mengakses state
