...
public class NilaiToeflToaflMahasiswaAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link NilaiToeflToaflMahasiswaAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link NilaiToeflToaflMahasiswaAction} dan dapat
	 ...
	 *
	 * @see NilaiToeflToaflMahasiswaAction
	 */
