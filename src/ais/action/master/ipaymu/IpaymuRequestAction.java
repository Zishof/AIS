...
/**
 * Controller/action ZK untuk ipaymu request. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * {@code Textbox searchtrxId}, {@code Textbox searchnim}, {@code Textbox searchbuyer}, {@code Combobox
 * tahunAkademik}, {@code Textbox status}, {@code MyToolbarbuttonConfig find}; inisialisasi/lifecycle ({@code
...
public class IpaymuRequestAction extends GenericAutowireComposer implements DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link IpaymuRequestAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link IpaymuRequestAction} dan dapat mengakses state
