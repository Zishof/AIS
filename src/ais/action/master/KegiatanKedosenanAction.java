...
/**
 * Controller/action ZK untuk kegiatan kedosenan. Tipe ini merupakan titik masuk UI yang
 ...
 * data ({@code onSave()}); operasi domain lain ({@code loginSebagaiPesertaAtauPengajar()}, {@code onDasbor()},
 * {@code onKelompokKegiatanKedosenan()}, {@code onRekapBerdasarJabatan()}, {@code onForm()}, {@code
 * onRekapBerdasarSkala()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di
 * atas.</p>
...
public class KegiatanKedosenanAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KegiatanKedosenanAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KegiatanKedosenanAction} dan dapat mengakses
