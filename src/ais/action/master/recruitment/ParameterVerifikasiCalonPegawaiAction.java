...
/**
 * Controller/action ZK untuk parameter verifikasi calon pegawai. Tipe ini merupakan titik masuk UI
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaParameterVerifikasiCalonPegawai()}); mutasi data
...
public class ParameterVerifikasiCalonPegawaiAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link ParameterVerifikasiCalonPegawaiAction}. Kelas ini menerjemahkan
	 * satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link ParameterVerifikasiCalonPegawaiAction} dan
	 ...
	 *
	 * @see ParameterVerifikasiCalonPegawaiAction
	 */
