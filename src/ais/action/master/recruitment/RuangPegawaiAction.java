...
/**
 * Controller/action ZK untuk ruang pegawai. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}, {@code getDataAlbumPegawaiAdmin()});
...
public class RuangPegawaiAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link RuangPegawaiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link RuangPegawaiAction} dan dapat mengakses state
