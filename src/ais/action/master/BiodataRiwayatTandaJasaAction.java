...
/**
 * Controller/action ZK untuk biodata riwayat tanda jasa. Tipe ini merupakan titik masuk UI yang
 ...
 * @see MyWindow
 */
public class BiodataRiwayatTandaJasaAction extends MyWindow {
	/**
	 * 
	 */
	...
	public BiodataRiwayatTandaJasaAction() throws Exception {
		super();
		init(null);
	}

	public BiodataRiwayatTandaJasaAction(SatuanKerja satuanKerjaOnSession)
			throws Exception {
		super();
		init(null);
	}

	public BiodataRiwayatTandaJasaAction(String title, String border,
	...
	public BiodataRiwayatTandaJasaAction(Pegawai pegawai) throws Exception {
		super();
		init(pegawai);
	}

	public BiodataRiwayatTandaJasaAction(Pegawai pegawai,
	...
	public BiodataRiwayatTandaJasaAction(Pegawai pegawai, String title,
	...
	private void init(final Pegawai pegawai) throws Exception {
		...
		if (pegawai == null) {
			PesanFormalHelper.tampilkanGagal("penampilan data riwayat tanda jasa/keluar negeri pegawai",
					"Sesi Bapak/Ibu saat ini tidak terhubung dengan data Pegawai. Halaman Riwayat Tanda "
							+ "Jasa/Keluar Negeri Pegawai hanya dapat diakses oleh pengguna yang login sebagai "
		...
		tabs.appendChild(tab1 = new MyTabConfig("Data Tanda Jasa"));
		tabs.appendChild(tab2 = new MyTabConfig("Data Keluar Negeri"));
		RiwayatKeluarNegeriPegawaiHelper riwayatKeluarNegeriPegawaiHelper = new RiwayatKeluarNegeriPegawaiHelper(
				pegawai);
		tabpanelRiwayatKeluarNegeri.appendChild(riwayatKeluarNegeriPegawaiHelper
				.display());
		...
		tab1.addEventListener(Events.ON_CLICK, new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				...
				if (pegawai == null || pegawai.getId() == null) {
					...
					RiwayatKeluarNegeriPegawaiHelper riwayatKeluarNegeriPegawaiHelper = new RiwayatKeluarNegeriPegawaiHelper(
							pegawai);
					tabpanelRiwayatKeluarNegeri
							.appendChild(riwayatKeluarNegeriPegawaiHelper
									.display());
				}
		...
		tab2.addEventListener(Events.ON_CLICK, new EventListener() {
			...
			@Override
			public void onEvent(Event event) throws Exception {
				RiwayatTandaJasaPegawaiHelper riwayatTandaJasaPegawaiHelper = new RiwayatTandaJasaPegawaiHelper(
						pegawai);
				tabpanelRiwayatTandaJasa.appendChild(riwayatTandaJasaPegawaiHelper
						.display());
		...
		cancel.addEventListener("onClick", new EventListener() {
			@Override
			public void onEvent(Event event) throws Exception {
				BiodataRiwayatTandaJasaAction.this.setVisible(false);
			}
		});
