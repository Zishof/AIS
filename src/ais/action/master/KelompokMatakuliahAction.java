...
/**
 * Controller/action ZK untuk kelompok matakuliah. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Combobox searchjenjang}, {@code Checkbox
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkKodeKelompokMatakuliah()}, {@code
 * checkNamaKelompokMatakuliah()}); mutasi data ({@code onSave()}); operasi domain lain ({@code onAdd()}). Bagian
...
public class KelompokMatakuliahAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KelompokMatakuliahAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KelompokMatakuliahAction} dan dapat mengakses
