...
/**
 * Controller/action ZK untuk komponen penilaian kkn. Tipe ini merupakan titik masuk UI yang
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaKomponenPenilaianKkn()}); mutasi data ({@code
...
public class KomponenPenilaianKknAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KomponenPenilaianKknAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KomponenPenilaianKknAction} dan dapat
	 ...
	 *
	 * @see KomponenPenilaianKknAction
	 */
