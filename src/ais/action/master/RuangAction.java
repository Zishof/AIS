...
/**
 * Controller/action ZK untuk ruang. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Textbox nama}, {@code MyDoublebox luas},
 * {@code Textbox kodeRuangan}, {@code Textbox searchkapasitasruangan}; inisialisasi/lifecycle ({@code
 ...
 * onFasilitasRuangan()}, {@code onAdd()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface
...
//	private DetailRuangDosenHelper detailRuangDosenHelper = new DetailRuangDosenHelper();
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link RuangAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link RuangAction} dan dapat mengakses state kelas
