...
/**
 * Controller/action ZK untuk message. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchjudul}, {@code Textbox searchisi}, {@code Textbox
 * penerima}, {@code Textbox judul}, {@code MyCkEditor isi}; inisialisasi/lifecycle ({@code doBeforeCompose()},
...
public class MessageAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link MessageAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link MessageAction} dan dapat mengakses state kelas
