...
/**
 * Controller/action ZK untuk message terkirim. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code Textbox searchjudul}, {@code Textbox searchisi}; inisialisasi/lifecycle ({@code doBeforeCompose()},
...
public class MessageTerkirimAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link MessageTerkirimAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link MessageTerkirimAction} dan dapat mengakses
