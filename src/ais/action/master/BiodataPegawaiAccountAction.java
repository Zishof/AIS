...
/**
 * Controller/action ZK untuk biodata pegawai account. Tipe ini merupakan titik masuk UI yang
 ...
 * commonOnSearchdefault}, {@code ManagingBiodataPegawai managingBiodataPegawai}, {@code ManagingPegawai
 * managingPegawai}, {@code SatuanKerja satuanKerjaOnSession}, {@code Boolean tampilBatal};
 * inisialisasi/lifecycle ({@code init()}); pembacaan/pencarian ({@code setCommonOnSearchdefault()}, {@code
 * getCommonOnSearchdefault()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut
 * di atas.</p>
