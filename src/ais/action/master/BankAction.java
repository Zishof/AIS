...
public class BankAction extends GenericCrudAction<Bank> {
    ...
    /**
     * Renderer lokal untuk layar/komponen {@link BankAction}. Kelas ini menerjemahkan satu item data menjadi baris
     * atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
     *
     * <p><b>Scope:</b> setiap instance terikat pada instance {@link BankAction} dan dapat mengakses state kelas
