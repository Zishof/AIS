...
/**
 * Controller/action ZK untuk import from feeder. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code Textbox password}, {@code Intbox port}, {@code Progressmeter progressmeter}, {@code Progressmeter
 * progressmeterChild}, {@code Label labelProses}, {@code Label labelProsesDetail}; inisialisasi/lifecycle
 * ({@code doBeforeCompose()}, {@code doAfterCompose()}); pembacaan/pencarian ({@code onUploadDataUlang()},
 * {@code onDownloadAplikasi32()}, {@code onDownloadAplikasi()}, {@code doUpload()}, {@code onUploadData()});
 * operasi domain lain ({@code exists()}, {@code onImport()}). Bagian lain dari kontrak tetap mengikuti kelas
