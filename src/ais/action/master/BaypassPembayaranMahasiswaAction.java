...
/**
 * Controller/action ZK untuk baypass pembayaran mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code MyWindow addWindow}, {@code Textbox searchnim}, {@code Textbox searchnama}, {@code Combobox
 * searchfakultas}, {@code Combobox searchjurusan}, {@code Decimalbox searchtahun}; inisialisasi/lifecycle
 * ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code initCriteria()}, {@code init()});
 * pembacaan/pencarian ({@code onSearchDefault()}, {@code loadData()}); mutasi data ({@code onSave()}); operasi
...
public class BaypassPembayaranMahasiswaAction extends GenericAutowireComposer
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		/**
		 * Event listener lokal milik {@link BaypassPembayaranMahasiswaAction}. Kelas ini menangani event untuk
		 * komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link BaypassPembayaranMahasiswaAction} dan dapat
		 ...
		 *
		 * @see BaypassPembayaranMahasiswaAction
		 */
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link BaypassPembayaranMahasiswaAction}. Kelas ini menerjemahkan satu
