...
/**
 * Controller/action ZK untuk kegiatan kesiswaan. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Combobox searchsekolah}, {@code Combobox
 * searchyayasan}, {@code Combobox searchstatus}, {@code Textbox searchnamamhs}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian
 * ({@code onUploadData()}, {@code onSearchDefault()}); mutasi data ({@code setTabDanPanelVisible()}, {@code
 * onSave()}); operasi domain lain ({@code loginSebagaiPesertaAtauPengajar()}, {@code
 * onKelompokKegiatanKesiswaan()}, {@code onForm()}, {@code onRekapBerdasarJabatan()}, {@code
 * onRekapBerdasarSkala()}, {@code onRekapBerdasarKelompok()}). Bagian lain dari kontrak tetap mengikuti kelas
...
//			ais.common.Common.tampilErrorJikaAdmin(e);
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KegiatanKesiswaanAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KegiatanKesiswaanAction} dan dapat mengakses
