...
/**
 * Controller/action ZK untuk format nis. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Textbox nama}, {@code Longbox mulaiUrutanKe},
 * {@code Combobox kolom1}, {@code Textbox tanda1}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code
 * doAfterCompose()}, {@code initKolom()}, {@code init()}, {@code initCriteria()}, {@code init()});
 * pembacaan/pencarian ({@code onSearchDefault()}); validasi/perhitungan ({@code checkNamaFormatNis()}); mutasi
...
public class FormatNisAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link FormatNisAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link FormatNisAction} dan dapat mengakses state
