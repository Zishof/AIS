...
/**
 * Controller/action ZK untuk jenis kelompok kegiatan kesiswaan. Tipe ini merupakan titik masuk UI
 ...
 * validasi/perhitungan ({@code checkNamaJenisKelompokKegiatanKesiswaan()}); mutasi data ({@code onSave()});
...
public class JenisKelompokKegiatanKesiswaanAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisKelompokKegiatanKesiswaanAction}. Kelas ini menerjemahkan
	 * satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisKelompokKegiatanKesiswaanAction} dan
	 ...
	 *
	 * @see JenisKelompokKegiatanKesiswaanAction
	 */
