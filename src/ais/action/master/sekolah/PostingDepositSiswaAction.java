 ...
 * Combobox searchsekolah}, {@code Combobox searchjenis}, {@code Decimalbox searchtahunMasuk};
 ...
 * ({@code onBiayaAdmin()}, {@code onBiayaPaymentGateway()}). Bagian lain dari kontrak tetap mengikuti kelas
