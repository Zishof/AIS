...
/**
 * Controller/action ZK untuk matapelajaran. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * searchsekolah}, {@code Textbox kode}, {@code Textbox nama}; inisialisasi/lifecycle ({@code doBeforeCompose()},
 * {@code doAfterCompose()}, {@code init()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian ({@code
 * onSearchDefault()}); mutasi data ({@code onSave()}); operasi domain lain ({@code onSubMatapelajaran()}, {@code
...
public class MatapelajaranAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link MatapelajaranAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link MatapelajaranAction} dan dapat mengakses state
