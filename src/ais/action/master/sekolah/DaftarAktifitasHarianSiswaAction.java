...
public class DaftarAktifitasHarianSiswaAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link DaftarAktifitasHarianSiswaAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DaftarAktifitasHarianSiswaAction} dan dapat
	 ...
	 *
	 * @see DaftarAktifitasHarianSiswaAction
	 */
