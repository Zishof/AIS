...
public class AmbilDataCalonCalonSiswaForDiskonSiswaHelper {
	...
	public AmbilDataCalonCalonSiswaForDiskonSiswaHelper(DiskonSiswa diskonSiswa) {
		...
		/**
		 * Event listener lokal milik {@link AmbilDataCalonCalonSiswaForDiskonSiswaHelper}. Kelas ini menangani event
		 * untuk komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataCalonCalonSiswaForDiskonSiswaHelper}
		 ...
		 *
		 * @see AmbilDataCalonCalonSiswaForDiskonSiswaHelper
		 */
