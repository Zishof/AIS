...
/**
 * Tipe khusus untuk rekap pembayaran. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * bulan}, {@code Combobox tahun}, {@code Center center}, {@code Rows rowsDetailBiaya}, {@code MyLabelBold
 * totalTagihan}; inisialisasi/lifecycle ({@code doAfterCompose()}, {@code init()}); pembacaan/pencarian ({@code
 * reloadTagihan()}, {@code tampilPembayaran()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
