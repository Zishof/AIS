...
public class CalendarJadwalPelajaranBulanIniComposer extends GenericForwardComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		/**
		 * Event listener lokal milik {@link CalendarJadwalPelajaranBulanIniComposer}. Kelas ini menangani event untuk
		 * komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link CalendarJadwalPelajaranBulanIniComposer} dan
		 ...
		 *
		 * @see CalendarJadwalPelajaranBulanIniComposer
		 */
