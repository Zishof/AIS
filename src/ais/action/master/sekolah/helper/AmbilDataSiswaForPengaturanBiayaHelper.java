...
public class AmbilDataSiswaForPengaturanBiayaHelper {
	...
	public AmbilDataSiswaForPengaturanBiayaHelper(PengaturanBiaya pengaturanBiaya) {
		...
		/**
		 * Event listener lokal milik {@link AmbilDataSiswaForPengaturanBiayaHelper}. Kelas ini menangani event untuk
		 * komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataSiswaForPengaturanBiayaHelper} dan
		 ...
		 *
		 * @see AmbilDataSiswaForPengaturanBiayaHelper
		 */
