...
public class AmbilDataSiswaForDiskonSiswaHelper {
	...
	public AmbilDataSiswaForDiskonSiswaHelper(DiskonSiswa diskonSiswa) {
		...
		/**
		 * Event listener lokal milik {@link AmbilDataSiswaForDiskonSiswaHelper}. Kelas ini menangani event untuk
		 * komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataSiswaForDiskonSiswaHelper} dan dapat
		 ...
		 *
		 * @see AmbilDataSiswaForDiskonSiswaHelper
		 */
