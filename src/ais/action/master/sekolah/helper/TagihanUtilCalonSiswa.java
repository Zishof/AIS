...
/**
 * Tipe khusus untuk tagihan util calon siswa. Kelas ini memberi nama dan batas tanggung jawab yang
 * eksplisit pada perilaku yang diwarisi atau kontrak yang diimplementasikannya.
 *
 * <p><b>Batas tanggung jawab:</b> gunakan tipe ini hanya untuk state dan operasi yang sesuai dengan nama
 * domainnya. Logika lintas domain harus didelegasikan ke service atau helper bersama supaya tidak muncul
 * implementasi paralel dengan hasil berbeda.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah pembacaan/pencarian ({@code ambilNominalBiaya()}, {@code
 * ambilNominalBiaya()}, {@code getTagihan()}, {@code getTagihan()}, {@code getTagihan()}, {@code
 * tampilkanKunci()}); operasi domain lain ({@code pastikanNominalBulananSamaDenganNominalBiaya()}, {@code
 * doGenerateTagihanBulanan()}, {@code doGenerateTagihanTahunan()}, {@code doGenerateTagihanInsendentil()},
 * {@code doGenerateTagihanInsendentil()}, {@code doSinkronkanTagihanCalonSiswa()}). Bagian lain dari kontrak
