...
public class ElearningSekolah extends MyWindow {
	...
	/**
	 * Kontrak callback/strategi bersarang milik {@link ElearningSekolah}. Tipe ini memisahkan satu variasi
	 * perilaku lokal tanpa membuat service atau interface global yang tumpang tindih.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link ElearningSekolah} dan dapat mengakses state
	 ...
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi operasi lokal: {@code load}(). Aturan bisnis bersama
	 * tetap berada pada kelas induk atau service yang dipanggilnya.</p>
	 * <p><b>Efek samping:</b> operasi dapat mengubah state lokal dan, sesuai nama methodnya, komponen UI atau
	 * persistence melalui konteks kelas induk. Gunakan transaksi, otorisasi, dan session milik alur induk;
	 * tambahkan perilaku lintas domain pada service bersama.</p>
	 *
	 * @see ElearningSekolah
	 */
