...
public class CalendarJadwalPelajaranHariIniComposer extends GenericForwardComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		/**
		 * Event listener lokal milik {@link CalendarJadwalPelajaranHariIniComposer}. Kelas ini menangani event untuk
		 * komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link CalendarJadwalPelajaranHariIniComposer} dan
		 ...
		 *
		 * @see CalendarJadwalPelajaranHariIniComposer
		 */
