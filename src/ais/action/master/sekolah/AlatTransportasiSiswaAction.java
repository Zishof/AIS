...
/**
 * Controller/action ZK untuk alat transportasi siswa. Tipe ini merupakan titik masuk UI yang
 ...
 * checkNamaAlatTransportasiSiswa()}); mutasi data ({@code onSave()}); operasi domain lain ({@code onAdd()}).
...
public class AlatTransportasiSiswaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AlatTransportasiSiswaAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AlatTransportasiSiswaAction} dan dapat
	 ...
	 *
	 * @see AlatTransportasiSiswaAction
	 */
