...
/**
 * Controller/action ZK untuk kelompok parameter tambahan catatan kelas siswa. Tipe ini merupakan
 ...
 * ({@code onSearchDefault()}); validasi/perhitungan ({@code
 * checkNamaKelompokParameterTambahanCatatanKelasSiswa()}); mutasi data ({@code onSave()}); operasi domain lain
...
public class KelompokParameterTambahanCatatanKelasSiswaAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KelompokParameterTambahanCatatanKelasSiswaAction}. Kelas ini
	 ...
	 * KelompokParameterTambahanCatatanKelasSiswaAction} dan dapat mengakses state kelas induk. Jangan menyimpan
	 ...
	 *
	 * @see KelompokParameterTambahanCatatanKelasSiswaAction
	 */
