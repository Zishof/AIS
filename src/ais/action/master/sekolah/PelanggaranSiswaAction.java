...
/**
 * Controller/action ZK untuk pelanggaran siswa. Tipe ini merupakan titik masuk UI yang
 ...
 * onSearchDefault()}); mutasi data ({@code onSave()}); pelaporan/ekspor ({@code cetak()}); operasi domain lain
 * ({@code onDasbor()}, {@code onAdd()}, {@code info()}). Bagian lain dari kontrak tetap mengikuti kelas induk
...
public class PelanggaranSiswaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PelanggaranSiswaAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PelanggaranSiswaAction} dan dapat mengakses
