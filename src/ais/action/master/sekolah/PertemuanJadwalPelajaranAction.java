...
/**
 * Controller/action ZK untuk pertemuan jadwal pelajaran. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code Textbox searchnama}, {@code Combobox searchhari}, {@code Textbox searchnamaruang}, {@code Textbox
 * searchketerangan}, {@code Textbox searchsiswa}, {@code Combobox searchyayasan}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code initCriteria()}); pembacaan/pencarian ({@code
 * onSearchDefault()}); penghapusan/pembatalan ({@code onDeleteJadwalPelajaran()}); operasi domain lain ({@code
 * onRekapPertemuanJadwalPelajaran()}, {@code generateiIntroductoryText()}, {@code onCopyJadwalPelajaran()}).
...
public class PertemuanJadwalPelajaranAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PertemuanJadwalPelajaranAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PertemuanJadwalPelajaranAction} dan dapat
	 ...
	 *
	 * @see PertemuanJadwalPelajaranAction
	 */
