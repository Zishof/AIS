...
/**
 * Controller/action ZK untuk penjurusan sekolah. Tipe ini merupakan titik masuk UI yang
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaPenjurusanSekolah()}); mutasi data ({@code
...
public class PenjurusanSekolahAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PenjurusanSekolahAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PenjurusanSekolahAction} dan dapat mengakses
