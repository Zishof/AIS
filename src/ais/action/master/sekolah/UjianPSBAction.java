...
/**
 * Controller/action ZK untuk ujian psb. Tipe ini merupakan titik masuk UI yang menghubungkan event
...
public class UjianPSBAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link UjianPSBAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link UjianPSBAction} dan dapat mengakses state
