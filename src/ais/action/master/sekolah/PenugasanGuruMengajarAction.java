...
/**
 * Controller/action ZK untuk penugasan guru mengajar. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code Textbox searchnama}, {@code Textbox searchguru}, {@code Combobox searchTahunAjaran}, {@code Combobox
 * searchJenisSemester}, {@code Combobox searchyayasan}, {@code Combobox searchsekolah}; inisialisasi/lifecycle
 * ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code initCriteria()}, {@code init()}, {@code init()});
...
public class PenugasanGuruMengajarAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PenugasanGuruMengajarAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PenugasanGuruMengajarAction} dan dapat
	 ...
	 *
	 * @see PenugasanGuruMengajarAction
	 */
