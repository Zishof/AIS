...
/**
 * Controller/action ZK untuk kegiatan siswa. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * searchsekolah}, {@code AmbilDataTbmuserBanbox searchpembina}, {@code Combobox searchjenis};
 ...
 * operasi domain lain ({@code onRekapData()}, {@code onAdd()}). Bagian lain dari kontrak tetap mengikuti kelas
...
public class KegiatanSiswaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KegiatanSiswaAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KegiatanSiswaAction} dan dapat mengakses state
