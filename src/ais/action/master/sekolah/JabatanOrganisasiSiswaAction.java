...
/**
 * Controller/action ZK untuk jabatan organisasi siswa. Tipe ini merupakan titik masuk UI yang
 ...
 * validasi/perhitungan ({@code checkNamaJabatanOrganisasiSiswa()}); mutasi data ({@code onSave()}); operasi
...
public class JabatanOrganisasiSiswaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JabatanOrganisasiSiswaAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JabatanOrganisasiSiswaAction} dan dapat
	 ...
	 *
	 * @see JabatanOrganisasiSiswaAction
	 */
