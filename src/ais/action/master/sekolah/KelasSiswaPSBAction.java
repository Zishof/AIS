...
/**
 * Controller/action ZK untuk kelas siswa psb. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Decimalbox kapasitasRuangan}, {@code Combobox
 * gelombangPendaftaranPsb}, {@code Combobox searchgelombangPendaftaranPsb}, {@code MyToolbarbuttonConfig add};
...
public class KelasSiswaPSBAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KelasSiswaPSBAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KelasSiswaPSBAction} dan dapat mengakses state
	 * kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi state utama: {@code DetailKelasSiswaHelper
	 * detailKelasSiswaHelper}, {@code DetailKelasLesSiswaHelper detailKelasLesSiswaHelper}; operasi lokal: {@code
	...
	public boolean onSave(Event event) throws Exception {
		...
		if (kelasSiswa.getAttribute("kelasSiswa") == null && kelasLesSiswa.getAttribute("kelasLesSiswa") == null) {
			MyMessageboxConfig.show("Kelas siswa / kelas les siswa harus diisi", "Peringatan", MyMessageboxConfig.OK,
