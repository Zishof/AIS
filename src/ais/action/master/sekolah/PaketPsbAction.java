...
/**
 * Controller/action ZK untuk paket psb. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * pembacaan/pencarian ({@code onSearchDefault()}); validasi/perhitungan ({@code checkNamaPaketPsb()}); mutasi
...
public class PaketPsbAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PaketPsbAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PaketPsbAction} dan dapat mengakses state
