...
/**
 * Controller/action ZK untuk kelompok kegiatan kesiswaan. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code Combobox jenisKelompokKegiatanKesiswaan}, {@code KelompokKegiatanKesiswaan kelompokKegiatanKesiswaan};
 ...
 * checkNamaKelompokKegiatanKesiswaan()}); mutasi data ({@code onSave()}); operasi domain lain ({@code
 * onKelompokAspek()}, {@code onJabatanKegiatanKesiswaan()}, {@code onSkalaKegiatanKesiswaan()}, {@code
 * onNilaiKegiatanKesiswaan()}, {@code onAdd()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
...
public class KelompokKegiatanKesiswaanAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KelompokKegiatanKesiswaanAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KelompokKegiatanKesiswaanAction} dan dapat
	 * mengakses state kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi state utama: {@code DetailKelompokKegiatanKesiswaanHelper
	 * detailKelompokKegiatanKesiswaanHelper}; operasi lokal: {@code render}(). Aturan bisnis bersama tetap berada
	 * pada kelas induk atau service yang dipanggilnya.</p>
	 * <p><b>Efek samping:</b> operasi dapat mengubah komponen ZK dan memanggil alur kelas induk. Jalankan pada
	 * event thread dengan konteks pengguna/session aktif; jangan menyalin query atau validasi domain ke
	 * renderer/listener ini.</p>
	 *
	 * @see KelompokKegiatanKesiswaanAction
	 */
