...
/**
 * Controller/action ZK untuk absen guru piket. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchketerangan}, {@code AmbilDataGuruBanbox searchguru}, {@code
 * Combobox searchyayasan}, {@code Combobox searchsekolah}, {@code Combobox searchta}; inisialisasi/lifecycle
...
public class AbsenGuruPiketAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AbsenGuruPiketAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AbsenGuruPiketAction} dan dapat mengakses
	 * state kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi state utama: {@code DetailAbsenGuruPiketHelper
	 * detailAbsenGuruPiketHelper}; operasi lokal: {@code render}(). Aturan bisnis bersama tetap berada pada kelas
	 * induk atau service yang dipanggilnya.</p>
	 * <p><b>Efek samping:</b> operasi dapat mengubah komponen ZK dan memanggil alur kelas induk. Jalankan pada
	 * event thread dengan konteks pengguna/session aktif; jangan menyalin query atau validasi domain ke
	 * renderer/listener ini.</p>
	 *
	 * @see AbsenGuruPiketAction
	 */
