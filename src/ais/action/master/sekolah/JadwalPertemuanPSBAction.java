...
/**
 * Controller/action ZK untuk jadwal pertemuan psb. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Combobox searchgelombangPendaftaranPsb},
 * {@code Combobox gelombangPendaftaranPsb}, {@code Checkbox sembunyikanTanggalTerlewat}, {@code Checkbox
 * searchaktif}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()},
...
public class JadwalPertemuanPSBAction extends GenericAutowireComposer implements DataInitDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JadwalPertemuanPSBAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JadwalPertemuanPSBAction} dan dapat mengakses
