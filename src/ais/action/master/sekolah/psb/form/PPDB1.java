...
/**
 * Tipe khusus untuk ppdb1. Kelas ini memberi nama dan batas tanggung jawab yang eksplisit pada
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Textbox sekolahAsal}, {@code Textbox
 * nomorIndukNasional}, {@code Textbox nama}, {@code Textbox panggilan}, {@code Combobox jenisKelamin}, {@code
 * Textbox tempatLahir}, {@code MyDatebox tanggalLahir}, {@code LampiranLain akteKelahiran};
 * inisialisasi/lifecycle ({@code init()}); validasi/perhitungan ({@code check()}); mutasi data ({@code
 * onSave()}, {@code setdata()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang
 * disebut di atas.</p>
 ...
 * @see PPDB
 */
public class PPDB1 extends PPDB {
	...
	protected LampiranLain kebutuhanKhususLampiran;
	...
	private Hbox hboxkebutuhanKhususLampiran;
	...
	private EventListener checkKesamaan = new EventListener() {
		...
		public void onEvent(Event arg0) throws Exception {
			CalonSiswaAction.CheckKesamaan checkKesamaan = new CalonSiswaAction.CheckKesamaan(calonSiswa,
					gelombangPendaftaranPsb, tanggalLahir, nama, namaIbu, PPDB1.this, new EventListener() {

						@Override
						public void onEvent(Event arg0) throws Exception {
							CalonSiswa calonSiswa1 = (CalonSiswa) arg0.getData();
							PPDB window = new PPDB1();
	...
	public PPDB1(CalonSiswa calonSiswa, GelombangPendaftaranPsb gelombangPendaftaranPsb, EventListener eventListener) {
	...
	public void init() {
		...
		try {
			...
			rowUtama1.setValign("top");
			rowUtama1.setParent(rows);
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB1.java:367");
		}
		...
		row = new MyFormRow();
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("2. Nama asal sekolah *"));
		...
		row = new MyFormRow();
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("3. NISN (Nomor Induk Siswa Nasional) *"));
		...
		row = new MyFormRow();
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("4. Nama lengkap (Tulis dengan huruf kapital) *"));
		...
		row = new MyFormRow();
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("5. Nama panggilan *"));
		...
		row = new MyFormRow();
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("6. Jenis kelamin *"));
		...
		row = new MyFormRow();
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("7. Tempat dan Tanggal lahir *"));
		Hbox hbox = new Hbox();
		row.appendChild(hbox);
		hbox.appendChild(tempatLahir = new Textbox(calonSiswa.getTempatLahir()));
		...
		row = new MyFormRow();
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("8. Agama *"));
		...
		row = new MyFormRow();
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("11. NIK (Nomor Induk Kependudukan) peserta didik 16 digit *"));
		...
		row = new MyFormRow();
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("19. Apakah peserta didik berkebutuhan khusus ?"));
		...
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig(""));
		kebutuhanKhususLampiran = null;
		hboxkebutuhanKhususLampiran = new Hbox();
		LampiranLain.createDownloadUploadFileLain(hboxkebutuhanKhususLampiran, calonSiswa.getId(),
				"KEBUTUHAN_KHUSUS_CALON_SISWA", "Kebutuhan Khusus", true, new EventListener() {

					@Override
					public void onEvent(Event arg0) throws Exception {
						kebutuhanKhususLampiran = (LampiranLain) arg0.getData();
					}
				});
		hboxkebutuhanKhususLampiran.setParent(row);

		Common.initKeterangan(rows,
				"(Boleh dikosongkan jika tidak ada kebutuhan khusus, upload bukti kebutuhan khusus dari rumah sakit jika anak memiliki kebutuhan khusus)");
		...
		String[] c = Common.getKonfigurasi("jenis_tinggal_calon_siswa",
		...
		row = new MyFormRow();
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("21. Tempat Tinggal *"));
		...
		c = Common.getKonfigurasi("moda_transportasi_calon_siswa",
		...
		row = new MyFormRow();
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("22. Moda Transportasi *"));
		...
		try {
			...
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB1.java:1178");
		}

		myRowStyled = new MyGroupConfig("F. DATA ALAMAT");
		myRowStyled.setParent(rows);

		row = new MyFormRow();
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("44. Alamat Siswa"));
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB1.java:1249");
		}
		...
		final MyGroupConfig myRowStyledKelas = new MyGroupConfig("G. KELAS YANG PILIH");
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB1.java:1310");
		}
		...
		try {
			...
			ais.common.ErrorAuditUtil.record(e, "PPDB1.tampilkanVerifikasiBerkas");
		}
		...
		if (calonSiswa.getId() != null) {
			try {
				...
				// TODO Auto-generated catch block
				e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB1.java:1335");
			}
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB1.java:1344");
		}
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB1.java:1358");
		}
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB1.java:1368");
		}
		...
		save.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				...
				if (onSave(event)) {
					...
					if (PPDB1.this.eventListener != null) {
						PPDB1.this.eventListener.onEvent(new Event("", save, PPDB1.this.calonSiswa));
					}
					if (baru) {
						...
						informasi = org.apache.commons.lang3.StringUtils.replace(informasi, "[no_reg]",
								PPDB1.this.calonSiswa.getNoRegistrasi());
									...
									public void onEvent(Event arg0) throws Exception {
										...
										Common.createDefaultTimer(new EventListener() {
											...
											public void onEvent(Event arg0) throws Exception {
												...
												if (baru && PPDB1.this.calonSiswa.getGelombangPendaftaranPsb()
														.getOtomatisLoginSetelahDaftar()) {
													PPDB1.this.calonSiswa.setTelahLogin(true);
													PPDB1.this.calonSiswa
															.setWaktuLogin(ais.ui.util.WaktuUtil.getDate());
													Common.refreshUpdate(PPDB1.this.calonSiswa);

													Common.setLogin(PPDB1.this.calonSiswa);
													...
													CalonSiswaAction.onCetakKartu(PPDB1.this.calonSiswa, daftar);
												}
											}
										});
	...
	public boolean check() throws Exception {
		...
		if (panggilan.getValue().trim().equals("")) {
			MyMessageboxConfig.show("Panggilan Calon Siswa harus diisi. Langkah yang dapat dilakukan: (1) lengkapi kolom Panggilan Calon Siswa; (2) pastikan data telah benar; (3) simpan kembali formulir.", "Peringatan", MyMessageboxConfig.OK,
					MyMessageboxConfig.INFORMATION, new EventListener() {

						@Override
						public void onEvent(Event arg0) throws Exception {
							panggilan.focus();
							Clients.scrollIntoView(panggilan);
						}
					});
		...
		try {
			...
			String info = CalonSiswa.kebutuhanKhusus(infoKebutuhanKhusus);
			...
			if (!info.trim().isEmpty()) {
				if (calonSiswa != null && calonSiswa.getId() != null) {
					...
					int jumlah = ((Number) streamingSession.createCriteria(LampiranLain.class)
							...
							.add(Restrictions.eq("jenis", "KEBUTUHAN_KHUSUS_CALON_SISWA")).uniqueResult()).intValue();

					StreamingHibernateUtil.getInstance().closeSession();

					if (jumlah == 0) {
						MyMessageboxConfig.show(
								"File scan/foto surat keterangan kebutuhan khusus dari rumah sakit harus diunggah apabila calon siswa memiliki kebutuhan khusus. Langkah yang dapat dilakukan: (1) siapkan file scan/foto surat keterangan; (2) unggah file pada kolom yang tersedia; (3) simpan kembali formulir.",
								"Peringatan", MyMessageboxConfig.OK, MyMessageboxConfig.INFORMATION,
								new EventListener() {

									@Override
									public void onEvent(Event arg0) throws Exception {
										Clients.scrollIntoView(hboxkebutuhanKhususLampiran);
									}
								});
					...
					if (kebutuhanKhususLampiran == null) {
						MyMessageboxConfig.show(
								"File scan/foto surat keterangan kebutuhan khusus dari rumah sakit harus diunggah apabila calon siswa memiliki kebutuhan khusus. Langkah yang dapat dilakukan: (1) siapkan file scan/foto surat keterangan; (2) unggah file pada kolom yang tersedia; (3) simpan kembali formulir.",
								"Peringatan", MyMessageboxConfig.OK, MyMessageboxConfig.INFORMATION,
								new EventListener() {
			...
			e1.printStackTrace(); ais.common.ErrorAuditUtil.record(e1, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB1.java:2297");
		}
		...
		try {
			...
			StreamingHibernateUtil.getInstance().rollbackTransaction();
			e1.printStackTrace(); ais.common.ErrorAuditUtil.record(e1, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB1.java:2338");
		}
		...
		try {
			...
			StreamingHibernateUtil.getInstance().rollbackTransaction();
			e1.printStackTrace(); ais.common.ErrorAuditUtil.record(e1, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB1.java:2379");
		}
	...
	public boolean onSave(Event event) throws Exception {
		...
		if (kebutuhanKhususLampiran != null) {
			Session streamingSession = StreamingHibernateUtil.getInstance().currentSession();
			streamingSession.refresh(kebutuhanKhususLampiran);
			kebutuhanKhususLampiran.setRef(calonSiswa.getId());
			streamingSession.getTransaction().begin();
			streamingSession.update(kebutuhanKhususLampiran);
			streamingSession.getTransaction().commit();
		...
		try {
			...
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB1.java:2614");
		}
	...
	private void setdata() {
		...
		try {
			...
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB1.java:2795");
		}
	}
