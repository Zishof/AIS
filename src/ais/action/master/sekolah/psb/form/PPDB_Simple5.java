...
public class PPDB_Simple5 extends PPDB {
	...
	private EventListener checkKesamaan = new EventListener() {
		...
		public void onEvent(Event arg0) throws Exception {
			CalonSiswaAction.CheckKesamaan checkKesamaan = new CalonSiswaAction.CheckKesamaan(calonSiswa,
					gelombangPendaftaranPsb, tanggalLahir, nama, namaIbu, PPDB_Simple5.this, new EventListener() {

						@Override
						public void onEvent(Event arg0) throws Exception {
							CalonSiswa calonSiswa1 = (CalonSiswa) arg0.getData();
							PPDB window = new PPDB_Simple5();
	...
	public PPDB_Simple5(CalonSiswa calonSiswa, GelombangPendaftaranPsb gelombangPendaftaranPsb,
	...
	public void init() {
		...
		try {
			...
			rowUtama1.setValign("top");
			rowUtama1.setParent(rows);
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB_Simple5.java:254");
		}
		...
		row = new MyFormRow();
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("10. Alamat Email *"));
		...
		try {
			...
			ais.common.ErrorAuditUtil.record(e, "PPDB_Simple5.tampilkanVerifikasiBerkas");
		}
		...
		if (calonSiswa.getId() != null) {
			try {
				...
				e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB_Simple5.java:584");
			}
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB_Simple5.java:593");
		}
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB_Simple5.java:607");
		}
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB_Simple5.java:617");
		}
		...
		save.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				...
				if (onSave(event)) {
					...
					if (PPDB_Simple5.this.eventListener != null) {
						PPDB_Simple5.this.eventListener.onEvent(new Event("", save, PPDB_Simple5.this.calonSiswa));
					}
					...
					if (baru) {
						...
						informasi = org.apache.commons.lang3.StringUtils.replace(informasi, "[no_reg]",
								PPDB_Simple5.this.calonSiswa.getNoRegistrasi());
									...
									public void onEvent(Event arg0) throws Exception {
										...
										Common.createDefaultTimer(new EventListener() {
											...
											public void onEvent(Event arg0) throws Exception {
												...
												if (baru && PPDB_Simple5.this.calonSiswa.getGelombangPendaftaranPsb()
														.getOtomatisLoginSetelahDaftar()) {
													PPDB_Simple5.this.calonSiswa.setTelahLogin(true);
													PPDB_Simple5.this.calonSiswa
															.setWaktuLogin(ais.ui.util.WaktuUtil.getDate());
													Common.refreshUpdate(PPDB_Simple5.this.calonSiswa);

													Common.setLogin(PPDB_Simple5.this.calonSiswa);
													...
													CalonSiswaAction.onCetakKartu(PPDB_Simple5.this.calonSiswa, daftar);
												}
											}
										});
	...
	public boolean onSave(Event event) throws Exception {
		...
		try {
			...
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB_Simple5.java:1170");
		}
	...
	private void setdata() {
		...
		try {
			...
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB_Simple5.java:1240");
		}
	}
