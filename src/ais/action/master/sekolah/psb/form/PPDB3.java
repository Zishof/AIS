...
public class PPDB3 extends PPDB {
	...
	public void init() {
		...
		// Verifikasi kelengkapan (jika sudah terdaftar)
		if (calonSiswa.getId() != null) {
			try {
				...
				e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB3.java:verif1");
			}
			try {
