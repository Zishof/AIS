...
/**
 * Tipe khusus untuk ppdb simple3. Kelas ini memberi nama dan batas tanggung jawab yang eksplisit
 ...
 * @see PPDB
 */
public class PPDB_Simple3 extends PPDB {
	...
	private EventListener checkKesamaan = new EventListener() {
		...
		public void onEvent(Event arg0) throws Exception {
			CalonSiswaAction.CheckKesamaan checkKesamaan = new CalonSiswaAction.CheckKesamaan(calonSiswa,
					gelombangPendaftaranPsb, tanggalLahir, nama, namaIbu, PPDB_Simple3.this, new EventListener() {

						@Override
						public void onEvent(Event arg0) throws Exception {
							CalonSiswa calonSiswa1 = (CalonSiswa) arg0.getData();
							PPDB window = new PPDB_Simple3();
	...
	public PPDB_Simple3(CalonSiswa calonSiswa, GelombangPendaftaranPsb gelombangPendaftaranPsb,
	...
	public void init() {
		...
		try {
			...
			rowUtama1.setValign("top");
			rowUtama1.setParent(rows);
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB_Simple3.java:260");
		}
		...
		try {
			...
			ais.common.ErrorAuditUtil.record(e, "PPDB_Simple3.tampilkanVerifikasiBerkas");
		}
		...
		if (calonSiswa.getId() != null) {
			try {
				...
				e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB_Simple3.java:617");
			}
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB_Simple3.java:626");
		}
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB_Simple3.java:639");
		}
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB_Simple3.java:649");
		}
		...
		save.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				...
				if (onSave(event)) {
					...
					if (PPDB_Simple3.this.eventListener != null) {
						PPDB_Simple3.this.eventListener.onEvent(new Event("", save, PPDB_Simple3.this.calonSiswa));
					}
					...
					if (baru) {
						...
						informasi = org.apache.commons.lang3.StringUtils.replace(informasi, "[no_reg]",
								PPDB_Simple3.this.calonSiswa.getNoRegistrasi());
									...
									public void onEvent(Event arg0) throws Exception {
										...
										Common.createDefaultTimer(new EventListener() {
											...
											public void onEvent(Event arg0) throws Exception {
												...
												if (baru && PPDB_Simple3.this.calonSiswa.getGelombangPendaftaranPsb()
														.getOtomatisLoginSetelahDaftar()) {
													PPDB_Simple3.this.calonSiswa.setTelahLogin(true);
													PPDB_Simple3.this.calonSiswa
															.setWaktuLogin(ais.ui.util.WaktuUtil.getDate());
													Common.refreshUpdate(PPDB_Simple3.this.calonSiswa);

													Common.setLogin(PPDB_Simple3.this.calonSiswa);
													...
													CalonSiswaAction.onCetakKartu(PPDB_Simple3.this.calonSiswa, daftar);
												}
											}
										});
	...
	public boolean onSave(Event event) throws Exception {
		...
		if (jenisKelamin.getSelectedItem() == null) {
			MyMessageboxConfig.show(
					"Mohon Bapak/Ibu terlebih dahulu memilih Jenis Kelamin calon siswa. Langkah yang dapat dilakukan: (1) buka pilihan Jenis Kelamin; (2) pilih Laki-laki atau Perempuan sesuai dokumen resmi; (3) lanjutkan menyimpan pendaftaran.",
					"Peringatan", MyMessageboxConfig.OK,
					MyMessageboxConfig.INFORMATION, new EventListener() {
		...
		if (namaAyah.getValue().trim().equals("")) {
			MyMessageboxConfig.show(
					"Mohon Bapak/Ibu terlebih dahulu mengisi Nama Ayah Kandung. Langkah yang dapat dilakukan: (1) klik kolom Nama Ayah Kandung; (2) isikan nama sesuai dokumen resmi; (3) lanjutkan menyimpan pendaftaran.",
					"Peringatan", MyMessageboxConfig.OK,
					MyMessageboxConfig.INFORMATION, new EventListener() {
		...
		if (tanggalLahirAyah.getValue() == null) {
			MyMessageboxConfig.show(
					"Mohon Bapak/Ibu terlebih dahulu mengisi Tanggal Lahir Ayah Kandung. Langkah yang dapat dilakukan: (1) klik kolom Tanggal Lahir Ayah Kandung; (2) pilih tanggal lahir sesuai dokumen resmi; (3) lanjutkan menyimpan pendaftaran.",
					"Peringatan", MyMessageboxConfig.OK,
					MyMessageboxConfig.INFORMATION, new EventListener() {
		...
		if (namaIbu.getValue().trim().equals("")) {
			MyMessageboxConfig.show(
					"Mohon Bapak/Ibu terlebih dahulu mengisi Nama Ibu Kandung. Langkah yang dapat dilakukan: (1) klik kolom Nama Ibu Kandung; (2) isikan nama sesuai dokumen resmi; (3) lanjutkan menyimpan pendaftaran.",
					"Peringatan", MyMessageboxConfig.OK,
					MyMessageboxConfig.INFORMATION, new EventListener() {
		...
		if (tanggalLahirIbu.getValue() == null) {
			MyMessageboxConfig.show(
					"Mohon Bapak/Ibu terlebih dahulu mengisi Tanggal Lahir Ibu Kandung. Langkah yang dapat dilakukan: (1) klik kolom Tanggal Lahir Ibu Kandung; (2) pilih tanggal lahir sesuai dokumen resmi; (3) lanjutkan menyimpan pendaftaran.",
					"Peringatan", MyMessageboxConfig.OK,
					MyMessageboxConfig.INFORMATION, new EventListener() {
		...
		try {
			...
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB_Simple3.java:1265");
		}
	...
	private void setdata() {
		...
		try {
			...
			e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sekolah/psb/form/PPDB_Simple3.java:1337");
		}
	}
