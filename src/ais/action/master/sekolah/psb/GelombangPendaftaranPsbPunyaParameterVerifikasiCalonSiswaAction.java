...
/**
 * Controller/action ZK untuk gelombang pendaftaran psb punya parameter verifikasi calon siswa.
 * Tipe ini merupakan titik masuk UI yang menghubungkan event layar dengan perilaku domain yang
 * diwarisi atau dikonfigurasi khusus oleh kelas ini.
 *
 ...
 * gelombangPendaftaranPsbPunyaParameterVerifikasiCalonSiswa}, {@code MyWindow addWindow}, {@code MyGrid grid},
 * {@code Textbox searchnama}, {@code Textbox searchjudul}, {@code Combobox gelombangPendaftaranPsb}, {@code
 * Combobox searchgelombangPendaftaranPsb}, {@code boolean edit}; inisialisasi/lifecycle ({@code
...
public class GelombangPendaftaranPsbPunyaParameterVerifikasiCalonSiswaAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link GelombangPendaftaranPsbPunyaParameterVerifikasiCalonSiswaAction}.
	 * Kelas ini menerjemahkan satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan
	 * tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link
	 * GelombangPendaftaranPsbPunyaParameterVerifikasiCalonSiswaAction} dan dapat mengakses state kelas induk.
	 ...
	 *
	 * @see GelombangPendaftaranPsbPunyaParameterVerifikasiCalonSiswaAction
	 */
