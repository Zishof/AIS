...
/**
 * Tipe khusus untuk tampilan ujian calon siswa. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code AktifitasJadwalUjianPSBHelper
 * aktifitasJadwalUjianPSBHelper}, {@code boolean materiBol}, {@code boolean ujianBol}, {@code boolean tugasBol};
 * inisialisasi/lifecycle ({@code init()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface
