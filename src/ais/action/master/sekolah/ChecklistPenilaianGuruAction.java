...
/**
 * Controller/action ZK untuk checklist penilaian guru. Tipe ini merupakan titik masuk UI yang
 ...
 * searchprogram}, {@code Combobox searchyayasan}, {@code Textbox nama}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian
 * ({@code onSearchDefault()}); mutasi data ({@code onSave()}); operasi domain lain ({@code onAngketUmum()},
 * {@code onParameterAngketUmum()}, {@code onAdd()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
...
public class ChecklistPenilaianGuruAction extends GenericAutowireComposer implements DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link ChecklistPenilaianGuruAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link ChecklistPenilaianGuruAction} dan dapat
	 ...
	 *
	 * @see ChecklistPenilaianGuruAction
	 */
