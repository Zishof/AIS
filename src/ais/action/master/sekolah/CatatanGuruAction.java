...
//		add.getParent().appendChild(upload);
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link CatatanGuruAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link CatatanGuruAction} dan dapat mengakses state
