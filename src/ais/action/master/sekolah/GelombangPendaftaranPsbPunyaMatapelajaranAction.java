...
/**
 * Controller/action ZK untuk gelombang pendaftaran psb punya matapelajaran. Tipe ini merupakan
 ...
 * GelombangPendaftaranPsbPunyaMatapelajaran gelombangPendaftaranPsbPunyaMatapelajaran}, {@code MyWindow
 * addWindow}, {@code MyGrid grid}, {@code Combobox matapelajaranSekolah}, {@code Combobox searchjurusansekolah},
 * {@code Combobox gelombangPendaftaranPsb}, {@code Combobox searchgelombangPendaftaranPsb}, {@code boolean
 * edit}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()});
...
public class GelombangPendaftaranPsbPunyaMatapelajaranAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link GelombangPendaftaranPsbPunyaMatapelajaranAction}. Kelas ini
	 ...
	 * GelombangPendaftaranPsbPunyaMatapelajaranAction} dan dapat mengakses state kelas induk. Jangan menyimpan
	 ...
	 *
	 * @see GelombangPendaftaranPsbPunyaMatapelajaranAction
	 */
