...
/**
 * Controller/action ZK untuk gelombang pendaftaran psb. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Combobox searchta}, {@code Textbox searchnama}, {@code Combobox
 * searchyayasan}, {@code Combobox searchsekolah}, {@code Checkbox searchaktif}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code init()}, {@code initKelengkapanBerkas()},
 * {@code initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}); mutasi data ({@code onSave()});
 * operasi domain lain ({@code onKelompok()}, {@code onPengaturanNIS()}, {@code onKebutuhanKhusus()}, {@code
 * onGaleriFoto()}, {@code onVerifikasiKelengkapanBerkas()}, {@code onVerifikasiTambahan()}). Bagian lain dari
...
//	private MyCheckboxConfig harusSebagaiSaudaraAlumni;
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link GelombangPendaftaranPsbAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link GelombangPendaftaranPsbAction} dan dapat
	 ...
	 *
	 * @see GelombangPendaftaranPsbAction
	 */
