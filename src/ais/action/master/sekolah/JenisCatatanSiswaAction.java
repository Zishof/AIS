...
/**
 * Controller/action ZK untuk jenis catatan siswa. Tipe ini merupakan titik masuk UI yang
 ...
 * initKelompokParameterTambahanCatatanSiswa()}, {@code initCriteria()}); pembacaan/pencarian ({@code
 ...
 */
public class JenisCatatanSiswaAction extends GenericAutowireComposer
	...
	private Set<KelompokParameterTambahanCatatanSiswa> selectedKelompokParameterTambahanCatatanSiswa;
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		MyToolbarbuttonConfig upload = Common.uploadData(this, JenisCatatanSiswa.class, contents);
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisCatatanSiswaAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisCatatanSiswaAction} dan dapat mengakses
	 ...
	 *
	 * @see JenisCatatanSiswaAction
	 */
	class JenisCatatanSiswaRenderer extends ais.ui.util.MyRowRenderer {

		@Override
		public void render(final Row arg0, Object arg1) throws Exception {
			arg0.setValign("top");
			// TODO Auto-generated method stub
			final JenisCatatanSiswa jenisCatatanSiswa = (JenisCatatanSiswa) arg1;

			RevisiHelper.createNewRevisi(JenisCatatanSiswa.class, jenisCatatanSiswa, jenisCatatanSiswa.getNama())
					.setParent(arg0);
			new Label(jenisCatatanSiswa.getSekolah() == null ? "" : jenisCatatanSiswa.getSekolah().getNama())
					.setParent(arg0);
			new Label(jenisCatatanSiswa.getKeterangan()).setParent(arg0);

			final MyCheckboxConfig checkbox = new MyCheckboxConfig("Aktif");
			checkbox.setDisabled(!edit);
			checkbox.setChecked(jenisCatatanSiswa.getAktif());
			...
			checkbox.addEventListener("onCheck", new EventListener() {
				...
				@Override
				public void onEvent(Event arg0) throws Exception {
					jenisCatatanSiswa.setAktif(checkbox.isChecked());
					Common.refreshSaveOrUpdate(jenisCatatanSiswa);
				}
			});

			Common.copyEditDeleteButtons(edit, delete, jenisCatatanSiswa, JenisCatatanSiswaAction.this).setParent(arg0);
	...
	public void init(GeneralValueObject obj) throws Exception {
		jenisCatatanSiswa = (JenisCatatanSiswa) obj;
		init(jenisCatatanSiswa);
		addWindow.setVisible(true);
		addWindow.onModal();
	}

	@SuppressWarnings({ "deprecation", "unchecked" })
	private void init(JenisCatatanSiswa jenisCatatanSiswa) {
		this.jenisCatatanSiswa = jenisCatatanSiswa;
		addWindow.setTitle(jenisCatatanSiswa.getId() == null ? "Tambah Jenis Catatan Siswa" : "Ubah Jenis Catatan Siswa");
		...
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("Nama Jenis Catatan Siswa *"));
		row.appendChild(nama = new Textbox(jenisCatatanSiswa.getNama()));
		nama.setWidth("90%");
		...
		Common.selectComboItem(yayasan, jenisCatatanSiswa.getYayasan());
		yayasan.setWidth("90%");
		...
		Common.pilihSekolah(sekolah, jenisCatatanSiswa.getSekolah());
		sekolah.setWidth("90%");
		...
		row.appendChild(keterangan = new Textbox(jenisCatatanSiswa.getKeterangan()));
		...
		Hbox hbox = new Hbox();
		hbox.setParent(row);
		LampiranLain.createDownloadUploadFileLain(hbox, jenisCatatanSiswa.getId(),
				LampiranLain.FILE_JRXML_LAYOUT_JENIS_FORM_CATATAN_SISWA, "File Laporan form jrxml", false,
				new EventListener() {
		...
		hbox.setParent(row);
		LampiranLain.createDownloadUploadFileLain(hbox, jenisCatatanSiswa.getId(),
				LampiranLain.FILE_JRXML_LAYOUT_JENIS_CATATAN_SISWA, "File Laporan rekap jrxml", false,
				new EventListener() {
		...
		initKelompokParameterTambahanCatatanSiswa(rows);
		...
		try {
			...
			if (jenisCatatanSiswa.getId() != null) {
				try {
					Session streamingSession = StreamingHibernateUtil.getInstance().currentSession();
					List<LampiranLain> lampiranLains = streamingSession.createCriteria(LampiranLain.class)
							.addOrder(Order.asc("id")).add(Restrictions.eq("ref", jenisCatatanSiswa.getId()))
					...
					e1.printStackTrace(); ais.common.ErrorAuditUtil.record(e1, "auto-audit src/ais/action/master/sekolah/JenisCatatanSiswaAction.java:357");
				}
			}
	...
	private void tampilkanButton(final Hbox hboxGambar) {
		...
		LampiranLain.createDownloadUploadFileLain(hboxGambar, jenisCatatanSiswa.getId(),
				"Catatan_Siswa_" + Common.getGeneratedBarCode(), "Gambar Pendukung", false, new EventListener() {
	...
	private void initKelompokParameterTambahanCatatanSiswa(Rows rows) {
		MyFormRow row = new MyFormRow();row.setValign("top");
		row.setParent(rows);
		ais.ui.util.ZkCompat.setSpans(row, "2");
		...
		Column c = new Column("Parameter Catatan Siswa");
		...
		for (final KelompokParameterTambahanCatatanSiswa kelompokParameterTambahanCatatanSiswa : kelompokParameterTambahanCatatanSiswas
				.values()) {

			if (ya == null || (ya != null && kelompokParameterTambahanCatatanSiswa.getYayasan() != null
					&& ya.getId().equals(kelompokParameterTambahanCatatanSiswa.getYayasan().getId()))) {

				if (sek == null || (sek != null && kelompokParameterTambahanCatatanSiswa.getSekolah() != null
						&& sek.getId().equals(kelompokParameterTambahanCatatanSiswa.getSekolah().getId()))) {

					final Checkbox checkbox = new Checkbox(kelompokParameterTambahanCatatanSiswa.getNama());
					checkbox.setParent(vboxSkala);
					checkbox.setChecked(ids.contains(kelompokParameterTambahanCatatanSiswa.getId()));
					checkbox.addEventListener("onClick", new EventListener() {

						@Override
						public void onEvent(Event arg0) throws Exception {
							if (checkbox.isChecked()) {
								selectedKelompokParameterTambahanCatatanSiswa
										.add(kelompokParameterTambahanCatatanSiswa);
							} else {

								for (KelompokParameterTambahanCatatanSiswa a : selectedKelompokParameterTambahanCatatanSiswa) {
									if (a.getId().equals(kelompokParameterTambahanCatatanSiswa.getId())) {
										selectedKelompokParameterTambahanCatatanSiswa.remove(a);
										break;
									}
								}
							...
							System.out.println("selectedKelompokParameterTambahanCatatanSiswa => "
									+ selectedKelompokParameterTambahanCatatanSiswa);
						}
					});
				}
	...
	public boolean onSave(Event event) throws Exception {
		...
		if (jenisCatatanSiswa.getId() != null) {
			jenisCatatanSiswa = (JenisCatatanSiswa) session.load(JenisCatatanSiswa.class, jenisCatatanSiswa.getId());

		}

		jenisCatatanSiswa.setNama(nama.getValue());
		jenisCatatanSiswa.setSekolah((Sekolah) sekolah.getSelectedItem().getValue());
		jenisCatatanSiswa.setYayasan((Yayasan) yayasan.getSelectedItem().getValue());
		jenisCatatanSiswa.setKeterangan(keterangan.getValue());
		jenisCatatanSiswa.setKelompokParameterTambahanCatatanSiswas(selectedKelompokParameterTambahanCatatanSiswa);

		Common.refreshSaveOrUpdate(session, jenisCatatanSiswa);
		...
		try {
			...
			if (lampiran != null && lampiran.getId() != null) {
				...
				lampiran.setRef(jenisCatatanSiswa.getId());
			...
			if (lampiran1 != null && lampiran1.getId() != null) {
				...
				lampiran1.setRef(jenisCatatanSiswa.getId());
	...
	public void onSearchDefault(Event event) {
		...
		List<JenisCatatanSiswa> jenisCatatanSiswa = initCriteria(true).setMaxResults(Common.ROWS_COUNT_ON_PAGE)
				.setFirstResult(Common.ROWS_COUNT_ON_PAGE * (paging == null ? 0 : paging.getActivePage())).list();
		ListModel strset = new SimpleListModel(jenisCatatanSiswa);
		grid.setRowRenderer(new JenisCatatanSiswaRenderer());
