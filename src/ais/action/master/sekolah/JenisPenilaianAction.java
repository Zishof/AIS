...
/**
 * Controller/action ZK untuk jenis penilaian. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * onItemPenilaian()}, {@code onNilaiHuruf()}, {@code onJenisNilaiHuruf()}, {@code onGrupKategori()}, {@code
 * onGrupPenilaian()}, {@code onKategoriPenilaian()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
...
public class JenisPenilaianAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisPenilaianAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisPenilaianAction} dan dapat mengakses
