...
/**
 * Controller/action ZK untuk kunjungan siswa. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * paging}, {@code MyGrid grid}, {@code Combobox searchyayasan}, {@code Combobox searchsekolah}, {@code
 * AmbilDataSiswaBanbox searchsiswa}, {@code MyDatebox tanggal}, {@code AmbilDataSiswaBanbox siswa};
 ...
 * domain lain ({@code onAdd()}, {@code onKodeSiswa()}). Bagian lain dari kontrak tetap mengikuti kelas induk
...
public class KunjunganSiswaAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KunjunganSiswaAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KunjunganSiswaAction} dan dapat mengakses
