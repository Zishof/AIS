...
/**
 * Controller/action ZK untuk pengeluaran mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnamaPenabung}, {@code Textbox searchnama}, {@code
 * AmbilDataMahasiswaBanbox mahasiswa}, {@code Textbox keterangan}, {@code boolean edit}; inisialisasi/lifecycle
 ...
 * onLaporanPengeluaranMahasiswa()}, {@code onJenis()}, {@code onAdd()}). Bagian lain dari kontrak tetap
...
public class PengeluaranMahasiswaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PengeluaranMahasiswaAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PengeluaranMahasiswaAction} dan dapat
	 ...
	 *
	 * @see PengeluaranMahasiswaAction
	 */
