 ...
 * {@code Textbox searchnim}, {@code Textbox searchnama}, {@code Combobox searchTahunAjaran}, {@code Combobox
 * searchGanjilGenap}, {@code Combobox searchprogram}, {@code Combobox searchfakultas}; inisialisasi/lifecycle
 * ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code initCriteria()}); pembacaan/pencarian ({@code
 * onSearchDefault()}); operasi domain lain ({@code displayRow()}). Bagian lain dari kontrak tetap mengikuti
...
//		TbmuserAction.tampilkanSocialMediaProfile(vb, mahasiswa.getSocialMediaProfile());
	 ...
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KrsMahasiswaAction} dan dapat mengakses state
	 * kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi state utama: {@code EventListener event}; operasi lokal:
