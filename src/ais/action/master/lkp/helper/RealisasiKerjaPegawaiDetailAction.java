...
//		new MyLabelKecil(pegawai.getCode() == null ? "" : pegawai.getCode()).setParent(vbox);
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link RealisasiKerjaPegawaiDetailAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link RealisasiKerjaPegawaiDetailAction} dan dapat
	 ...
	 *
	 * @see RealisasiKerjaPegawaiDetailAction
	 */
