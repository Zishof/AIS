...
/**
 * Controller/action ZK untuk satuan kegiatan tugas jabatan. Tipe ini merupakan titik masuk UI yang
 ...
 * validasi/perhitungan ({@code checkNamaSatuanKegiatanTugasJabatan()}); mutasi data ({@code onSave()}); operasi
...
public class SatuanKegiatanTugasJabatanAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link SatuanKegiatanTugasJabatanAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link SatuanKegiatanTugasJabatanAction} dan dapat
	 ...
	 *
	 * @see SatuanKegiatanTugasJabatanAction
	 */
