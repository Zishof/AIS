...
/**
 * Tipe khusus untuk kegiatan tugas jabatan tree model. Kelas ini memberi nama dan batas tanggung
 ...
 * SatuanKerja satuanKerja}, {@code String periode}, {@code List tbmroles}; pembacaan/pencarian ({@code
 * getChildren()}, {@code getChildren()}, {@code getChildrenByIds()}, {@code getChildrenByIds()}, {@code
 * getChild()}, {@code getChildCount()}); mutasi data ({@code setSatuanKerja()}); penghapusan/pembatalan ({@code
 * deleteChilds()}); operasi domain lain ({@code generateAllChildren()}, {@code isLeaf()}, {@code
