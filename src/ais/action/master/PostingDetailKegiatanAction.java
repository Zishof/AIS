...
/**
 * Controller/action ZK untuk posting detail kegiatan. Tipe ini merupakan titik masuk UI yang
 ...
 * pembacaan/pencarian ({@code ambilTanggalPostingPiutang()}, {@code onSearchDefaultTanpaProgress()}, {@code
 * onSearchDefault()}, {@code loadDataDenganProgressPosting()}); mutasi data ({@code onBatalkanPostingSemua()},
 * {@code onPostingSemua()}, {@code kriteriaPostingStatic()}, {@code batalkanPostingSemua()}, {@code
...
public class PostingDetailKegiatanAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PostingDetailKegiatanAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PostingDetailKegiatanAction} dan dapat
	 ...
	 *
	 * @see PostingDetailKegiatanAction
	 */
