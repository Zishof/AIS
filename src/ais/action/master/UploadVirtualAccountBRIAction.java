...
/**
 * Controller/action ZK untuk upload virtual account bri. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Combobox searchTahunAjaran}, {@code Combobox
 * jenisSemester}, {@code Textbox kode}, {@code Combobox tahunAkademik}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian
 * ({@code onDownloadTagihanMahasiswa()}, {@code onDownloadTagihanNoRegCalonMahasiswa()}, {@code
 * onDownloadTagihanNoUjianCalonMahasiswa()}, {@code upload()}, {@code onSearchDefault()}); mutasi data ({@code
...
public class UploadVirtualAccountBRIAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link UploadVirtualAccountBRIAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link UploadVirtualAccountBRIAction} dan dapat
	 ...
	 *
	 * @see UploadVirtualAccountBRIAction
	 */
