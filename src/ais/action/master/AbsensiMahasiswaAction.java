...
/**
 * Controller/action ZK untuk absensi mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * Integer semesterPendek}, {@code Tabpanel absensiSp}, {@code Tabpanel asisten}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}); pembacaan/pencarian ({@code onSearchDefault()}, {@code
 * load()}); operasi domain lain ({@code onAsisten()}, {@code onAbsensiSp()}, {@code
 * onRekapitulasiAbsensiMahasiswa()}, {@code onRekapitulasiAbsensiPerMahasiswa()}). Bagian lain dari kontrak
