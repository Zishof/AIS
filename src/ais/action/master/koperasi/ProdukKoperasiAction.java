...
/**
 * Controller/action ZK untuk produk koperasi. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * reloadFormula()}, {@code reloadDataFormula()}, {@code onSearchDefault()}); mutasi data ({@code onSave()});
 * operasi domain lain ({@code onAdd()}, {@code periksaBatasBunga()}). Bagian lain dari kontrak tetap mengikuti
...
public class ProdukKoperasiAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link ProdukKoperasiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link ProdukKoperasiAction} dan dapat mengakses
