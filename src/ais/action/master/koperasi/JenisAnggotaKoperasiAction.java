...
/**
 * Controller/action ZK untuk jenis anggota koperasi. Tipe ini merupakan titik masuk UI yang
 ...
 * checkNamaJenisAnggotaKoperasi()}); mutasi data ({@code onSave()}); operasi domain lain ({@code onAdd()}).
...
public class JenisAnggotaKoperasiAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisAnggotaKoperasiAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisAnggotaKoperasiAction} dan dapat
	 ...
	 *
	 * @see JenisAnggotaKoperasiAction
	 */
