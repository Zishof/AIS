...
/**
 * Controller/action ZK untuk anggota koperasi. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchkode}, {@code Combobox searchTipeAnggotaKoperasi}, {@code
 * Combobox searchJenisAnggotaKoperasi}, {@code Combobox searchKoperasi}, {@code Combobox searchStatus};
 * inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code init()},
 * {@code initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}, {@code tampilkanStatistikAnggota()});
 * validasi/perhitungan ({@code checkKode()}, {@code checkEmail()}); mutasi data ({@code onSave()}); operasi
...
public class AnggotaKoperasiAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AnggotaKoperasiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AnggotaKoperasiAction} dan dapat mengakses
