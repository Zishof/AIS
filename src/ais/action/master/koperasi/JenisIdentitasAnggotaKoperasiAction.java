...
/**
 * Controller/action ZK untuk jenis identitas anggota koperasi. Tipe ini merupakan titik masuk UI
 ...
 * checkNamaJenisIdentitasAnggotaKoperasi()}); mutasi data ({@code onSave()}); operasi domain lain ({@code
...
public class JenisIdentitasAnggotaKoperasiAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisIdentitasAnggotaKoperasiAction}. Kelas ini menerjemahkan
	 * satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisIdentitasAnggotaKoperasiAction} dan dapat
	 ...
	 *
	 * @see JenisIdentitasAnggotaKoperasiAction
	 */
