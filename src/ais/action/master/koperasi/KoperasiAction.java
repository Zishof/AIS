...
/**
 * Controller/action ZK untuk koperasi. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaKoperasi()}); mutasi data ({@code onSave()});
...
public class KoperasiAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KoperasiAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KoperasiAction} dan dapat mengakses state
