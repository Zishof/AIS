...
/**
 * Controller/action ZK untuk transaksi koperasi. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox serachnama}, {@code Textbox serachjenis}, {@code Textbox
 * serachkode}, {@code Combobox searchstatus}, {@code Checkbox searchaktif}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code init()}, {@code initCriteria()});
 * pembacaan/pencarian ({@code reloadAngsuran()}, {@code reloadFormula()}, {@code reloadDataFormula()}, {@code
 * onSearchDefault()}, {@code ambil()}, {@code ambilClass()}); validasi/perhitungan ({@code checkTransaksi()});
 * mutasi data ({@code onSave()}, {@code setPersetujuan()}, {@code kriteriaSimpanPinjamStatic()}, {@code
 * postingSemua()}, {@code batalkanPostingSemua()}); pelaporan/ekspor ({@code cetakData()}, {@code cetak()});
 * operasi domain lain ({@code onStatistik()}, {@code onAdd()}, {@code form()}, {@code istilah()}, {@code
 * generateCode()}, {@code populateTransaksi()}); konfigurasi constructor: {@code tbmuser}. Bagian lain dari
...
public class TransaksiKoperasiAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link TransaksiKoperasiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link TransaksiKoperasiAction} dan dapat mengakses
