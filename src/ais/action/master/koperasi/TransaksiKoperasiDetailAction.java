...
/**
 * Controller/action ZK untuk transaksi koperasi detail. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code Textbox searchnama}, {@code Checkbox searchaktif}, {@code boolean edit}, {@code MyToolbarbuttonConfig
 * add}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code initCriteria()});
...
public class TransaksiKoperasiDetailAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link TransaksiKoperasiDetailAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link TransaksiKoperasiDetailAction} dan dapat
	 ...
	 *
	 * @see TransaksiKoperasiDetailAction
	 */
