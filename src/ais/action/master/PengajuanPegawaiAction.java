...
/**
 * Controller/action ZK untuk pengajuan pegawai. Tipe ini merupakan titik masuk UI yang
 ...
 * searchpegawai}, {@code AmbilDataSatuanKerjaBanbox searchparent}, {@code MyDatebox start};
 * inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code init()},
 * {@code initCriteria()}); pembacaan/pencarian ({@code getindex()}, {@code onSearchDefault()}, {@code ambil()},
 * {@code ambilClass()}); mutasi data ({@code onSave()}, {@code setPersetujuan()}); pelaporan/ekspor ({@code
 * cetakData()}); operasi domain lain ({@code onLaporan()}, {@code onJenisPengajuanPegawai()}, {@code
 * onManajemenParameter()}, {@code onAdd()}, {@code form()}, {@code generateCode()}). Bagian lain dari kontrak
...
public class PengajuanPegawaiAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PengajuanPegawaiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PengajuanPegawaiAction} dan dapat mengakses
