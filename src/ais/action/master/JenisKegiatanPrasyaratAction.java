...
/**
 * Controller/action ZK untuk jenis kegiatan prasyarat. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Textbox searchnamaprasyarat}, {@code Checkbox
 ...
 * pembacaan/pencarian ({@code onSearchDefault()}); validasi/perhitungan ({@code checkSyarat()}, {@code
 * checkSyarat()}); mutasi data ({@code onSave()}); operasi domain lain ({@code onAdd()}). Bagian lain dari
...
public class JenisKegiatanPrasyaratAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisKegiatanPrasyaratAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisKegiatanPrasyaratAction} dan dapat
	 ...
	 *
	 * @see JenisKegiatanPrasyaratAction
	 */
