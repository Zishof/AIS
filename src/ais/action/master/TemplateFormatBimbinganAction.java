...
/**
 * Controller/action ZK untuk template format bimbingan. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Textbox nama}, {@code MyIntbox setelahHari},
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaTemplateFormatBimbingan()}); mutasi data ({@code
...
public class TemplateFormatBimbinganAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link TemplateFormatBimbinganAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link TemplateFormatBimbinganAction} dan dapat
	 ...
	 *
	 * @see TemplateFormatBimbinganAction
	 */
