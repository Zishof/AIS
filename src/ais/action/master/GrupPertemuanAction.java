...
/**
 * Controller/action ZK untuk grup pertemuan. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Combobox searchtahunakademik}, {@code
 * Combobox searchfakultas}, {@code Combobox searchjurusan}, {@code Textbox searchtahun}; inisialisasi/lifecycle
 * ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code initCriteria()});
 * pembacaan/pencarian ({@code onTampilJenisLayanan()}, {@code onTampilGrupPertemuan()}, {@code loadMahasiswa()},
 * {@code onSearchDefault()}, {@code tampilkanInfoMahasiswa()}); mutasi data ({@code onSave()}, {@code
 * saveDetail()}); operasi domain lain ({@code onSejarah()}, {@code onTugasAkhir()}, {@code onSidang()}, {@code
...
public class GrupPertemuanAction extends GenericAutowireComposer implements DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link GrupPertemuanAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link GrupPertemuanAction} dan dapat mengakses state
