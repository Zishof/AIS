...
/**
 * Controller/action ZK untuk upload biodata calon mahasiswa spanptkin. Tipe ini merupakan titik
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Textbox keterangan}, {@code boolean delete},
 * {@code MyCheckboxConfig generateNoRegistrasiOlehSistem}, {@code UploadBiodataCalonMahasiswa
 * uploadBiodataCalonMahasiswa}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()},
 * {@code init()}, {@code initCriteria()}); pembacaan/pencarian ({@code onDownload()}, {@code upload()}, {@code
 * uploadFormat1()}, {@code onSearchDefault()}); mutasi data ({@code onSave()}); operasi domain lain ({@code
...
public class UploadBiodataCalonMahasiswaSPANPTKINAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link UploadBiodataCalonMahasiswaSPANPTKINAction}. Kelas ini
	 * menerjemahkan satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik
	 * kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link UploadBiodataCalonMahasiswaSPANPTKINAction}
	 ...
	 *
	 * @see UploadBiodataCalonMahasiswaSPANPTKINAction
	 */
