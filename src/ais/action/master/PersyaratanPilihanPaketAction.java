...
/**
 * Controller/action ZK untuk persyaratan pilihan paket. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Paket paket}, {@code Combobox persyaratan},
 ...
 * validasi/perhitungan ({@code checkNamaPersyaratanPilihanPaket()}); mutasi data ({@code onSave()}); operasi
...
public class PersyaratanPilihanPaketAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PersyaratanPilihanPaketAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PersyaratanPilihanPaketAction} dan dapat
	 ...
	 *
	 * @see PersyaratanPilihanPaketAction
	 */
