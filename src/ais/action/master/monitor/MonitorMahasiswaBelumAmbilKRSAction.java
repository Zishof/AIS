...
/**
 * Controller/action ZK untuk monitor mahasiswa belum ambil krs. Tipe ini merupakan titik masuk UI
 ...
 */
public class MonitorMahasiswaBelumAmbilKRSAction extends GenericAutowireComposer implements DataLoader {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		if (searchsemester != null) { searchsemester.setSelectedIndex(0); }
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link MonitorMahasiswaBelumAmbilKRSAction}. Kelas ini menerjemahkan
	 * satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link MonitorMahasiswaBelumAmbilKRSAction} dan dapat
	 ...
	 *
	 * @see MonitorMahasiswaBelumAmbilKRSAction
	 */
	class MahasiswaRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(final Row arg0, Object arg1) throws Exception {arg0.setValign("top");
			...
			if (Common.getCurrentUser() != null && Common.getCurrentUser().hakAkses() != null
					&& Common.getCurrentUser().hakAkses().getRoleId()
			...
			button.addEventListener("onClick", new EventListener() {
				...
				public void onEvent(Event event) throws Exception {
					tampilStudiMahasiswaHelper.tampil(mahasiswa, MonitorMahasiswaBelumAmbilKRSAction.this, false);
				}
	...
	public Criteria initCriteria(boolean order) {
		...
		criteria.add(searchnama.getValue().trim().equals("") ? Restrictions.sqlRestriction("1=1")
				...
				.add(searchsemester.getSelectedItem() == null ? Restrictions.sqlRestriction("1=1")
						: Restrictions.or(
								Restrictions.isNull("keterangan_tambahan_pengambilan_krs"
										+ searchsemester.getSelectedItem().getValue()),
								Restrictions.ilike(
										"keterangan_tambahan_pengambilan_krs"
												+ searchsemester.getSelectedItem().getValue(),
										"Belum pernah mengambil KRS", MatchMode.ANYWHERE)))
