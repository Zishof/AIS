...
public class MonitorMahasiswaSudahMembayarAction extends GenericAutowireComposer implements DataLoader {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		/**
		 * Event listener lokal milik {@link MonitorMahasiswaSudahMembayarAction}. Kelas ini menangani event untuk
		 * komponen induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link MonitorMahasiswaSudahMembayarAction} dan dapat
		 ...
		 *
		 * @see MonitorMahasiswaSudahMembayarAction
		 */
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link MonitorMahasiswaSudahMembayarAction}. Kelas ini menerjemahkan
