...
/**
 * Controller/action ZK untuk pengecekan pendaftaran wisuda administrasi fakultas. Tipe ini
 ...
 */
public class PengecekanPendaftaranWisudaAdministrasiFakultasAction extends GenericAutowireComposer {
	...
	public void onPilihMahasiswa() throws Exception {
		...
		if (pendaftaranWisuda == null) {
			...
			String wisuda_administrasi = "Kartu Hasil Studi;Tanda Lulus Ujian;Lembar Pengesahan Skripsi;Tanda Lulus Toafl/Toefl;Pas Photo;Administrasi Fakultas";

			jsonObject = new JSONObject(pendaftaranWisuda.getStatusPendaftaran());

			for (String konf : Common.getKonfigurasi("wisuda_administrasi_fakultas", wisuda_administrasi).getNilai()
					.split(";")) {
			...
			if (pendaftaranWisuda.getStatusPersetujuanAdministrasiFakultas() != null
