...
/**
 * Controller/action ZK untuk hasil ujian mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code MyGrid grid}, {@code Intbox
 * searchkuota}, {@code MyLabelConfig searchkuotalabel}, {@code MyLabelBold searchkuotatersedia}, {@code boolean
 * delete}, {@code MyToolbarbuttonConfig reset}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code
 * doAfterCompose()}); pembacaan/pencarian ({@code onSearchDefault()}); mutasi data ({@code onReset()}). Bagian
...
public class HasilUjianMahasiswaAction extends GenericAutowireComposer implements DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link HasilUjianMahasiswaAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link HasilUjianMahasiswaAction} dan dapat mengakses
