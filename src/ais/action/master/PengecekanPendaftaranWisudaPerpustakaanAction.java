...
/**
 * Controller/action ZK untuk pengecekan pendaftaran wisuda perpustakaan. Tipe ini merupakan titik
 ...
 */
public class PengecekanPendaftaranWisudaPerpustakaanAction extends GenericAutowireComposer {
	...
	public void onPilihMahasiswa() throws Exception {
		...
		if (pendaftaranWisuda == null) {
			...
			for (String konf : Common.getKonfigurasi("wisuda_perpustakaan", wisuda_perpustakaan).getNilai()
					.split(";")) {
			...
			if (pendaftaranWisuda.getStatusPersetujuanPerpustakaan() != null
	...
	public void onSetuju() throws Exception {
		...
		MyMessageboxConfig.show("Apakah anda yakin, mahasiswa ini tidak ada masalah menyangkut perpustakaan ?",
				...
				new EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						...
						if (i == MyMessageboxConfig.CANCEL)
							...
							pendaftaranWisuda.setStatusPersetujuanPerpustakaan(1);
	...
	public void onTolak() throws InterruptedException {
		...
		MyMessageboxConfig.show(
				"Apakah anda yakin, mahasiswa ini belum menyelesaikan masalah menyangkut perpustakaan ?", "Pertanyaan",
				MyMessageboxConfig.OK | MyMessageboxConfig.CANCEL, MyMessageboxConfig.QUESTION, new EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						...
						if (i == MyMessageboxConfig.CANCEL)
							...
							pendaftaranWisuda.setStatusPersetujuanPerpustakaan(0);
