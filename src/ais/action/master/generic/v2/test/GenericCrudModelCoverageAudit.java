...
public final class GenericCrudModelCoverageAudit {
    ...
    private static void runAudit() throws Exception {
        ...
        for (int i = 0; i < models.size(); i++) {
            ...
            boolean reviewed = GenericCrudReviewedAdapterFactory.isReviewed(entityClass);
            if (routed != null) {
                explicit++;
                definition = routed;
            } else if (reviewed) {
                // Adapter hasil review merupakan definition eksplisit walaupun
                // dipakai oleh route auto-generated, bukan registry route statis.
                explicit++;
            }
