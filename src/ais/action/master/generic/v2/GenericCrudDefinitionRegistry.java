...
public final class GenericCrudDefinitionRegistry {
    ...
    private static GenericCrudDefinition buildNomorSuratAlurKeuangan() {
        GenericCrudDefinition d = new GenericCrudDefinition();
        d.setEntityClass(NomorSuratAlurKeuangan.class);
        d.setModuleKey("akunting");
        d.setPageKey("nomor_surat_alur_keuangan");
        d.setDisplayName("Nomor Surat Alur Keuangan");
        d.setSourceActionClassName("ais.action.master.akunting.NomorSuratAlurKeuanganAction");
        d.setExistingActionLifecycleBound(false);
        d.setLifecycleStatus(GenericCrudDefinition.FULL_CRUD);
        d.setEnabled(true);
        d.setCreateEnabled(false);
        ...
        d.setRestoreEnabled(false);
        d.setAdminDeleteEnabled(false);
        d.setDefaultSortProperty("kode");
        d.setDefaultPageSize(10);
        d.setMaxPageSize(100);
        NomorSuratAlurKeuanganGenericCrudAdapter adapter = new NomorSuratAlurKeuanganGenericCrudAdapter();
        ...
        d.addField(relationField("nomorSurat", "Template Nomor Surat", NomorSurat.class,
    ...
    private static GenericCrudDefinition buildCicilanPembayaranGagal() {
        GenericCrudDefinition d = new GenericCrudDefinition(); d.setEntityClass(CicilanPembayaranGagal.class);
        d.setModuleKey("root"); d.setPageKey("cicilan_pembayaran_gagal"); d.setDisplayName("Cicilan Pembayaran Gagal");
        d.setSourceActionClassName("ais.action.master.CicilanPembayaranGagalAction");
        d.setExistingActionLifecycleBound(false); d.setLifecycleStatus(GenericCrudDefinition.READ_ONLY);
        d.setEnabled(true); d.setCreateEnabled(false); d.setUpdateEnabled(false); d.setDeleteEnabled(false);
        d.setImportEnabled(false); d.setExportPdfEnabled(true); d.setExportDocxEnabled(true); d.setExportPptxEnabled(true);
        d.setSavedViewEnabled(true); d.setAuditEnabled(true); d.setRowAuditEnabled(true);
        d.setGlobalAuditEnabled(false); d.setRestoreEnabled(false); d.setAdminDeleteEnabled(false);
        d.setDefaultSortProperty("id"); d.setDefaultSortAscending(false); d.setDefaultPageSize(10); d.setMaxPageSize(100);
        CicilanPembayaranGagalGenericCrudAdapter adapter = new CicilanPembayaranGagalGenericCrudAdapter();
        d.setAdapter(adapter); d.setScopeAdapter(adapter);
        d.addField(field("id", "ID", Long.class, "number", false, false, false, false, true, false, 10));
        d.addField(relationField("kegiatan", "Kegiatan / Peserta", Kegiatan.class, true, false, false, true, 20));
        d.addField(field("ke", "Cicilan Ke", Integer.class, "number", true, false, false, false, true, false, 30));
        d.addField(relationField("jenisPembayaran", "Jenis Pembayaran", JenisPembayaran.class, true, false, false, false, 40));
        d.addField(field("tanggal", "Tanggal", java.util.Date.class, "datetime", true, false, false, false, true, false, 50));
    ...
    private static GenericCrudDefinition buildFaspayRequest() {
        GenericCrudDefinition d = paymentRequest("faspay", "faspay_request", "Faspay Request",
                FaspayRequest.class, "ais.action.master.faspay.FaspayRequestAction");
        FaspayRequestGenericCrudAdapter adapter = new FaspayRequestGenericCrudAdapter();
        d.setAdapter(adapter); d.setScopeAdapter(adapter); addPaymentFields(d);
        d.addField(field("trxId", "Transaction ID", String.class, "text", true, false, false, false, true, true, 20));
        d.addField(field("billNo", "Bill Number", String.class, "text", true, false, false, false, true, true, 30));
        d.addField(field("merchant_id", "Merchant ID", String.class, "text", true, false, false, false, true, true, 40));
        d.addField(field("payment_channel_name", "Kanal Pembayaran", String.class, "text", true, false, false, false, true, true, 50));
        d.addField(field("amount", "Nominal", Double.class, "number", true, false, false, false, true, false, 60));
        d.addField(field("biayaAdministrasi", "Biaya Administrasi", Double.class, "number", true, false, false, false, true, false, 65));
        d.addField(field("status", "Status", String.class, "text", true, false, false, false, true, true, 100));
        d.addField(field("kodeStatus", "Kode Status", String.class, "text", true, false, false, false, true, true, 110));
    ...
    private static GenericCrudDefinition buildBsiRequest() {
        GenericCrudDefinition d=paymentRequest("bsi","bsi_request","BSI Virtual Account",BsiRequest.class,"ais.action.master.bsi.BsiRequestAction");
