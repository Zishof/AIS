...
/**
 * Controller/action ZK untuk ujian. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * searchjurusan}, {@code Combobox searchjenis}, {@code AmbilDataMatakuliahBanbox searchmatakuliah};
 ...
 * onSave()}); operasi domain lain ({@code onSertifikat()}, {@code onSyaratUjianTab()}, {@code
 * onKuotaUjianTab()}, {@code onAdd()}, {@code onAddExternal()}). Bagian lain dari kontrak tetap mengikuti kelas
...
public class UjianAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link UjianAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link UjianAction} dan dapat mengakses state kelas
