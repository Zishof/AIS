...
/**
 * Controller/action ZK untuk penduduk. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * searchnama}, {@code MyTextbox searchalamat}, {@code MyTextbox searchtelp}; inisialisasi/lifecycle ({@code
 ...
 * operasi domain lain ({@code onAdd()}, {@code onExternalAdd()}, {@code createKode()}, {@code createBiodata()}).
...
//			init(new Penduduk());
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PendudukAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PendudukAction} dan dapat mengakses state
