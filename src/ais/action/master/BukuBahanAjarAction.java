...
/**
 * Controller/action ZK untuk buku bahan ajar. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Textbox searchpengarang}, {@code Textbox
 * searchpenerbit}, {@code Textbox searchisbn}, {@code Doublebox searchtahun}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian
 * ({@code tampilkanKutipan()}, {@code getDspaceBukuBahanAjar()}, {@code getDspace()}, {@code
 * tampilkanInfoDosen()}, {@code onSearchDefault()}); mutasi data ({@code onSave()}); operasi domain lain ({@code
 * displayRow()}, {@code onAdd()}, {@code onAddExternal()}, {@code generateCSLItemData()}). Bagian lain dari
...
public class BukuBahanAjarAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link BukuBahanAjarAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link BukuBahanAjarAction} dan dapat mengakses state
