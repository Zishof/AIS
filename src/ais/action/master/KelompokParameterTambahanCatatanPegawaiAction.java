...
/**
 * Controller/action ZK untuk kelompok parameter tambahan catatan pegawai. Tipe ini merupakan titik
 ...
 * validasi/perhitungan ({@code checkNamaKelompokParameterTambahanCatatanPegawai()}); mutasi data ({@code
...
public class KelompokParameterTambahanCatatanPegawaiAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KelompokParameterTambahanCatatanPegawaiAction}. Kelas ini
	 * menerjemahkan satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik
	 * kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KelompokParameterTambahanCatatanPegawaiAction}
	 ...
	 *
	 * @see KelompokParameterTambahanCatatanPegawaiAction
	 */
