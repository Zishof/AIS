...
/**
 * Controller/action ZK untuk kelompok kegiatan kemahasiswaan. Tipe ini merupakan titik masuk UI
 ...
 * {@code Combobox jenisKelompokKegiatanKemahasiswaan}, {@code KelompokKegiatanKemahasiswaan
 * kelompokKegiatanKemahasiswaan}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()},
 * {@code init()}, {@code initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}); validasi/perhitungan
 * ({@code checkNamaKelompokKegiatanKemahasiswaan()}); mutasi data ({@code onSave()}); operasi domain lain
 * ({@code onKelompokAspek()}, {@code onJabatanKegiatanKemahasiswaan()}, {@code onSkalaKegiatanKemahasiswaan()},
 * {@code onNilaiKegiatanKemahasiswaan()}, {@code onAdd()}). Bagian lain dari kontrak tetap mengikuti kelas induk
...
public class KelompokKegiatanKemahasiswaanAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KelompokKegiatanKemahasiswaanAction}. Kelas ini menerjemahkan
	 * satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KelompokKegiatanKemahasiswaanAction} dan dapat
	 * mengakses state kelas induk. Jangan menyimpan atau membagikannya lintas desktop/session.</p>
	 * <p>Kontrak yang tampak dari deklarasi ini meliputi state utama: {@code
	 * DetailKelompokKegiatanKemahasiswaanHelper detailKelompokKegiatanKemahasiswaanHelper}; operasi lokal: {@code
	 ...
	 *
	 * @see KelompokKegiatanKemahasiswaanAction
	 */
