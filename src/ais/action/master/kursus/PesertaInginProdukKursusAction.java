...
/**
 * Controller/action ZK untuk peserta ingin produk kursus. Tipe ini merupakan titik masuk UI yang
 ...
 * searchproduk}, {@code Textbox keterangan}, {@code boolean edit}; inisialisasi/lifecycle ({@code
...
public class PesertaInginProdukKursusAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PesertaInginProdukKursusAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PesertaInginProdukKursusAction} dan dapat
	 ...
	 *
	 * @see PesertaInginProdukKursusAction
	 */
