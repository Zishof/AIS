...
/**
 * Controller/action ZK untuk komponen data buku. Tipe ini merupakan titik masuk UI yang
 ...
 */
public class KomponenDataBukuAction extends KomponenDataProdukKursusAction {
	...
	public KomponenDataBukuAction() {
		super(KomponenProdukKursus.BUKU);
