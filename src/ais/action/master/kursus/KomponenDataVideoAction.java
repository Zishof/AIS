...
/**
 * Controller/action ZK untuk komponen data video. Tipe ini merupakan titik masuk UI yang
 ...
 */
public class KomponenDataVideoAction extends KomponenDataProdukKursusAction {
	...
	public KomponenDataVideoAction() {
		super(KomponenProdukKursus.VIDEO);
