...
/**
 * Controller/action ZK untuk komponen data latihan soal. Tipe ini merupakan titik masuk UI yang
 ...
 */
public class KomponenDataLatihanSoalAction extends KomponenDataProdukKursusAction {
	...
	public KomponenDataLatihanSoalAction() {
		super(KomponenProdukKursus.LATIHAN_SOAL);
	}
