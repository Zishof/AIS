...
/**
 * Controller/action ZK untuk berita kursus. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * {@code MyCkEditor isi}, {@code Textbox keterangan}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code
...
public class BeritaKursusAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link BeritaKursusAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link BeritaKursusAction} dan dapat mengakses state
