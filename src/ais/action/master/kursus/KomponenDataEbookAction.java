...
/**
 * Controller/action ZK untuk komponen data ebook. Tipe ini merupakan titik masuk UI yang
 ...
 */
public class KomponenDataEbookAction extends KomponenDataProdukKursusAction {
	...
	public KomponenDataEbookAction() {
		super(KomponenProdukKursus.EBOOK);
	}
