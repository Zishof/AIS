...
/**
 * Controller/action ZK untuk update nama matkul. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code boolean edit}, {@code Matakuliah matakuliah}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code
 ...
 */
public class UpdateNamaMatkulAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link UpdateNamaMatkulAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link UpdateNamaMatkulAction} dan dapat mengakses
	...
	class MataKuliahRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(final Row arg0, Object arg1) throws Exception {arg0.setValign("top");
			...
			RevisiHelper.createNewRevisi(Matakuliah.class, matakuliah,
					matakuliah.getNama()).setParent(arg0);
								...
								public void onEvent(Event event)
									...
									if (i == MyMessageboxConfig.OK) {
										try {
											...
											Common.refreshDelete(matakuliah);
	...
	private void init(Matakuliah matakuliah) {
		this.matakuliah = matakuliah;
		addWindow.setTitle("Perubahan Nama Matakuliah");
		...
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("Kode Mata Kuliah"));
		row.appendChild(new ais.ui.util.MyLabelConfig(matakuliah.getKode() == null ? ""
				: matakuliah.getKode()));

		row = new MyFormRow();
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("Nama Matakuliah"));
		row.appendChild(nama = new Textbox(matakuliah.getNama() == null ? ""
				: matakuliah.getNama()));
		nama.setWidth("90%");
	...
	public boolean onSave(Event event) throws Exception {
		...
		MatakuliahDao matakuliahDao = DaoFactory.getInstance()
				.getMatakuliahDao();
	...
	public Criteria initCriteria(boolean order) {
		...
		criteria.add(Restrictions.ilike("nama", searchnama.getValue(),
				MatchMode.ANYWHERE));
		criteria.add(Restrictions.ilike("kode", searchkode.getValue(),
				MatchMode.ANYWHERE));
		return criteria;
	}
	...
	public void onSearchDefault(Event event) {
		...
		List<Matakuliah> agama = initCriteria(true)
