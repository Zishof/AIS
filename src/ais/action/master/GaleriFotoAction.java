 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Textbox nama}, {@code MyDatebox mulai},
 * {@code MyDatebox sampai}, {@code Textbox keterangan}; inisialisasi/lifecycle ({@code doBeforeCompose()},
...
public class GaleriFotoAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link GaleriFotoAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link GaleriFotoAction} dan dapat mengakses state
