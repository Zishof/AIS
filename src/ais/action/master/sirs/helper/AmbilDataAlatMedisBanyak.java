...
/**
 * Tipe khusus untuk ambil data alat medis banyak. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * ais.ui.util.AmbilDataPagingHelper pagingHelper}, {@code EventListener eventListener}, {@code List alatMediss},
 * {@code List alatMedissHanyaDitampilkan}, {@code Set ids}, {@code Boolean alatMedisLab}, {@code Boolean
 * alatMedisOperasi}; pembacaan/pencarian ({@code getAlatMedisLab()}, {@code onSearchDefault()}, {@code
 * setEventListener()}, {@code getEventListener()}); mutasi data ({@code setAlatMedisLab()}); operasi domain lain
...
public class AmbilDataAlatMedisBanyak extends Window {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataAlatMedisBanyak}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataAlatMedisBanyak} dan dapat mengakses
