...
/**
 * Tipe khusus untuk ambil data alat medis banbox. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * alatMedisLab}, {@code Boolean alatMedisOperasi}, {@code Boolean alatMedisRadiologi}, {@code Boolean
 * alatMedisVk}, {@code Boolean alatMedisRenalUnit}; pembacaan/pencarian ({@code getAlatMedisLab()}, {@code
 * onSearchDefault()}, {@code setEventListener()}, {@code getEventListener()}); mutasi data ({@code
 * setAlatMedisLab()}); operasi domain lain ({@code display()}). Bagian lain dari kontrak tetap mengikuti kelas
