...
/**
 * Tipe khusus untuk ambil data pendaftaran rawat inap banbox. Kelas ini memberi nama dan batas
 ...
 * ais.ui.util.AmbilDataPagingHelper pagingHelper}, {@code EventListener eventListener}, {@code Boolean lunas},
 * {@code MyTextbox kodePendaftaranan}, {@code MyTextbox mr}, {@code MyTextbox nama}; pembacaan/pencarian ({@code
 ...
 * @see Bandbox
 */
public class AmbilDataPendaftaranRawatInapBanbox extends Bandbox {
	...
	public AmbilDataPendaftaranRawatInapBanbox(Boolean lunas) {
		super();
		this.lunas = lunas;
			...
			public void onEvent(Event arg0) throws Exception {
				...
				Pendaftaran pendaftaran = (Pendaftaran) HibernateUtil
						...
						.add(Restrictions.ilike("kode",
								AmbilDataPendaftaranRawatInapBanbox.this
				...
				AmbilDataPendaftaranRawatInapBanbox.this.setOpen(false);
				AmbilDataPendaftaranRawatInapBanbox.this.setAttribute(
						"pendaftaran", pendaftaran);
				AmbilDataPendaftaranRawatInapBanbox.this.setValue(pendaftaran
						.getKode()
						+ " - "
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataPendaftaranRawatInapBanbox}. Kelas ini menerjemahkan
	 * satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataPendaftaranRawatInapBanbox} dan dapat
	 ...
	 *
	 * @see AmbilDataPendaftaranRawatInapBanbox
	 */
	class PendaftaranRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(Row arg0, Object arg1) throws Exception {
			...
			new Label(pendaftaran.getRuangPerawatan() == null ? ""
					: pendaftaran.getRuangPerawatan().getNama())
					.setParent(arg0);
			new Label(pendaftaran.getKamarPerawatan() == null ? ""
					: pendaftaran.getKamarPerawatan().getNama())
					.setParent(arg0);
			new Label(pendaftaran.getTempatTidur() == null ? "" : pendaftaran
					.getTempatTidur().getNama()).setParent(arg0);
	...
	public void display() {
		...
		panel.setWidth("100%");
		panel.setHeight("100%");
		panel.setTitle("Daftar Pendaftar Pasien Rawat Inap");
			...
			public void onEvent(Event event) throws Exception {
				if (eventListener != null) {
					try {
						...
						e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/sirs/helper/AmbilDataPendaftaranRawatInapBanbox.java:259");
					}
				}
				onSearchDefault(event);
			}
	...
	public void onSearchDefault(Event event) {
		...
		List<Pendaftaran> pendaftaran = session
				...
				.add(Restrictions.eq("jenis", Pendaftaran.RAWAT_INAP))
				// .add(Restrictions.ne("statusPendaftaran",
				// Pendaftaran.KELUAR))
