...
/**
 * Tipe khusus untuk ambil data diagnosa penyakit banbox. Kelas ini memberi nama dan batas tanggung
 ...
 * ais.ui.util.AmbilDataPagingHelper pagingHelper}, {@code EventListener eventListener}, {@code MyTextbox kode},
 * {@code MyTextbox mr}, {@code MyTextbox nama}, {@code MyTextbox telp}; pembacaan/pencarian ({@code
...
public class AmbilDataDiagnosaPenyakitBanbox extends Bandbox {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataDiagnosaPenyakitBanbox}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataDiagnosaPenyakitBanbox} dan dapat
	 ...
	 *
	 * @see AmbilDataDiagnosaPenyakitBanbox
	 */
