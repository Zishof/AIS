...
/**
 * Tipe khusus untuk ambil data tempat tidur banbox. Kelas ini memberi nama dan batas tanggung
 ...
 * {@code KelasPerawatan myKelasPerawatan}, {@code Ruang myRuang}, {@code Kamar myKamar}, {@code Combobox
 * kelasPerawatan}; pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()}, {@code
 * getEventListener()}, {@code getMyKelasPerawatan()}, {@code getMyRuang()}, {@code getMyKamar()}); mutasi data
 * ({@code setMyKelasPerawatan()}, {@code setMyRuang()}, {@code setMyKamar()}); operasi domain lain ({@code
...
public class AmbilDataTempatTidurBanbox extends Bandbox {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataTempatTidurBanbox}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataTempatTidurBanbox} dan dapat
	 ...
	 *
	 * @see AmbilDataTempatTidurBanbox
	 */
