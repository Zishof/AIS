...
/**
 * Tipe khusus untuk ambil data item medis banyak berdasarkan stok. Kelas ini memberi nama dan
 ...
 * eventListener}, {@code List items}, {@code Lokasi lokasi}, {@code Set ids}, {@code String orderBy}, {@code
 * Boolean disableStokHabis}, {@code MyTextbox kodeItemMedisan}; pembacaan/pencarian ({@code onSearchDefault()},
...
public class AmbilDataItemMedisBanyakBerdasarkanStok extends Window {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataItemMedisBanyakBerdasarkanStok}. Kelas ini menerjemahkan
	 * satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataItemMedisBanyakBerdasarkanStok} dan
	 ...
	 *
	 * @see AmbilDataItemMedisBanyakBerdasarkanStok
	 */
