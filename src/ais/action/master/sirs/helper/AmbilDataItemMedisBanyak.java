...
/**
 * Tipe khusus untuk ambil data item medis banyak. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * {@code List itemsHanyaDitampilkan}, {@code Set ids}, {@code JenisItemMedis myjenisItemMedis}, {@code MyTextbox
 * kodeItemMedisan}; pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()}, {@code
...
public class AmbilDataItemMedisBanyak extends Window {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataItemMedisBanyak}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataItemMedisBanyak} dan dapat mengakses
