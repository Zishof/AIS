...
/**
 * Tipe khusus untuk ambil data booking registrasi banbox. Kelas ini memberi nama dan batas
 ...
 * kodeBookingRegistrasian}, {@code MyTextbox mr}, {@code MyTextbox nama}; pembacaan/pencarian ({@code
...
public class AmbilDataBookingRegistrasiBanbox extends Bandbox {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataBookingRegistrasiBanbox}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataBookingRegistrasiBanbox} dan dapat
	 ...
	 *
	 * @see AmbilDataBookingRegistrasiBanbox
	 */
