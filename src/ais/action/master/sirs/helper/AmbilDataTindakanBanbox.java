...
/**
 * Tipe khusus untuk ambil data tindakan banbox. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * tindakanLab}, {@code Boolean tindakanOperasi}, {@code Boolean tindakanRadiologi}, {@code Boolean tindakanVk},
 * {@code Boolean tindakanRenalUnit}; pembacaan/pencarian ({@code getTindakanLab()}, {@code onSearchDefault()},
 * {@code setEventListener()}, {@code getEventListener()}, {@code getTindakanOperasi()}, {@code
 * getTindakanRadiologi()}); mutasi data ({@code setTindakanLab()}, {@code setTindakanOperasi()}, {@code
 * setTindakanRadiologi()}, {@code setTindakanVk()}, {@code setTindakanRenalUnit()}, {@code setTindakanGizi()});
...
public class AmbilDataTindakanBanbox extends Bandbox {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataTindakanBanbox}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataTindakanBanbox} dan dapat mengakses
