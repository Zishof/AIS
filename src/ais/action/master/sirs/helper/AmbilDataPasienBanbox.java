...
/**
 * Tipe khusus untuk ambil data pasien banbox. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * eventListener}, {@code MyTextbox kodePasienan}, {@code MyTextbox nama}, {@code MyTextbox telp}, {@code
 * MyTextbox alamat}; pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()}, {@code
 * getEventListener()}); operasi domain lain ({@code display()}); konfigurasi constructor: {@code pasien}. Bagian
...
public class AmbilDataPasienBanbox extends Bandbox {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataPasienBanbox}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataPasienBanbox} dan dapat mengakses
