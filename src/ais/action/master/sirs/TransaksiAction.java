...
public class TransaksiAction extends GenericAutowireComposer implements GetTransaksi, TransaksiListener {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link TransaksiAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link TransaksiAction} dan dapat mengakses state
