...
/**
 * Controller/action ZK untuk pemeriksaan tree. Tipe ini merupakan titik masuk UI yang
 ...
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Window addWindow}, {@code Tree tree},
 * {@code Textbox nama}, {@code Combobox jenis}, {@code Textbox nilaiYangMungkin}, {@code Textbox nilaiDefault},
 * {@code Textbox normal}, {@code Textbox satuan}; inisialisasi/lifecycle ({@code doAfterCompose()}, {@code
 * initTree()}, {@code init()}); pembacaan/pencarian ({@code onReloadTree()}, {@code reloadTreeitem()}, {@code
