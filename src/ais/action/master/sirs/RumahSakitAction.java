...
public class RumahSakitAction extends GenericCrudAction<RumahSakit> {
    ...
    /**
     * Renderer lokal untuk layar/komponen {@link RumahSakitAction}. Kelas ini menerjemahkan satu item data menjadi
     * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
     *
     * <p><b>Scope:</b> setiap instance terikat pada instance {@link RumahSakitAction} dan dapat mengakses state
