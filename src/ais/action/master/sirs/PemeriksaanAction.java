...
/**
 * Controller/action ZK untuk pemeriksaan. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * paging}, {@code Grid grid}, {@code Textbox searchnama}, {@code Textbox nama}, {@code Combobox jenis}, {@code
 * Textbox nilaiYangMungkin}, {@code Textbox nilaiDefault}; inisialisasi/lifecycle ({@code doAfterCompose()},
 * {@code init()}, {@code initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}, {@code
 * getNilaiDefault()}); mutasi data ({@code onSave()}, {@code setNilaiDefault()}); operasi domain lain ({@code
...
public class PemeriksaanAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PemeriksaanAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PemeriksaanAction} dan dapat mengakses state
