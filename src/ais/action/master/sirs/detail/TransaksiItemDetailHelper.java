...
/**
 * Helper terfokus untuk transaksi item detail. Tipe ini membungkus satu variasi kecil dari alur
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Grid grid}, {@code MyTextbox barcode},
 * {@code Footer totalDiskon}, {@code Footer totalPajak}, {@code Footer total}, {@code Footer totalHrg}, {@code
 * GetTransaksi dataParent}; pembacaan/pencarian ({@code loadData()}, {@code loadTotal()}); operasi domain lain
...
public class TransaksiItemDetailHelper extends Borderlayout {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link TransaksiItemDetailHelper}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link TransaksiItemDetailHelper} dan dapat mengakses
