...
/**
 * Controller/action ZK untuk pajak detail. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code PajakMedis pajak}, {@code Paging
 * paging}, {@code Grid grid}, {@code MyTextbox kode}, {@code MyTextbox nama}, {@code Checkbox isItem}, {@code
 * Checkbox isTindakan}, {@code Checkbox isAlatMedis}; inisialisasi/lifecycle ({@code initCriteria()});
...
public class PajakDetailAction extends MyDetail {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PajakDetailAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PajakDetailAction} dan dapat mengakses state
