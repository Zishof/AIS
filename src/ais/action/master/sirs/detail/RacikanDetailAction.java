...
/**
 * Controller/action ZK untuk racikan detail. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * {@code Toolbar toolbar}, {@code Boolean aktif}; inisialisasi/lifecycle ({@code reInitRacikan()});
