...
/**
 * Controller/action ZK untuk transaksi alat medis detail. Tipe ini merupakan titik masuk UI yang
 ...
 * @see MyDetail
 */
public class TransaksiAlatMedisDetailAction extends MyDetail {
	...
	public TransaksiAlatMedisDetailAction(TransaksiMedis transaksi) {
		super();
		...
		this.addEventListener(Events.ON_OPEN, new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				Common.clear(TransaksiAlatMedisDetailAction.this);
				if (isOpen()) {
					display();
				}
			}
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link TransaksiAlatMedisDetailAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link TransaksiAlatMedisDetailAction} dan dapat
	 ...
	 *
	 * @see TransaksiAlatMedisDetailAction
	 */
	class TransaksiDetailRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(final Row row, Object data) throws Exception {row.setValign("top");
			...
			new Label(transaksiDetail.getAlatMedis() == null ? "" : transaksiDetail.getAlatMedis().getKode())
					.setParent(row);
			RevisiHelper
	...
	private void display() {
		...
		groupbox.appendChild(new Caption("Daftar Transaksi Alat Medis"));
