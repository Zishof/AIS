...
/**
 * Helper terfokus untuk transaksi alat medis detail. Tipe ini membungkus satu variasi kecil dari
 ...
 * dataParent}; pembacaan/pencarian ({@code loadData()}, {@code loadTotal()}, {@code ambilData()}); operasi
...
public class TransaksiAlatMedisDetailHelper extends Borderlayout {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link TransaksiAlatMedisDetailHelper}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link TransaksiAlatMedisDetailHelper} dan dapat
	 ...
	 *
	 * @see TransaksiAlatMedisDetailHelper
	 */
