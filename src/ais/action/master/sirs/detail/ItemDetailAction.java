...
/**
 * Controller/action ZK untuk item detail. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code KelompokItem kelompokItem}, {@code Grid
 * grid}, {@code MyTextbox kodeIteman}, {@code MyTextbox nama}; pembacaan/pencarian ({@code loadData()}); operasi
...
public class ItemDetailAction extends MyDetail {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link ItemDetailAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link ItemDetailAction} dan dapat mengakses state
