...
/**
 * Controller/action ZK untuk deposit. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * tanggal}, {@code AmbilDataPendaftaranSemuaBanbox pendaftaran}, {@code Doublebox nilai}; inisialisasi/lifecycle
 ...
 * domain lain ({@code onAdd()}, {@code addExternal()}). Bagian lain dari kontrak tetap mengikuti kelas induk
...
public class DepositAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link DepositAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DepositAction} dan dapat mengakses state kelas
