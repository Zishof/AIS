...
/**
 * Controller/action ZK untuk cetak kartu pasien. Tipe ini merupakan titik masuk UI yang
 ...
 * searchmr}, {@code MyTextbox kode}, {@code AmbilDataPasienBanbox pasien}; inisialisasi/lifecycle ({@code
 * doAfterCompose()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()});
 * mutasi data ({@code onSave()}); pelaporan/ekspor ({@code onCetakKartu()}); operasi domain lain ({@code
...
public class CetakKartuPasienAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link CetakKartuPasienAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link CetakKartuPasienAction} dan dapat mengakses
