...
/**
 * Controller/action ZK untuk pendaftaran rawat jalan. Tipe ini merupakan titik masuk UI yang
 ...
 * doAfterCompose()}, {@code initPilihanPaket()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian
...
public class PendaftaranRawatJalanAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PendaftaranRawatJalanAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PendaftaranRawatJalanAction} dan dapat
	 ...
	 *
	 * @see PendaftaranRawatJalanAction
	 */
