...
public class AsuransiAction extends GenericCrudAction<Asuransi> {
    ...
    @Override
    protected Class<Asuransi> getEntityClass() { return Asuransi.class; }

    @Override
    protected Asuransi createNewEntity() { return new Asuransi(); }
    ...
    public Criteria initCriteria(boolean order) {
        ...
        Criteria criteria = session.createCriteria(Asuransi.class);
    ...
    protected void buildFormContent(MyWindow window, final Asuransi asuransi) throws Exception {
        ...
        nama = new Textbox(asuransi.getNama() == null ? "" : asuransi.getNama());
        nama.setWidth("100%");
        fb.addRow("Nama Asuransi", nama);

        keterangan = new Textbox(asuransi.getKeterangan() == null ? "" : asuransi.getKeterangan());
    ...
    public boolean onSave(Event event) throws Exception {
        ...
        if (checkNamaAsuransi()) {
            MyMessageboxConfig.show("Mohon maaf, Nama Asuransi yang Bapak/Ibu masukkan sudah terdaftar sebelumnya. Langkah yang dapat dilakukan: (1) gunakan nama asuransi yang berbeda; (2) periksa kembali data asuransi yang telah ada melalui pencarian; (3) lakukan perubahan pada data yang sudah ada apabila diperlukan.", "Peringatan",
                    MyMessageboxConfig.OK, MyMessageboxConfig.INFORMATION);
            return false;
        }
        Session session = HibernateUtil.currentSession();
        Asuransi entity = currentEntity;
        if (entity.getId() != null) {
            entity = (Asuransi) session.load(Asuransi.class, entity.getId());
    ...
    class AsuransiRenderer extends MyRowRenderer {
        ...
        public void render(final Row arg0, Object arg1) throws Exception {
            ...
            RevisiHelper.createNewRevisi(Asuransi.class, asuransi, asuransi.getNama()).setParent(arg0);
            new Label(asuransi.getKeterangan()).setParent(arg0);

            Common.copyEditDeleteButtons(edit, delete, asuransi, AsuransiAction.this).setParent(arg0);
        }
    }
}
