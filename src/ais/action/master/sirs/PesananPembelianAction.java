...
/**
 * Controller/action ZK untuk pesanan pembelian. Tipe ini merupakan titik masuk UI yang
 ...
 * AmbilDataPermintaanPembelianBanbox permintaanPembelian}, {@code MyTextbox kode}, {@code Combobox lokasi};
 * inisialisasi/lifecycle ({@code doAfterCompose()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian
 * ({@code onSearchDefault()}); validasi/perhitungan ({@code checkKodePesananPembelian()}); mutasi data ({@code
...
public class PesananPembelianAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PesananPembelianAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PesananPembelianAction} dan dapat mengakses
