...
/**
 * Controller/action ZK untuk diagnosa penyakit. Tipe ini merupakan titik masuk UI yang
 ...
 * onDelete()}); operasi domain lain ({@code onAdd()}, {@code createDiagnosa()}, {@code createPoliDanDokter()},
 * {@code createCatatan()}, {@code createMain()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
...
public class DiagnosaPenyakitAction extends GenericAutowireComposer implements OnSave {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link DiagnosaPenyakitAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link DiagnosaPenyakitAction} dan dapat mengakses
