...
/**
 * Controller/action ZK untuk permintaan pembelian. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code Paging paging}, {@code MyTextbox searchkode}, {@code Combobox searchlokasi}, {@code Combobox lokasi},
 * {@code MyTextbox kode}, {@code MyTextbox keterangan}; inisialisasi/lifecycle ({@code doAfterCompose()}, {@code
 * init()}, {@code initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}); validasi/perhitungan
 * ({@code checkKodePermintaanPembelian()}); mutasi data ({@code onSave()}); operasi domain lain ({@code
...
public class PermintaanPembelianAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PermintaanPembelianAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PermintaanPembelianAction} dan dapat mengakses
