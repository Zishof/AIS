...
public class JenisPasienAction extends GenericCrudAction<JenisPasien> {
    ...
    public Criteria initCriteria(boolean order) {
        ...
        Criteria criteria = session.createCriteria(JenisPasien.class);
    ...
    protected void buildFormContent(MyWindow window, final JenisPasien jenisPasien) throws Exception {
        ...
        nama = new Textbox(jenisPasien.getNama() == null ? "" : jenisPasien.getNama());
        nama.setWidth("100%");
        fb.addRow("Nama Jenis Pasien", nama);

        keterangan = new Textbox(jenisPasien.getKeterangan() == null ? "" : jenisPasien.getKeterangan());
    ...
    public boolean onSave(Event event) throws Exception {
        ...
        Session session = HibernateUtil.currentSession();
        JenisPasien entity = currentEntity;
        if (entity.getId() != null) {
            entity = (JenisPasien) session.load(JenisPasien.class, entity.getId());
    ...
    class JenisPasienRenderer extends MyRowRenderer {
        ...
        public void render(final Row arg0, Object arg1) throws Exception {
            arg0.setValign("top");
            final JenisPasien jenisPasien = (JenisPasien) arg1;

            RevisiHelper.createNewRevisi(JenisPasien.class, jenisPasien, jenisPasien.getNama()).setParent(arg0);
            new Label(jenisPasien.getKeterangan()).setParent(arg0);

            Common.copyEditDeleteButtons(edit, delete, jenisPasien, JenisPasienAction.this).setParent(arg0);
        }
    }
}
