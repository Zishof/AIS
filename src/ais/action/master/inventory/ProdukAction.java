...
public class ProdukAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault, DataInitDefault {
	...
	private void init(Produk produk) throws Exception {
		...
		Common.insertCombo(kebijakanRetur, "nama", KebijakanRetur.class,
				Restrictions.eq("aktif", true));
		KebijakanRetur kebijakanTerpilih = produk.getKebijakanRetur();
		if (kebijakanTerpilih == null) {
			kebijakanTerpilih = (KebijakanRetur) HibernateUtil.currentSession()
					.createCriteria(KebijakanRetur.class)
					.add(Restrictions.ilike("nama", KebijakanRetur.TANPA_KEBIJAKAN))
	...
	public boolean onSave(Event event) throws Exception {
		...
		KebijakanRetur kebijakan = kebijakanRetur == null || kebijakanRetur.getSelectedItem() == null
				? null : (KebijakanRetur) kebijakanRetur.getSelectedItem().getValue();
		if (kebijakan == null) {
