...
public final class PriceTagUtil {
	...
	/** Versi berpaginasi untuk tabel administrasi; limit/offset diterapkan oleh DB. */
	@SuppressWarnings("unchecked")
	...
	/** Hitung total filter yang sama tanpa mengambil entity/foto. */
	...
	private static Criteria buatCriteria(Session s, Long tokoId, String q, boolean semuaToko,
			boolean adminGlobal, String jenisItemFilter) {
		return buatCriteria(s, tokoId, q, semuaToko, adminGlobal, jenisItemFilter, null);
	}
