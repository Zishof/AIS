...
public class GrupProdukAction extends GenericCrudAction<GrupProduk> {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link GrupProdukAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link GrupProdukAction} dan dapat mengakses state
