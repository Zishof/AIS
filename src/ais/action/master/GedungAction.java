...
public class GedungAction extends GenericCrudAction<Gedung> {
    ...
    /**
     * Renderer lokal untuk layar/komponen {@link GedungAction}. Kelas ini menerjemahkan satu item data menjadi
     * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
     *
     * <p><b>Scope:</b> setiap instance terikat pada instance {@link GedungAction} dan dapat mengakses state kelas
