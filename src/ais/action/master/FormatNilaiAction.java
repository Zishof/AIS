...
/**
 * Controller/action ZK untuk format nilai. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Textbox keterangan}, {@code MyDoublebox
 * persen}, {@code Combobox statusPertemuan}, {@code boolean edit}; inisialisasi/lifecycle ({@code
...
public class FormatNilaiAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link FormatNilaiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link FormatNilaiAction} dan dapat mengakses state
