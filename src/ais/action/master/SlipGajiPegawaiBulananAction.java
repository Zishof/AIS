...
/**
 * Controller/action ZK untuk slip gaji pegawai bulanan. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code Textbox searchcode}, {@code Textbox searchnama}, {@code Intbox searchtahun}, {@code
 * AmbilDataSatuanKerjaBanbox searchparent}, {@code MyToolbarbuttonConfig add}, {@code SatuanKerjaTreeModel
 * satuanKerjaTreeModel}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code
 * initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}); mutasi data ({@code prosesPenggajian()}).
...
public class SlipGajiPegawaiBulananAction extends GenericAutowireComposer implements CommonOnSearchdefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link SlipGajiPegawaiBulananAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link SlipGajiPegawaiBulananAction} dan dapat
	 ...
	 *
	 * @see SlipGajiPegawaiBulananAction
	 */
