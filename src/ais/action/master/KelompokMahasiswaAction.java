...
/**
 * Controller/action ZK untuk kelompok mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * nama}, {@code Combobox statusAwalMahasiswa}, {@code Textbox keterangan}; inisialisasi/lifecycle ({@code
 ...
 * onManajemenStatusAwalMahasiswa()}, {@code onAdd()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
...
public class KelompokMahasiswaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KelompokMahasiswaAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KelompokMahasiswaAction} dan dapat mengakses
