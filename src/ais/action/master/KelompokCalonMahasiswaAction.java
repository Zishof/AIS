...
/**
 * Controller/action ZK untuk kelompok calon mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code AmbilDataGelombangPendaftaranBanbox searchgelombangPendaftaran}, {@code
 * Combobox gelombangPendaftaran}, {@code Combobox statusAwalMahasiswa}, {@code Combobox jenisSeleksiTarget},
 * {@code Intbox kuota}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code
 * init()}, {@code initCriteria()}); pembacaan/pencarian ({@code reloadDetail()}, {@code onSearchDefault()});
 * validasi/perhitungan ({@code validasiStatusAwalMahasiswa()}); mutasi data ({@code onSave()}); operasi domain
 * lain ({@code onManajemenStatusAwalMahasiswa()}, {@code onManajemenAfiliasi()}, {@code onAdd()}, {@code
 * kriteriaKelompok()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di
 * atas.</p>
...
public class KelompokCalonMahasiswaAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KelompokCalonMahasiswaAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KelompokCalonMahasiswaAction} dan dapat
	 ...
	 *
	 * @see KelompokCalonMahasiswaAction
	 */
