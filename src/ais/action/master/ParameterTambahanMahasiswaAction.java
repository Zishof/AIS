...
/**
 * Controller/action ZK untuk parameter tambahan mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * operasi domain lain ({@code onKonfigurasiBiodataMahasiswa()}, {@code onManajemenKelompok()}, {@code
 * onManajemenParameter()}, {@code onManajemenKelompokAlumni()}, {@code onAlumni()}, {@code onAdd()}). Bagian
...
public class ParameterTambahanMahasiswaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link ParameterTambahanMahasiswaAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link ParameterTambahanMahasiswaAction} dan dapat
