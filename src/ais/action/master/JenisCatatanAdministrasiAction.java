...
/**
 * Controller/action ZK untuk jenis catatan administrasi. Tipe ini merupakan titik masuk UI yang
 ...
 * doAfterCompose()}, {@code init()}, {@code init()}, {@code initKelompokParameterTambahanCatatanAdministrasi()},
...
public class JenisCatatanAdministrasiAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisCatatanAdministrasiAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisCatatanAdministrasiAction} dan dapat
	 ...
	 *
	 * @see JenisCatatanAdministrasiAction
	 */
