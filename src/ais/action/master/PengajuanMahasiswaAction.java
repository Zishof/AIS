...
/**
 * Controller/action ZK untuk pengajuan mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * searchfakultas}, {@code Combobox searchjurusan}, {@code Combobox searchTahunAjaran}; inisialisasi/lifecycle
 ...
 * onJenisPengajuan()}, {@code onManajemenParameter()}, {@code onAdd()}, {@code form()}, {@code
 * parseWaktuLama()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di
 * atas.</p>
...
public class PengajuanMahasiswaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PengajuanMahasiswaAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PengajuanMahasiswaAction} dan dapat mengakses
	...
	public MyGrid form(GeneralValueObject generalValueObject, DisposisiSop disposisiSop,
		...
		/**
		 * Event listener lokal milik {@link PengajuanMahasiswaAction}. Kelas ini menangani event untuk komponen induk
