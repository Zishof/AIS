...
/**
 * Controller/action ZK untuk riwayat tanda jasa pegawai. Tipe ini merupakan titik masuk UI yang
 ...
 * riwayatTandaJasaPegawaiHelper}; operasi lokal: {@code doBeforeCompose()}, {@code doAfterCompose}(). Bagian
 ...
 */
public class RiwayatTandaJasaPegawaiAction extends GenericAutowireComposer {
	...
	public org.zkoss.zk.ui.metainfo.ComponentInfo doBeforeCompose(org.zkoss.zk.ui.Page page, org.zkoss.zk.ui.Component parent,org.zkoss.zk.ui.metainfo.ComponentInfo compInfo) {Common.doCheckSecurity();return super.doBeforeCompose(page, parent, compInfo);}public void doAfterCompose(Component comp) throws Exception {
		...
		riwayatTandaJasaPegawaiHelper = new RiwayatTandaJasaPegawaiHelper(Common.getCurrentUser().ambilPegawai());
		riwayatTandaJasaPegawaiHelper.display().setParent(window);
	}
