...
//		add.getParent().appendChild(upload);
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link GolonganAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link GolonganAction} dan dapat mengakses state
