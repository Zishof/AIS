...
/**
 * Controller/action ZK untuk tipe masa kerja. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkKodeTipeMasaKerja()}, {@code
 * checkNamaTipeMasaKerja()}); mutasi data ({@code onSave()}); operasi domain lain ({@code onAdd()}). Bagian lain
...
public class TipeMasaKerjaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link TipeMasaKerjaAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link TipeMasaKerjaAction} dan dapat mengakses state
