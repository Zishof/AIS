...
/**
 * Controller/action ZK untuk riwayat kenaikan pangkat fungsional untuk pegawai. Tipe ini merupakan
 ...
 * AmbilDataPegawaiBanbox searchpegawai}, {@code Combobox searchstatus}, {@code Textbox namaPejabat}, {@code
 * Textbox nomorSuratkeputusan}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()},
 * {@code init()}, {@code initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}); mutasi data ({@code
 ...
 */
public class RiwayatKenaikanPangkatFungsionalUntukPegawaiAction extends GenericAutowireComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		if (pegawai == null) {
			...
			searchpegawai.setAttribute("pegawai", null);
			searchpegawai.setValue(null);
		...
		if (ambilDataPegawaiBanbox != null) { ambilDataPegawaiBanbox.setValue(pegawai == null ? "" : pegawai.getCode() + " - " + pegawai.getNama()); }
		if (ambilDataPegawaiBanbox != null) { ambilDataPegawaiBanbox.setAttribute("pegawai", pegawai); }
...
//				.checkPrevilages(CommonPrivilages.CREATE));
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link RiwayatKenaikanPangkatFungsionalUntukPegawaiAction}. Kelas ini
	 ...
	 * RiwayatKenaikanPangkatFungsionalUntukPegawaiAction} dan dapat mengakses state kelas induk. Jangan menyimpan
	 ...
	 *
	 * @see RiwayatKenaikanPangkatFungsionalUntukPegawaiAction
	 */
	class KenaikanPangkatRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(final Row arg0, Object arg1) throws Exception {
			...
			RevisiHelper.createNewRevisi(KenaikanPangkat.class, kenaikanPangkat, kenaikanPangkat.getPegawai().getNama())
					.setParent(arg0);
	...
	private void init(KenaikanPangkat kenaikanPangkat) throws Exception {
		...
		addWindow.setTitle(kenaikanPangkat.getId() == null ? "Tambah Kenaikan Pangkat Mutasi" : "Ubah Kenaikan Pangkat Mutasi");
		...
		kenaikanJabatan.setChecked(true);
		kenaikanJabatan.setDisabled(true);

		final MyFormRow jenisjabatanrow = new MyFormRow();
		jenisjabatanrow.setVisible(true);
		...
		jenis.appendChild(comboitem);
		Common.selectComboItem(jenis, Pegawai.JENIS_FUNGSIONAL);
...
kenaikanPangkat.setGolongan(
	...
	public Criteria initCriteria(boolean order) {
		...
		criteria.add((searchpegawai == null) ? org.hibernate.criterion.Restrictions.sqlRestriction("1=1") : (searchpegawai.getAttribute("pegawai") == null ? Restrictions.eq("pegawai", null)
		...
		// criteria.add(Restrictions.eq("kenaikanPangkatFungsional", true));
