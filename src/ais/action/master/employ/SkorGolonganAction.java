...
/**
 * Controller/action ZK untuk skor golongan. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaSkorGolongan()}); mutasi data ({@code onSave()});
...
public class SkorGolonganAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link SkorGolonganAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link SkorGolonganAction} dan dapat mengakses state
