...
/**
 * Tipe khusus untuk ambil data jenis pelatihan banyak. Kelas ini memberi nama dan batas tanggung
 ...
 * kategoriItems}, {@code List kategoriItemsHanyaDitampilkan}, {@code Set ids}, {@code MyTextbox nama};
 ...
 * @see MyWindow
 */
public class AmbilDataJenisPelatihanBanyak extends MyWindow {
	...
	private List<JenisPelatihan> kategoriItems;
	private List<JenisPelatihan> kategoriItemsHanyaDitampilkan;

	private Set<Long> ids = new HashSet<Long>();

	public AmbilDataJenisPelatihanBanyak(List<JenisPelatihan> kategoriItems) {
		super();
	...
	public AmbilDataJenisPelatihanBanyak(List<JenisPelatihan> kategoriItems,
			List<JenisPelatihan> kategoriItemsHanyaDitampilkan) {
		super();
		this.kategoriItems = kategoriItems;
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataJenisPelatihanBanyak}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataJenisPelatihanBanyak} dan dapat
	 ...
	 *
	 * @see AmbilDataJenisPelatihanBanyak
	 */
	class JenisPelatihanRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(Row arg0, Object arg1) throws Exception {arg0.setValign("top");
			...
			for (JenisPelatihan myJenisPelatihan : kategoriItems) {
				if (myJenisPelatihan.getId().equals(kategoriItem.getId())) {
	...
	public void display() {
		...
		panel.setWidth("100%");
		panel.setHeight("100%");
		panel.setTitle("Daftar JenisPelatihan");
		...
		cancel.addEventListener("onClick", new EventListener() {
			@Override
			public void onEvent(Event event) throws Exception {
				AmbilDataJenisPelatihanBanyak.this.detach();
			}
		});
		...
		button.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				if (eventListener != null && grid.getRows() != null
					...
					List<JenisPelatihan> kategoriItems = new ArrayList<JenisPelatihan>();
					List<Row> rows = grid.getRows().getChildren();
					for (Row row : rows) {
						MyCheckboxConfig checkbox = (MyCheckboxConfig) row.getAttribute("checkbox");
						if (checkbox.isChecked() && !checkbox.isDisabled()) {
							JenisPelatihan myJenisPelatihan = (JenisPelatihan) row
	...
	public void onSearchDefault(Event event) {
		...
		kategoriItem.addAll(myJenisPelatihan);
