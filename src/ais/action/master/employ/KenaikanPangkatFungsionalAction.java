...
/**
 * Controller/action ZK untuk kenaikan pangkat fungsional. Tipe ini merupakan titik masuk UI yang
 ...
 */
public class KenaikanPangkatFungsionalAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KenaikanPangkatFungsionalAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KenaikanPangkatFungsionalAction} dan dapat
	 ...
	 *
	 * @see KenaikanPangkatFungsionalAction
	 */
	...
	private void init(KenaikanPangkat kenaikanPangkat) throws Exception {
		...
		boolean menggunakanLangsungGajiPokok = Common.bolehKonfigurasi("kenaikan_pangkat_menggunakan_langsung_gaji_pokok", Konfigurasi.TIDAK_AKTIF);

		row = new MyFormRow();
		row.setVisible(!menggunakanLangsungGajiPokok);
		row.setParent(rows);
		...
		row.appendChild(gajiPokok = new AmbilDataGajiPokokBanbox());
