...
/**
 * Controller/action ZK untuk jabatan fungsional tree. Tipe ini merupakan titik masuk UI yang
 ...
 * {@code boolean delete}, {@code JabatanFungsional jabatanFungsional}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code initTree()}, {@code init()}); pembacaan/pencarian ({@code
 * reloadDataTunjangan()}, {@code reloadTunjangan()}, {@code onReloadTree()}, {@code reloadTreeitem()}, {@code
