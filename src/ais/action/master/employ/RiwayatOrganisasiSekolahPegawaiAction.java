...
/**
 * Controller/action ZK untuk riwayat organisasi sekolah pegawai. Tipe ini merupakan titik masuk UI
 ...
 * riwayatOrganisasiSekolahPegawaiHelper}; operasi lokal: {@code doBeforeCompose()}, {@code doAfterCompose}().
 ...
 */
public class RiwayatOrganisasiSekolahPegawaiAction extends
	...
	public org.zkoss.zk.ui.metainfo.ComponentInfo doBeforeCompose(org.zkoss.zk.ui.Page page, org.zkoss.zk.ui.Component parent,org.zkoss.zk.ui.metainfo.ComponentInfo compInfo) {Common.doCheckSecurity();return super.doBeforeCompose(page, parent, compInfo);}public void doAfterCompose(Component comp) throws Exception {
		...
		riwayatOrganisasiSekolahPegawaiHelper = new RiwayatOrganisasiSekolahPegawaiHelper(
                Common.getCurrentUser().ambilPegawai());
		riwayatOrganisasiSekolahPegawaiHelper.display().setParent(window);
	}
