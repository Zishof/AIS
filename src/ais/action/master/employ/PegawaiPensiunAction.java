...
/**
 * Controller/action ZK untuk pegawai pensiun. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * {@code Textbox searchcode}, {@code Textbox searchnama}, {@code AmbilDataSatuanKerjaBanbox searchparent},
 * {@code MyToolbarbuttonConfig add}, {@code boolean edit}, {@code SatuanKerja satuanKerjaOnSession};
 * inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code initCriteria()});
 * pembacaan/pencarian ({@code onSearchDefault()}); operasi domain lain ({@code main()}). Bagian lain dari
...
public class PegawaiPensiunAction extends GenericAutowireComposer implements CommonOnSearchdefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PegawaiPensiunAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PegawaiPensiunAction} dan dapat mengakses
