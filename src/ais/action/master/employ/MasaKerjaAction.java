...
/**
 * Controller/action ZK untuk masa kerja. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * paging}, {@code MyGrid grid}, {@code TreeSet skors}, {@code Textbox searchnama}, {@code Checkbox searchaktif},
 ...
 * reloadDataFormula()}, {@code reloadFormula()}, {@code onSearchDefault()}); mutasi data ({@code onSave()});
...
public class MasaKerjaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link MasaKerjaAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link MasaKerjaAction} dan dapat mengakses state
