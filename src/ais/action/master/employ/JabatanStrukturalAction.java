...
/**
 * Controller/action ZK untuk jabatan struktural. Tipe ini merupakan titik masuk UI yang
 ...
 * ({@code onSearchDefault()}); validasi/perhitungan ({@code checkNamaJabatanStruktural()}); mutasi data ({@code
...
public class JabatanStrukturalAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JabatanStrukturalAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JabatanStrukturalAction} dan dapat mengakses
