...
/**
 * Controller/action ZK untuk mutasi. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * AmbilDataPegawaiBanbox searchpegawai}, {@code Combobox jabatanStrukturalAwal}, {@code Combobox
 * jabatanStrukturalAkhir}, {@code Combobox searchstatus}; inisialisasi/lifecycle ({@code doBeforeCompose()},
...
public class MutasiAction extends GenericAutowireComposer implements DataInitDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link MutasiAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link MutasiAction} dan dapat mengakses state kelas
