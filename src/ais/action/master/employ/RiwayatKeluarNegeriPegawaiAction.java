...
/**
 * Controller/action ZK untuk riwayat keluar negeri pegawai. Tipe ini merupakan titik masuk UI yang
 ...
 * riwayatKeluarNegeriPegawaiHelper}; operasi lokal: {@code doBeforeCompose()}, {@code doAfterCompose}(). Bagian
 ...
 */
public class RiwayatKeluarNegeriPegawaiAction extends GenericAutowireComposer {
	...
	public org.zkoss.zk.ui.metainfo.ComponentInfo doBeforeCompose(org.zkoss.zk.ui.Page page, org.zkoss.zk.ui.Component parent,org.zkoss.zk.ui.metainfo.ComponentInfo compInfo) {Common.doCheckSecurity();return super.doBeforeCompose(page, parent, compInfo);}public void doAfterCompose(Component comp) throws Exception {
		...
		riwayatKeluarNegeriPegawaiHelper = new RiwayatKeluarNegeriPegawaiHelper(Common.getCurrentUser().ambilPegawai());
		riwayatKeluarNegeriPegawaiHelper.display().setParent(window);
	}
