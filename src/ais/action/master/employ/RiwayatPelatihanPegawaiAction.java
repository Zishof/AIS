...
/**
 * Controller/action ZK untuk riwayat pelatihan pegawai. Tipe ini merupakan titik masuk UI yang
 ...
 * riwayatPelatihanPegawaiHelper}; operasi lokal: {@code doBeforeCompose()}, {@code doAfterCompose}(). Bagian
 ...
 */
public class RiwayatPelatihanPegawaiAction extends GenericAutowireComposer {
	...
	public org.zkoss.zk.ui.metainfo.ComponentInfo doBeforeCompose(org.zkoss.zk.ui.Page page, org.zkoss.zk.ui.Component parent,org.zkoss.zk.ui.metainfo.ComponentInfo compInfo) {Common.doCheckSecurity();return super.doBeforeCompose(page, parent, compInfo);}public void doAfterCompose(Component comp) throws Exception {
		...
		riwayatPelatihanPegawaiHelper = new RiwayatPelatihanPegawaiHelper(
                Common.getCurrentUser().ambilPegawai());
		riwayatPelatihanPegawaiHelper.display().setParent(window);
	}
