...
/**
 * Controller/action ZK untuk riwayat organisasi lain pegawai. Tipe ini merupakan titik masuk UI
 ...
 * riwayatOrganisasiLainPegawaiHelper}; operasi lokal: {@code doBeforeCompose()}, {@code doAfterCompose}().
 ...
 */
public class RiwayatOrganisasiLainPegawaiAction extends GenericAutowireComposer {
	...
	public org.zkoss.zk.ui.metainfo.ComponentInfo doBeforeCompose(org.zkoss.zk.ui.Page page, org.zkoss.zk.ui.Component parent,org.zkoss.zk.ui.metainfo.ComponentInfo compInfo) {Common.doCheckSecurity();return super.doBeforeCompose(page, parent, compInfo);}public void doAfterCompose(Component comp) throws Exception {
		...
		riwayatOrganisasiLainPegawaiHelper = new RiwayatOrganisasiLainPegawaiHelper(
                Common.getCurrentUser().ambilPegawai());
		riwayatOrganisasiLainPegawaiHelper.display().setParent(window);
	}
