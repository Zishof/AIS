...
/**
 * Controller/action ZK untuk jenis pimpinan. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * validasi/perhitungan ({@code checkNamaJenisPimpinan()}); mutasi data ({@code onSave()}); operasi domain lain
...
public class JenisPimpinanAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenisPimpinanAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenisPimpinanAction} dan dapat mengakses state
