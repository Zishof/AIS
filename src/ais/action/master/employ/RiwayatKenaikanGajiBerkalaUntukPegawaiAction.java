...
/**
 * Controller/action ZK untuk riwayat kenaikan gaji berkala untuk pegawai. Tipe ini merupakan titik
 ...
 */
public class RiwayatKenaikanGajiBerkalaUntukPegawaiAction extends GenericAutowireComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		if (pegawai == null) {
			alert("Anda harus login sebagai Pegawai");
			...
			ambilDataPegawaiBanbox.setValue(pegawai == null ? "" : pegawai.getCode() + " - " + pegawai.getNama());
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link RiwayatKenaikanGajiBerkalaUntukPegawaiAction}. Kelas ini
	 * menerjemahkan satu item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik
	 * kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link RiwayatKenaikanGajiBerkalaUntukPegawaiAction}
	 ...
	 *
	 * @see RiwayatKenaikanGajiBerkalaUntukPegawaiAction
	 */
									...
									if (i == MyMessageboxConfig.OK) {
										try {
											...
											kenaikanGajiBerkalaDao
													.delete(kenaikanGajiBerkalaDao.merge(kenaikanGajiBerkala));
