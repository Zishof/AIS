...
/**
 * Controller/action ZK untuk tipe pegawai. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * MyCheckboxConfig haris}, {@code Textbox nama}, {@code Textbox keterangan}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code init()}, {@code initCriteria()});
 * pembacaan/pencarian ({@code onSearchDefault()}); validasi/perhitungan ({@code checkKodeTipePegawai()}, {@code
 * checkNamaTipePegawai()}); mutasi data ({@code onSave()}); operasi domain lain ({@code onAdd()}). Bagian lain
...
public class TipePegawaiAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link TipePegawaiAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link TipePegawaiAction} dan dapat mengakses state
