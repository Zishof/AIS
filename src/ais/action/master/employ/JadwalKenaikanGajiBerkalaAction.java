...
/**
 * Controller/action ZK untuk jadwal kenaikan gaji berkala. Tipe ini merupakan titik masuk UI yang
 ...
 */
public class JadwalKenaikanGajiBerkalaAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JadwalKenaikanGajiBerkalaAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JadwalKenaikanGajiBerkalaAction} dan dapat
	 ...
	 *
	 * @see JadwalKenaikanGajiBerkalaAction
	 */
	class KenaikanGajiBerkalaRenderer extends ais.ui.util.MyRowRenderer {
		...
		public void render(final Row arg0, Object arg1) throws Exception {
			...
			Vbox a;
			(a = RevisiHelper.createNewRevisi(KenaikanGajiBerkala.class, kenaikanGajiBerkala,
					kenaikanGajiBerkala.getPegawai().getNama())).setParent(arg0);

			Hbox hbox = new Hbox();
			hbox.setParent(a);
			LampiranLain.createDownloadUploadFileLain(hbox, kenaikanGajiBerkala.getId(),
					KenaikanGajiBerkala.class.getName(), "Dokumen", false, null, null, false, false, false, false);
...
//			new Label(kenaikanGajiBerkala.getGaji() == null ? ""
//					: kenaikanGajiBerkala.getGaji().toString()).setParent(arg0);
			new Label(
							...
							new EventListener() {
								...
								public void onEvent(Event event) throws Exception {
									...
									if (i == MyMessageboxConfig.OK) {
										try {
											// KenaikanPangkatDao
											// kenaikanPangkatDao = DaoFactory
											// .getInstance()
											// .getKenaikanPangkatDao();
											// //
											// peraturanDao.beginTransaction();
											// kenaikanPangkatDao.delete(kenaikanPangkatDao
											// .merge(kenaikanGajiBerkala));
											// //
...
//		}
	...
	public Criteria initCriteria(boolean order) {
		...
		bawah.set(Calendar.YEAR, vMulai.get(Calendar.YEAR) - 2);
		...
		atas.set(Calendar.YEAR, vSampai.get(Calendar.YEAR) - 2);
		...
		if (order)
			criteria
					...
					.addOrder(Order.desc("tmt")).addOrder(Order.asc("pegawai"));
		...
		criteria.add(Restrictions.isNotNull("tmt"));
	...
	public void onSearchDefault(Event event) {
		...
		List<KenaikanGajiBerkala> kenaikanPangkat = initCriteria(true).setMaxResults(Common.ROWS_COUNT_ON_PAGE)
