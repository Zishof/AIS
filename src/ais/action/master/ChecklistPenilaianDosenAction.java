...
/**
 * Controller/action ZK untuk checklist penilaian dosen. Tipe ini merupakan titik masuk UI yang
 ...
 * searchprogram}, {@code Checkbox searchaktif}, {@code Combobox searchfakultas}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code initCriteria()}, {@code init()});
 * pembacaan/pencarian ({@code onSearchDefault()}); mutasi data ({@code simpanMediaKeFileSementara()}, {@code
 * onSave()}); operasi domain lain ({@code onAngketUmum()}, {@code onParameterAngketUmum()}, {@code onAdd()}).
...
public class ChecklistPenilaianDosenAction extends GenericAutowireComposer implements DataCriteria, DataInitDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link ChecklistPenilaianDosenAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link ChecklistPenilaianDosenAction} dan dapat
	 ...
	 *
	 * @see ChecklistPenilaianDosenAction
	 */
