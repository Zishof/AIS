...
/**
 * Controller/action ZK untuk kelompok status mahasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * nama}, {@code Combobox statusMahasiswa}, {@code Textbox keterangan}; inisialisasi/lifecycle ({@code
 ...
 * onManajemenStatusMahasiswa()}, {@code onAdd()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau
...
public class KelompokStatusMahasiswaAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KelompokStatusMahasiswaAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KelompokStatusMahasiswaAction} dan dapat
	 ...
	 *
	 * @see KelompokStatusMahasiswaAction
	 */
