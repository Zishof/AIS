...
/**
 * Controller/action ZK untuk ikut pertemuan. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * {@code Textbox searchnama}, {@code Combobox tahunAjaran}, {@code Combobox jenisSemester}, {@code
 * AmbilDataMatakuliahBanbox searchmatakuliah}, {@code AmbilDataDosenBanbox searchdosen}, {@code Combobox
 * searchprogram}; inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code
 * initCriteria()}); pembacaan/pencarian ({@code onSearchDefault()}, {@code loadData()}). Bagian lain dari
...
public class IkutPertemuanAction extends GenericAutowireComposer implements DataLoader {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link IkutPertemuanAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link IkutPertemuanAction} dan dapat mengakses state
