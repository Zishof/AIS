...
/**
 * Penyusun berkas ekspor Peserta Mahasiswa KKN untuk Feeder, tanpa ketergantungan pada ZK.
 *
 * <p>Badan penyusunnya DIPINDAHKAN dari {@code DownloadAktifitasMahasiwaKknPesertaMahasiswa} — bukan disalin —
 ...
 */
public final class EksporPesertaMahasiswaKknFeeder {

    private EksporPesertaMahasiswaKknFeeder() { }
		...
		List<MahasiswaDapatKelompokKkn> kelompokKkns = ConstantValues.simpleList(
				session.createCriteria(MahasiswaDapatKelompokKkn.class)
						...
						.add(saring.kelas != null && !saring.kelas.trim().isEmpty()
								? Restrictions.ilike("kelompokKkn.nama_kelompok", saring.kelas.trim(), MatchMode.EXACT)
