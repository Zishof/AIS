...
public class DownloadAktifitasMahasiwaKknPesertaMahasiswa extends MyWindow {
	...
	public DownloadAktifitasMahasiwaKknPesertaMahasiswa() {
		super();
		try {
	...
	public DownloadAktifitasMahasiwaKknPesertaMahasiswa(String title, String border, boolean closable) {
	...
	private void init() throws Exception {
		...
		print.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				...
				} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/feeder/integrator/helper/DownloadAktifitasMahasiwaKknPesertaMahasiswa.java:188");
