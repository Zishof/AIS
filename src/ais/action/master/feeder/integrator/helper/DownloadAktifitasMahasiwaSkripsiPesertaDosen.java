...
/**
 * Tipe khusus untuk download aktifitas mahasiwa skripsi peserta dosen. Kelas ini memberi nama dan
 ...
 * @see MyWindow
 */
public class DownloadAktifitasMahasiwaSkripsiPesertaDosen extends MyWindow {
	...
	public DownloadAktifitasMahasiwaSkripsiPesertaDosen() {
		super();
		try {
	...
	public DownloadAktifitasMahasiwaSkripsiPesertaDosen(String title, String border, boolean closable) {
	...
	private void init() throws Exception {
		...
		print.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				...
				} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/feeder/integrator/helper/DownloadAktifitasMahasiwaSkripsiPesertaDosen.java:189");
...
//							} else 
				...
				label.setValue("");
					...
					label.setValue("Error: " + ais.common.PesanFormalHelper.pesanGagalException(
							"pengambilan data Template Aktivitas Mahasiswa (Skripsi) untuk Dosen dari database untuk dikirim ke Neo Feeder",
							null, e,
							new String[] {
									"Periksa kembali data Skripsi serta Dosen pembimbing/penguji terkait dan coba ulangi.",
									"Pastikan data Skripsi dan Dosen terkait sudah lengkap dan tersinkron.",
