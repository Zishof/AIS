...
/**
 * Tipe khusus untuk download history. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * nimMahasiswa}; inisialisasi/lifecycle ({@code init()}, {@code initSpreadsheet()}); konfigurasi constructor:
