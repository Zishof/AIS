...
/**
 * Tipe khusus untuk download aktifitas mahasiwa skripsi peserta mahasiswa. Kelas ini memberi nama
 ...
 * @see MyWindow
 */
public class DownloadAktifitasMahasiwaSkripsiPesertaMahasiswa extends MyWindow {
	...
	public DownloadAktifitasMahasiwaSkripsiPesertaMahasiswa() {
		super();
		try {
	...
	public DownloadAktifitasMahasiwaSkripsiPesertaMahasiswa(String title, String border, boolean closable) {
	...
	private void init() throws Exception {
		...
		print.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				...
				} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/feeder/integrator/helper/DownloadAktifitasMahasiwaSkripsiPesertaMahasiswa.java:188");
