...
/**
 * Tipe khusus untuk download matakuliah. Kelas ini memberi nama dan batas tanggung jawab yang
 ...
 * searchsemester}, {@code Textbox namaMatakuliah}, {@code File file}, {@code AmbilDataKurikulumBanbox
 * kurikulum}; inisialisasi/lifecycle ({@code init()}, {@code initSpreadsheet()}); konfigurasi constructor:
 * {@code comboitem}. Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di
 * atas.</p>
