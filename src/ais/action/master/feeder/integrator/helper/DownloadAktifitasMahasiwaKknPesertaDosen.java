...
public class DownloadAktifitasMahasiwaKknPesertaDosen extends MyWindow {
	...
	private void initSpreadsheet() throws Exception {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					// Susunan berkas milik EksporPesertaDosenKknFeeder; layar ini hanya
					...
					int jumlah = ais.action.master.feeder.integrator.ekspor.EksporPesertaDosenKknFeeder.tulis(
							file, saringan,
					...
					label.setValue("Error: " + ais.common.PesanFormalHelper.pesanGagalException(
							"penyiapan berkas ekspor Peserta Dosen KKN", null, e,
							new String[] {
