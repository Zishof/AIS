...
/**
 * Tipe khusus untuk download aktifitas mahasiwa mahasiswa request tugas akhir. Kelas ini memberi
 ...
 * @see MyWindow
 */
public class DownloadAktifitasMahasiwaMahasiswaRequestTugasAkhir extends MyWindow {
	...
	public DownloadAktifitasMahasiwaMahasiswaRequestTugasAkhir() {
		super();
		try {
	...
	public DownloadAktifitasMahasiwaMahasiswaRequestTugasAkhir(String title, String border, boolean closable) {
	...
	private void init() throws Exception {
		...
		print.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				...
				} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/feeder/integrator/helper/DownloadAktifitasMahasiwaMahasiswaRequestTugasAkhir.java:187");
