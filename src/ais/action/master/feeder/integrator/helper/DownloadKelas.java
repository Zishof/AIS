...
public class DownloadKelas extends MyWindow {
	...
	private void initSpreadsheet() throws Exception {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					// Susunan berkas milik EksporKelasFeeder; layar ini hanya
					...
					int jumlah = ais.action.master.feeder.integrator.ekspor.EksporKelasFeeder.tulis(
							file, saringan,
					...
					label.setValue("Error: " + ais.common.PesanFormalHelper.pesanGagalException(
							"penyiapan berkas ekspor Kelas", null, e,
							new String[] {
