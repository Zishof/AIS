...
/**
 * Tipe khusus untuk download aktifitas mahasiwa mahasiswa request tugas akhir peserta dosen. Kelas
 * ini memberi nama dan batas tanggung jawab yang eksplisit pada perilaku yang diwarisi atau
...
public class DownloadAktifitasMahasiwaMahasiswaRequestTugasAkhirPesertaDosen extends MyWindow {
	...
	private void initSpreadsheet() throws Exception {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					// Susunan berkas milik EksporPesertaDosenBimbinganFeeder; layar ini hanya
					...
					int jumlah = ais.action.master.feeder.integrator.ekspor.EksporPesertaDosenBimbinganFeeder.tulis(
							file, saringan,
					...
					label.setValue("Error: " + ais.common.PesanFormalHelper.pesanGagalException(
							"penyiapan berkas ekspor Peserta Dosen Bimbingan", null, e,
							new String[] {
