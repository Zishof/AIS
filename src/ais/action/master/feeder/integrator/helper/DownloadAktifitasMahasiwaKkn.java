			...
			public void run() {
				...
				label.setValue("");
					...
					label.setValue("Error: " + ais.common.PesanFormalHelper.pesanGagalException(
							"pengambilan data Aktivitas KKN Mahasiswa dari database untuk diekspor ke Neo Feeder",
							null, e,
							new String[] {
									"Periksa kembali data dan filter yang dipilih (Fakultas/Prodi/Nama Kelompok/TA/Semester), lalu coba ulangi.",
									"Pastikan data Kelompok KKN terkait sudah lengkap (SK, tanggal mulai/selesai, prodi).",
