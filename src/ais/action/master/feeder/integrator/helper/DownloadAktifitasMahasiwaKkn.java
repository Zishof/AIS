...
/**
 * Tipe khusus untuk download aktifitas mahasiwa kkn. Kelas ini memberi nama dan batas tanggung
 ...
 * @see MyWindow
 */
public class DownloadAktifitasMahasiwaKkn extends MyWindow {
	...
	public DownloadAktifitasMahasiwaKkn() {
		super();
		try {
	...
	public DownloadAktifitasMahasiwaKkn(String title, String border, boolean closable) {
	...
	private void init() throws Exception {
		...
		print.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				...
				} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/feeder/integrator/helper/DownloadAktifitasMahasiwaKkn.java:186");
	...
	private void initSpreadsheet() throws Exception {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					// Susunan berkas milik EksporAktifitasKknFeeder; layar ini hanya
					...
					int jumlah = ais.action.master.feeder.integrator.ekspor.EksporAktifitasKknFeeder.tulis(
							file, saringan,
					...
					label.setValue("Error: " + ais.common.PesanFormalHelper.pesanGagalException(
							"penyiapan berkas ekspor Aktifitas KKN", null, e,
							new String[] {
