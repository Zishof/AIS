...
/**
 * Tipe khusus untuk download aktifitas mahasiwa mahasiswa request tugas akhir peserta mahasiswa.
 * Kelas ini memberi nama dan batas tanggung jawab yang eksplisit pada perilaku yang diwarisi atau
 * kontrak yang diimplementasikannya.
 *
 ...
 * @see MyWindow
 */
public class DownloadAktifitasMahasiwaMahasiswaRequestTugasAkhirPesertaMahasiswa extends MyWindow {
	...
	public DownloadAktifitasMahasiwaMahasiswaRequestTugasAkhirPesertaMahasiswa() {
		super();
		try {
	...
	public DownloadAktifitasMahasiwaMahasiswaRequestTugasAkhirPesertaMahasiswa(String title, String border,
			boolean closable) {
	...
	private void init() throws Exception {
		...
		print.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				...
				} catch (Exception e) { ais.common.ErrorAuditUtil.record(e, "auto-audit(empty-catch) src/ais/action/master/feeder/integrator/helper/DownloadAktifitasMahasiwaMahasiswaRequestTugasAkhirPesertaMahasiswa.java:189");
			...
			public void run() {
				...
				for (MahasiswaRequestTugasAkhir mahasiswaRequestTugasAkhir : mahasiswaRequestTugasAkhirs) {
					...
					if (idjenis == null || idjenis.trim().isEmpty()) {
						...
						try {
							...
							e.printStackTrace(); ais.common.ErrorAuditUtil.record(e, "auto-audit src/ais/action/master/feeder/integrator/helper/DownloadAktifitasMahasiwaMahasiswaRequestTugasAkhirPesertaMahasiswa.java:305");
						}
					}
				...
				label.setValue("");
					...
					label.setValue("Error: " + ais.common.PesanFormalHelper.pesanGagalException(
							"pengambilan data Aktivitas Mahasiswa (Request Tugas Akhir - Peserta Mahasiswa) untuk Neo Feeder",
							null, e,
							new String[] {
									"Periksa kembali koneksi ke server Neo Feeder (Pengaturan Koneksi) dan coba ulangi.",
									"Pastikan data Request Tugas Akhir dan Mahasiswa terkait sudah lengkap dan benar.",
