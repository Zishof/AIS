...
/**
 * Tipe khusus untuk feeder exporter generator. Kelas ini memberi nama dan batas tanggung jawab
 * yang eksplisit pada perilaku yang diwarisi atau kontrak yang diimplementasikannya.
 *
 * <p><b>Batas tanggung jawab:</b> gunakan tipe ini hanya untuk state dan operasi yang sesuai dengan nama
 * domainnya. Logika lintas domain harus didelegasikan ke service atau helper bersama supaya tidak muncul
 * implementasi paralel dengan hasil berbeda.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah operasi domain lain ({@code dosen_pt()}, {@code ajar_dosen()},
 * {@code mahasiswa_pt()}, {@code mahasiswa()}, {@code perkuliahan()}, {@code formatNilai()}). Bagian lain dari
