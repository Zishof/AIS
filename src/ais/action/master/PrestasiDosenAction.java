...
/**
 * Controller/action ZK untuk prestasi dosen. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * AmbilDataDosenBanbox searchdosen}, {@code MyDatebox searchmulai}, {@code Combobox searchta};
 * inisialisasi/lifecycle ({@code doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code
 * initCriteria()}); pembacaan/pencarian ({@code getDspace()}, {@code getDspaceTipePrestasiDosen()}, {@code
 * onSearchDefault()}); mutasi data ({@code onSave()}); operasi domain lain ({@code onDasbor()}, {@code
 * onKategoriPrestasiDosen()}, {@code onCabangPrestasiDosen()}, {@code onRekapCabang()}, {@code
...
public class PrestasiDosenAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PrestasiDosenAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PrestasiDosenAction} dan dapat mengakses state
