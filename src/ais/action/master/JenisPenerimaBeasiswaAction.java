...
/**
 * Controller/action ZK untuk jenis penerima beasiswa. Tipe ini merupakan titik masuk UI yang
 ...
 * validasi/perhitungan ({@code checkNamaJenisPenerimaBeasiswa()}); mutasi data ({@code onSave()}); operasi
