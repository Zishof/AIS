...
/**
 * Controller/action ZK untuk aktor sop. Tipe ini merupakan titik masuk UI yang menghubungkan event
...
public class AktorSopAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AktorSopAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AktorSopAction} dan dapat mengakses state
