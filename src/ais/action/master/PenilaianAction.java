...
/**
 * Controller/action ZK untuk penilaian. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * initAktivasiPenilaianDosen()}, {@code initAktivasiPenilaianDosen()}, {@code initCriteria()}, {@code
 * initCriteria()}); pembacaan/pencarian ({@code onUploadDanDownloadNilai()}, {@code
 * onUploadDanDownloadNilaiFormatEpsbed()}, {@code onSearchDefault()}); operasi domain lain ({@code onJenis()},
 * {@code onNilaiHuruf()}, {@code onPengajuan()}, {@code onStatistik()}, {@code onHistory()}, {@code
 * onJadwalRemedial()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di
 * atas.</p>
...
//	protected Decimalbox semester;
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PenilaianAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PenilaianAction} dan dapat mengakses state
