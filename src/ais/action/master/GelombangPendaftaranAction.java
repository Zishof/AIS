...
/**
 * Controller/action ZK untuk gelombang pendaftaran. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Textbox searchnama}, {@code Combobox searchTahunAjaran}, {@code Checkbox
 * searchaktif}, {@code Textbox kode}, {@code Textbox nama}; inisialisasi/lifecycle ({@code doBeforeCompose()},
 * {@code doAfterCompose()}, {@code init()}, {@code initCriteria()}, {@code init()}); pembacaan/pencarian ({@code
 * onSearchDefault()}); mutasi data ({@code onSave()}); operasi domain lain ({@code onKelompok()}, {@code
 * onVerifikasiKelengkapanBerkas()}, {@code onPembagianKelas()}, {@code bukaHalamanTab()}, {@code onAdd()}).
...
public class GelombangPendaftaranAction extends GenericAutowireComposer implements DataInitDefault {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link GelombangPendaftaranAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link GelombangPendaftaranAction} dan dapat
	 ...
	 *
	 * @see GelombangPendaftaranAction
	 */
