...
/**
 * DKPS Tabel 2.1-1 — Kerjasama Tridharma Bagian 1: Kerjasama Pendidikan.
 *
 * <p>Menampilkan daftar kerjasama program studi dengan lembaga mitra dalam bidang
 * pendidikan selama periode evaluasi akreditasi LAMDIK 2.0. Data mencakup identitas
 ...
 * Perguruan Tinggi, khususnya pada ranah pendidikan dan pengajaran.</p>
 *
 ...
 * dan Internasional (melibatkan lembaga luar negeri). Setiap baris diisi tanda centang
 * pada sub-kolom yang sesuai.</p>
 *
 * <h3>Sumber data</h3>
 * <p>Data diambil dari tabel {@code kerjasama} dengan filter {@code jenis='PENDIDIKAN'}.
 ...
 */
public class LaporanDkps_2_1_1_KerjasamaPendidikan extends AkreditasiBaseWindow {

    /** Kode sheet untuk konfigurasi grid, grafik, dan Excel template. */
    public static final String sheetCode = "DKPS-2.1-1";
     ...
     */
    public LaporanDkps_2_1_1_KerjasamaPendidikan() {
        super();
        try {
            initFakultasJurusan();
            buildBase(false);
     ...
     */
    public LaporanDkps_2_1_1_KerjasamaPendidikan(String title, String border, boolean closable) throws Exception {
    ...
    /**
     * Memuat data kerjasama pendidikan dari database di background thread.
     *
     * <p>Query utama mengambil data dari tabel {@code kerjasama} dengan filter
     * {@code jenis='PENDIDIKAN'}. Kolom tingkat kerjasama dipetakan ke tiga
                ...
                public void run() {
                    ...
                    try {
                        ...
                        try {
                            ...
                            queryBerhasil = true;
                        } catch (Exception ignored) { ais.common.ErrorAuditUtil.record(ignored, "auto-audit(empty-catch) src/ais/action/master/akreditasi/LaporanDkps_2_1_1_KerjasamaPendidikan.java:163");
                        }
                        ...
                        ex.printStackTrace(); ais.common.ErrorAuditUtil.record(ex, "auto-audit src/ais/action/master/akreditasi/LaporanDkps_2_1_1_KerjasamaPendidikan.java:179");
                        label.setValue("");
                    } finally {
                        if (session != null) {
                            try { session.disconnect(); } catch (Exception ignored) { ais.common.ErrorAuditUtil.record(ignored, "auto-audit(empty-catch) src/ais/action/master/akreditasi/LaporanDkps_2_1_1_KerjasamaPendidikan.java:183");}
                            try { session.close(); } catch (Exception ignored) { ais.common.ErrorAuditUtil.record(ignored, "auto-audit(empty-catch) src/ais/action/master/akreditasi/LaporanDkps_2_1_1_KerjasamaPendidikan.java:184");}
                        }
