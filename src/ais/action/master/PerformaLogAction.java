...
public class PerformaLogAction extends GenericAutowireComposer implements DataCriteria, DataSearchDefault {
    ...
    /**
     * Renderer lokal untuk layar/komponen {@link PerformaLogAction}. Kelas ini menerjemahkan satu item data
     * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
     *
     * <p><b>Scope:</b> setiap instance terikat pada instance {@link PerformaLogAction} dan dapat mengakses state
    ...
    /**
     * Pembawa data/helper lokal milik {@link PerformaLogAction} untuk dashboard data. Tipe ini mengelompokkan
     * nilai antara agar perhitungan atau rendering tidak memakai array/map tanpa kontrak yang jelas.
     *
     * <p><b>Scope:</b> tipe bersifat {@code static}; instance tidak menangkap object {@link PerformaLogAction}.
     ...
     * {@code int normal}, {@code int perhatian}, {@code int kritis}, {@code PerformaLog terkini}, {@code List
     * logs}. Aturan bisnis bersama tetap berada pada kelas induk atau service yang dipanggilnya.</p>
     *
     * @see PerformaLogAction
     */
