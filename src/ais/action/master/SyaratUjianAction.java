...
/**
 * Controller/action ZK untuk syarat ujian. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * doAfterCompose()}, {@code init()}, {@code init()}, {@code initJadwal()}, {@code initCriteria()});
 * pembacaan/pencarian ({@code onSearchDefault()}); validasi/perhitungan ({@code checkNamaSyaratUjian()}, {@code
 * checkSyaratSyaratUjian()}, {@code checkSyaratSyaratUjian()}, {@code checkSyaratSyaratUjian()}); mutasi data
 * ({@code onSave()}); operasi domain lain ({@code onAdd()}, {@code nilaiCombo()}, {@code
 * tambahkanCakupanDuplikat()}, {@code tambahkanCakupanDuplikatDenganDefault()}). Bagian lain dari kontrak tetap
...
//	private Combobox searchjurusan;
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link SyaratUjianAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link SyaratUjianAction} dan dapat mengakses state
