...
public class PengumumanPerkuliahanAction extends GenericAutowireComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		/**
		 * Event listener lokal milik {@link PengumumanPerkuliahanAction}. Kelas ini menangani event untuk komponen
		 * induk dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PengumumanPerkuliahanAction} dan dapat
		 ...
		 *
		 * @see PengumumanPerkuliahanAction
		 */
