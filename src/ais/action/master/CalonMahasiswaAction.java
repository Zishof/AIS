...
import ais.database.dao.AgamaDao;
import ais.database.dao.DaoFactory;
import ais.database.hibernate.HibernateUtil;
import ais.database.model.Agama;

/**
 * Controller/action ZK untuk calon mahasiswa. Tipe ini merupakan titik masuk UI yang menghubungkan
 ...
 * validasi/perhitungan ({@code checkNamaAgama()}); mutasi data ({@code onSave()}); operasi domain lain ({@code
 ...
 */
public class CalonMahasiswaAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link CalonMahasiswaAction}. Kelas ini menerjemahkan satu item data
	 * menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link CalonMahasiswaAction} dan dapat mengakses
	...
	private void init(Agama agama) {
		this.agama = agama;
		addWindow.setTitle(agama.getId() == null ? "Tambah Agama" : "Ubah Agama");
		...
		row.setParent(rows);
		row.appendChild(new ais.ui.util.MyLabelConfig("Nama Agama"));
	...
	public void onSearchDefault(Event event) {
		...
		List<Agama> agama = initCriteria(true)
