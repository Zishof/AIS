...
/**
 * Controller/action ZK untuk jenjang program studi. Tipe ini merupakan titik masuk UI yang
 ...
 * paging}, {@code MyGrid grid}, {@code Combobox searchjurusan}, {@code Combobox searchfakultas}, {@code Combobox
 * jurusan}, {@code Combobox jenjang}, {@code MyDatebox tanggalBerdiri}; inisialisasi/lifecycle ({@code
 * doBeforeCompose()}, {@code doAfterCompose()}, {@code init()}, {@code initCriteria()}); pembacaan/pencarian
 * ({@code onSearchDefault()}); validasi/perhitungan ({@code checkJenjangProgramStudi()}); mutasi data ({@code
...
public class JenjangProgramStudiAction extends GenericAutowireComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		/**
		 * Event listener lokal milik {@link JenjangProgramStudiAction}. Kelas ini menangani event untuk komponen induk
		 * dan meneruskan pekerjaan domain ke method/service yang sudah tersedia.
		 *
		 * <p><b>Scope:</b> setiap instance terikat pada instance {@link JenjangProgramStudiAction} dan dapat mengakses
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link JenjangProgramStudiAction}. Kelas ini menerjemahkan satu item
