...
/**
 * Controller/action ZK untuk ruang psb calon siswa detail. Tipe ini merupakan titik masuk UI yang
 ...
 * tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code RuangPSB ruangPSB}, {@code MyGrid
...
public class RuangPsbCalonSiswaDetailAction extends MyDetail implements DataCriteria {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link RuangPsbCalonSiswaDetailAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link RuangPsbCalonSiswaDetailAction} dan dapat
	 ...
	 *
	 * @see RuangPsbCalonSiswaDetailAction
	 */
