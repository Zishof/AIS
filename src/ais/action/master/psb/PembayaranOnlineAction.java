...
/**
 * Controller/action ZK untuk pembayaran online. Tipe ini merupakan titik masuk UI yang
 ...
 * pinPassword}, {@code Row tampilanPin}, {@code CalonSiswa calonSiswa}, {@code Center center}, {@code North
 * menuLogin}, {@code Combobox tahun}, {@code Combobox bulan}; inisialisasi/lifecycle ({@code doBeforeCompose()},
 * {@code doAfterCompose()}); mutasi data ({@code onReset()}); operasi domain lain ({@code onLogin()}). Bagian
