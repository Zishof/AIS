...
/**
 * Tipe khusus untuk informasi psb. Kelas ini memberi nama dan batas tanggung jawab yang eksplisit
 ...
 * {@code Tabs tabs}, {@code Tabpanels tabpanels}; inisialisasi/lifecycle ({@code init()}); pembacaan/pencarian
 * ({@code loadData()}); mutasi data ({@code prosess()}, {@code prosess()}); operasi domain lain ({@code
 * onCreate()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di atas.</p>
