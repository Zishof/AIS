 ...
 * grid}, {@code Textbox pinPassword}, {@code Row tampilanPin}, {@code CalonSiswa calonSiswa}, {@code North
 ...
 * ({@code onReset()}); operasi domain lain ({@code onLogin()}, {@code genInfo()}). Bagian lain dari kontrak
