...
import ais.action.master.GaleriFotoAction;
import ais.database.model.GaleriFoto;

/**
 * Controller/action ZK untuk galeri foto psb editor. Tipe ini merupakan titik masuk UI yang
 ...
 */
public class GaleriFotoPsbEditorAction extends GaleriFotoAction {
	...
	public GaleriFotoPsbEditorAction() {
