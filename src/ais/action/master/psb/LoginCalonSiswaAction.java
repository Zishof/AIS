...
/**
 * Controller/action ZK untuk login calon siswa. Tipe ini merupakan titik masuk UI yang
 ...
 * tumpang tindih.</p>
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code Textbox nomorInduk}, {@code Textbox
 * pinPassword}, {@code Row tampilanPin}, {@code Combobox tahun}, {@code Combobox bulan}, {@code Combobox
 * tanggal}, {@code Textbox nis}, {@code Label infoLogin}; inisialisasi/lifecycle ({@code doBeforeCompose()},
 * {@code doAfterCompose()}); mutasi data ({@code onReset()}); operasi domain lain ({@code onLogin()}, {@code
 * onLogin()}). Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang disebut di atas.</p>
