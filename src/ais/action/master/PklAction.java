...
/**
 * Controller/action ZK untuk pkl. Tipe ini merupakan titik masuk UI yang menghubungkan event layar
...
public class PklAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link PklAction}. Kelas ini menerjemahkan satu item data menjadi baris
	 * atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link PklAction} dan dapat mengakses state kelas
