...
/**
 * Controller/action ZK untuk kop surat. Tipe ini merupakan titik masuk UI yang menghubungkan event
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaKopSurat()}); mutasi data ({@code onSave()});
...
public class KopSuratAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link KopSuratAction}. Kelas ini menerjemahkan satu item data menjadi
	 * baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link KopSuratAction} dan dapat mengakses state
