...
/**
 * Controller/action ZK untuk variable surat keluar. Tipe ini merupakan titik masuk UI yang
 ...
 * onSearchDefault()}); validasi/perhitungan ({@code checkNamaVariableSuratKeluar()}); mutasi data ({@code
...
public class VariableSuratKeluarAction extends GenericAutowireComposer
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link VariableSuratKeluarAction}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link VariableSuratKeluarAction} dan dapat mengakses
