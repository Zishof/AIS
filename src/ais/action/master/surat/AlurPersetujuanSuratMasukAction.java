...
/**
 * Controller/action ZK untuk alur persetujuan surat masuk. Tipe ini merupakan titik masuk UI yang
 ...
 * jenisJabatan}, {@code Textbox nama}, {@code AmbilDataAlurPersetujuanSuratMasukBanbox parent};
...
public class AlurPersetujuanSuratMasukAction extends GenericAutowireComposer {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AlurPersetujuanSuratMasukAction}. Kelas ini menerjemahkan satu
	 * item data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AlurPersetujuanSuratMasukAction} dan dapat
	 ...
	 *
	 * @see AlurPersetujuanSuratMasukAction
	 */
