...
/**
 * Tipe khusus untuk ambil data nomor surat banbox. Kelas ini memberi nama dan batas tanggung jawab
 ...
 * SatuanKerjaTreeModel satuanKerjaTreeModel}, {@code String tipe}, {@code MyTextbox nama}, {@code MyTextbox
 * nomor}, {@code Combobox fakultas}; pembacaan/pencarian ({@code onSearchDefault()}, {@code setEventListener()},
...
public class AmbilDataNomorSuratBanbox extends Bandbox {
	...
	/**
	 * Renderer lokal untuk layar/komponen {@link AmbilDataNomorSuratBanbox}. Kelas ini menerjemahkan satu item
	 * data menjadi baris atau komponen ZK dengan memakai state dan aturan tampilan milik kelas induk.
	 *
	 * <p><b>Scope:</b> setiap instance terikat pada instance {@link AmbilDataNomorSuratBanbox} dan dapat mengakses
