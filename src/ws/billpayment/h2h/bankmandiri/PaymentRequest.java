...
/**
 * DTO permintaan SOAP bill-payment untuk payment request. Field kelas ini adalah representasi
 ...
 * java.lang.String trxDateTime}, {@code java.lang.String transmissionDateTime}, {@code java.lang.String
 * companyCode}, {@code java.lang.String channelID}, {@code java.lang.String terminalID}, {@code java.lang.String
 * billKey1}, {@code java.lang.String billKey2}; pembacaan/pencarian ({@code getLanguage()}, {@code
 * getTrxDateTime()}, {@code getTransmissionDateTime()}, {@code getCompanyCode()}, {@code getChannelID()}, {@code
 * getTerminalID()}); mutasi data ({@code setLanguage()}, {@code setTrxDateTime()}, {@code
 * setTransmissionDateTime()}, {@code setCompanyCode()}, {@code setChannelID()}, {@code setTerminalID()});
 * operasi domain lain ({@code toString()}, {@code equals()}, {@code hashCode()}). Bagian lain dari kontrak tetap
...
public class PaymentRequest implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4445006681700176344L;
	...
	private java.lang.String[] paidBills;
	...
	public String toString() {
		return "language = " + language + ", trxDateTime = " + trxDateTime
				...
				+ billKey3 + ", paidBills = " + paidBills
				+ ", paymentAmount = " + paymentAmount + ", currency = "
				+ currency + ", transactionID = " + transactionID
	...
	public PaymentRequest(java.lang.String language,
			...
			java.lang.String[] paidBills, java.lang.String paymentAmount,
			java.lang.String currency, java.lang.String transactionID,
	...
	/**
	 * Gets the language value for this PaymentRequest.
	 * 
	 * @return language
	 */
	...
	/**
	 * Sets the language value for this PaymentRequest.
	 * 
	 * @param language
	 */
	...
	/**
	 * Gets the trxDateTime value for this PaymentRequest.
	 * 
	 * @return trxDateTime
	 */
	...
	/**
	 * Sets the trxDateTime value for this PaymentRequest.
	 * 
	 * @param trxDateTime
	 */
	...
	/**
	 * Gets the transmissionDateTime value for this PaymentRequest.
	 * 
	...
	/**
	 * Sets the transmissionDateTime value for this PaymentRequest.
	 * 
	...
	/**
	 * Gets the companyCode value for this PaymentRequest.
	 * 
	 * @return companyCode
	 */
	...
	/**
	 * Sets the companyCode value for this PaymentRequest.
	 * 
	 * @param companyCode
	 */
	...
	/**
	 * Gets the channelID value for this PaymentRequest.
	 * 
	 * @return channelID
	 */
	...
	/**
	 * Sets the channelID value for this PaymentRequest.
	 * 
	 * @param channelID
	 */
	...
	/**
	 * Gets the terminalID value for this PaymentRequest.
	 * 
	 * @return terminalID
	 */
	...
	/**
	 * Sets the terminalID value for this PaymentRequest.
	 * 
	 * @param terminalID
	 */
	...
	/**
	 * Gets the billKey1 value for this PaymentRequest.
	 * 
	 * @return billKey1
	 */
	...
	/**
	 * Sets the billKey1 value for this PaymentRequest.
	 * 
	 * @param billKey1
	 */
	...
	/**
	 * Gets the billKey2 value for this PaymentRequest.
	 * 
	 * @return billKey2
	 */
	...
	/**
	 * Sets the billKey2 value for this PaymentRequest.
	 * 
	 * @param billKey2
	 */
	...
	/**
	 * Gets the billKey3 value for this PaymentRequest.
	 * 
	 * @return billKey3
	 */
	...
	/**
	 * Sets the billKey3 value for this PaymentRequest.
	 * 
	 * @param billKey3
	 */
	...
	/**
	 * Gets the paidBills value for this PaymentRequest.
	 * 
	 * @return paidBills
	 */
	public java.lang.String[] getPaidBills() {
		return paidBills;
	}

	/**
	 * Sets the paidBills value for this PaymentRequest.
	 * 
	 * @param paidBills
	 */
	public void setPaidBills(java.lang.String[] paidBills) {
		this.paidBills = paidBills;
	}

	/**
	 * Gets the paymentAmount value for this PaymentRequest.
	 * 
	...
	/**
	 * Sets the paymentAmount value for this PaymentRequest.
	 * 
	 * @param paymentAmount
	 */
	...
	/**
	 * Gets the currency value for this PaymentRequest.
	 * 
	 * @return currency
	 */
	...
	/**
	 * Sets the currency value for this PaymentRequest.
	 * 
	 * @param currency
	 */
	...
	/**
	 * Gets the transactionID value for this PaymentRequest.
	 * 
	...
	/**
	 * Sets the transactionID value for this PaymentRequest.
	 * 
	 * @param transactionID
	 */
	...
	/**
	 * Gets the reference1 value for this PaymentRequest.
	 * 
	 * @return reference1
	 */
	...
	/**
	 * Sets the reference1 value for this PaymentRequest.
	 * 
	 * @param reference1
	 */
	...
	/**
	 * Gets the reference2 value for this PaymentRequest.
	 * 
	 * @return reference2
	 */
	...
	/**
	 * Sets the reference2 value for this PaymentRequest.
	 * 
	 * @param reference2
	 */
	...
	/**
	 * Gets the reference3 value for this PaymentRequest.
	 * 
	 * @return reference3
	 */
	...
	/**
	 * Sets the reference3 value for this PaymentRequest.
	 * 
	 * @param reference3
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& ((this.paidBills == null && other.getPaidBills() == null) || (this.paidBills != null && java.util.Arrays
						.equals(this.paidBills, other.getPaidBills())))
				&& ((this.paymentAmount == null && other.getPaymentAmount() == null) || (this.paymentAmount != null && this.paymentAmount
						.equals(other.getPaymentAmount())))
	...
	public synchronized int hashCode() {
		...
		if (getPaidBills() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getPaidBills()); i++) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			PaymentRequest.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName(
				"bankmandiri.h2h.billpayment.ws", "PaymentRequest"));
		...
		typeDesc.addFieldDesc(elemField);
		elemField = new org.apache.axis.description.ElementDesc();
		elemField.setFieldName("paidBills");
		elemField.setXmlName(new javax.xml.namespace.QName(
				"bankmandiri.h2h.billpayment.ws", "paidBills"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName(
				"bankmandiri.h2h.billpayment.ws", "string"));
		typeDesc.addFieldDesc(elemField);
		elemField = new org.apache.axis.description.ElementDesc();
		elemField.setFieldName("paymentAmount");
		elemField.setXmlName(new javax.xml.namespace.QName(
				"bankmandiri.h2h.billpayment.ws", "paymentAmount"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"bankmandiri.h2h.billpayment.ws", "transactionID"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
