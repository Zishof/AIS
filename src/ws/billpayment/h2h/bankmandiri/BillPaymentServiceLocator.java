...
public class BillPaymentServiceLocator extends org.apache.axis.client.Service implements ws.billpayment.h2h.bankmandiri.BillPaymentService {
    ...
    private java.lang.String BillPaymentServiceSoap_address = "http://localhost:1111/exUBP/server.php";
    ...
    public ws.billpayment.h2h.bankmandiri.BillPaymentServiceSoap getBillPaymentServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ws.billpayment.h2h.bankmandiri.BillPaymentServiceSoapStub _stub = new ws.billpayment.h2h.bankmandiri.BillPaymentServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.billpayment.h2h.bankmandiri.BillPaymentServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                ws.billpayment.h2h.bankmandiri.BillPaymentServiceSoapStub _stub = new ws.billpayment.h2h.bankmandiri.BillPaymentServiceSoapStub(new java.net.URL(BillPaymentServiceSoap_address), this);
                _stub.setPortName(getBillPaymentServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("bankmandiri.h2h.billpayment.ws", "BillPaymentService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("bankmandiri.h2h.billpayment.ws", "BillPaymentServiceSoap"));
        }
