...
/**
 * DTO respons SOAP bill-payment untuk reversal response. Field kelas ini membawa status dan data
 ...
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code ws.billpayment.h2h.bankmandiri.Status
 * status}, {@code java.lang.Object __equalsCalc}, {@code boolean __hashCodeCalc}, {@code
 * org.apache.axis.description.TypeDesc typeDesc}; pembacaan/pencarian ({@code getStatus()}, {@code
 * getTypeDesc()}, {@code getSerializer()}, {@code getDeserializer()}); mutasi data ({@code setStatus()});
