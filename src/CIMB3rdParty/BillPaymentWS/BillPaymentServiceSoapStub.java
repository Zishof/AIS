 ...
 * ({@code _initOperationDesc1()}); operasi domain lain ({@code createCall()}, {@code inquiry()}, {@code
 * payment()}, {@code echoTest()}); konfigurasi constructor: {@code cachedEndpoint}, {@code cls}, {@code qName},
 * {@code qName2}, {@code service}. Bagian lain dari kontrak tetap mengikuti kelas induk atau interface yang
 * disebut di atas.</p>
