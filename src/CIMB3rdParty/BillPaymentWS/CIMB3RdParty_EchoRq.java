...
/**
 * DTO permintaan SOAP bill-payment untuk cimb3 rd party echo rq. Field kelas ini adalah
 ...
 * <p>Perbedaan lokal yang dapat diamati adalah state lokal utama: {@code java.lang.String echoRequest}, {@code
 * java.lang.Object __equalsCalc}, {@code boolean __hashCodeCalc}, {@code org.apache.axis.description.TypeDesc
 * typeDesc}; pembacaan/pencarian ({@code getEchoRequest()}, {@code getTypeDesc()}, {@code getSerializer()},
 * {@code getDeserializer()}); mutasi data ({@code setEchoRequest()}); operasi domain lain ({@code equals()},
