...
| eSchool | Belum menjadi vertical penuh | Baru tersedia pondasi education dan banyak fitur bisa diturunkan dari ePesantren. |
...
Status saat ini: sebagian. Input nilai dan skala huruf sudah ada. Cetak rapor resmi, leger, ranking, validasi wali kelas, dan promosi kelas masih perlu dilengkapi.
...
Status saat ini: sebagian kuat di ePesantren. Perlu menu eSchool sendiri dan template resmi sekolah.
